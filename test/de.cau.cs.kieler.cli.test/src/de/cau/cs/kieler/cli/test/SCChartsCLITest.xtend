...
class SCChartsCLITest extends AbstractCLITest {
    ...
    def void testComplexCompile() {
        ...
        assertExists(new File(wd, "kieler-gen/abo.sctx/de.cau.cs.kieler.sccharts.processors.triggerEffect/abo.sctx"))
        assertExists(new File(wd, "kieler-gen/abo.sctx/de.cau.cs.kieler.sccharts.scg.processors.SCG/abo.scg"))
    }
}
