 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.s.s.Term#getContinuation <em>Continuation</em>}</li>
 * </ul>
 *
 * @see de.cau.cs.kieler.s.s.SPackage#getTerm()
 * @model
 * @generated
 */
public interface Term extends Instruction
{
  /**
   ...
   * @see de.cau.cs.kieler.s.s.SPackage#getTerm_Continuation()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.s.s.Term#getContinuation <em>Continuation</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
