package de.cau.cs.kieler.tickrunner;
/*
...
/**
 * The KIELER Tick Runner is a command line tool for running and evaluating
 * different compiled tick functions with ESO files.
 * 
 * @author cmot
 * @kieler.design 2015-06-08 proposed
 * @kieler.rating 2015-06-08 proposed yellow
 * 
 */
public class KielerTickRunner {
        ...
        if (args.length < 1 || args[0].startsWith("-")) {
            System.out
                    .println("\n"
                            ...
                            + "======================\n"
                            + "Usage: \n"
                            + "  KielerTickRunner -f file [Options]\n"
                            + "Example 4:\n"
