...
public class KitsQuickfixProvider extends DefaultQuickfixProvider {
    ...
    @Fix(KitsJavaValidator.MISSING_PRIO)
        ...
        acceptor.accept(issue, "Determine missing transition priority",
                ...
                new ISemanticModification() {
                    ...
                    public void apply(EObject element, IModificationContext context) throws Exception {
                        ...
                        if (SyncchartsPackage.eINSTANCE.getState().isInstance(element)) {
    ...
    @Fix(KitsJavaValidator.NON_UNIQUE_PRIO)
   ...
   @Fix(KitsJavaValidator.NO_PRIO_1_TRANSITION)
    ...
    @Fix(KitsJavaValidator.UNSORTED_PRIOS)
