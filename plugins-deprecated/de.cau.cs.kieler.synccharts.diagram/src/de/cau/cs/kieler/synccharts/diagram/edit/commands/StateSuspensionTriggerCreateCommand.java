 ...
 * @generated
 */
public class StateSuspensionTriggerCreateCommand extends EditElementCommand {

    /**
     * @generated
     */
    public StateSuspensionTriggerCreateCommand(CreateElementRequest req) {
    ...
    public boolean canExecute() {
        ...
        if (container.getSuspensionTrigger() != null) {
            return false;
        }
        return true;
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
        ...
        owner.setSuspensionTrigger(newElement);
