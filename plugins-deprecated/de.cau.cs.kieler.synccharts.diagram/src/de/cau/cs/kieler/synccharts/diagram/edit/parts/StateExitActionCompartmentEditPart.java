...
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateExitActionCompartmentCanonicalEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateExitActionCompartmentItemSemanticEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.part.Messages;

/**
 * @generated
 */
public class StateExitActionCompartmentEditPart extends ShapeCompartmentEditPart {
     ...
     * @generated
     */
    public StateExitActionCompartmentEditPart(View view) {
        super(view);
    }
    ...
    public String getCompartmentName() {
        return Messages.StateExitActionCompartmentEditPart_title;
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
                new StateExitActionCompartmentItemSemanticEditPolicy());
        installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());
        installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
        installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
                new StateExitActionCompartmentCanonicalEditPolicy());
    }
