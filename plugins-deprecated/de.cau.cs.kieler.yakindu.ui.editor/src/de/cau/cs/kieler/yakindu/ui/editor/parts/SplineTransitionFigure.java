 ...
 * @author ckru
 */
public class SplineTransitionFigure extends TransitionFigure {
    ...
    public static class ArrowLocatorEx extends ArrowLocator {
        ...
        public void relocate(final IFigure target) {
            ...
            if (getConnection() instanceof SplineTransitionFigure) {
                SplineTransitionFigure spline = (SplineTransitionFigure) getConnection();
                if (spline.getSplineMode() == SplineTransitionFigure.SPLINE_CUBIC) {
                ...
                } else if (spline.getSplineMode() == SplineTransitionFigure.SPLINE_CUBIC_APPROX) {
