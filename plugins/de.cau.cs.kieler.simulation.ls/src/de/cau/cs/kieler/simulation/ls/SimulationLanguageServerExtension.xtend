...
import de.cau.cs.kieler.kicool.ls.KiCoolLanguageServerExtension
...
import de.cau.cs.kieler.simulation.ide.processor.ClientInputs
import de.cau.cs.kieler.simulation.ide.processor.LSUserValues
import de.cau.cs.kieler.simulation.ide.server.SimulationServer
import de.cau.cs.kieler.simulation.ls.data.LoadedTraceMessage
import de.cau.cs.kieler.simulation.ls.data.SavedTraceMessage
import de.cau.cs.kieler.simulation.ls.data.SimulationStartedMessage
import de.cau.cs.kieler.simulation.ls.data.SimulationStepMessage
import de.cau.cs.kieler.simulation.ls.data.SimulationStoppedMessage
...
import static de.cau.cs.kieler.simulation.ide.processor.ClientInputs.*
...
class SimulationLanguageServerExtension implements ILanguageServerExtension, SimulationCommandExtension, ISimulationListener, ILanguageClientProvider {
    ...
    override synchronized step(JsonObject valuesForNextStep, String simulationType) {
        // Set the values used by the UserValues processor de.cau.cs.kieler.simulation.ls.uservalues
