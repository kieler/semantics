...
public interface CircuitPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ACTOR__ANNOTATIONS = AnnotationsPackage.NAMED_OBJECT__ANNOTATIONS;
	 ...
	 * @ordered
	 */
	int ACTOR__NAME = AnnotationsPackage.NAMED_OBJECT__NAME;
	 ...
	 * @ordered
	 */
	int ACTOR__OUTGOING_LINKS = AnnotationsPackage.NAMED_OBJECT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ACTOR__INCOMING_LINKS = AnnotationsPackage.NAMED_OBJECT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ACTOR__INNER_ACTORS = AnnotationsPackage.NAMED_OBJECT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int ACTOR__INNER_LINKS = AnnotationsPackage.NAMED_OBJECT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int ACTOR__PORTS = AnnotationsPackage.NAMED_OBJECT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int ACTOR__TYPE = AnnotationsPackage.NAMED_OBJECT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int ACTOR_FEATURE_COUNT = AnnotationsPackage.NAMED_OBJECT_FEATURE_COUNT + 6;
