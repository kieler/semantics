		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStateAccess().getAlternatives_13(), "rule__State__Alternatives_13");
					put(grammarAccess.getStateAccess().getOutgoingTransitionsAlternatives_13_1_2_0(), "rule__State__OutgoingTransitionsAlternatives_13_1_2_0");
					...
					put(grammarAccess.getStateAccess().getGroup_13_1(), "rule__State__Group_13_1__0");
					put(grammarAccess.getStateAccess().getGroup_13_1_0(), "rule__State__Group_13_1_0__0");
					put(grammarAccess.getStateAccess().getGroup_13_1_0_2(), "rule__State__Group_13_1_0_2__0");
					put(grammarAccess.getStateAccess().getGroup_13_1_1(), "rule__State__Group_13_1_1__0");
					...
					put(grammarAccess.getStateAccess().getInterfaceDeclarationAssignment_8(), "rule__State__InterfaceDeclarationAssignment_8");
					...
					put(grammarAccess.getStateAccess().getRegionsAssignment_13_1_0_1(), "rule__State__RegionsAssignment_13_1_0_1");
					put(grammarAccess.getStateAccess().getRegionsAssignment_13_1_0_2_1(), "rule__State__RegionsAssignment_13_1_0_2_1");
					put(grammarAccess.getStateAccess().getBodyTextAssignment_13_1_1_1(), "rule__State__BodyTextAssignment_13_1_1_1");
					put(grammarAccess.getStateAccess().getOutgoingTransitionsAssignment_13_1_2(), "rule__State__OutgoingTransitionsAssignment_13_1_2");
