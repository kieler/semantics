		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTextualTransitionAccess().getMakeConditionalAlternatives_1_0(), "rule__TextualTransition__MakeConditionalAlternatives_1_0");
					...
					put(grammarAccess.getTextualTransitionAccess().getGroup_4(), "rule__TextualTransition__Group_4__0");
					put(grammarAccess.getTextualTransitionAccess().getGroup_4_2(), "rule__TextualTransition__Group_4_2__0");
					put(grammarAccess.getTextualTransitionAccess().getGroup_4_3(), "rule__TextualTransition__Group_4_3__0");
					put(grammarAccess.getTextualTransitionAccess().getGroup_4_3_1(), "rule__TextualTransition__Group_4_3_1__0");
					put(grammarAccess.getTextualTransitionAccess().getGroup_4_3_1_1(), "rule__TextualTransition__Group_4_3_1_1__0");
					...
					put(grammarAccess.getTextualTransitionAccess().getMakeConditionalAssignment_1(), "rule__TextualTransition__MakeConditionalAssignment_1");
					put(grammarAccess.getTextualTransitionAccess().getMakeFinalAssignment_2(), "rule__TextualTransition__MakeFinalAssignment_2");
					put(grammarAccess.getTextualTransitionAccess().getTargetStateProxyAssignment_3(), "rule__TextualTransition__TargetStateProxyAssignment_3");
					put(grammarAccess.getTextualTransitionAccess().getIsImmediateAssignment_4_1(), "rule__TextualTransition__IsImmediateAssignment_4_1");
					put(grammarAccess.getTextualTransitionAccess().getDelayAssignment_4_2_1(), "rule__TextualTransition__DelayAssignment_4_2_1");
					put(grammarAccess.getTextualTransitionAccess().getTriggerAssignment_4_3_0(), "rule__TextualTransition__TriggerAssignment_4_3_0");
					put(grammarAccess.getTextualTransitionAccess().getEffectsAssignment_4_3_1_1_0(), "rule__TextualTransition__EffectsAssignment_4_3_1_1_0");
					put(grammarAccess.getTextualTransitionAccess().getIsHistoryAssignment_5(), "rule__TextualTransition__IsHistoryAssignment_5");
