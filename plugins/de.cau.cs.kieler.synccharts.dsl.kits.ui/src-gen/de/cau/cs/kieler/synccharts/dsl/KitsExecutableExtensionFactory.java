 ...
 * generated
 */
public class KitsExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(KitsExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		de.cau.cs.kieler.synccharts.dsl.internal.KitsActivator instance = de.cau.cs.kieler.synccharts.dsl.internal.KitsActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = de.cau.cs.kieler.synccharts.dsl.internal.KitsActivator.getInstance().getInjector("de.cau.cs.kieler.synccharts.dsl.Kits");
