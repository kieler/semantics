package de.cau.cs.kieler.synccharts.dsl.rtsys.glue.actions;
...
public class OpenXtextDeclarationTool {
	...
	private static final String EDITOR_ID = "de.cau.cs.kieler.synccharts.dsl.RetypingSynccharts";
	...
	public static void openXtextDeclaration(URI semanticElementURI,
		...
		EObject semanticElement = eResource.getResourceSet().getEObject(semanticElementURI, true);
