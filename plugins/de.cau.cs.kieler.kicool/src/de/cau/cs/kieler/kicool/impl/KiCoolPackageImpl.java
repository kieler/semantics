...
public class KiCoolPackageImpl extends EPackageImpl implements KiCoolPackage {
     ...
     * @generated
     */
    public EReference getProcessorReference_Context() {
    ...
    public void createPackageContents() {
        ...
        createEReference(processorReferenceEClass, PROCESSOR_REFERENCE__CONTEXT);
    ...
    public void initializePackageContents() {
        ...
        intermediateReferenceEClass.getESuperTypes().add(this.getProcessorEntry());
        ...
        initEReference(getProcessorReference_Context(), this.getProcessorContext(), null, "context", null, 0, 1, ProcessorReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
