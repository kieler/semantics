...
public class InternalKiCoolLexer extends Lexer {
    ...
    public final void mRULE_COMMENT_ANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1875:25: ( '/**' ( options {greedy=false; } : . )* '*/' )
            // InternalKiCool.g:1875:27: '/**' ( options {greedy=false; } : . )* '*/'
            {
            match("/**"); 

            // InternalKiCool.g:1875:33: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1877:17: ( '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/' )
            // InternalKiCool.g:1877:19: '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 
            ...
            // InternalKiCool.g:1877:31: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_SL_COMMENT_ANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1879:28: ( '//*' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalKiCool.g:1879:30: '//*' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//*"); 

            // InternalKiCool.g:1879:36: (~ ( ( '\\n' | '\\r' ) ) )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1881:17: ( '//' ~ ( '*' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalKiCool.g:1881:19: '//' ~ ( '*' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            // InternalKiCool.g:1883:22: ( '0' .. '9' )
            // InternalKiCool.g:1883:24: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1885:10: ( ( RULE_NUMBER )+ )
            // InternalKiCool.g:1885:12: ( RULE_NUMBER )+
            {
            // InternalKiCool.g:1885:12: ( RULE_NUMBER )+
            int cnt9=0;
            loop9:
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1887:12: ( ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' ) )
            // InternalKiCool.g:1887:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            {
            // InternalKiCool.g:1887:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // InternalKiCool.g:1887:15: ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )?
                    {
                    // InternalKiCool.g:1887:15: ( RULE_NUMBER )+
                    int cnt10=0;
                    loop10:
                    do {
                        int alt10=2;
                    ...
                    match('.'); 
                    // InternalKiCool.g:1887:32: ( RULE_NUMBER )*
                    loop11:
                    do {
                        int alt11=2;
                    ...
                    // InternalKiCool.g:1887:45: ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )?
                    int alt14=2;
                    ...
                    switch (alt14) {
                        case 1 :
                            // InternalKiCool.g:1887:46: ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+
                            {
                            ...
                            // InternalKiCool.g:1887:67: ( RULE_NUMBER )+
                            int cnt13=0;
                            loop13:
                            do {
                                int alt13=2;
                    ...
                    break;
                case 2 :
                    // InternalKiCool.g:1887:87: ( RULE_NUMBER )+ 'f'
                    {
                    // InternalKiCool.g:1887:87: ( RULE_NUMBER )+
                    int cnt16=0;
                    loop16:
                    do {
                        int alt16=2;
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1889:14: ( ( 'true' | 'false' ) )
            // InternalKiCool.g:1889:16: ( 'true' | 'false' )
            {
            // InternalKiCool.g:1889:16: ( 'true' | 'false' )
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalKiCool.g:1889:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1891:13: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalKiCool.g:1891:15: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalKiCool.g:1891:19: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
            loop19:
            do {
                int alt19=3;
                ...
                switch (alt19) {
            	case 1 :
            	    // InternalKiCool.g:1891:20: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1893:9: ( ( '^' )? ( ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' ) | '_' '0' .. '9' | '__' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalKiCool.g:1893:11: ( '^' )? ( ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' ) | '_' '0' .. '9' | '__' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalKiCool.g:1893:11: ( '^' )?
            int alt20=2;
            ...
            // InternalKiCool.g:1893:16: ( ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' ) | '_' '0' .. '9' | '__' )
            int alt24=3;
            ...
            switch (alt24) {
                case 1 :
                    // InternalKiCool.g:1893:17: ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' )
                    {
                    // InternalKiCool.g:1893:17: ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' )
                    int alt23=2;
                    switch ( input.LA(1) ) {
                    ...
                    switch (alt23) {
                        case 1 :
                            // InternalKiCool.g:1893:18: ( '_' )? 'a' .. 'z'
                            {
                            // InternalKiCool.g:1893:18: ( '_' )?
                            int alt21=2;
                            ...
                            break;
                        case 2 :
                            // InternalKiCool.g:1893:32: ( '_' )? 'A' .. 'Z'
                            {
                            // InternalKiCool.g:1893:32: ( '_' )?
                            int alt22=2;
                    ...
                    break;
                case 2 :
                    // InternalKiCool.g:1893:47: '_' '0' .. '9'
                    {
                    match('_'); 
                    matchRange('0','9'); 
            ...
            // InternalKiCool.g:1893:66: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop25:
            do {
                int alt25=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1895:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalKiCool.g:1895:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalKiCool.g:1895:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt26=0;
            loop26:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1897:16: ( . )
            // InternalKiCool.g:1897:18: .
            {
            matchAny(); 
    ...
    static class DFA17 extends DFA {
        ...
        public String getDescription() {
            return "1887:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )";
        }
    }
    static final String DFA27_eotS =
        "\1\uffff\5\35\2\uffff\1\35\1\uffff\1\35\5\uffff\1\32\1\57\2\35\3\32\4\uffff\2\35\1\uffff\4\35\2\uffff\2\35\1\uffff\1\35\11\uffff\1\57\2\35\2\uffff\1\35\1\107\5\35\1\115\1\35\1\117\4\uffff\3\35\1\uffff\5\35\1\uffff\1\130\1\uffff\1\131\3\35\1\135\1\136\1\35\1\140\2\uffff\1\131\1\141\1\35\2\uffff\1\35\2\uffff\1\144\1\35\1\uffff\4\35\1\152\1\uffff";
    ...
    static final String DFA27_maxS =
        "\1\uffff\1\171\1\145\1\141\1\156\1\154\2\uffff\1\162\1\uffff\1\145\5\uffff\1\57\1\146\1\162\1\141\1\uffff\2\172\4\uffff\1\163\1\164\1\uffff\1\162\1\142\1\164\1\151\2\uffff\1\145\1\163\1\uffff\1\171\5\uffff\2\uffff\2\uffff\1\146\1\165\1\154\2\uffff\1\164\1\172\1\163\1\145\1\165\1\145\1\141\1\172\1\164\1\172\4\uffff\1\145\1\163\1\145\1\uffff\1\151\1\154\1\164\1\162\1\163\1\uffff\1\172\1\uffff\1\172\1\145\1\155\1\157\2\172\1\155\1\172\2\uffff\2\172\1\156\2\uffff\1\145\2\uffff\1\172\1\144\1\uffff\1\151\1\141\1\164\1\145\1\172\1\uffff";
    static final String DFA27_acceptS =
        "\6\uffff\1\10\1\11\1\uffff\1\14\1\uffff\1\16\1\17\1\20\1\21\1\22\7\uffff\2\33\1\34\1\35\2\uffff\1\33\4\uffff\1\10\1\11\2\uffff\1\14\1\uffff\1\16\1\17\1\20\1\21\1\22\2\uffff\1\27\1\30\3\uffff\1\32\1\34\12\uffff\1\23\1\24\1\25\1\26\3\uffff\1\5\5\uffff\1\12\1\uffff\1\15\10\uffff\1\13\1\31\3\uffff\1\3\1\4\1\uffff\1\7\1\1\2\uffff\1\2\5\uffff\1\6";
    static final String DFA27_specialS =
        "\1\1\23\uffff\1\3\30\uffff\1\0\1\2\74\uffff}>";
