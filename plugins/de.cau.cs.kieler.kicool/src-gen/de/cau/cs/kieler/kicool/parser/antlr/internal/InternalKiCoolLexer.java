...
public class InternalKiCoolLexer extends Lexer {
    ...
    public final void mRULE_COMMENT_ANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1853:25: ( '/**' ( options {greedy=false; } : . )* '*/' )
            // InternalKiCool.g:1853:27: '/**' ( options {greedy=false; } : . )* '*/'
            {
            match("/**"); 

            // InternalKiCool.g:1853:33: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1855:17: ( '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/' )
            // InternalKiCool.g:1855:19: '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 
            ...
            // InternalKiCool.g:1855:31: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_SL_COMMENT_ANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1857:28: ( '//*' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalKiCool.g:1857:30: '//*' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//*"); 

            // InternalKiCool.g:1857:36: (~ ( ( '\\n' | '\\r' ) ) )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1859:17: ( '//' ~ ( '*' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalKiCool.g:1859:19: '//' ~ ( '*' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            // InternalKiCool.g:1861:22: ( '0' .. '9' )
            // InternalKiCool.g:1861:24: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1863:10: ( ( RULE_NUMBER )+ )
            // InternalKiCool.g:1863:12: ( RULE_NUMBER )+
            {
            // InternalKiCool.g:1863:12: ( RULE_NUMBER )+
            int cnt9=0;
            loop9:
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1865:12: ( ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' ) )
            // InternalKiCool.g:1865:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            {
            // InternalKiCool.g:1865:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // InternalKiCool.g:1865:15: ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )?
                    {
                    // InternalKiCool.g:1865:15: ( RULE_NUMBER )+
                    int cnt10=0;
                    loop10:
                    do {
                        int alt10=2;
                    ...
                    match('.'); 
                    // InternalKiCool.g:1865:32: ( RULE_NUMBER )*
                    loop11:
                    do {
                        int alt11=2;
                    ...
                    // InternalKiCool.g:1865:45: ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )?
                    int alt14=2;
                    ...
                    switch (alt14) {
                        case 1 :
                            // InternalKiCool.g:1865:46: ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+
                            {
                            ...
                            // InternalKiCool.g:1865:67: ( RULE_NUMBER )+
                            int cnt13=0;
                            loop13:
                            do {
                                int alt13=2;
                    ...
                    break;
                case 2 :
                    // InternalKiCool.g:1865:87: ( RULE_NUMBER )+ 'f'
                    {
                    // InternalKiCool.g:1865:87: ( RULE_NUMBER )+
                    int cnt16=0;
                    loop16:
                    do {
                        int alt16=2;
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1867:14: ( ( 'true' | 'false' ) )
            // InternalKiCool.g:1867:16: ( 'true' | 'false' )
            {
            // InternalKiCool.g:1867:16: ( 'true' | 'false' )
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalKiCool.g:1867:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1869:13: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalKiCool.g:1869:15: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalKiCool.g:1869:19: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
            loop19:
            do {
                int alt19=3;
                ...
                switch (alt19) {
            	case 1 :
            	    // InternalKiCool.g:1869:20: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1871:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalKiCool.g:1871:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalKiCool.g:1871:11: ( '^' )?
            int alt20=2;
            ...
            // InternalKiCool.g:1871:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop21:
            do {
                int alt21=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1873:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalKiCool.g:1873:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalKiCool.g:1873:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt22=0;
            loop22:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:1875:16: ( . )
            // InternalKiCool.g:1875:18: .
            {
            matchAny(); 
    ...
    static class DFA17 extends DFA {
        ...
        public String getDescription() {
            return "1865:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )";
        }
    }
    static final String DFA23_eotS =
        "\1\uffff\5\33\2\uffff\1\33\1\uffff\1\33\5\uffff\1\30\1\55\2\33\2\30\3\uffff\2\33\1\uffff\4\33\2\uffff\2\33\1\uffff\1\33\10\uffff\1\55\1\uffff\2\33\2\uffff\1\33\1\105\5\33\1\113\1\33\1\115\4\uffff\3\33\1\uffff\5\33\1\uffff\1\126\1\uffff\1\127\3\33\1\133\1\134\1\33\1\136\2\uffff\1\127\1\137\1\33\2\uffff\1\33\2\uffff\1\142\1\33\1\uffff\4\33\1\150\1\uffff";
    static final String DFA23_eofS =
        "\151\uffff";
    static final String DFA23_minS =
        "\1\0\2\145\1\141\1\156\1\154\2\uffff\1\157\1\uffff\1\145\5\uffff\1\52\1\56\1\162\1\141\1\0\1\101\3\uffff\1\163\1\164\1\uffff\1\162\1\142\1\160\1\151\2\uffff\1\145\1\163\1\uffff\1\171\5\uffff\2\0\1\uffff\1\56\1\uffff\1\165\1\154\2\uffff\1\164\1\60\1\163\1\145\1\165\1\145\1\141\1\60\1\164\1\60\4\uffff\1\145\1\163\1\145\1\uffff\1\151\1\154\1\164\1\162\1\163\1\uffff\1\60\1\uffff\1\60\1\145\1\155\1\157\2\60\1\155\1\60\2\uffff\2\60\1\156\2\uffff\1\145\2\uffff\1\60\1\144\1\uffff\1\151\1\141\1\164\1\145\1\60\1\uffff";
    static final String DFA23_maxS =
        "\1\uffff\1\171\1\145\1\141\1\156\1\154\2\uffff\1\162\1\uffff\1\145\5\uffff\1\57\1\146\1\162\1\141\1\uffff\1\172\3\uffff\1\163\1\164\1\uffff\1\162\1\142\1\164\1\151\2\uffff\1\145\1\163\1\uffff\1\171\5\uffff\2\uffff\1\uffff\1\146\1\uffff\1\165\1\154\2\uffff\1\164\1\172\1\163\1\145\1\165\1\145\1\141\1\172\1\164\1\172\4\uffff\1\145\1\163\1\145\1\uffff\1\151\1\154\1\164\1\162\1\163\1\uffff\1\172\1\uffff\1\172\1\145\1\155\1\157\2\172\1\155\1\172\2\uffff\2\172\1\156\2\uffff\1\145\2\uffff\1\172\1\144\1\uffff\1\151\1\141\1\164\1\145\1\172\1\uffff";
    static final String DFA23_acceptS =
        "\6\uffff\1\7\1\10\1\uffff\1\14\1\uffff\1\16\1\17\1\20\1\21\1\22\6\uffff\1\33\1\34\1\35\2\uffff\1\33\4\uffff\1\7\1\10\2\uffff\1\14\1\uffff\1\16\1\17\1\20\1\21\1\22\2\uffff\1\27\1\uffff\1\30\2\uffff\1\32\1\34\12\uffff\1\23\1\24\1\25\1\26\3\uffff\1\12\5\uffff\1\11\1\uffff\1\15\10\uffff\1\13\1\31\3\uffff\1\3\1\4\1\uffff\1\6\1\1\2\uffff\1\2\5\uffff\1\5";
