...
public class LatexTableExporter extends AbstractTableExporter {
    ...
    /** The column where the number of steps is located. */
    ...
    public String exportData(final PanelData data) {
        ...
        String name = data.getExecFileName();
        ...
        builder.append("\\label{figure:" + name + "Output}" + NEWLINE);
    ...
    private String buildTable(final String[][] table) {
        ...
        while (i < table.length - 1) {
            while (table[++i][0].equals(currentHead)) {
