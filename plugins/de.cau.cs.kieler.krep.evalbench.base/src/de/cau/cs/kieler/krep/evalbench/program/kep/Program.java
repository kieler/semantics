...
public class Program {
	...
	if (this.signals.containsKey(name.trim().toUpperCase())) {
	    ...
	    this.signals.put(name.trim().toUpperCase(), new KepSignal(name.trim()
		    .toUpperCase(), t, this.signals.size()));
	...
	ArrayList<KepSignal> sigs = new ArrayList<KepSignal>(this.signals.values());
