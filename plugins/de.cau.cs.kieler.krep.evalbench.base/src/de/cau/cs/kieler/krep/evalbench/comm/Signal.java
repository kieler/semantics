...
public class Signal implements Comparable<Signal>{
     ...
     *            signal index
     */
    public Signal(String name, boolean status, Integer value, HashMap<String, Integer> index) {
     ...
     * @param value value if valued, null for pure signal
     * @param index index in the current program
     */
    public Signal(final String name, final boolean status, final Integer value, final Integer index) {
    	IPreferenceStore preferenceStore = Activator.getDefault()
		.getPreferenceStore();
      if(preferenceStore.getBoolean(VerifyPreferencePage.CASE_SENSITIVE)){
    		this.name = name;
     ...
     */
    public Signal(String name, Integer value) {
    	IPreferenceStore preferenceStore = Activator.getDefault()
		.getPreferenceStore();
      if(preferenceStore.getBoolean(VerifyPreferencePage.CASE_SENSITIVE)){
