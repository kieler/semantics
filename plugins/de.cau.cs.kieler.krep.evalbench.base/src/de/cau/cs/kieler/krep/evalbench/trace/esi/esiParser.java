...
public class esiParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "ID", "NUMBER", "Letter", "Digit", "WHITESPACE", "COMMENT", "'!'", "'reset'", "';'", "'%'", "'Output'", "':'", "'('", "')'"
    };
    ...
    public String[] getTokenNames() { return esiParser.tokenNames; }
    ...
    // $ANTLR start "parse"
    // esi.g:49:1: parse[IAssembler asm] returns [LinkedList<Trace> traces] : l= tracelist ;
    public final LinkedList<Trace> parse(IAssembler asm) throws RecognitionException {
        LinkedList<Trace> traces = null;
    ...
    // esi.g:55:1: tracelist returns [LinkedList<Trace> traces] : (t= trace | ( ( '!' 'reset' ';' t= trace )+ ) ) ;
    ...
    // $ANTLR start "tick"
    // esi.g:72:1: tick returns [Tick t] : inputs= signals ( '%' 'Output' ':' outputs= signals )? ';' ;
            ...
            switch (alt6) {
                case 1 :
                    ...
                    i=(Token)match(input,ID,FOLLOW_ID_in_signal256); 
                     s = new Signal((i!=null?i.getText():null), true, null, index); 
    ...
    public static final BitSet FOLLOW_tracelist_in_parse45 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_trace_in_tracelist80 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_10_in_tracelist92 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_11_in_tracelist94 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_12_in_tracelist96 = new BitSet(new long[]{0x0000000000003410L});
    public static final BitSet FOLLOW_trace_in_tracelist100 = new BitSet(new long[]{0x0000000000000402L});
    public static final BitSet FOLLOW_tick_in_trace144 = new BitSet(new long[]{0x0000000000003012L});
    public static final BitSet FOLLOW_signals_in_tick178 = new BitSet(new long[]{0x0000000000003000L});
    public static final BitSet FOLLOW_13_in_tick181 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_14_in_tick183 = new BitSet(new long[]{0x0000000000008000L});
    public static final BitSet FOLLOW_15_in_tick185 = new BitSet(new long[]{0x0000000000001010L});
    public static final BitSet FOLLOW_signals_in_tick189 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_12_in_tick193 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_signal_in_signals223 = new BitSet(new long[]{0x0000000000000012L});
    public static final BitSet FOLLOW_ID_in_signal256 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ID_in_signal281 = new BitSet(new long[]{0x0000000000010000L});
    public static final BitSet FOLLOW_16_in_signal283 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_num_in_signal287 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_signal289 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NUMBER_in_num325 = new BitSet(new long[]{0x0000000000000002L});
