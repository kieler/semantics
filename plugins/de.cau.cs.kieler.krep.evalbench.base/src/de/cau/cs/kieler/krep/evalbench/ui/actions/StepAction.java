...
/**
 * Action that performs a single step in the current program.
...
public class StepAction extends Action {
	 ...
	 * @param trace trace from which the inputs are read If trace is null
	 * or all ticks are executed, the inputs are read from the input view
	 */
	...
	@Override
	public void run() {
	    AssemblerEditor editor = Activator.commonLayer.getActiveAssemblerEditor();
