...
public class rifParser extends Parser {
    public static final String[] tokenNames = new String[] { "<invalid>",
            ...
            "WHITESPACE", "COMMENT", "'#@inputs'", "'@#'", "'#@outputs'",
            "'#@locals'", "'\"'", "'\":'", "'bool'", "'int'", "'#step'",
            "'#outs'", "'#locs'", "'T'", "'F'" };
    ...
    public static Trace parse(IAssembler asm, final Reader source)
    ...
    private void addSignal(IO io, int value) {
        switch (io) {
        case INPUT:
            trace.add(io, new Signal(inputs.get(i), true, value, i));
            i++;
            break;
        case OUTPUT:
            trace.add(io, new Signal(outputs.get(j), true, value, j));
            j++;
            break;
        }
    }
    ...
    // $ANTLR start "init"
    // rif.g:72:1: init : '#@inputs' ( ( decl[IO.INPUT] )* ) '@#' '#@outputs' (
    // ( decl[IO.OUTPUT] )* ) '@#' '#@locals' ( ( decl[null] )* ) '@#' ;
    public final void init() throws RecognitionException {
        try {
            // rif.g:72:5: ( '#@inputs' ( ( decl[IO.INPUT] )* ) '@#' '#@outputs'
            // ( ( decl[IO.OUTPUT] )* ) '@#' '#@locals' ( ( decl[null] )* ) '@#'
            // )
            // rif.g:72:7: '#@inputs' ( ( decl[IO.INPUT] )* ) '@#' '#@outputs' (
            // ( decl[IO.OUTPUT] )* ) '@#' '#@locals' ( ( decl[null] )* ) '@#'
            {
    ...
    // $ANTLR start "tick"
    // rif.g:81:1: tick : '#step' num () ( data[IO.INPUT] )* '#outs' (
    // data[IO.OUTPUT] )* '#locs' ( data[null] )* ;
    public final void tick() throws RecognitionException {
        try {
            // rif.g:81:6: ( '#step' num () ( data[IO.INPUT] )* '#outs' (
            // data[IO.OUTPUT] )* '#locs' ( data[null] )* )
            // rif.g:81:8: '#step' num () ( data[IO.INPUT] )* '#outs' (
            // data[IO.OUTPUT] )* '#locs' ( data[null] )*
            {
    ...
    public static final BitSet FOLLOW_trace_in_parse37 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_init_in_trace47 = new BitSet(
            new long[] { 0x0000000000040002L });
    public static final BitSet FOLLOW_tick_in_trace50 = new BitSet(
            new long[] { 0x0000000000040002L });
    public static final BitSet FOLLOW_10_in_init60 = new BitSet(
            new long[] { 0x0000000000004800L });
    public static final BitSet FOLLOW_decl_in_init63 = new BitSet(
            new long[] { 0x0000000000004800L });
    public static final BitSet FOLLOW_11_in_init69 = new BitSet(
            new long[] { 0x0000000000001000L });
    public static final BitSet FOLLOW_12_in_init78 = new BitSet(
            new long[] { 0x0000000000004800L });
    public static final BitSet FOLLOW_decl_in_init81 = new BitSet(
            new long[] { 0x0000000000004800L });
    public static final BitSet FOLLOW_11_in_init86 = new BitSet(
            new long[] { 0x0000000000002000L });
    public static final BitSet FOLLOW_13_in_init96 = new BitSet(
            new long[] { 0x0000000000004800L });
    public static final BitSet FOLLOW_decl_in_init99 = new BitSet(
            new long[] { 0x0000000000004800L });
    public static final BitSet FOLLOW_11_in_init105 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_14_in_decl115 = new BitSet(
            new long[] { 0x0000000000000010L });
    public static final BitSet FOLLOW_ID_in_decl119 = new BitSet(
            new long[] { 0x0000000000008000L });
    public static final BitSet FOLLOW_15_in_decl122 = new BitSet(
            new long[] { 0x0000000000030000L });
    public static final BitSet FOLLOW_type_in_decl124 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_set_in_type0 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_18_in_tick158 = new BitSet(
            new long[] { 0x0000000000000020L });
    public static final BitSet FOLLOW_num_in_tick161 = new BitSet(
            new long[] { 0x0000000000680020L });
    public static final BitSet FOLLOW_data_in_tick167 = new BitSet(
            new long[] { 0x0000000000680020L });
    public static final BitSet FOLLOW_19_in_tick181 = new BitSet(
            new long[] { 0x0000000000700020L });
    public static final BitSet FOLLOW_data_in_tick183 = new BitSet(
            new long[] { 0x0000000000700020L });
    public static final BitSet FOLLOW_20_in_tick197 = new BitSet(
            new long[] { 0x0000000000600022L });
    public static final BitSet FOLLOW_data_in_tick199 = new BitSet(
            new long[] { 0x0000000000600022L });
    public static final BitSet FOLLOW_num_in_data214 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_21_in_data228 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_22_in_data243 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUMBER_in_num275 = new BitSet(
            new long[] { 0x0000000000000002L });
