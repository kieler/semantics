...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.scl.scl.Goto} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GotoItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    /**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Goto_targetLabel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Goto_targetLabel_feature", "_UI_Goto_type"),
				 SclPackage.Literals.GOTO__TARGET_LABEL,
				 true,
				 false,
				 false,
    ...
    public String getText(Object object) {
		String label = ((Goto)object).getTargetLabel();
