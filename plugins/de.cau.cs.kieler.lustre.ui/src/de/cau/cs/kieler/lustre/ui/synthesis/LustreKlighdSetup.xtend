 ...
 * @author nre
 */
class LustreKlighdSetup implements IKlighdStartupHook {
    
    override execute() {
        KlighdDataManager.instance
            .registerDiagramSynthesisClass("de.cau.cs.kieler.lustre.ui.synthesis.LustreSCChartsSynthesis", LustreSCChartsSynthesis)
    }
