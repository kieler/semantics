...
class SCChartsAdditionalExtensions {
    ...
    def ValuedObject createValuedObject(Scope scope, String name, boolean input, boolean output, ValueType type, boolean signal) {
    ...
    def void fixHierarchyCrossingTransition(Transition transition, HashMap<Region, State> initialStates, int counter) {
            ...
            for (var i = 0; i < routeToEnd.length-1; i++) {
                ...
                if (routeState.hierarchical) {
                    ...
                    if (!initialStates.containsKey(regionInsideRouteState)) {
                        ...
                        val initialState = regionInsideRouteState.createInitialState("_I").uniqueName
                    ...
                    val initialState = initialStates.get(regionInsideRouteState)
        ...
        if (routeFromStart.length > 0) {
            ...
            val dummyState = originalSource.parentRegion.createState("_exit").uniqueName
