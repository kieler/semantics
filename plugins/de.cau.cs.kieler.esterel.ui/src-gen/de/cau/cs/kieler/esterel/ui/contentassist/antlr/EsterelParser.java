		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProcedureAccess().getIdList1Alternatives_2_0_0(), "rule__Procedure__IdList1Alternatives_2_0_0");
					put(grammarAccess.getProcedureAccess().getIdList1Alternatives_2_1_1_0(), "rule__Procedure__IdList1Alternatives_2_1_1_0");
					put(grammarAccess.getProcedureAccess().getIdList2Alternatives_5_0_0(), "rule__Procedure__IdList2Alternatives_5_0_0");
					put(grammarAccess.getProcedureAccess().getIdList2Alternatives_5_1_1_0(), "rule__Procedure__IdList2Alternatives_5_1_1_0");
					...
					put(grammarAccess.getDataExprAccess().getAlternatives_1_1(), "rule__DataExpr__Alternatives_1_1");
					put(grammarAccess.getDataMultAccess().getAlternatives_1_1(), "rule__DataMult__Alternatives_1_1");
					put(grammarAccess.getDataEquationAccess().getAlternatives_1_0(), "rule__DataEquation__Alternatives_1_0");
					put(grammarAccess.getDataMinusAccess().getAlternatives_0(), "rule__DataMinus__Alternatives_0");
					...
					put(grammarAccess.getChannelTypeAccess().getAlternatives_1_1(), "rule__ChannelType__Alternatives_1_1");
					put(grammarAccess.getChannelTypeAccess().getAlternatives_1_3(), "rule__ChannelType__Alternatives_1_3");
					...
					put(grammarAccess.getProcCallAccess().getGroup_8(), "rule__ProcCall__Group_8__0");
					...
					put(grammarAccess.getVariableSingleAccess().getGroup(), "rule__VariableSingle__Group__0");
					put(grammarAccess.getVariableSingleAccess().getGroup_1(), "rule__VariableSingle__Group_1__0");
					...
					put(grammarAccess.getDataMultAccess().getGroup(), "rule__DataMult__Group__0");
					put(grammarAccess.getDataMultAccess().getGroup_1(), "rule__DataMult__Group_1__0");
					put(grammarAccess.getDataEquationAccess().getGroup(), "rule__DataEquation__Group__0");
					put(grammarAccess.getDataEquationAccess().getGroup_1(), "rule__DataEquation__Group_1__0");
					put(grammarAccess.getDataMinusAccess().getGroup(), "rule__DataMinus__Group__0");
					put(grammarAccess.getDataUnaryExprAccess().getGroup_0(), "rule__DataUnaryExpr__Group_0__0");
					...
					put(grammarAccess.getChannelTypeAccess().getGroup_1(), "rule__ChannelType__Group_1__0");
					...
					put(grammarAccess.getProcCallAccess().getVarListAssignment_3(), "rule__ProcCall__VarListAssignment_3");
					put(grammarAccess.getProcCallAccess().getVarListAssignment_4_1(), "rule__ProcCall__VarListAssignment_4_1");
					put(grammarAccess.getProcCallAccess().getExprAssignment_7(), "rule__ProcCall__ExprAssignment_7");
					put(grammarAccess.getProcCallAccess().getExprAssignment_8_1(), "rule__ProcCall__ExprAssignment_8_1");
					put(grammarAccess.getDoAccess().getStatementAssignment_1(), "rule__Do__StatementAssignment_1");
					put(grammarAccess.getDoAccess().getEndUpAssignment_2_0(), "rule__Do__EndUpAssignment_2_0");
					put(grammarAccess.getDoAccess().getEndWatchAssignment_2_1(), "rule__Do__EndWatchAssignment_2_1");
					...
					put(grammarAccess.getConstantRenamingAccess().getNewNameAssignment_0(), "rule__ConstantRenaming__NewNameAssignment_0");
					...
					put(grammarAccess.getVariableListAccess().getVariableAssignment_1_2(), "rule__VariableList__VariableAssignment_1_2");
					put(grammarAccess.getVariableSingleAccess().getNameAssignment_0(), "rule__VariableSingle__NameAssignment_0");
					put(grammarAccess.getVariableSingleAccess().getExpressionAssignment_1_1(), "rule__VariableSingle__ExpressionAssignment_1_1");
					...
					put(grammarAccess.getDataExprAccess().getOpAssignment_1_1_0(), "rule__DataExpr__OpAssignment_1_1_0");
					put(grammarAccess.getDataExprAccess().getOpAssignment_1_1_1(), "rule__DataExpr__OpAssignment_1_1_1");
					put(grammarAccess.getDataExprAccess().getOpAssignment_1_1_2(), "rule__DataExpr__OpAssignment_1_1_2");
					put(grammarAccess.getDataExprAccess().getRightAssignment_1_2(), "rule__DataExpr__RightAssignment_1_2");
					put(grammarAccess.getDataMultAccess().getOpAssignment_1_1_0(), "rule__DataMult__OpAssignment_1_1_0");
					put(grammarAccess.getDataMultAccess().getOpAssignment_1_1_1(), "rule__DataMult__OpAssignment_1_1_1");
					put(grammarAccess.getDataMultAccess().getOpAssignment_1_1_2(), "rule__DataMult__OpAssignment_1_1_2");
					put(grammarAccess.getDataMultAccess().getOpAssignment_1_1_3(), "rule__DataMult__OpAssignment_1_1_3");
					put(grammarAccess.getDataMultAccess().getRightAssignment_1_2(), "rule__DataMult__RightAssignment_1_2");
					put(grammarAccess.getDataEquationAccess().getOpAssignment_1_0_0(), "rule__DataEquation__OpAssignment_1_0_0");
					put(grammarAccess.getDataEquationAccess().getOpAssignment_1_0_1(), "rule__DataEquation__OpAssignment_1_0_1");
					put(grammarAccess.getDataEquationAccess().getOpAssignment_1_0_2(), "rule__DataEquation__OpAssignment_1_0_2");
					put(grammarAccess.getDataEquationAccess().getOpAssignment_1_0_3(), "rule__DataEquation__OpAssignment_1_0_3");
					put(grammarAccess.getDataEquationAccess().getOpAssignment_1_0_4(), "rule__DataEquation__OpAssignment_1_0_4");
					put(grammarAccess.getDataEquationAccess().getOpAssignment_1_0_5(), "rule__DataEquation__OpAssignment_1_0_5");
					put(grammarAccess.getDataEquationAccess().getRightAssignment_1_1(), "rule__DataEquation__RightAssignment_1_1");
					put(grammarAccess.getDataMinusAccess().getPreAssignment_0_0(), "rule__DataMinus__PreAssignment_0_0");
					put(grammarAccess.getDataMinusAccess().getPreAssignment_0_1(), "rule__DataMinus__PreAssignment_0_1");
					put(grammarAccess.getDataMinusAccess().getExprAssignment_1(), "rule__DataMinus__ExprAssignment_1");
					...
					put(grammarAccess.getDelayEventAccess().getPreSigExprAssignment_1_2(), "rule__DelayEvent__PreSigExprAssignment_1_2");
					put(grammarAccess.getDelayEventAccess().getBlockSigExprAssignment_2_1(), "rule__DelayEvent__BlockSigExprAssignment_2_1");
					...
					put(grammarAccess.getChannelTypeAccess().getTypeAssignment_0_0(), "rule__ChannelType__TypeAssignment_0_0");
					put(grammarAccess.getChannelTypeAccess().getTypeAssignment_0_1(), "rule__ChannelType__TypeAssignment_0_1");
					put(grammarAccess.getChannelTypeAccess().getTypeAssignment_1_1_0(), "rule__ChannelType__TypeAssignment_1_1_0");
					put(grammarAccess.getChannelTypeAccess().getTypeAssignment_1_1_1(), "rule__ChannelType__TypeAssignment_1_1_1");
					put(grammarAccess.getChannelTypeAccess().getFuncAssignment_1_3_0(), "rule__ChannelType__FuncAssignment_1_3_0");
					put(grammarAccess.getChannelTypeAccess().getOpAssignment_1_3_1(), "rule__ChannelType__OpAssignment_1_3_1");
