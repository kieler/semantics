...
public class EsterelExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {
	...
	public Object create() throws CoreException {
		de.cau.cs.kieler.esterel.internal.EsterelActivator instance = de.cau.cs.kieler.esterel.internal.EsterelActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = de.cau.cs.kieler.esterel.internal.EsterelActivator.getInstance().getInjector("de.cau.cs.kieler.esterel.Esterel");
