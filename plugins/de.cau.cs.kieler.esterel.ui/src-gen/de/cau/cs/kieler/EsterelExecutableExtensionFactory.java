 ...
 * generated
 */
public class EsterelExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(EsterelExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		de.cau.cs.kieler.internal.EsterelActivator instance = de.cau.cs.kieler.internal.EsterelActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = de.cau.cs.kieler.internal.EsterelActivator.getInstance().getInjector("de.cau.cs.kieler.Esterel");
