...
public class EHelpAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected EHelpSwitch<Adapter> modelSwitch =
    new EHelpSwitch<Adapter>()
    {
      ...
      {
        return createConfigHomeAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.ehelp.eHelp.Config <em>Config</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   * @return the new adapter.
   * @see de.cau.cs.kieler.ehelp.eHelp.Config
   * @generated
   */
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.ehelp.eHelp.ConfigHome <em>Config Home</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   * @return the new adapter.
   * @see de.cau.cs.kieler.ehelp.eHelp.ConfigHome
   * @generated
   */
  public Adapter createConfigHomeAdapter()
  {
    return null;
  }
