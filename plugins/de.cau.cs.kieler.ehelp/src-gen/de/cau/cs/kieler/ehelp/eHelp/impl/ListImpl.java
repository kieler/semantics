 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.ehelp.eHelp.impl.ListImpl#getItems <em>Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListImpl extends ContentImpl implements List
{
  ...
  {
    return EHelpPackage.Literals.LIST;
  }
  ...
  public EList<ListItem> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<ListItem>(ListItem.class, this, EHelpPackage.LIST__ITEMS);
    }
    return items;
  }
