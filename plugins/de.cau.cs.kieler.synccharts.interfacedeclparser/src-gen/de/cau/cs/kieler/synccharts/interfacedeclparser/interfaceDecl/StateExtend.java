 ...
 *   <li>{@link de.cau.cs.kieler.synccharts.interfacedeclparser.interfaceDecl.StateExtend#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
...
public interface StateExtend extends EObject
{
   ...
   * The list contents are of type {@link de.cau.cs.kieler.synccharts.interfacedeclparser.interfaceDecl.Variables}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.cau.cs.kieler.synccharts.interfacedeclparser.interfaceDecl.InterfaceDeclPackage#getStateExtend_Variable()
   * @model containment="true"
   * @generated
   */
