...
public interface InterfaceDeclPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the containment reference list '{@link de.cau.cs.kieler.synccharts.interfacedeclparser.interfaceDecl.StateExtend#getVariable <em>Variable</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Variable</em>'.
   * @see de.cau.cs.kieler.synccharts.interfacedeclparser.interfaceDecl.StateExtend#getVariable()
   * @see #getStateExtend()
   * @generated
   */
