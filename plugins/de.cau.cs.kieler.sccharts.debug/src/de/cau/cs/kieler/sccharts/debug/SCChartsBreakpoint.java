...
/**
 * Line Breakpoints are represented here and are designed for SCCharts.
 * 
 * @author lgr
 *
 */
public class SCChartsBreakpoint extends LineBreakpoint {
	...
	/**
	 * Creates a new breakpoint using
	 * {@link #SCChartsBreakpoint(IResource, int, boolean)} as a constructor
	 * with the {@code persistent} variable set to true.
	 * 
	 * @param resource
	 ...
	 *             .
	 */
	protected SCChartsBreakpoint(final IResource resource, final int lineNumber, final boolean persistent)
			throws CoreException {
		IWorkspaceRunnable runnable = new IWorkspaceRunnable() {

			@Override
			public void run(IProgressMonitor monitor) throws CoreException {
				IMarker marker = resource.createMarker("de.cau.cs.kieler.sccharts.debug.scchartsBreakpointMarker");
				setMarker(marker);
