		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getActionAccess().getAlternatives_4_1(), "rule__Action__Alternatives_4_1");
					...
					put(grammarAccess.getActionAccess().getGroup_4_1_0(), "rule__Action__Group_4_1_0__0");
					put(grammarAccess.getActionAccess().getGroup_4_1_1(), "rule__Action__Group_4_1_1__0");
					...
					put(grammarAccess.getHandlerAccess().getDomElementAssignment_2_0_1(), "rule__Handler__DomElementAssignment_2_0_1");
					put(grammarAccess.getHandlerAccess().getInterfaceAssignment_2_0_3(), "rule__Handler__InterfaceAssignment_2_0_3");
					put(grammarAccess.getHandlerAccess().getScriptAssignment_2_0_4(), "rule__Handler__ScriptAssignment_2_0_4");
					...
					put(grammarAccess.getActionAccess().getDomElementAssignment_3(), "rule__Action__DomElementAssignment_3");
					put(grammarAccess.getActionAccess().getDeferredAssignment_4_1_0_0(), "rule__Action__DeferredAssignment_4_1_0_0");
					put(grammarAccess.getActionAccess().getInterfaceAssignment_4_1_0_1(), "rule__Action__InterfaceAssignment_4_1_0_1");
					put(grammarAccess.getActionAccess().getScriptAssignment_4_1_0_2(), "rule__Action__ScriptAssignment_4_1_0_2");
					put(grammarAccess.getActionAccess().getInterfaceAssignment_4_1_1_0(), "rule__Action__InterfaceAssignment_4_1_1_0");
					put(grammarAccess.getActionAccess().getScriptAssignment_4_1_1_1(), "rule__Action__ScriptAssignment_4_1_1_1");
					put(grammarAccess.getActionAccess().getVariableAssignment_5_1(), "rule__Action__VariableAssignment_5_1");
					put(grammarAccess.getActionAccess().getControlAssignment_6_1(), "rule__Action__ControlAssignment_6_1");
