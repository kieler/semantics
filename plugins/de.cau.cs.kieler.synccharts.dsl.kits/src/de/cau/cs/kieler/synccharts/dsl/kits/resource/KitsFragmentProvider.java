...
public class KitsFragmentProvider implements IFragmentProvider {
	...
	public String getFragment(EObject obj) {
		String name = SimpleAttributeResolver.newResolver(String.class, "id")
				.apply(obj);
		if (obj instanceof Signal) {
			String containerName = null;
			if (SimpleAttributeResolver.newResolver(String.class, "id").apply(
					obj.eContainer()) != null) {
				containerName = SimpleAttributeResolver.newResolver(
						String.class, "id").apply(obj.eContainer());
			} else if (obj.eContainer() instanceof Region) {
				containerName = "region";
			}

				System.out.println("------------------------");
			System.out.println(containerName + "." + name);
			System.out.println("------------------------");
