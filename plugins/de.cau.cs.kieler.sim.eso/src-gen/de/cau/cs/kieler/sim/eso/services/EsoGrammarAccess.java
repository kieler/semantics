...
public class EsoGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class TickElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cOutputKeyword_4_1 = (Keyword)cGroup_4.eContents().get(1);
		private final Keyword cColonKeyword_4_2 = (Keyword)cGroup_4.eContents().get(2);
		private final Assignment cExtraInfosOutputAssignment_4_3 = (Assignment)cGroup_4.eContents().get(3);
		private final RuleCall cExtraInfosOutputKvpairParserRuleCall_4_3_0 = (RuleCall)cExtraInfosOutputAssignment_4_3.eContents().get(0);
		private final Keyword cSemicolonKeyword_5 = (Keyword)cGroup.eContents().get(5);
		
		//tick:
		//
		//	{tick} input+=signal* ("%" "Output" ":" output+=signal*)? extraInfos+=kvpair* ("%%" "Output" ":"
		//
		...
		//"Output"
		public Keyword getOutputKeyword_4_1() { return cOutputKeyword_4_1; }

		//":"
		public Keyword getColonKeyword_4_2() { return cColonKeyword_4_2; }

		//extraInfosOutput+=kvpair*
		public Assignment getExtraInfosOutputAssignment_4_3() { return cExtraInfosOutputAssignment_4_3; }

		//kvpair
		public RuleCall getExtraInfosOutputKvpairParserRuleCall_4_3_0() { return cExtraInfosOutputKvpairParserRuleCall_4_3_0; }
