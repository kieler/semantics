...
set XesDef(info:comp_date)    {Lun__5_jan_2015_08:35:55_CET}
set XesDef(info:comp_uid)     {gerard.berry}
set XesDef(info:cc_comp_name) {Apple LLVM version 6.0 (clang-600.0.56) (based on LLVM 3.5svn)}
set XesDef(info:machine)      {PCi586}
set XesDef(info:system)       {macos10_10}
