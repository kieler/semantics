...
ruleSignalDeclaration returns [EObject current=null] 
    ...
    { 
        $current = $this_SignalDefinition_0.current; 
        afterParserOrEnumRuleCall();
    }
...
entryRuleSuspendEffect returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSuspendEffectRule()); }
	 iv_ruleSuspendEffect=ruleSuspendEffect 
	 { $current=$iv_ruleSuspendEffect.current; } 
	 EOF 
;

// Rule SuspendEffect
ruleSuspendEffect returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleStateReaction returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getStateReactionRule()); }
	 iv_ruleStateReaction=ruleStateReaction 
	 { $current=$iv_ruleStateReaction.current; } 
	 EOF 
;

// Rule StateReaction
ruleStateReaction returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
...
entryRulePreReferenceExpression returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getPreReferenceExpressionRule()); }
	 iv_rulePreReferenceExpression=rulePreReferenceExpression 
	 { $current=$iv_rulePreReferenceExpression.current; } 
	 EOF 
;

// Rule PreReferenceExpression
rulePreReferenceExpression returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
(
    ...
    { 
        $current = $this_PreReferenceExpression_4.current; 
        afterParserOrEnumRuleCall();
    }
...
ruleMultiplicativeOperator2 returns [Enumerator current=null] 
    @init { enterRule(); }
    @after { leaveRule(); }:
((	enumLiteral_0='*' 
	{
