...
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program
{
  ...
  public NotificationChain basicSetPriority(IntValue newPriority, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SPackage.PROGRAM__PRIORITY, oldPriority, newPriority);
  ...
  public void setPriority(IntValue newPriority)
  {
    if (newPriority != priority)
    {
      ...
      if (priority != null)
        msgs = ((InternalEObject)priority).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SPackage.PROGRAM__PRIORITY, null, msgs);
      if (newPriority != null)
        msgs = ((InternalEObject)newPriority).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SPackage.PROGRAM__PRIORITY, null, msgs);
      msgs = basicSetPriority(newPriority, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SPackage.PROGRAM__PRIORITY, newPriority, newPriority));
  }
