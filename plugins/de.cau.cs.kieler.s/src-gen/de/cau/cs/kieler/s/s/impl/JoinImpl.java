 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.s.s.impl.JoinImpl#getContinuation <em>Continuation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JoinImpl extends InstructionImpl implements Join
{
    ...
    if (continuation != null && continuation.eIsProxy())
    {
      ...
      if (continuation != oldContinuation)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SPackage.JOIN__CONTINUATION, oldContinuation, continuation));
      }
    }
    return continuation;
  }
  ...
  public void setContinuation(State newContinuation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SPackage.JOIN__CONTINUATION, oldContinuation, continuation));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SPackage.JOIN__CONTINUATION:
