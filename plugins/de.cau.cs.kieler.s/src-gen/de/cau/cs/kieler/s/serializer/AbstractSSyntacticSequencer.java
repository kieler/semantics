...
public class AbstractSSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_State___SIGNALSKeyword_2_0_SemicolonKeyword_2_2__q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (SGrammarAccess) access;
		...
		match_State___SIGNALSKeyword_2_0_SemicolonKeyword_2_2__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getStateAccess().getSIGNALSKeyword_2_0()), new TokenAlias(false, false, grammarAccess.getStateAccess().getSemicolonKeyword_2_2()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_State___SIGNALSKeyword_2_0_SemicolonKeyword_2_2__q.equals(syntax))
				emit_State___SIGNALSKeyword_2_0_SemicolonKeyword_2_2__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     ('SIGNALS' ';')?
	 */
	protected void emit_State___SIGNALSKeyword_2_0_SemicolonKeyword_2_2__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
