 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.s.s.Join#getContinuation <em>Continuation</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.s.s.SPackage#getJoin()
 * @model
 * @generated
 */
public interface Join extends Instruction
{
   ...
   * @see de.cau.cs.kieler.s.s.SPackage#getJoin_Continuation()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.s.s.Join#getContinuation <em>Continuation</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
