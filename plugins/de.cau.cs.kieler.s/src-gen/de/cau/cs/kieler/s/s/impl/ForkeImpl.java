...
public class ForkeImpl extends InstructionImpl implements Forke
{
    ...
    if (state != null && state.eIsProxy())
    {
      ...
      if (state != oldState)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SPackage.FORKE__STATE, oldState, state));
      }
    }
    return state;
  }
  ...
  public void setState(State newState)
  {
    ...
    state = newState;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SPackage.FORKE__STATE, oldState, state));
  }
