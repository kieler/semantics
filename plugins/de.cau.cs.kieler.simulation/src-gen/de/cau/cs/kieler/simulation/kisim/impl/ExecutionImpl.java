 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.simulation.kisim.impl.ExecutionImpl#getActions <em>Actions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExecutionImpl extends MinimalEObjectImpl.Container implements Execution
{
  ...
  {
    return KisimPackage.Literals.EXECUTION;
  }
  ...
  public EList<Action> getActions()
  {
    if (actions == null)
    {
      actions = new EObjectContainmentEList<Action>(Action.class, this, KisimPackage.EXECUTION__ACTIONS);
    }
    return actions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KisimPackage.EXECUTION__ACTIONS:
