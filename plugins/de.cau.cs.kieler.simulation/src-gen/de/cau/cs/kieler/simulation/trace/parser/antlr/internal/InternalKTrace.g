...
entryRuleTraceFile returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTraceFileRule()); }
	iv_ruleTraceFile=ruleTraceFile
	{ $current=$iv_ruleTraceFile.current; }
	EOF;

// Rule TraceFile
ruleTraceFile returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleEsoTraces returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEsoTracesRule()); }
	iv_ruleEsoTraces=ruleEsoTraces
	{ $current=$iv_ruleEsoTraces.current; }
	EOF;

// Rule EsoTraces
ruleEsoTraces returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleEsoTrace returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEsoTraceRule()); }
	iv_ruleEsoTrace=ruleEsoTrace
	{ $current=$iv_ruleEsoTrace.current; }
	EOF;

// Rule EsoTrace
ruleEsoTrace returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleEsoTick returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEsoTickRule()); }
	iv_ruleEsoTick=ruleEsoTick
	{ $current=$iv_ruleEsoTick.current; }
	EOF;

// Rule EsoTick
ruleEsoTick returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleKTraces returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getKTracesRule()); }
	iv_ruleKTraces=ruleKTraces
	{ $current=$iv_ruleKTraces.current; }
	EOF;

// Rule KTraces
ruleKTraces returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleKTrace returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getKTraceRule()); }
	iv_ruleKTrace=ruleKTrace
	{ $current=$iv_ruleKTrace.current; }
	EOF;

// Rule KTrace
ruleKTrace returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleKTick returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getKTickRule()); }
	iv_ruleKTick=ruleKTick
	{ $current=$iv_ruleKTick.current; }
	EOF;

// Rule KTick
ruleKTick returns [EObject current=null]
@init {
	enterRule();
}
@after {
