...
public abstract class AbstractKTraceSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_KTick_EqualsSignGreaterThanSignKeyword_2_0_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_KTick_EqualsSignGreaterThanSignKeyword_2_0_q = new TokenAlias(false, true, grammarAccess.getKTickAccess().getEqualsSignGreaterThanSignKeyword_2_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_KTick_EqualsSignGreaterThanSignKeyword_2_0_q.equals(syntax))
				emit_KTick_EqualsSignGreaterThanSignKeyword_2_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_KTick_EqualsSignGreaterThanSignKeyword_2_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
