...
entryRuleSimulationConfiguration returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSimulationConfigurationRule()); }
	 iv_ruleSimulationConfiguration=ruleSimulationConfiguration 
	 { $current=$iv_ruleSimulationConfiguration.current; } 
	 EOF 
;

// Rule SimulationConfiguration
ruleSimulationConfiguration returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleDataHandlerConfiguration returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDataHandlerConfigurationRule()); }
	 ...
	 { $current=$iv_ruleDataHandlerConfiguration.current; } 
	 EOF 
;

// Rule DataHandlerConfiguration
ruleDataHandlerConfiguration returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='configure' 
