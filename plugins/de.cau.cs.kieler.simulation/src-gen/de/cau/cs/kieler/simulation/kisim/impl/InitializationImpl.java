 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.simulation.kisim.impl.InitializationImpl#getActions <em>Actions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InitializationImpl extends MinimalEObjectImpl.Container implements Initialization
{
  ...
  {
    return KisimPackage.Literals.INITIALIZATION;
  }
  ...
  public EList<Action> getActions()
  {
    if (actions == null)
    {
      actions = new EObjectContainmentEList<Action>(Action.class, this, KisimPackage.INITIALIZATION__ACTIONS);
    }
    return actions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KisimPackage.INITIALIZATION__ACTIONS:
