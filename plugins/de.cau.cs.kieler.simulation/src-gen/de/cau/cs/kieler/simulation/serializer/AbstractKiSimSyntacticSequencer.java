...
public abstract class AbstractKiSimSyntacticSequencer extends AbstractSyntacticSequencer {

	protected KiSimGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (KiSimGrammarAccess) access;
