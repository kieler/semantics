...
public class SCCExpStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new de.cau.kieler.scc.model.scctext.SCCExpRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://cau.kieler.de/scc/SCCExp")) {
		EPackage.Registry.INSTANCE.put("http://cau.kieler.de/scc/SCCExp", de.cau.kieler.scc.model.scctext.sccexp.SccexpPackage.eINSTANCE);
	}
