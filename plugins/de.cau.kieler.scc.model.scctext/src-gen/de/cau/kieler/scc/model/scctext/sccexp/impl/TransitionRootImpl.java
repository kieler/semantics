 ...
 * <ul>
 *   <li>{@link de.cau.kieler.scc.model.scctext.sccexp.impl.TransitionRootImpl#getDef <em>Def</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransitionRootImpl extends DefRootImpl implements TransitionRoot
{
  ...
  {
    return SccexpPackage.Literals.TRANSITION_ROOT;
  }
  ...
  public NotificationChain basicSetDef(TransitionSpecification newDef, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SccexpPackage.TRANSITION_ROOT__DEF, oldDef, newDef);
  ...
  public void setDef(TransitionSpecification newDef)
  {
    if (newDef != def)
    {
      ...
      if (def != null)
        msgs = ((InternalEObject)def).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SccexpPackage.TRANSITION_ROOT__DEF, null, msgs);
      if (newDef != null)
        msgs = ((InternalEObject)newDef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SccexpPackage.TRANSITION_ROOT__DEF, null, msgs);
      msgs = basicSetDef(newDef, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SccexpPackage.TRANSITION_ROOT__DEF, newDef, newDef));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SccexpPackage.TRANSITION_ROOT__DEF:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == org.yakindu.sct.model.stext.stext.TransitionRoot.class)
    {
      ...
      {
        case SccexpPackage.TRANSITION_ROOT__DEF: return StextPackage.TRANSITION_ROOT__DEF;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == org.yakindu.sct.model.stext.stext.TransitionRoot.class)
    {
      ...
      {
        case StextPackage.TRANSITION_ROOT__DEF: return SccexpPackage.TRANSITION_ROOT__DEF;
        default: return -1;
      }
    }
