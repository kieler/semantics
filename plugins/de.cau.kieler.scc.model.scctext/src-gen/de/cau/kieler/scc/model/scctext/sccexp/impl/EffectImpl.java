 ...
 * <ul>
 *   <li>{@link de.cau.kieler.scc.model.scctext.sccexp.impl.EffectImpl#getActions <em>Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EffectImpl extends org.yakindu.sct.model.sgraph.impl.EffectImpl implements Effect
{
  /**
  ...
  {
    return SccexpPackage.Literals.EFFECT;
  }
  ...
  public EList<Expression> getActions()
  {
    if (actions == null)
    {
      actions = new EObjectContainmentEList<Expression>(Expression.class, this, SccexpPackage.EFFECT__ACTIONS);
    }
    return actions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SccexpPackage.EFFECT__ACTIONS:
