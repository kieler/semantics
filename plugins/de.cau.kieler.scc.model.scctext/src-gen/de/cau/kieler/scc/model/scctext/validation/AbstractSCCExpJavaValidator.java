package de.cau.kieler.scc.model.scctext.validation;
...
public class AbstractSCCExpJavaValidator extends STextJavaValidator {

	@Override
	protected List<EPackage> getEPackages() {
	    List<EPackage> result = new ArrayList<EPackage>();
	    result.add(de.cau.kieler.scc.model.scctext.sccexp.SccexpPackage.eINSTANCE);
