 ...
 * generated by Xtext
 */
package de.cau.cs.kieler.esterel.kexpressions.ui.contentassist.antlr;
...
public class KExpressionsParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.cau.cs.kieler.esterel.kexpressions.ui.contentassist.antlr.internal.InternalKExpressionsParser createParser() {
		de.cau.cs.kieler.esterel.kexpressions.ui.contentassist.antlr.internal.InternalKExpressionsParser result = new de.cau.cs.kieler.esterel.kexpressions.ui.contentassist.antlr.internal.InternalKExpressionsParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getValuedObjectReferenceAccess().getAlternatives(), "rule__ValuedObjectReference__Alternatives");
					...
					put(grammarAccess.getValuedObjectReferenceAccess().getTickAssignment_1(), "rule__ValuedObjectReference__TickAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.cau.cs.kieler.esterel.kexpressions.ui.contentassist.antlr.internal.InternalKExpressionsParser typedParser = (de.cau.cs.kieler.esterel.kexpressions.ui.contentassist.antlr.internal.InternalKExpressionsParser) parser;
