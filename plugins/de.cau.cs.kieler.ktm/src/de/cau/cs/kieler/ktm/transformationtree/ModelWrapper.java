 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.ModelWrapper#getModelTypeID <em>Model Type ID</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.ModelWrapper#getModelObjects <em>Model Objects</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.ModelWrapper#getTargetTransformations <em>Target Transformations</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.ModelWrapper#getSourceTransformation <em>Source Transformation</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.ModelWrapper#isTransient <em>Transient</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.ModelWrapper#getRootObject <em>Root Object</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.ktm.transformationtree.TransformationTreePackage#getModelWrapper()
 * @model
 * @generated
 */
public interface ModelWrapper extends EObject {
     ...
     * @see de.cau.cs.kieler.ktm.transformationtree.TransformationTreePackage#getModelWrapper_ModelTypeID()
     * @model required="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.ktm.transformationtree.ModelWrapper#getModelTypeID <em>Model Type ID</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The list contents are of type {@link de.cau.cs.kieler.ktm.transformationtree.EObjectWrapper}.
     * It is bidirectional and its opposite is '{@link de.cau.cs.kieler.ktm.transformationtree.EObjectWrapper#getModel <em>Model</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see de.cau.cs.kieler.ktm.transformationtree.TransformationTreePackage#getModelWrapper_ModelObjects()
     ...
     * @see de.cau.cs.kieler.ktm.transformationtree.TransformationTreePackage#getModelWrapper_TargetTransformations()
     ...
     * @see de.cau.cs.kieler.ktm.transformationtree.TransformationTreePackage#getModelWrapper_SourceTransformation()
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.ktm.transformationtree.ModelWrapper#getSourceTransformation <em>Source Transformation</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see de.cau.cs.kieler.ktm.transformationtree.TransformationTreePackage#getModelWrapper_Transient()
     * @model required="true"
     * @generated
     */
    boolean isTransient();
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.ktm.transformationtree.ModelWrapper#isTransient <em>Transient</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see de.cau.cs.kieler.ktm.transformationtree.TransformationTreePackage#getModelWrapper_RootObject()
     * @model required="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.ktm.transformationtree.ModelWrapper#getRootObject <em>Root Object</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
