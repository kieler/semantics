 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.impl.ModelWrapperImpl#getModelTypeID <em>Model Type ID</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.impl.ModelWrapperImpl#getModelObjects <em>Model Objects</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.impl.ModelWrapperImpl#getTargetTransformations <em>Target Transformations</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.impl.ModelWrapperImpl#getSourceTransformation <em>Source Transformation</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.impl.ModelWrapperImpl#isTransient <em>Transient</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.impl.ModelWrapperImpl#getRootObject <em>Root Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelWrapperImpl extends MinimalEObjectImpl.Container implements ModelWrapper {
    ...
    protected EClass eStaticClass() {
        return TransformationTreePackage.Literals.MODEL_WRAPPER;
    }
    ...
    public void setModelTypeID(String newModelTypeID) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TransformationTreePackage.MODEL_WRAPPER__MODEL_TYPE_ID, oldModelTypeID, modelTypeID));
    }
    ...
    public EList<EObjectWrapper> getModelObjects() {
        if (modelObjects == null) {
            modelObjects = new EObjectContainmentWithInverseEList<EObjectWrapper>(EObjectWrapper.class, this, TransformationTreePackage.MODEL_WRAPPER__MODEL_OBJECTS, TransformationTreePackage.EOBJECT_WRAPPER__MODEL);
        }
        return modelObjects;
    }
    ...
    public EList<ModelTransformation> getTargetTransformations() {
        if (targetTransformations == null) {
            targetTransformations = new EObjectContainmentWithInverseEList<ModelTransformation>(ModelTransformation.class, this, TransformationTreePackage.MODEL_WRAPPER__TARGET_TRANSFORMATIONS, TransformationTreePackage.MODEL_TRANSFORMATION__SOURCE);
        }
    ...
    public ModelTransformation getSourceTransformation() {
        if (eContainerFeatureID() != TransformationTreePackage.MODEL_WRAPPER__SOURCE_TRANSFORMATION) return null;
    ...
    public NotificationChain basicSetSourceTransformation(ModelTransformation newSourceTransformation, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject)newSourceTransformation, TransformationTreePackage.MODEL_WRAPPER__SOURCE_TRANSFORMATION, msgs);
        return msgs;
    }
    ...
    public void setSourceTransformation(ModelTransformation newSourceTransformation) {
        if (newSourceTransformation != eInternalContainer() || (eContainerFeatureID() != TransformationTreePackage.MODEL_WRAPPER__SOURCE_TRANSFORMATION && newSourceTransformation != null)) {
            ...
            if (newSourceTransformation != null)
                msgs = ((InternalEObject)newSourceTransformation).eInverseAdd(this, TransformationTreePackage.MODEL_TRANSFORMATION__TARGET, ModelTransformation.class, msgs);
            msgs = basicSetSourceTransformation(newSourceTransformation, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TransformationTreePackage.MODEL_WRAPPER__SOURCE_TRANSFORMATION, newSourceTransformation, newSourceTransformation));
    }
    ...
    public void setTransient(boolean newTransient) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TransformationTreePackage.MODEL_WRAPPER__TRANSIENT, oldTransient, transient_));
    }
    ...
    public EObjectWrapper getRootObject() {
        if (rootObject != null && rootObject.eIsProxy()) {
            ...
            if (rootObject != oldRootObject) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, TransformationTreePackage.MODEL_WRAPPER__ROOT_OBJECT, oldRootObject, rootObject));
            }
        }
        return rootObject;
    }
    ...
    public void setRootObject(EObjectWrapper newRootObject) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TransformationTreePackage.MODEL_WRAPPER__ROOT_OBJECT, oldRootObject, rootObject));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case TransformationTreePackage.MODEL_WRAPPER__MODEL_OBJECTS:
                return ((InternalEList<InternalEObject>)(InternalEList<?>)getModelObjects()).basicAdd(otherEnd, msgs);
            case TransformationTreePackage.MODEL_WRAPPER__TARGET_TRANSFORMATIONS:
                return ((InternalEList<InternalEObject>)(InternalEList<?>)getTargetTransformations()).basicAdd(otherEnd, msgs);
            case TransformationTreePackage.MODEL_WRAPPER__SOURCE_TRANSFORMATION:
                if (eInternalContainer() != null)
                    msgs = eBasicRemoveFromContainer(msgs);
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case TransformationTreePackage.MODEL_WRAPPER__MODEL_TYPE_ID:
            ...
            case TransformationTreePackage.MODEL_WRAPPER__TRANSIENT:
                return isTransient();
            case TransformationTreePackage.MODEL_WRAPPER__ROOT_OBJECT:
