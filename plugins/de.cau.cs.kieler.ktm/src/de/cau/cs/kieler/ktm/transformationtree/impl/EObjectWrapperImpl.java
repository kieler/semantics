 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.impl.EObjectWrapperImpl#getModel <em>Model</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.impl.EObjectWrapperImpl#getDisplayName <em>Display Name</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.impl.EObjectWrapperImpl#getTargetTransformations <em>Target Transformations</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.impl.EObjectWrapperImpl#getSourceTransformations <em>Source Transformations</em>}</li>
 *   <li>{@link de.cau.cs.kieler.ktm.transformationtree.impl.EObjectWrapperImpl#getEObject <em>EObject</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EObjectWrapperImpl extends MinimalEObjectImpl.Container implements EObjectWrapper {
    ...
    protected EClass eStaticClass() {
        return TransformationTreePackage.Literals.EOBJECT_WRAPPER;
    }
    ...
    public ModelWrapper getModel() {
        if (eContainerFeatureID() != TransformationTreePackage.EOBJECT_WRAPPER__MODEL) return null;
    ...
    public NotificationChain basicSetModel(ModelWrapper newModel, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject)newModel, TransformationTreePackage.EOBJECT_WRAPPER__MODEL, msgs);
        return msgs;
    }
    ...
    public void setModel(ModelWrapper newModel) {
        if (newModel != eInternalContainer() || (eContainerFeatureID() != TransformationTreePackage.EOBJECT_WRAPPER__MODEL && newModel != null)) {
            ...
            if (newModel != null)
                msgs = ((InternalEObject)newModel).eInverseAdd(this, TransformationTreePackage.MODEL_WRAPPER__MODEL_OBJECTS, ModelWrapper.class, msgs);
            msgs = basicSetModel(newModel, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TransformationTreePackage.EOBJECT_WRAPPER__MODEL, newModel, newModel));
    }
    ...
    public void setDisplayName(String newDisplayName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TransformationTreePackage.EOBJECT_WRAPPER__DISPLAY_NAME, oldDisplayName, displayName));
    }
    ...
    public EList<EObjectTransformation> getTargetTransformations() {
        if (targetTransformations == null) {
            targetTransformations = new EObjectWithInverseResolvingEList<EObjectTransformation>(EObjectTransformation.class, this, TransformationTreePackage.EOBJECT_WRAPPER__TARGET_TRANSFORMATIONS, TransformationTreePackage.EOBJECT_TRANSFORMATION__SOURCE);
        }
    ...
    public EList<EObjectTransformation> getSourceTransformations() {
        if (sourceTransformations == null) {
            sourceTransformations = new EObjectWithInverseResolvingEList<EObjectTransformation>(EObjectTransformation.class, this, TransformationTreePackage.EOBJECT_WRAPPER__SOURCE_TRANSFORMATIONS, TransformationTreePackage.EOBJECT_TRANSFORMATION__TARGET);
        }
    ...
    public EObject getEObject() {
        if (eObject != null && eObject.eIsProxy()) {
            ...
            if (eObject != oldEObject) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, TransformationTreePackage.EOBJECT_WRAPPER__EOBJECT, oldEObject, eObject));
            }
        }
        return eObject;
    }
    ...
    public void setEObject(EObject newEObject) {
        ...
        eObject = newEObject;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TransformationTreePackage.EOBJECT_WRAPPER__EOBJECT, oldEObject, eObject));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case TransformationTreePackage.EOBJECT_WRAPPER__MODEL:
                if (eInternalContainer() != null)
                    msgs = eBasicRemoveFromContainer(msgs);
                return basicSetModel((ModelWrapper)otherEnd, msgs);
            case TransformationTreePackage.EOBJECT_WRAPPER__TARGET_TRANSFORMATIONS:
                return ((InternalEList<InternalEObject>)(InternalEList<?>)getTargetTransformations()).basicAdd(otherEnd, msgs);
            case TransformationTreePackage.EOBJECT_WRAPPER__SOURCE_TRANSFORMATIONS:
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        switch (eContainerFeatureID()) {
            case TransformationTreePackage.EOBJECT_WRAPPER__MODEL:
                return eInternalContainer().eInverseRemove(this, TransformationTreePackage.MODEL_WRAPPER__MODEL_OBJECTS, ModelWrapper.class, msgs);
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case TransformationTreePackage.EOBJECT_WRAPPER__MODEL:
                return getModel();
            case TransformationTreePackage.EOBJECT_WRAPPER__DISPLAY_NAME:
                return getDisplayName();
            case TransformationTreePackage.EOBJECT_WRAPPER__TARGET_TRANSFORMATIONS:
                return getTargetTransformations();
            case TransformationTreePackage.EOBJECT_WRAPPER__SOURCE_TRANSFORMATIONS:
                return getSourceTransformations();
            case TransformationTreePackage.EOBJECT_WRAPPER__EOBJECT:
