 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.expressions.impl.OperatorExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperatorExpressionImpl extends ComplexExpressionImpl implements OperatorExpression {
    ...
    protected EClass eStaticClass() {
        return ExpressionsPackage.Literals.OPERATOR_EXPRESSION;
    }
    ...
    public void setOperator(OperatorType newOperator) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.OPERATOR_EXPRESSION__OPERATOR, oldOperator, operator));
    }
