 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.expressions.impl.SignalImpl#getValue <em>Value</em>}</li>
 *   <li>{@link de.cau.cs.kieler.expressions.impl.SignalImpl#isIsInput <em>Is Input</em>}</li>
 *   <li>{@link de.cau.cs.kieler.expressions.impl.SignalImpl#isIsOutput <em>Is Output</em>}</li>
 *   <li>{@link de.cau.cs.kieler.expressions.impl.SignalImpl#getCombineOperator <em>Combine Operator</em>}</li>
 *   <li>{@link de.cau.cs.kieler.expressions.impl.SignalImpl#getHostCombineOperator <em>Host Combine Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
