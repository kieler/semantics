...
public class KExpressionsParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, CharStream in) {
		...
		de.cau.cs.kieler.core.kexpressions.parser.antlr.internal.InternalKExpressionsParser parser = createParser(tokenStream);
	...
	protected de.cau.cs.kieler.core.kexpressions.parser.antlr.internal.InternalKExpressionsParser createParser(XtextTokenStream stream) {
		return new de.cau.cs.kieler.core.kexpressions.parser.antlr.internal.InternalKExpressionsParser(stream, getElementFactory(), getGrammarAccess());
	}
