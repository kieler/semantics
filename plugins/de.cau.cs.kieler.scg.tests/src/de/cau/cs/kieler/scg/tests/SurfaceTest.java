 ...
 * @generated
 */
public class SurfaceTest extends NodeTest {
    ...
    public static void main(String[] args) {
        TestRunner.run(SurfaceTest.class);
    }
     ...
     * @generated
     */
    public SurfaceTest(String name) {
        super(name);
    }
    ...
    protected void setUp() throws Exception {
        setFixture(ScgFactory.eINSTANCE.createSurface());
    }
