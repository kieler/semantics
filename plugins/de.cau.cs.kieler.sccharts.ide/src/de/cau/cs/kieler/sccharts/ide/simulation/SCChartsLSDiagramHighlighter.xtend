...
import de.cau.cs.kieler.simulation.ide.language.server.LSDiagramHighlighter
...
class SCChartsLSDiagramHighlighter extends LSDiagramHighlighter implements ILSDiagramHighlighter {
     ...
     * Single instance.
     */
    private static var SCChartsLSDiagramHighlighter instance
    ...
    static def create() {
        if(instance === null) {
            instance = new SCChartsLSDiagramHighlighter
        }
        instance
    }
