...
import de.cau.cs.kieler.sccharts.ide.synthesis.KNodeExtensionsReplacement
import org.eclipse.elk.core.options.CoreOptions
import de.cau.cs.kieler.sccharts.ide.synthesis.styles.CommentStyles
...
import de.cau.cs.kieler.kicool.ide.kitt.tracing.TracingEdgeNode
...
//    }
    ...
    private def KEdge createLooseDependencyEdge(Map<Pair<EObject, EObject>, KEdge> edges, KNode attachNode,
        ...
        if (edges.containsKey(sourceTargetPair)) {
            ...
            edge.getContainer.addAction(Trigger::SINGLECLICK, AbstractToggleDependencyAction.ID)
