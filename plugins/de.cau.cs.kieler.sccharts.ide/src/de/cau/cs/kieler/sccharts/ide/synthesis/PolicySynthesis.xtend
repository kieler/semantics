...
import de.cau.cs.kieler.kicool.ide.synthesis.updates.MessageObjectReferencesManager
...
import de.cau.cs.kieler.sccharts.ide.synthesis.hooks.actions.MemorizingExpandCollapseAction
import de.cau.cs.kieler.sccharts.ide.synthesis.labels.TransitionLabelSerializer
import de.cau.cs.kieler.sccharts.ide.synthesis.styles.ColorStore
import de.cau.cs.kieler.sccharts.ide.synthesis.styles.ColorStore.Color
import de.cau.cs.kieler.sccharts.ide.synthesis.styles.ControlflowRegionStyles
import de.cau.cs.kieler.sccharts.ide.synthesis.styles.StateStyles
import de.cau.cs.kieler.sccharts.ide.synthesis.styles.TransitionStyles
...
import static de.cau.cs.kieler.sccharts.ide.synthesis.GeneralSynthesisOptions.*
