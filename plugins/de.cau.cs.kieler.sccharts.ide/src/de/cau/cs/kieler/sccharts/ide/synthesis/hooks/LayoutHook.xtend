...
import de.cau.cs.kieler.sccharts.ide.synthesis.hooks.SynthesisActionHook
...
class LayoutHook extends SynthesisActionHook {
    ...
    private static final IProperty<Boolean> BLOCK_ALTERNATIN_LAYOUT = new Property<Boolean>(
        "de.cau.cs.kieler.sccharts.ui.synthesis.hooks.layout.override", false)
    ...
    private static final IProperty<Boolean> DEFAULT_DIRECTION = new Property<Boolean>(
        "de.cau.cs.kieler.sccharts.ui.synthesis.hooks.layout.direction.default", false)
    ...
    private static final IProperty<Integer> HV_DEPTH = new Property<Integer>(
        "de.cau.cs.kieler.sccharts.ui.synthesis.hooks.layout.hv.depth", null)
