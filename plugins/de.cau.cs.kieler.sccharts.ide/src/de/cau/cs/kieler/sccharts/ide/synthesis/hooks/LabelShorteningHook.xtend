...
import de.cau.cs.kieler.sccharts.ide.synthesis.labels.LabelFocusSelectionListener
import de.cau.cs.kieler.sccharts.ide.synthesis.labels.LabelShorteningStrategies
