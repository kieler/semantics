...
import de.cau.cs.kieler.sccharts.ide.SCChartsIdeModule
...
import de.cau.cs.kieler.sccharts.ide.synthesis.hooks.SynthesisHooks.Type
...
abstract class AbstractSubSynthesis<I extends EObject, O extends KGraphElement> {
    ...
    def static doesKGTExist(String resourceLocation) {
        KiCoolSynthesis.doesKGTExist(SCChartsIdeModule.UI_PLUGIN_ID, resourceLocation, SKIN_FOLDER + skinPrefix)
    }
    /** 
    ...
    def static KNode getKGTFromBundle(String resourceLocation) {
        return KiCoolSynthesis.getKGTFromBundle(SCChartsIdeModule.UI_PLUGIN_ID, resourceLocation, SKIN_FOLDER + skinPrefix)
    }
}
