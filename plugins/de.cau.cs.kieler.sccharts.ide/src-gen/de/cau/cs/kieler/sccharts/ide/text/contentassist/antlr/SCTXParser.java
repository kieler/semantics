...
public class SCTXParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SCTXGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getControlflowRegionAccess().getAlternatives_9(), "rule__ControlflowRegion__Alternatives_9");
			builder.put(grammarAccess.getControlflowRegionAccess().getAlternatives_9_1_3(), "rule__ControlflowRegion__Alternatives_9_1_3");
			...
			builder.put(grammarAccess.getControlflowRegionAccess().getGroup_7_4(), "rule__ControlflowRegion__Group_7_4__0");
			builder.put(grammarAccess.getControlflowRegionAccess().getGroup_8(), "rule__ControlflowRegion__Group_8__0");
			builder.put(grammarAccess.getControlflowRegionAccess().getGroup_9_0(), "rule__ControlflowRegion__Group_9_0__0");
			builder.put(grammarAccess.getControlflowRegionAccess().getGroup_9_1(), "rule__ControlflowRegion__Group_9_1__0");
			...
			builder.put(grammarAccess.getControlflowRegionAccess().getCounterVariableAssignment_7_1(), "rule__ControlflowRegion__CounterVariableAssignment_7_1");
			builder.put(grammarAccess.getControlflowRegionAccess().getForStartAssignment_7_3(), "rule__ControlflowRegion__ForStartAssignment_7_3");
			builder.put(grammarAccess.getControlflowRegionAccess().getForEndAssignment_7_4_1(), "rule__ControlflowRegion__ForEndAssignment_7_4_1");
			builder.put(grammarAccess.getControlflowRegionAccess().getScheduleAssignment_8_1(), "rule__ControlflowRegion__ScheduleAssignment_8_1");
			builder.put(grammarAccess.getControlflowRegionAccess().getDeclarationsAssignment_9_0_1(), "rule__ControlflowRegion__DeclarationsAssignment_9_0_1");
			builder.put(grammarAccess.getControlflowRegionAccess().getActionsAssignment_9_0_2(), "rule__ControlflowRegion__ActionsAssignment_9_0_2");
			builder.put(grammarAccess.getControlflowRegionAccess().getStatesAssignment_9_0_3(), "rule__ControlflowRegion__StatesAssignment_9_0_3");
			builder.put(grammarAccess.getControlflowRegionAccess().getDeclarationsAssignment_9_1_1(), "rule__ControlflowRegion__DeclarationsAssignment_9_1_1");
			builder.put(grammarAccess.getControlflowRegionAccess().getActionsAssignment_9_1_2(), "rule__ControlflowRegion__ActionsAssignment_9_1_2");
			builder.put(grammarAccess.getControlflowRegionAccess().getStatesAssignment_9_1_3_0(), "rule__ControlflowRegion__StatesAssignment_9_1_3_0");
			builder.put(grammarAccess.getControlflowRegionAccess().getStatesAssignment_9_1_3_1(), "rule__ControlflowRegion__StatesAssignment_9_1_3_1");
