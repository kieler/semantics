...
public class SCTXParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SCTXGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getStateAccess().getBaseStateReferencesAssignment_8_1_0_1(), "rule__State__BaseStateReferencesAssignment_8_1_0_1");
			builder.put(grammarAccess.getStateAccess().getBaseStateReferencesAssignment_8_1_0_2_1(), "rule__State__BaseStateReferencesAssignment_8_1_0_2_1");
