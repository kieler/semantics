...
public class SCTXParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SCTXGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getScopeCallAccess().getAlternatives_1(), "rule__ScopeCall__Alternatives_1");
			...
			builder.put(grammarAccess.getControlflowRegionAccess().getAlternatives_8(), "rule__ControlflowRegion__Alternatives_8");
			builder.put(grammarAccess.getControlflowRegionAccess().getAlternatives_8_1_3(), "rule__ControlflowRegion__Alternatives_8_1_3");
			...
			builder.put(grammarAccess.getScopeCallAccess().getGroup_1_0(), "rule__ScopeCall__Group_1_0__0");
			builder.put(grammarAccess.getScopeCallAccess().getGroup_1_0_2(), "rule__ScopeCall__Group_1_0_2__0");
			builder.put(grammarAccess.getScopeCallAccess().getGroup_1_1(), "rule__ScopeCall__Group_1_1__0");
			...
			builder.put(grammarAccess.getControlflowRegionAccess().getGroup_6(), "rule__ControlflowRegion__Group_6__0");
			builder.put(grammarAccess.getControlflowRegionAccess().getGroup_6_4(), "rule__ControlflowRegion__Group_6_4__0");
			builder.put(grammarAccess.getControlflowRegionAccess().getGroup_7(), "rule__ControlflowRegion__Group_7__0");
			builder.put(grammarAccess.getControlflowRegionAccess().getGroup_8_0(), "rule__ControlflowRegion__Group_8_0__0");
			builder.put(grammarAccess.getControlflowRegionAccess().getGroup_8_1(), "rule__ControlflowRegion__Group_8_1__0");
			builder.put(grammarAccess.getDataflowRegionAccess().getGroup(), "rule__DataflowRegion__Group__0");
			builder.put(grammarAccess.getDataflowRegionAccess().getGroup_5(), "rule__DataflowRegion__Group_5__0");
			builder.put(grammarAccess.getDataflowRegionAccess().getGroup_5_4(), "rule__DataflowRegion__Group_5_4__0");
			...
			builder.put(grammarAccess.getScopeCallAccess().getScopeAssignment_0(), "rule__ScopeCall__ScopeAssignment_0");
			builder.put(grammarAccess.getScopeCallAccess().getParametersAssignment_1_0_1(), "rule__ScopeCall__ParametersAssignment_1_0_1");
			builder.put(grammarAccess.getScopeCallAccess().getParametersAssignment_1_0_2_1(), "rule__ScopeCall__ParametersAssignment_1_0_2_1");
			...
			builder.put(grammarAccess.getControlflowRegionAccess().getFinalAssignment_2(), "rule__ControlflowRegion__FinalAssignment_2");
			...
			builder.put(grammarAccess.getControlflowRegionAccess().getCounterVariableAssignment_6_1(), "rule__ControlflowRegion__CounterVariableAssignment_6_1");
			builder.put(grammarAccess.getControlflowRegionAccess().getForStartAssignment_6_3(), "rule__ControlflowRegion__ForStartAssignment_6_3");
			builder.put(grammarAccess.getControlflowRegionAccess().getForEndAssignment_6_4_1(), "rule__ControlflowRegion__ForEndAssignment_6_4_1");
			builder.put(grammarAccess.getControlflowRegionAccess().getScheduleAssignment_7_1(), "rule__ControlflowRegion__ScheduleAssignment_7_1");
			builder.put(grammarAccess.getControlflowRegionAccess().getDeclarationsAssignment_8_0_1(), "rule__ControlflowRegion__DeclarationsAssignment_8_0_1");
			builder.put(grammarAccess.getControlflowRegionAccess().getActionsAssignment_8_0_2(), "rule__ControlflowRegion__ActionsAssignment_8_0_2");
			builder.put(grammarAccess.getControlflowRegionAccess().getStatesAssignment_8_0_3(), "rule__ControlflowRegion__StatesAssignment_8_0_3");
			builder.put(grammarAccess.getControlflowRegionAccess().getDeclarationsAssignment_8_1_1(), "rule__ControlflowRegion__DeclarationsAssignment_8_1_1");
			builder.put(grammarAccess.getControlflowRegionAccess().getActionsAssignment_8_1_2(), "rule__ControlflowRegion__ActionsAssignment_8_1_2");
			builder.put(grammarAccess.getControlflowRegionAccess().getStatesAssignment_8_1_3_0(), "rule__ControlflowRegion__StatesAssignment_8_1_3_0");
			builder.put(grammarAccess.getControlflowRegionAccess().getStatesAssignment_8_1_3_1(), "rule__ControlflowRegion__StatesAssignment_8_1_3_1");
			...
			builder.put(grammarAccess.getDataflowRegionAccess().getNameAssignment_3(), "rule__DataflowRegion__NameAssignment_3");
			builder.put(grammarAccess.getDataflowRegionAccess().getLabelAssignment_4(), "rule__DataflowRegion__LabelAssignment_4");
			builder.put(grammarAccess.getDataflowRegionAccess().getCounterVariableAssignment_5_1(), "rule__DataflowRegion__CounterVariableAssignment_5_1");
			builder.put(grammarAccess.getDataflowRegionAccess().getForStartAssignment_5_3(), "rule__DataflowRegion__ForStartAssignment_5_3");
			builder.put(grammarAccess.getDataflowRegionAccess().getForEndAssignment_5_4_1(), "rule__DataflowRegion__ForEndAssignment_5_4_1");
			builder.put(grammarAccess.getDataflowRegionAccess().getScheduleAssignment_6_1(), "rule__DataflowRegion__ScheduleAssignment_6_1");
			builder.put(grammarAccess.getDataflowRegionAccess().getOnceAssignment_7(), "rule__DataflowRegion__OnceAssignment_7");
			builder.put(grammarAccess.getDataflowRegionAccess().getDeclarationsAssignment_9(), "rule__DataflowRegion__DeclarationsAssignment_9");
			builder.put(grammarAccess.getDataflowRegionAccess().getEquationsAssignment_10(), "rule__DataflowRegion__EquationsAssignment_10");
