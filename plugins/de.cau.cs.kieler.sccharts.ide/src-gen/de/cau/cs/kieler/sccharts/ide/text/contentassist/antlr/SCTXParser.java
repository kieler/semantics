...
public class SCTXParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SCTXGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getClassDeclarationWOSemicolonAccess().getPolicyAssignment_4_0_3(), "rule__ClassDeclarationWOSemicolon__PolicyAssignment_4_0_3");
			builder.put(grammarAccess.getClassDeclarationWOSemicolonAccess().getDeclarationsAssignment_4_0_4(), "rule__ClassDeclarationWOSemicolon__DeclarationsAssignment_4_0_4");
