...
(
		lv_type_1_0=	'input' 
    {
        createLeafNode(grammarAccess.getSignalDeclAccess().getTypeInputKeyword_0_1_0(), "type"); 
    }
 
	    {
	        ...
	        try {
	       		set($current, "type", lv_type_1_0, "input", lastConsumedNode);
	        } catch (ValueConverterException vce) {
				handleValueConverterException(vce);
	        }
	    }
...
(
		lv_type_7_0=	'output' 
    {
        createLeafNode(grammarAccess.getSignalDeclAccess().getTypeOutputKeyword_1_1_0(), "type"); 
    }
 
	    {
	        ...
	        try {
	       		set($current, "type", lv_type_7_0, "output", lastConsumedNode);
	        } catch (ValueConverterException vce) {
				handleValueConverterException(vce);
	        }
	    }
...
(
		lv_type_13_0=	'inputoutput' 
    {
        createLeafNode(grammarAccess.getSignalDeclAccess().getTypeInputoutputKeyword_2_1_0(), "type"); 
    }
 
	    {
	        ...
	        try {
	       		set($current, "type", lv_type_13_0, "inputoutput", lastConsumedNode);
	        } catch (ValueConverterException vce) {
				handleValueConverterException(vce);
	        }
	    }
...
(
		lv_type_19_0=	'return' 
    {
        createLeafNode(grammarAccess.getSignalDeclAccess().getTypeReturnKeyword_3_1_0(), "type"); 
    }
 
	    {
	        ...
	        try {
	       		set($current, "type", lv_type_19_0, "return", lastConsumedNode);
	        } catch (ValueConverterException vce) {
				handleValueConverterException(vce);
	        }
	    }
