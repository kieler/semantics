 ...
 *
 * SignalDecl:
 *   {Input} type="input" signal+=Signal ("," signal+=Signal)* ";"|{Output} type="output"
 *   signal+=Signal ("," signal+=Signal)* ";"|{InputOutput} type="inputoutput" signal+=
 *   Signal ("," signal+=Signal)* ";"|{Return} type="return" signal+=Signal ("," signal+=
 *   Signal)* ";"; 
 * 
 * // ----------------------------------------------
 * //            Interface Declarations
...
// type="input"
protected class SignalDecl_TypeAssignment_0_1 extends AssignmentToken  {
	
	public SignalDecl_TypeAssignment_0_1(AbstractToken parent, AbstractToken next, int no, IInstanceDescription current) {
		super(parent, next, no, current);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getSignalDeclAccess().getTypeAssignment_0_1();
	}
	...
	protected IInstanceDescription tryConsumeVal() {
		...
		if("input".equals(value)) { // org::eclipse::xtext::impl::KeywordImpl
			...
			element = grammarAccess.getSignalDeclAccess().getTypeInputKeyword_0_1_0();
			return obj;
		}
		return null;
	}
...
protected class SignalDecl_SignalAssignment_0_2 extends AssignmentToken  {
	...
	public AbstractToken createParentFollower(AbstractToken next,	int actIndex, int index, IInstanceDescription inst) {
		if(value == inst.getDelegate() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new SignalDecl_TypeAssignment_0_1(parent, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// type="output"
protected class SignalDecl_TypeAssignment_1_1 extends AssignmentToken  {
	
	public SignalDecl_TypeAssignment_1_1(AbstractToken parent, AbstractToken next, int no, IInstanceDescription current) {
		super(parent, next, no, current);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getSignalDeclAccess().getTypeAssignment_1_1();
	}
	...
	protected IInstanceDescription tryConsumeVal() {
		...
		if("output".equals(value)) { // org::eclipse::xtext::impl::KeywordImpl
			type = AssignmentType.KW;
			element = grammarAccess.getSignalDeclAccess().getTypeOutputKeyword_1_1_0();
			return obj;
		}
		return null;
	}
...
protected class SignalDecl_SignalAssignment_1_2 extends AssignmentToken  {
	...
	public AbstractToken createParentFollower(AbstractToken next,	int actIndex, int index, IInstanceDescription inst) {
		if(value == inst.getDelegate() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new SignalDecl_TypeAssignment_1_1(parent, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// type="inputoutput"
protected class SignalDecl_TypeAssignment_2_1 extends AssignmentToken  {
	
	public SignalDecl_TypeAssignment_2_1(AbstractToken parent, AbstractToken next, int no, IInstanceDescription current) {
		super(parent, next, no, current);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getSignalDeclAccess().getTypeAssignment_2_1();
	}
	...
	protected IInstanceDescription tryConsumeVal() {
		if((value = current.getConsumable("type",true)) == null) return null;
		IInstanceDescription obj = current.cloneAndConsume("type");
		if("inputoutput".equals(value)) { // org::eclipse::xtext::impl::KeywordImpl
			type = AssignmentType.KW;
			element = grammarAccess.getSignalDeclAccess().getTypeInputoutputKeyword_2_1_0();
			return obj;
		}
		return null;
	}
...
protected class SignalDecl_SignalAssignment_2_2 extends AssignmentToken  {
	...
	public AbstractToken createParentFollower(AbstractToken next,	int actIndex, int index, IInstanceDescription inst) {
		if(value == inst.getDelegate() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new SignalDecl_TypeAssignment_2_1(parent, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// type="return"
protected class SignalDecl_TypeAssignment_3_1 extends AssignmentToken  {
	
	public SignalDecl_TypeAssignment_3_1(AbstractToken parent, AbstractToken next, int no, IInstanceDescription current) {
		super(parent, next, no, current);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getSignalDeclAccess().getTypeAssignment_3_1();
	}
	...
	protected IInstanceDescription tryConsumeVal() {
		if((value = current.getConsumable("type",true)) == null) return null;
		IInstanceDescription obj = current.cloneAndConsume("type");
		if("return".equals(value)) { // org::eclipse::xtext::impl::KeywordImpl
			type = AssignmentType.KW;
			element = grammarAccess.getSignalDeclAccess().getTypeReturnKeyword_3_1_0();
			return obj;
		}
		return null;
	}
...
protected class SignalDecl_SignalAssignment_3_2 extends AssignmentToken  {
	...
	public AbstractToken createParentFollower(AbstractToken next,	int actIndex, int index, IInstanceDescription inst) {
		if(value == inst.getDelegate() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new SignalDecl_TypeAssignment_3_1(parent, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
