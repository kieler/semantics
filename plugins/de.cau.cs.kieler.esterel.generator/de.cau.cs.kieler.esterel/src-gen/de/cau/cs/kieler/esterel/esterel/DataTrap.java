 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.DataTrap#getTrap <em>Trap</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getDataTrap()
 * @model
 * @generated
 */
public interface DataTrap extends DataUnaryExpr
{
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getDataTrap_Trap()
   * @model
   * @generated
   */
  TrapDecl getTrap();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.DataTrap#getTrap <em>Trap</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
