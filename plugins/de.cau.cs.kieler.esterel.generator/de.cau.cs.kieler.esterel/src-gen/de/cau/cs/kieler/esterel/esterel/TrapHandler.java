 ...
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.TrapHandler#getStatement <em>Statement</em>}</li>
 * </ul>
 * </p>
 *
...
public interface TrapHandler extends EObject
{
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getTrapHandler_Statement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.TrapHandler#getStatement <em>Statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
