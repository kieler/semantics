...
public class EsterelFormatter extends AbstractDeclarativeFormatter {
	...
	protected void configureFormatting(FormattingConfig c) {
		de.cau.cs.kieler.esterel.services.EsterelGrammarAccess f = (de.cau.cs.kieler.esterel.services.EsterelGrammarAccess) getGrammarAccess();
		...
		c.setIndentation(f.getSignalDeclAccess().getTypeInputKeyword_0_1_0(), f
		...
		c.setIndentation(f.getSignalDeclAccess().getTypeOutputKeyword_1_1_0(), f
		...
		c.setIndentation(f.getSignalDeclAccess().getTypeInputoutputKeyword_2_1_0(), f
		...
		c.setIndentation(f.getSignalDeclAccess().getTypeReturnKeyword_3_1_0(), f
