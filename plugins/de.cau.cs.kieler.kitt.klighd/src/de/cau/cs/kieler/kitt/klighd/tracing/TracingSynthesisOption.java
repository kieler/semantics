 ...
 * Usage:
 * <p>
 * 1. In getDisplayedSynthesisOptions add TracingSynthesis.getSynthesisOption into the return list of options.
 * <p>
 * 2. Make sure that all generated KGraphElemts are associated with their source elements.
 * Use associateWith.
 * Otherwise these skipped model elements will be missing in the tracing visualization.
 * <p>
 * 3. Mark the KNode associated with the root element of an model which is part of the transformation 
 * chain with the following property (on KLayoutData):
 * setLayoutOption(TracingProperties.TRACED_MODEL_ROOT_NODE,true)
 * <p>
 * 4. Update your diagram with the TracingVisualizationUpdateStrategy.
 * (ID: de.cau.cs.kieler.kitt.klighd.update.TracingVisualizationUpdateStartegy)
 * @author als
...
public final class TracingSynthesisOption {
    ...
    public static TracingMode getOptionMode(Object optionValue) {
        return TracingMode.getTracingMode(optionValue);
    }
