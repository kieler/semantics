...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.kitt.tracingtree.ModelTransformation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelTransformationItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ModelTransformation_transformationID_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ModelTransformation_transformationID_feature", "_UI_ModelTransformation_type"),
                 TracingTreePackage.Literals.MODEL_TRANSFORMATION__TRANSFORMATION_ID,
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(TracingTreePackage.Literals.MODEL_TRANSFORMATION__TARGET);
            childrenFeatures.add(TracingTreePackage.Literals.MODEL_TRANSFORMATION__OBJECT_TRANSFORMATIONS);
        }
    ...
    public String getText(Object object) {
        String label = ((ModelTransformation)object).getTransformationID();
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (TracingTreePackage.Literals.MODEL_TRANSFORMATION__TARGET,
                 TracingTreeFactory.eINSTANCE.createModelWrapper()));

        newChildDescriptors.add
            (createChildParameter
                (TracingTreePackage.Literals.MODEL_TRANSFORMATION__OBJECT_TRANSFORMATIONS,
                 TracingTreeFactory.eINSTANCE.createEObjectTransformation()));
    }
