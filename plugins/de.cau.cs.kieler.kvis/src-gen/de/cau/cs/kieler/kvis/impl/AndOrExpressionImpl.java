 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kvis.impl.AndOrExpressionImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kvis.impl.AndOrExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kvis.impl.AndOrExpressionImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AndOrExpressionImpl extends BooleanExpressionImpl implements AndOrExpression
{
  /**
   ...
   * @ordered
   */
  protected static final BooleanOperatorType OPERATOR_EDEFAULT = BooleanOperatorType.AND;
   ...
   * @ordered
   */
  protected BooleanOperatorType operator = OPERATOR_EDEFAULT;
   ...
   * @generated
   */
  public void setOperator(BooleanOperatorType newOperator)
  {
    BooleanOperatorType oldOperator = operator;
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case KvisPackage.AND_OR_EXPRESSION__LEFT:
        ...
        return;
      case KvisPackage.AND_OR_EXPRESSION__OPERATOR:
        setOperator((BooleanOperatorType)newValue);
        return;
      case KvisPackage.AND_OR_EXPRESSION__RIGHT:
