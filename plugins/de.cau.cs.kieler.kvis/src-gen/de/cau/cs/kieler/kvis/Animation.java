 ...
 * </ul>
 *
 * @see de.cau.cs.kieler.kvis.KvisPackage#getAnimation()
 * @model
 * @generated
 */
public interface Animation extends EObject
{
   ...
   * @see de.cau.cs.kieler.kvis.KvisPackage#getAnimation_Variable()
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kvis.Animation#getVariable <em>Variable</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link de.cau.cs.kieler.kvis.AttributeMapping}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.cau.cs.kieler.kvis.KvisPackage#getAnimation_Mappings()
   * @model containment="true"
   * @generated
   */
  EList<AttributeMapping> getMappings();
