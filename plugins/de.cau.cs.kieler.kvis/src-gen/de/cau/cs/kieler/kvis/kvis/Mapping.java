 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kvis.kvis.Mapping#getVariableDomain <em>Variable Domain</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kvis.kvis.Mapping#getAttributeDomain <em>Attribute Domain</em>}</li>
 * </ul>
 *
 * @see de.cau.cs.kieler.kvis.kvis.KvisPackage#getMapping()
 * @model
 * @generated
 */
public interface Mapping extends EObject
{
   ...
   * @see de.cau.cs.kieler.kvis.kvis.KvisPackage#getMapping_VariableDomain()
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kvis.kvis.Mapping#getVariableDomain <em>Variable Domain</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.kvis.kvis.KvisPackage#getMapping_AttributeDomain()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kvis.kvis.Mapping#getAttributeDomain <em>Attribute Domain</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
