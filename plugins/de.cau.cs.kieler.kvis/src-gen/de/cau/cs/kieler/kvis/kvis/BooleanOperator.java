 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kvis.kvis.BooleanOperator#getAND <em>AND</em>}</li>
 * </ul>
 *
 * @see de.cau.cs.kieler.kvis.kvis.KvisPackage#getBooleanOperator()
 * @model
 * @generated
 */
public interface BooleanOperator extends EObject
{
   ...
   * @see #setAND(String)
   * @see de.cau.cs.kieler.kvis.kvis.KvisPackage#getBooleanOperator_AND()
   * @model
   * @generated
   */
  String getAND();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kvis.kvis.BooleanOperator#getAND <em>AND</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
