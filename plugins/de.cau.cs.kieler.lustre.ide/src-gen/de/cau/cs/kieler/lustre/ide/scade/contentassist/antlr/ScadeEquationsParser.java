...
public class ScadeEquationsParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(ScadeEquationsGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ScadeEquationsGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getReferenceDeclarationAccess().getGroup_2_0_1(), "rule__ReferenceDeclaration__Group_2_0_1__0");
			builder.put(grammarAccess.getReferenceDeclarationAccess().getGroup_2_0_3(), "rule__ReferenceDeclaration__Group_2_0_3__0");
			builder.put(grammarAccess.getReferenceDeclarationAccess().getGroup_2_0_3_2(), "rule__ReferenceDeclaration__Group_2_0_3_2__0");
			builder.put(grammarAccess.getReferenceDeclarationAccess().getGroup_2_0_5(), "rule__ReferenceDeclaration__Group_2_0_5__0");
			...
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGroup_2_0_1(), "rule__ReferenceDeclarationWOSemicolon__Group_2_0_1__0");
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGroup_2_0_3(), "rule__ReferenceDeclarationWOSemicolon__Group_2_0_3__0");
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGroup_2_0_3_2(), "rule__ReferenceDeclarationWOSemicolon__Group_2_0_3_2__0");
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGroup_2_0_5(), "rule__ReferenceDeclarationWOSemicolon__Group_2_0_5__0");
			...
			builder.put(grammarAccess.getScadeEquationAccess().getReferencesAssignment_0_1_0(), "rule__ScadeEquation__ReferencesAssignment_0_1_0");
			builder.put(grammarAccess.getScadeEquationAccess().getReferencesAssignment_0_1_2(), "rule__ScadeEquation__ReferencesAssignment_0_1_2");
			builder.put(grammarAccess.getScadeEquationAccess().getReferencesAssignment_0_1_3_1(), "rule__ScadeEquation__ReferencesAssignment_0_1_3_1");
			...
			builder.put(grammarAccess.getReferenceDeclarationAccess().getReferenceContainerAssignment_2_0_1_0(), "rule__ReferenceDeclaration__ReferenceContainerAssignment_2_0_1_0");
			builder.put(grammarAccess.getReferenceDeclarationAccess().getReferenceAssignment_2_0_2(), "rule__ReferenceDeclaration__ReferenceAssignment_2_0_2");
			builder.put(grammarAccess.getReferenceDeclarationAccess().getGenericParametersAssignment_2_0_3_1(), "rule__ReferenceDeclaration__GenericParametersAssignment_2_0_3_1");
			builder.put(grammarAccess.getReferenceDeclarationAccess().getGenericParametersAssignment_2_0_3_2_1(), "rule__ReferenceDeclaration__GenericParametersAssignment_2_0_3_2_1");
			builder.put(grammarAccess.getReferenceDeclarationAccess().getValuedObjectsAssignment_2_0_4(), "rule__ReferenceDeclaration__ValuedObjectsAssignment_2_0_4");
			builder.put(grammarAccess.getReferenceDeclarationAccess().getValuedObjectsAssignment_2_0_5_1(), "rule__ReferenceDeclaration__ValuedObjectsAssignment_2_0_5_1");
			...
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getReferenceContainerAssignment_2_0_1_0(), "rule__ReferenceDeclarationWOSemicolon__ReferenceContainerAssignment_2_0_1_0");
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getReferenceAssignment_2_0_2(), "rule__ReferenceDeclarationWOSemicolon__ReferenceAssignment_2_0_2");
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGenericParametersAssignment_2_0_3_1(), "rule__ReferenceDeclarationWOSemicolon__GenericParametersAssignment_2_0_3_1");
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGenericParametersAssignment_2_0_3_2_1(), "rule__ReferenceDeclarationWOSemicolon__GenericParametersAssignment_2_0_3_2_1");
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getValuedObjectsAssignment_2_0_4(), "rule__ReferenceDeclarationWOSemicolon__ValuedObjectsAssignment_2_0_4");
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getValuedObjectsAssignment_2_0_5_1(), "rule__ReferenceDeclarationWOSemicolon__ValuedObjectsAssignment_2_0_5_1");
	...
	@Override
	protected InternalScadeEquationsParser createParser() {
		InternalScadeEquationsParser result = new InternalScadeEquationsParser(null);
