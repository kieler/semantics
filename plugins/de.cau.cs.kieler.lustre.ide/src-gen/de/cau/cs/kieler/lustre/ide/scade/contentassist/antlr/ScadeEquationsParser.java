...
public class ScadeEquationsParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ScadeEquationsGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getValuedObjectAccess().getGroup_2_2(), "rule__ValuedObject__Group_2_2__0");
			...
			builder.put(grammarAccess.getValuedObjectAccess().getGroup_6(), "rule__ValuedObject__Group_6__0");
			...
			builder.put(grammarAccess.getValuedObjectAccess().getGenericParametersAssignment_2_1(), "rule__ValuedObject__GenericParametersAssignment_2_1");
			builder.put(grammarAccess.getValuedObjectAccess().getGenericParametersAssignment_2_2_1(), "rule__ValuedObject__GenericParametersAssignment_2_2_1");
			builder.put(grammarAccess.getValuedObjectAccess().getCardinalitiesAssignment_3_1(), "rule__ValuedObject__CardinalitiesAssignment_3_1");
			builder.put(grammarAccess.getValuedObjectAccess().getInitialValueAssignment_4_1(), "rule__ValuedObject__InitialValueAssignment_4_1");
			builder.put(grammarAccess.getValuedObjectAccess().getCombineOperatorAssignment_5_1(), "rule__ValuedObject__CombineOperatorAssignment_5_1");
			builder.put(grammarAccess.getValuedObjectAccess().getLabelAssignment_6_1(), "rule__ValuedObject__LabelAssignment_6_1");
