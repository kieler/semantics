...
public class ScadeEquationsParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ScadeEquationsGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getReferenceDeclarationAccess().getGroup_2_0_2_2(), "rule__ReferenceDeclaration__Group_2_0_2_2__0");
			...
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGroup_2_0_2_2(), "rule__ReferenceDeclarationWOSemicolon__Group_2_0_2_2__0");
			...
			builder.put(grammarAccess.getReferenceValuedObjectAccess().getGroup_2(), "rule__ReferenceValuedObject__Group_2__0");
			builder.put(grammarAccess.getReferenceValuedObjectAccess().getGroup_3(), "rule__ReferenceValuedObject__Group_3__0");
			builder.put(grammarAccess.getReferenceValuedObjectAccess().getGroup_3_2(), "rule__ReferenceValuedObject__Group_3_2__0");
			...
			builder.put(grammarAccess.getReferenceDeclarationAccess().getGenericParametersAssignment_2_0_2_1(), "rule__ReferenceDeclaration__GenericParametersAssignment_2_0_2_1");
			builder.put(grammarAccess.getReferenceDeclarationAccess().getGenericParametersAssignment_2_0_2_2_1(), "rule__ReferenceDeclaration__GenericParametersAssignment_2_0_2_2_1");
			...
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGenericParametersAssignment_2_0_2_1(), "rule__ReferenceDeclarationWOSemicolon__GenericParametersAssignment_2_0_2_1");
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGenericParametersAssignment_2_0_2_2_1(), "rule__ReferenceDeclarationWOSemicolon__GenericParametersAssignment_2_0_2_2_1");
			...
			builder.put(grammarAccess.getReferenceValuedObjectAccess().getAnnotationsAssignment_0(), "rule__ReferenceValuedObject__AnnotationsAssignment_0");
			builder.put(grammarAccess.getReferenceValuedObjectAccess().getNameAssignment_1(), "rule__ReferenceValuedObject__NameAssignment_1");
			builder.put(grammarAccess.getReferenceValuedObjectAccess().getCardinalitiesAssignment_2_1(), "rule__ReferenceValuedObject__CardinalitiesAssignment_2_1");
			builder.put(grammarAccess.getReferenceValuedObjectAccess().getGenericParametersAssignment_3_1(), "rule__ReferenceValuedObject__GenericParametersAssignment_3_1");
			builder.put(grammarAccess.getReferenceValuedObjectAccess().getGenericParametersAssignment_3_2_1(), "rule__ReferenceValuedObject__GenericParametersAssignment_3_2_1");
