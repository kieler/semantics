...
public class ScadeEquationsParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ScadeEquationsGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGroup_2_0_2(), "rule__ReferenceDeclarationWOSemicolon__Group_2_0_2__0");
			...
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGroup_2_0_4_2(), "rule__ReferenceDeclarationWOSemicolon__Group_2_0_4_2__0");
			...
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getReferenceContainerAssignment_2_0_2_0(), "rule__ReferenceDeclarationWOSemicolon__ReferenceContainerAssignment_2_0_2_0");
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getReferenceAssignment_2_0_3(), "rule__ReferenceDeclarationWOSemicolon__ReferenceAssignment_2_0_3");
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGenericParametersAssignment_2_0_4_1(), "rule__ReferenceDeclarationWOSemicolon__GenericParametersAssignment_2_0_4_1");
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGenericParametersAssignment_2_0_4_2_1(), "rule__ReferenceDeclarationWOSemicolon__GenericParametersAssignment_2_0_4_2_1");
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getValuedObjectsAssignment_2_0_5(), "rule__ReferenceDeclarationWOSemicolon__ValuedObjectsAssignment_2_0_5");
			builder.put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getValuedObjectsAssignment_2_0_6_1(), "rule__ReferenceDeclarationWOSemicolon__ValuedObjectsAssignment_2_0_6_1");
