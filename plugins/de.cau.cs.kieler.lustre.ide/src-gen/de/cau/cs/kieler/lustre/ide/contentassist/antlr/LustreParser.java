...
public class LustreParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, LustreGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEquationAccess().getGroup_1_1_4(), "rule__Equation__Group_1_1_4__0");
			...
			builder.put(grammarAccess.getEquationAccess().getReferenceAssignment_1_0(), "rule__Equation__ReferenceAssignment_1_0");
			builder.put(grammarAccess.getEquationAccess().getReferencesAssignment_1_1_1(), "rule__Equation__ReferencesAssignment_1_1_1");
			builder.put(grammarAccess.getEquationAccess().getReferencesAssignment_1_1_3(), "rule__Equation__ReferencesAssignment_1_1_3");
			builder.put(grammarAccess.getEquationAccess().getReferencesAssignment_1_1_4_1(), "rule__Equation__ReferencesAssignment_1_1_4_1");
