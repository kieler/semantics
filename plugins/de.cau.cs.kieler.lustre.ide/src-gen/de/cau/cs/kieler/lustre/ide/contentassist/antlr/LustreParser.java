...
public class LustreParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, LustreGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPackBodyAccess().getGroup_0(), "rule__PackBody__Group_0__0");
			builder.put(grammarAccess.getPackBodyAccess().getGroup_0_3(), "rule__PackBody__Group_0_3__0");
			...
			builder.put(grammarAccess.getNodeDeclarationAccess().getGroup_4_0_3_1_1_0(), "rule__NodeDeclaration__Group_4_0_3_1_1_0__0");
			builder.put(grammarAccess.getNodeDeclarationAccess().getGroup_4_0_3_1_1_0_3(), "rule__NodeDeclaration__Group_4_0_3_1_1_0_3__0");
			...
			builder.put(grammarAccess.getPackBodyAccess().getConstantsAssignment_0_1(), "rule__PackBody__ConstantsAssignment_0_1");
			builder.put(grammarAccess.getPackBodyAccess().getConstantsAssignment_0_3_0(), "rule__PackBody__ConstantsAssignment_0_3_0");
			builder.put(grammarAccess.getPackBodyAccess().getExternalsAssignment_1(), "rule__PackBody__ExternalsAssignment_1");
			builder.put(grammarAccess.getPackBodyAccess().getNodesAssignment_2(), "rule__PackBody__NodesAssignment_2");
			...
			builder.put(grammarAccess.getNodeDeclarationAccess().getConstantsAssignment_4_0_3_1_1_0_1(), "rule__NodeDeclaration__ConstantsAssignment_4_0_3_1_1_0_1");
			builder.put(grammarAccess.getNodeDeclarationAccess().getConstantsAssignment_4_0_3_1_1_0_3_0(), "rule__NodeDeclaration__ConstantsAssignment_4_0_3_1_1_0_3_0");
			...
			builder.put(grammarAccess.getVariableDeclarationAccess().getValuedObjectsAssignment_1_1(), "rule__VariableDeclaration__ValuedObjectsAssignment_1_1");
