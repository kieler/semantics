 ...
 */
package de.cau.cs.kieler.sccharts.sim.sclp.test;
 ...
 */
public class SCChartsSimSCLPAutomatedJUnitTest extends KiemAutomatedJUnitTest {
     ...
     */
    public SCChartsSimSCLPAutomatedJUnitTest(final IPath esoFile) {
        super(esoFile);
    }
    ...
    protected String getPluginId() {
        return "de.cau.cs.kieler.sccharts.sim.sclp.test";
    }
