...
public class KExpressionsActivator extends AbstractUIPlugin {
	...
	public static final String DE_CAU_CS_KIELER_CORE_KEXPRESSIONS_KEXPRESSIONS = "de.cau.cs.kieler.core.kexpressions.KExpressions";
	...
	protected Module getRuntimeModule(String grammar) {
		if (DE_CAU_CS_KIELER_CORE_KEXPRESSIONS_KEXPRESSIONS.equals(grammar)) {
