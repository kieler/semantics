 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.synccharts.transitionlabel.impl.ExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts.transitionlabel.impl.ExpressionImpl#getSubExpressions <em>Sub Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExpressionImpl extends MinimalEObjectImpl.Container implements Expression
{
  ...
  {
    return TransitionlabelPackage.Literals.EXPRESSION;
  }
  ...
  public void setOperator(OperatorKind newOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TransitionlabelPackage.EXPRESSION__OPERATOR, oldOperator, operator));
  }
  ...
  public EList<Expression> getSubExpressions()
  {
    ...
    {
      subExpressions = new EObjectContainmentEList<Expression>(Expression.class, this, TransitionlabelPackage.EXPRESSION__SUB_EXPRESSIONS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TransitionlabelPackage.EXPRESSION__SUB_EXPRESSIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TransitionlabelPackage.EXPRESSION__OPERATOR:
        return getOperator();
      case TransitionlabelPackage.EXPRESSION__SUB_EXPRESSIONS:
