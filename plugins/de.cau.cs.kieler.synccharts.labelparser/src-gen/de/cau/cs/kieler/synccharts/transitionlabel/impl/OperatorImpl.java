 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.synccharts.transitionlabel.impl.OperatorImpl#getOperatorKind <em>Operator Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperatorImpl extends MinimalEObjectImpl.Container implements Operator
{
  ...
  {
    return TransitionlabelPackage.Literals.OPERATOR;
  }
  ...
  public void setOperatorKind(OperatorKind newOperatorKind)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TransitionlabelPackage.OPERATOR__OPERATOR_KIND, oldOperatorKind, operatorKind));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TransitionlabelPackage.OPERATOR__OPERATOR_KIND:
