 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.synccharts.transitionlabel.impl.OperationsImpl#getOperators <em>Operators</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationsImpl extends ExpressionImpl implements Operations
{
  ...
  {
    return TransitionlabelPackage.Literals.OPERATIONS;
  }
  ...
  public void setOperators(OperatorKind newOperators)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TransitionlabelPackage.OPERATIONS__OPERATORS, oldOperators, operators));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TransitionlabelPackage.OPERATIONS__OPERATORS:
        return getOperators();
    }
