...
public class BooleanValueImpl extends ValueImpl implements BooleanValue
{
  ...
  {
    return TransitionlabelPackage.Literals.BOOLEAN_VALUE;
  }
  ...
  public void setValue(boolean newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TransitionlabelPackage.BOOLEAN_VALUE__VALUE, oldValue, value));
  }
