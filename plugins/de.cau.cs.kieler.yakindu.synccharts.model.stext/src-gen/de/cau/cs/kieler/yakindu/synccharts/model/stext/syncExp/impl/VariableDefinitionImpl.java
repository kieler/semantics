 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.yakindu.synccharts.model.stext.syncExp.impl.VariableDefinitionImpl#getVarInitialValue <em>Var Initial Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VariableDefinitionImpl extends de.cau.cs.kieler.yakindu.sccharts.model.stext.sCChartsExp.impl.VariableDefinitionImpl implements VariableDefinition
{
  /**
  ...
  {
    return SyncExpPackage.Literals.VARIABLE_DEFINITION;
  }
  ...
  public NotificationChain basicSetVarInitialValue(Expression newVarInitialValue, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SyncExpPackage.VARIABLE_DEFINITION__VAR_INITIAL_VALUE, oldVarInitialValue, newVarInitialValue);
  ...
  public void setVarInitialValue(Expression newVarInitialValue)
  {
    if (newVarInitialValue != varInitialValue)
    {
      ...
      if (varInitialValue != null)
        msgs = ((InternalEObject)varInitialValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SyncExpPackage.VARIABLE_DEFINITION__VAR_INITIAL_VALUE, null, msgs);
      if (newVarInitialValue != null)
        msgs = ((InternalEObject)newVarInitialValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SyncExpPackage.VARIABLE_DEFINITION__VAR_INITIAL_VALUE, null, msgs);
      msgs = basicSetVarInitialValue(newVarInitialValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SyncExpPackage.VARIABLE_DEFINITION__VAR_INITIAL_VALUE, newVarInitialValue, newVarInitialValue));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SyncExpPackage.VARIABLE_DEFINITION__VAR_INITIAL_VALUE:
