 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.yakindu.synccharts.model.stext.syncExp.impl.EventDefinitionImpl#isIsInput <em>Is Input</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.synccharts.model.stext.syncExp.impl.EventDefinitionImpl#isIsOutput <em>Is Output</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.synccharts.model.stext.syncExp.impl.EventDefinitionImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.synccharts.model.stext.syncExp.impl.EventDefinitionImpl#getVarInitialValue <em>Var Initial Value</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.synccharts.model.stext.syncExp.impl.EventDefinitionImpl#getVarCombineOperator <em>Var Combine Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventDefinitionImpl extends SignalDefinitionImpl implements EventDefinition
{
  ...
  {
    return SyncExpPackage.Literals.EVENT_DEFINITION;
  }
  ...
  public void setIsInput(boolean newIsInput)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SyncExpPackage.EVENT_DEFINITION__IS_INPUT, oldIsInput, isInput));
  }
  ...
  public void setIsOutput(boolean newIsOutput)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SyncExpPackage.EVENT_DEFINITION__IS_OUTPUT, oldIsOutput, isOutput));
  }
  ...
  public Type getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SyncExpPackage.EVENT_DEFINITION__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(Type newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SyncExpPackage.EVENT_DEFINITION__TYPE, oldType, type));
  }
  ...
  public NotificationChain basicSetVarInitialValue(Expression newVarInitialValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SyncExpPackage.EVENT_DEFINITION__VAR_INITIAL_VALUE, oldVarInitialValue, newVarInitialValue);
  ...
  public void setVarInitialValue(Expression newVarInitialValue)
  {
    if (newVarInitialValue != varInitialValue)
    {
      ...
      if (varInitialValue != null)
        msgs = ((InternalEObject)varInitialValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SyncExpPackage.EVENT_DEFINITION__VAR_INITIAL_VALUE, null, msgs);
      if (newVarInitialValue != null)
        msgs = ((InternalEObject)newVarInitialValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SyncExpPackage.EVENT_DEFINITION__VAR_INITIAL_VALUE, null, msgs);
      msgs = basicSetVarInitialValue(newVarInitialValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SyncExpPackage.EVENT_DEFINITION__VAR_INITIAL_VALUE, newVarInitialValue, newVarInitialValue));
  }
  ...
  public void setVarCombineOperator(CombineOperator newVarCombineOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SyncExpPackage.EVENT_DEFINITION__VAR_COMBINE_OPERATOR, oldVarCombineOperator, varCombineOperator));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SyncExpPackage.EVENT_DEFINITION__VAR_INITIAL_VALUE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SyncExpPackage.EVENT_DEFINITION__IS_INPUT:
        return isIsInput();
      case SyncExpPackage.EVENT_DEFINITION__IS_OUTPUT:
        return isIsOutput();
      case SyncExpPackage.EVENT_DEFINITION__TYPE:
        if (resolve) return getType();
        return basicGetType();
      case SyncExpPackage.EVENT_DEFINITION__VAR_INITIAL_VALUE:
        return getVarInitialValue();
      case SyncExpPackage.EVENT_DEFINITION__VAR_COMBINE_OPERATOR:
