...
public class SyncChartstextGrammarAccess extends AbstractGrammarElementFinder {
	...
	@Inject
	public SyncChartstextGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("de.cau.cs.kieler.yakindu.synccharts.model.stext.SyncChartstext".equals(grammar.getName())) {
				return grammar;
			}
