...
import de.cau.cs.kieler.yakindu.sccharts.model.stext.validation.SCChartsExpJavaValidator;
import org.eclipse.xtext.validation.ComposedChecks;

@ComposedChecks(validators= {org.eclipse.xtext.validation.ImportUriValidator.class, org.eclipse.xtext.validation.NamesAreUniqueValidator.class})
public class AbstractSyncExpJavaValidator extends SCChartsExpJavaValidator {

	@Override
	protected List<EPackage> getEPackages() {
	    List<EPackage> result = new ArrayList<EPackage>();
	    result.add(de.cau.cs.kieler.yakindu.synccharts.model.stext.syncExp.SyncExpPackage.eINSTANCE);
