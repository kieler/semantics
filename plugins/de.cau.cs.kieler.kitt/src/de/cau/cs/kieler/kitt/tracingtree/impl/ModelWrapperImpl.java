 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kitt.tracingtree.impl.ModelWrapperImpl#getModelTypeID <em>Model Type ID</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kitt.tracingtree.impl.ModelWrapperImpl#getModelObjects <em>Model Objects</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kitt.tracingtree.impl.ModelWrapperImpl#getTargetTransformations <em>Target Transformations</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kitt.tracingtree.impl.ModelWrapperImpl#getSourceTransformation <em>Source Transformation</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kitt.tracingtree.impl.ModelWrapperImpl#isTransient <em>Transient</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kitt.tracingtree.impl.ModelWrapperImpl#getRootObject <em>Root Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
