 ...
 * generated by Xtext
 */
package de.cau.cs.kieler.sccharts.ui.text.contentassist.antlr;
...
public class SCTXParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.cau.cs.kieler.sccharts.ui.text.contentassist.antlr.internal.InternalSCTXParser createParser() {
		de.cau.cs.kieler.sccharts.ui.text.contentassist.antlr.internal.InternalSCTXParser result = new de.cau.cs.kieler.sccharts.ui.text.contentassist.antlr.internal.InternalSCTXParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStateAccess().getAlternatives_8_1_4(), "rule__State__Alternatives_8_1_4");
					...
					put(grammarAccess.getTransitionAccess().getPreemptionAlternatives_2_0_0_0(), "rule__Transition__PreemptionAlternatives_2_0_0_0");
					put(grammarAccess.getTransitionAccess().getAlternatives_2_0_5_2(), "rule__Transition__Alternatives_2_0_5_2");
					put(grammarAccess.getTransitionAccess().getAlternatives_2_1_1_2(), "rule__Transition__Alternatives_2_1_1_2");
					put(grammarAccess.getTransitionAccess().getPreemptionAlternatives_2_1_3_0(), "rule__Transition__PreemptionAlternatives_2_1_3_0");
					put(grammarAccess.getRegionAccess().getAlternatives(), "rule__Region__Alternatives");
					put(grammarAccess.getControlflowRegionAccess().getAlternatives_8(), "rule__ControlflowRegion__Alternatives_8");
					put(grammarAccess.getControlflowRegionAccess().getAlternatives_8_1_3(), "rule__ControlflowRegion__Alternatives_8_1_3");
					put(grammarAccess.getIntOrReferenceAccess().getAlternatives(), "rule__IntOrReference__Alternatives");
					...
					put(grammarAccess.getStateAccess().getGroup_8_0_2(), "rule__State__Group_8_0_2__0");
					...
					put(grammarAccess.getImplicitStateAccess().getGroup(), "rule__ImplicitState__Group__0");
					...
					put(grammarAccess.getScopeParameterAccess().getGroup(), "rule__ScopeParameter__Group__0");
					put(grammarAccess.getScopeParameterAccess().getGroup_0(), "rule__ScopeParameter__Group_0__0");
					put(grammarAccess.getScopeParameterAccess().getGroup_2(), "rule__ScopeParameter__Group_2__0");
					put(grammarAccess.getScopeParameterAccess().getGroup_2_2(), "rule__ScopeParameter__Group_2_2__0");
					put(grammarAccess.getBoolScheduleExpressionAccess().getGroup(), "rule__BoolScheduleExpression__Group__0");
					put(grammarAccess.getBoolScheduleExpressionAccess().getGroup_1(), "rule__BoolScheduleExpression__Group_1__0");
					put(grammarAccess.getTransitionAccess().getGroup(), "rule__Transition__Group__0");
					put(grammarAccess.getTransitionAccess().getGroup_2_0(), "rule__Transition__Group_2_0__0");
					put(grammarAccess.getTransitionAccess().getGroup_2_0_5(), "rule__Transition__Group_2_0_5__0");
					put(grammarAccess.getTransitionAccess().getGroup_2_0_5_3(), "rule__Transition__Group_2_0_5_3__0");
					put(grammarAccess.getTransitionAccess().getGroup_2_0_6(), "rule__Transition__Group_2_0_6__0");
					put(grammarAccess.getTransitionAccess().getGroup_2_0_6_2(), "rule__Transition__Group_2_0_6_2__0");
					put(grammarAccess.getTransitionAccess().getGroup_2_1(), "rule__Transition__Group_2_1__0");
					put(grammarAccess.getTransitionAccess().getGroup_2_1_1(), "rule__Transition__Group_2_1_1__0");
					put(grammarAccess.getTransitionAccess().getGroup_2_1_1_3(), "rule__Transition__Group_2_1_1_3__0");
					put(grammarAccess.getTransitionAccess().getGroup_2_1_2(), "rule__Transition__Group_2_1_2__0");
					put(grammarAccess.getTransitionAccess().getGroup_2_1_2_2(), "rule__Transition__Group_2_1_2_2__0");
					put(grammarAccess.getTransitionAccess().getGroup_3(), "rule__Transition__Group_3__0");
					put(grammarAccess.getImplicitControlflowRegionAccess().getGroup(), "rule__ImplicitControlflowRegion__Group__0");
					put(grammarAccess.getControlflowRegionAccess().getGroup(), "rule__ControlflowRegion__Group__0");
					put(grammarAccess.getControlflowRegionAccess().getGroup_6(), "rule__ControlflowRegion__Group_6__0");
					put(grammarAccess.getControlflowRegionAccess().getGroup_6_4(), "rule__ControlflowRegion__Group_6_4__0");
					put(grammarAccess.getControlflowRegionAccess().getGroup_7(), "rule__ControlflowRegion__Group_7__0");
					put(grammarAccess.getControlflowRegionAccess().getGroup_8_0(), "rule__ControlflowRegion__Group_8_0__0");
					put(grammarAccess.getControlflowRegionAccess().getGroup_8_1(), "rule__ControlflowRegion__Group_8_1__0");
					...
					put(grammarAccess.getDuringActionAccess().getGroup_3_3(), "rule__DuringAction__Group_3_3__0");
					...
					put(grammarAccess.getExitActionAccess().getGroup_2_2(), "rule__ExitAction__Group_2_2__0");
					...
					put(grammarAccess.getSuspendActionAccess().getGroup_4_3(), "rule__SuspendAction__Group_4_3__0");
					put(grammarAccess.getSuspendActionAccess().getGroup_5(), "rule__SuspendAction__Group_5__0");
					...
					put(grammarAccess.getPrecedingActionAccess().getGroup_2_2(), "rule__PrecedingAction__Group_2_2__0");
					...
					put(grammarAccess.getPrecedingActionAccess().getGroup_4(), "rule__PrecedingAction__Group_4__0");
					...
					put(grammarAccess.getSucceedingActionAccess().getGroup_2_2(), "rule__SucceedingAction__Group_2_2__0");
					...
					put(grammarAccess.getPeriodActionAccess().getGroup(), "rule__PeriodAction__Group__0");
					put(grammarAccess.getPeriodActionAccess().getGroup_5(), "rule__PeriodAction__Group_5__0");
					...
					put(grammarAccess.getStateAccess().getScheduleAssignment_8_0_2_1(), "rule__State__ScheduleAssignment_8_0_2_1");
					put(grammarAccess.getStateAccess().getScheduleAssignment_8_1_0_1(), "rule__State__ScheduleAssignment_8_1_0_1");
					put(grammarAccess.getStateAccess().getDeclarationsAssignment_8_1_2(), "rule__State__DeclarationsAssignment_8_1_2");
					put(grammarAccess.getStateAccess().getActionsAssignment_8_1_3(), "rule__State__ActionsAssignment_8_1_3");
					put(grammarAccess.getStateAccess().getRegionsAssignment_8_1_4_0(), "rule__State__RegionsAssignment_8_1_4_0");
					put(grammarAccess.getStateAccess().getRegionsAssignment_8_1_4_1(), "rule__State__RegionsAssignment_8_1_4_1");
					put(grammarAccess.getStateAccess().getOutgoingTransitionsAssignment_9(), "rule__State__OutgoingTransitionsAssignment_9");
					put(grammarAccess.getImplicitStateAccess().getRegionsAssignment_1(), "rule__ImplicitState__RegionsAssignment_1");
					...
					put(grammarAccess.getScopeParameterAccess().getPureOutputAssignment_0_0(), "rule__ScopeParameter__PureOutputAssignment_0_0");
					put(grammarAccess.getScopeParameterAccess().getCallByReferenceAssignment_0_1(), "rule__ScopeParameter__CallByReferenceAssignment_0_1");
					put(grammarAccess.getScopeParameterAccess().getExpressionAssignment_1(), "rule__ScopeParameter__ExpressionAssignment_1");
					put(grammarAccess.getScopeParameterAccess().getExplicitBindingAssignment_2_1(), "rule__ScopeParameter__ExplicitBindingAssignment_2_1");
					put(grammarAccess.getScopeParameterAccess().getExplicitBindingIndicesAssignment_2_2_1(), "rule__ScopeParameter__ExplicitBindingIndicesAssignment_2_2_1");
					put(grammarAccess.getBoolScheduleExpressionAccess().getScheduleAssignment_1_1(), "rule__BoolScheduleExpression__ScheduleAssignment_1_1");
					put(grammarAccess.getTransitionAccess().getAnnotationsAssignment_1(), "rule__Transition__AnnotationsAssignment_1");
					put(grammarAccess.getTransitionAccess().getPreemptionAssignment_2_0_0(), "rule__Transition__PreemptionAssignment_2_0_0");
					put(grammarAccess.getTransitionAccess().getTargetStateAssignment_2_0_1(), "rule__Transition__TargetStateAssignment_2_0_1");
					put(grammarAccess.getTransitionAccess().getDelayAssignment_2_0_2(), "rule__Transition__DelayAssignment_2_0_2");
					put(grammarAccess.getTransitionAccess().getDeferredAssignment_2_0_3(), "rule__Transition__DeferredAssignment_2_0_3");
					put(grammarAccess.getTransitionAccess().getHistoryAssignment_2_0_4(), "rule__Transition__HistoryAssignment_2_0_4");
					put(grammarAccess.getTransitionAccess().getTriggerDelayAssignment_2_0_5_1(), "rule__Transition__TriggerDelayAssignment_2_0_5_1");
					put(grammarAccess.getTransitionAccess().getTriggerAssignment_2_0_5_2_0(), "rule__Transition__TriggerAssignment_2_0_5_2_0");
					put(grammarAccess.getTransitionAccess().getTriggerAssignment_2_0_5_2_1(), "rule__Transition__TriggerAssignment_2_0_5_2_1");
					put(grammarAccess.getTransitionAccess().getTriggerProbabilityAssignment_2_0_5_3_1(), "rule__Transition__TriggerProbabilityAssignment_2_0_5_3_1");
					put(grammarAccess.getTransitionAccess().getNondeterministicAssignment_2_0_5_4(), "rule__Transition__NondeterministicAssignment_2_0_5_4");
					put(grammarAccess.getTransitionAccess().getEffectsAssignment_2_0_6_1(), "rule__Transition__EffectsAssignment_2_0_6_1");
					put(grammarAccess.getTransitionAccess().getEffectsAssignment_2_0_6_2_1(), "rule__Transition__EffectsAssignment_2_0_6_2_1");
					put(grammarAccess.getTransitionAccess().getDelayAssignment_2_1_0(), "rule__Transition__DelayAssignment_2_1_0");
					put(grammarAccess.getTransitionAccess().getTriggerDelayAssignment_2_1_1_1(), "rule__Transition__TriggerDelayAssignment_2_1_1_1");
					put(grammarAccess.getTransitionAccess().getTriggerAssignment_2_1_1_2_0(), "rule__Transition__TriggerAssignment_2_1_1_2_0");
					put(grammarAccess.getTransitionAccess().getTriggerAssignment_2_1_1_2_1(), "rule__Transition__TriggerAssignment_2_1_1_2_1");
					put(grammarAccess.getTransitionAccess().getTriggerProbabilityAssignment_2_1_1_3_1(), "rule__Transition__TriggerProbabilityAssignment_2_1_1_3_1");
					put(grammarAccess.getTransitionAccess().getNondeterministicAssignment_2_1_1_4(), "rule__Transition__NondeterministicAssignment_2_1_1_4");
					put(grammarAccess.getTransitionAccess().getEffectsAssignment_2_1_2_1(), "rule__Transition__EffectsAssignment_2_1_2_1");
					put(grammarAccess.getTransitionAccess().getEffectsAssignment_2_1_2_2_1(), "rule__Transition__EffectsAssignment_2_1_2_2_1");
					put(grammarAccess.getTransitionAccess().getPreemptionAssignment_2_1_3(), "rule__Transition__PreemptionAssignment_2_1_3");
					put(grammarAccess.getTransitionAccess().getTargetStateAssignment_2_1_4(), "rule__Transition__TargetStateAssignment_2_1_4");
					put(grammarAccess.getTransitionAccess().getDeferredAssignment_2_1_5(), "rule__Transition__DeferredAssignment_2_1_5");
					put(grammarAccess.getTransitionAccess().getHistoryAssignment_2_1_6(), "rule__Transition__HistoryAssignment_2_1_6");
					put(grammarAccess.getTransitionAccess().getLabelAssignment_3_1(), "rule__Transition__LabelAssignment_3_1");
					put(grammarAccess.getImplicitControlflowRegionAccess().getStatesAssignment_1(), "rule__ImplicitControlflowRegion__StatesAssignment_1");
					put(grammarAccess.getControlflowRegionAccess().getAnnotationsAssignment_1(), "rule__ControlflowRegion__AnnotationsAssignment_1");
					put(grammarAccess.getControlflowRegionAccess().getFinalAssignment_2(), "rule__ControlflowRegion__FinalAssignment_2");
					put(grammarAccess.getControlflowRegionAccess().getNameAssignment_4(), "rule__ControlflowRegion__NameAssignment_4");
					put(grammarAccess.getControlflowRegionAccess().getLabelAssignment_5(), "rule__ControlflowRegion__LabelAssignment_5");
					put(grammarAccess.getControlflowRegionAccess().getCounterVariableAssignment_6_1(), "rule__ControlflowRegion__CounterVariableAssignment_6_1");
					put(grammarAccess.getControlflowRegionAccess().getForStartAssignment_6_3(), "rule__ControlflowRegion__ForStartAssignment_6_3");
					put(grammarAccess.getControlflowRegionAccess().getForEndAssignment_6_4_1(), "rule__ControlflowRegion__ForEndAssignment_6_4_1");
					put(grammarAccess.getControlflowRegionAccess().getScheduleAssignment_7_1(), "rule__ControlflowRegion__ScheduleAssignment_7_1");
					put(grammarAccess.getControlflowRegionAccess().getDeclarationsAssignment_8_0_1(), "rule__ControlflowRegion__DeclarationsAssignment_8_0_1");
					put(grammarAccess.getControlflowRegionAccess().getActionsAssignment_8_0_2(), "rule__ControlflowRegion__ActionsAssignment_8_0_2");
					put(grammarAccess.getControlflowRegionAccess().getStatesAssignment_8_0_3(), "rule__ControlflowRegion__StatesAssignment_8_0_3");
					put(grammarAccess.getControlflowRegionAccess().getDeclarationsAssignment_8_1_1(), "rule__ControlflowRegion__DeclarationsAssignment_8_1_1");
					put(grammarAccess.getControlflowRegionAccess().getActionsAssignment_8_1_2(), "rule__ControlflowRegion__ActionsAssignment_8_1_2");
					put(grammarAccess.getControlflowRegionAccess().getStatesAssignment_8_1_3_0(), "rule__ControlflowRegion__StatesAssignment_8_1_3_0");
					put(grammarAccess.getControlflowRegionAccess().getStatesAssignment_8_1_3_1(), "rule__ControlflowRegion__StatesAssignment_8_1_3_1");
					...
					put(grammarAccess.getDuringActionAccess().getTriggerProbabilityAssignment_3_3_1(), "rule__DuringAction__TriggerProbabilityAssignment_3_3_1");
					...
					put(grammarAccess.getExitActionAccess().getTriggerProbabilityAssignment_2_2_1(), "rule__ExitAction__TriggerProbabilityAssignment_2_2_1");
					...
					put(grammarAccess.getExitActionAccess().getLabelAssignment_4_1(), "rule__ExitAction__LabelAssignment_4_1");
					...
					put(grammarAccess.getSuspendActionAccess().getTriggerDelayAssignment_4_1(), "rule__SuspendAction__TriggerDelayAssignment_4_1");
					put(grammarAccess.getSuspendActionAccess().getTriggerAssignment_4_2(), "rule__SuspendAction__TriggerAssignment_4_2");
					put(grammarAccess.getSuspendActionAccess().getTriggerProbabilityAssignment_4_3_1(), "rule__SuspendAction__TriggerProbabilityAssignment_4_3_1");
					put(grammarAccess.getSuspendActionAccess().getLabelAssignment_5_1(), "rule__SuspendAction__LabelAssignment_5_1");
					put(grammarAccess.getPrecedingActionAccess().getTriggerAssignment_2_1(), "rule__PrecedingAction__TriggerAssignment_2_1");
					put(grammarAccess.getPrecedingActionAccess().getTriggerProbabilityAssignment_2_2_1(), "rule__PrecedingAction__TriggerProbabilityAssignment_2_2_1");
					...
					put(grammarAccess.getPrecedingActionAccess().getLabelAssignment_4_1(), "rule__PrecedingAction__LabelAssignment_4_1");
					put(grammarAccess.getSucceedingActionAccess().getTriggerAssignment_2_1(), "rule__SucceedingAction__TriggerAssignment_2_1");
					put(grammarAccess.getSucceedingActionAccess().getTriggerProbabilityAssignment_2_2_1(), "rule__SucceedingAction__TriggerProbabilityAssignment_2_2_1");
					...
					put(grammarAccess.getPeriodActionAccess().getAnnotationsAssignment_1(), "rule__PeriodAction__AnnotationsAssignment_1");
					put(grammarAccess.getPeriodActionAccess().getDelayAssignment_2(), "rule__PeriodAction__DelayAssignment_2");
					put(grammarAccess.getPeriodActionAccess().getTriggerAssignment_4(), "rule__PeriodAction__TriggerAssignment_4");
					put(grammarAccess.getPeriodActionAccess().getLabelAssignment_5_1(), "rule__PeriodAction__LabelAssignment_5_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.cau.cs.kieler.sccharts.ui.text.contentassist.antlr.internal.InternalSCTXParser typedParser = (de.cau.cs.kieler.sccharts.ui.text.contentassist.antlr.internal.InternalSCTXParser) parser;
