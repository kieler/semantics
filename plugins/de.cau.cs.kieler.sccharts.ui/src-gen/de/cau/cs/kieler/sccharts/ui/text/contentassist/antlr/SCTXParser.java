		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTransitionAccess().getAlternatives_6_2(), "rule__Transition__Alternatives_6_2");
					put(grammarAccess.getRegionAccess().getAlternatives(), "rule__Region__Alternatives");
					put(grammarAccess.getNestedControlflowRegionAccess().getAlternatives_8(), "rule__NestedControlflowRegion__Alternatives_8");
					...
					put(grammarAccess.getImplicitDataflowRegionAccess().getGroup(), "rule__ImplicitDataflowRegion__Group__0");
					...
					put(grammarAccess.getNestedControlflowRegionAccess().getGroup(), "rule__NestedControlflowRegion__Group__0");
					put(grammarAccess.getNestedControlflowRegionAccess().getGroup_5(), "rule__NestedControlflowRegion__Group_5__0");
					put(grammarAccess.getNestedControlflowRegionAccess().getGroup_5_4(), "rule__NestedControlflowRegion__Group_5_4__0");
					...
					put(grammarAccess.getTransitionAccess().getTriggerDelayAssignment_6_1(), "rule__Transition__TriggerDelayAssignment_6_1");
					put(grammarAccess.getTransitionAccess().getTriggerAssignment_6_2_0(), "rule__Transition__TriggerAssignment_6_2_0");
					put(grammarAccess.getTransitionAccess().getTriggerAssignment_6_2_1(), "rule__Transition__TriggerAssignment_6_2_1");
					...
					put(grammarAccess.getTransitionAccess().getLabelAssignment_8_1(), "rule__Transition__LabelAssignment_8_1");
					...
					put(grammarAccess.getImplicitDataflowRegionAccess().getEquationsAssignment_1(), "rule__ImplicitDataflowRegion__EquationsAssignment_1");
					...
					put(grammarAccess.getNestedControlflowRegionAccess().getAnnotationsAssignment_1(), "rule__NestedControlflowRegion__AnnotationsAssignment_1");
					put(grammarAccess.getNestedControlflowRegionAccess().getNameAssignment_3(), "rule__NestedControlflowRegion__NameAssignment_3");
					put(grammarAccess.getNestedControlflowRegionAccess().getLabelAssignment_4(), "rule__NestedControlflowRegion__LabelAssignment_4");
					put(grammarAccess.getNestedControlflowRegionAccess().getCounterVariableAssignment_5_1(), "rule__NestedControlflowRegion__CounterVariableAssignment_5_1");
					put(grammarAccess.getNestedControlflowRegionAccess().getForStartAssignment_5_3(), "rule__NestedControlflowRegion__ForStartAssignment_5_3");
					put(grammarAccess.getNestedControlflowRegionAccess().getForEndAssignment_5_4_1(), "rule__NestedControlflowRegion__ForEndAssignment_5_4_1");
					put(grammarAccess.getNestedControlflowRegionAccess().getDeclarationsAssignment_7(), "rule__NestedControlflowRegion__DeclarationsAssignment_7");
					put(grammarAccess.getNestedControlflowRegionAccess().getStatesAssignment_8_0(), "rule__NestedControlflowRegion__StatesAssignment_8_0");
					put(grammarAccess.getNestedControlflowRegionAccess().getStatesAssignment_8_1(), "rule__NestedControlflowRegion__StatesAssignment_8_1");
