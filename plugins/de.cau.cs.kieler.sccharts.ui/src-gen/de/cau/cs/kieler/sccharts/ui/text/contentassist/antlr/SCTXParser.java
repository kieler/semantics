		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getControlflowRegionAccess().getAlternatives_7(), "rule__ControlflowRegion__Alternatives_7");
					put(grammarAccess.getControlflowRegionAccess().getAlternatives_7_1_2(), "rule__ControlflowRegion__Alternatives_7_1_2");
					...
					put(grammarAccess.getControlflowRegionAccess().getGroup_5_4(), "rule__ControlflowRegion__Group_5_4__0");
					put(grammarAccess.getControlflowRegionAccess().getGroup_6(), "rule__ControlflowRegion__Group_6__0");
					put(grammarAccess.getControlflowRegionAccess().getGroup_7_0(), "rule__ControlflowRegion__Group_7_0__0");
					put(grammarAccess.getControlflowRegionAccess().getGroup_7_1(), "rule__ControlflowRegion__Group_7_1__0");
					...
					put(grammarAccess.getControlflowRegionAccess().getCounterVariableAssignment_5_1(), "rule__ControlflowRegion__CounterVariableAssignment_5_1");
					put(grammarAccess.getControlflowRegionAccess().getForStartAssignment_5_3(), "rule__ControlflowRegion__ForStartAssignment_5_3");
					put(grammarAccess.getControlflowRegionAccess().getForEndAssignment_5_4_1(), "rule__ControlflowRegion__ForEndAssignment_5_4_1");
					put(grammarAccess.getControlflowRegionAccess().getScheduleAssignment_6_1(), "rule__ControlflowRegion__ScheduleAssignment_6_1");
					put(grammarAccess.getControlflowRegionAccess().getDeclarationsAssignment_7_0_1(), "rule__ControlflowRegion__DeclarationsAssignment_7_0_1");
					put(grammarAccess.getControlflowRegionAccess().getStatesAssignment_7_0_2(), "rule__ControlflowRegion__StatesAssignment_7_0_2");
					put(grammarAccess.getControlflowRegionAccess().getDeclarationsAssignment_7_1_1(), "rule__ControlflowRegion__DeclarationsAssignment_7_1_1");
					put(grammarAccess.getControlflowRegionAccess().getStatesAssignment_7_1_2_0(), "rule__ControlflowRegion__StatesAssignment_7_1_2_0");
					put(grammarAccess.getControlflowRegionAccess().getStatesAssignment_7_1_2_1(), "rule__ControlflowRegion__StatesAssignment_7_1_2_1");
