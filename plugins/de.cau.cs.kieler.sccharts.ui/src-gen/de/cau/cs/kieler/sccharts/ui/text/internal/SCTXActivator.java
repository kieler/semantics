 ...
 * generated by Xtext
 */
package de.cau.cs.kieler.sccharts.ui.text.internal;
...
public class SCTXActivator extends AbstractUIPlugin {
	...
	protected Module getRuntimeModule(String grammar) {
		if (DE_CAU_CS_KIELER_SCCHARTS_TEXT_SCTX.equals(grammar)) {
			return new de.cau.cs.kieler.sccharts.text.SCTXRuntimeModule();
		}
	...
	protected Module getUiModule(String grammar) {
		if (DE_CAU_CS_KIELER_SCCHARTS_TEXT_SCTX.equals(grammar)) {
			return new de.cau.cs.kieler.sccharts.ui.text.SCTXUiModule(this);
		}
