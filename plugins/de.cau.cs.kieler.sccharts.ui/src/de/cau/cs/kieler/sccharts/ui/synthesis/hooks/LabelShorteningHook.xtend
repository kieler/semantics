...
class LabelShorteningHook extends SynthesisActionHook {
    ...
    public static final SynthesisOption HIDE_LABELS = SynthesisOption.createCheckOption("sccharts.labelShortening.hideLabels", "Transition Labels",
    ...
    public static val SynthesisOption SHORTEN_LABEL_STRATEGY = SynthesisOption::createChoiceOption("sccharts.labelShortening.shortenLabelStrategy", "Label Management",
        newLinkedList(
    ...
    public static val SynthesisOption SHORTEN_LABEL_WIDTH = SynthesisOption::createRangeOption("sccharts.labelShortening.shortenLabelWidth", "Shortening Width",
