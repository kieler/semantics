...
class StateActionsHook extends SynthesisHook {
    ...
    public static final SynthesisOption SHOW_STATE_ACTIONS = SynthesisOption.createCheckOption("sccharts.stateActions.showStateActions", "State Actions", true).
    	setCategory(GeneralSynthesisOptions::APPEARANCE)
    /** The to break lines in effect chain */
    public static final SynthesisOption LINEBREAKS_IN_EFFECTS = SynthesisOption.createCheckOption("sccharts.stateActions.linebreaksInEffects", "Linebreaks in Actions", false).
        setCategory(GeneralSynthesisOptions::APPEARANCE)
