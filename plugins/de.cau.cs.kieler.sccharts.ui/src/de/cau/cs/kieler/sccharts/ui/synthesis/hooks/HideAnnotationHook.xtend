...
class HideAnnotationHook extends SynthesisHook {
    ...
    public static final SynthesisOption SHOW_HIDDEN_ELEMENTS = SynthesisOption.createCheckOption("sccharts.hideAnnotations.showHiddenElements", "Hidden Elements (@Hide)",
