...
final class GeneralSynthesisOptions {
    ...
    public static final SynthesisOption NODE_SIZE_CONSTRAINT = SynthesisOption.createRangeOption("Node Size Constraint",1.0, 500.0, 34.0f).setCategory(TOPDOWN_LAYOUT)
