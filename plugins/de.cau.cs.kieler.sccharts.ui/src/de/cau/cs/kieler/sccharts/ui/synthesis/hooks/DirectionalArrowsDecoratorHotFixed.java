 ...
 * @author cds
 */
public final class DirectionalArrowsDecoratorHotFixed extends AbstractDecoratorRenderingProvider {
     ...
     * Use create methods.
     */
    private DirectionalArrowsDecoratorHotFixed() {
    }
     ...
     * @return new instance.
     */
    public static DirectionalArrowsDecoratorHotFixed create() {
        return new DirectionalArrowsDecoratorHotFixed();
    }
     ...
     */
    public DirectionalArrowsDecoratorHotFixed withColor(final int r, final int g, final int b, final int a) {
        arrowColor.r = r;
        arrowColor.g = g;
        arrowColor.b = b;
        arrowColor.a = a;
     ...
     * @return this decorator for method chaining.
     */
    public DirectionalArrowsDecoratorHotFixed withColor(final java.awt.Color color) {
    ...
    private KRendering createUpArrow() {
        ...
        // Setup placement and visibility
        setPlacement(arrow, left(2, 0), top(-4, 0), right(0, 0), top(0, 0));
    ...
    private KRendering createDownArrow() {
        ...
        // Setup placement and visibility
        setPlacement(arrow, left(2, 0), bottom(0, 0), right(0, 0), bottom(-4, 0));
