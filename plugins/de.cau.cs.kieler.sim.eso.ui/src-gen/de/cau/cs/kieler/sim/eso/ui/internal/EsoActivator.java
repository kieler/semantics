...
public class EsoActivator extends AbstractUIPlugin {
	...
	protected Module getRuntimeModule(String grammar) {
		if (DE_CAU_CS_KIELER_SIM_ESO_ESO.equals(grammar)) {
			return new de.cau.cs.kieler.sim.eso.EsoRuntimeModule();
		}
	...
	protected Module getUiModule(String grammar) {
		if (DE_CAU_CS_KIELER_SIM_ESO_ESO.equals(grammar)) {
			return new de.cau.cs.kieler.sim.eso.ui.EsoUiModule(this);
		}
