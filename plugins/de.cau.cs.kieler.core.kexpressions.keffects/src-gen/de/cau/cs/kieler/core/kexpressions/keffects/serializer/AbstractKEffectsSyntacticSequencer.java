...
public abstract class AbstractKEffectsSyntacticSequencer extends AbstractSyntacticSequencer {

	protected KEffectsGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (KEffectsGrammarAccess) access;
