...
public abstract class AbstractSctSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Transition_WithKeyword_4_2_0_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Transition_WithKeyword_4_2_0_q = new TokenAlias(false, true, grammarAccess.getTransitionAccess().getWithKeyword_4_2_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_Transition_WithKeyword_4_2_0_q.equals(syntax))
				emit_Transition_WithKeyword_4_2_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     'with'?
	 */
	protected void emit_Transition_WithKeyword_4_2_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
