...
public abstract class AbstractSctSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Transition_DoKeyword_3_3_0_1_0_0_or_SolidusKeyword_3_3_0_1_0_1;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Transition_DoKeyword_3_3_0_1_0_0_or_SolidusKeyword_3_3_0_1_0_1 = new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getTransitionAccess().getDoKeyword_3_3_0_1_0_0()), new TokenAlias(false, false, grammarAccess.getTransitionAccess().getSolidusKeyword_3_3_0_1_0_1()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_Transition_DoKeyword_3_3_0_1_0_0_or_SolidusKeyword_3_3_0_1_0_1.equals(syntax))
				emit_Transition_DoKeyword_3_3_0_1_0_0_or_SolidusKeyword_3_3_0_1_0_1(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     'do' | '/'
	 */
	protected void emit_Transition_DoKeyword_3_3_0_1_0_0_or_SolidusKeyword_3_3_0_1_0_1(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
