...
public abstract class AbstractActionsSemanticSequencer extends KExpressionsSemanticSequencer {
	...
	/**
	 * Constraint:
	 *     (valuedObject=[ValuedObject|ID] indexExpressions+=Expression* expression=Expression)
	 */
	...
	/**
	 * Constraint:
	 *     (valuedObject=[ValuedObject|ID] indexExpressions+=Expression* newValue=Expression?)
	 */
