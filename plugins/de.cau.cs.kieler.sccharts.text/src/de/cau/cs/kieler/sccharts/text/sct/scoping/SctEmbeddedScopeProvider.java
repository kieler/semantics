...
/**
 * Specialized version of {@link SctScopeProvider} for embedded Sct.
 *
 * @author chsch
 */
public class SctEmbeddedScopeProvider extends SctScopeProvider {
...
//    public IScope scope_Signal(final EObject obj, final EReference reference) {
     ...
     * reflection by the Xtext runtime. Delegates to
     * {@link SctScopeProvider#scope_Variable(EObject, EReference, State)}.
     *
     * @param obj
     * @param reference
     * @return
