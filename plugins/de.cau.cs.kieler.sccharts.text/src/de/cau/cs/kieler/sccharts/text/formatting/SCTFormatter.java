 ...
 */
public class SCTFormatter extends AbstractDeclarativeFormatter {
	
	@Override
	protected void configureFormatting(FormattingConfig c) {
		de.cau.cs.kieler.sccharts.text.services.SCTGrammarAccess f = (de.cau.cs.kieler.sccharts.text.services.SCTGrammarAccess) getGrammarAccess();
