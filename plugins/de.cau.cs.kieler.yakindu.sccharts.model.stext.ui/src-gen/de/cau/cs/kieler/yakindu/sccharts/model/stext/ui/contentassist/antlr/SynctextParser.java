...
public class SynctextParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.cau.cs.kieler.yakindu.sccharts.model.stext.ui.contentassist.antlr.internal.InternalSynctextParser createParser() {
		de.cau.cs.kieler.yakindu.sccharts.model.stext.ui.contentassist.antlr.internal.InternalSynctextParser result = new de.cau.cs.kieler.yakindu.sccharts.model.stext.ui.contentassist.antlr.internal.InternalSynctextParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getValReferenceExpressionAccess().getExpressionAlternatives_3_0(), "rule__ValReferenceExpression__ExpressionAlternatives_3_0");
					put(grammarAccess.getPreReferenceExpressionAccess().getExpressionAlternatives_3_0(), "rule__PreReferenceExpression__ExpressionAlternatives_3_0");
					...
					put(grammarAccess.getValReferenceExpressionAccess().getGroup(), "rule__ValReferenceExpression__Group__0");
					...
					put(grammarAccess.getValReferenceExpressionAccess().getExpressionAssignment_3(), "rule__ValReferenceExpression__ExpressionAssignment_3");
					put(grammarAccess.getPreReferenceExpressionAccess().getExpressionAssignment_3(), "rule__PreReferenceExpression__ExpressionAssignment_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.cau.cs.kieler.yakindu.sccharts.model.stext.ui.contentassist.antlr.internal.InternalSynctextParser typedParser = (de.cau.cs.kieler.yakindu.sccharts.model.stext.ui.contentassist.antlr.internal.InternalSynctextParser) parser;
