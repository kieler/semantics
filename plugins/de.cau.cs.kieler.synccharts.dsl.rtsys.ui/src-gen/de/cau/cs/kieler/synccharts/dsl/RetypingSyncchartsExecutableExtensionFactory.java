 ...
 * generated
 */
public class RetypingSyncchartsExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(RetypingSyncchartsExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		de.cau.cs.kieler.synccharts.dsl.internal.RetypingSyncchartsActivator instance = de.cau.cs.kieler.synccharts.dsl.internal.RetypingSyncchartsActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = de.cau.cs.kieler.synccharts.dsl.internal.RetypingSyncchartsActivator.getInstance().getInjector("de.cau.cs.kieler.synccharts.dsl.RetypingSynccharts");
