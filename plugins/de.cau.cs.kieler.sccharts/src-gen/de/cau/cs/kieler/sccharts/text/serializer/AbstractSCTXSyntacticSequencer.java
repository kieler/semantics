...
public abstract class AbstractSCTXSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_MethodDeclaration___LeftCurlyBracketKeyword_7_0_RightCurlyBracketKeyword_7_3__q;
	protected AbstractElementAlias match_MethodImplementation_LeftParenthesisRightParenthesisKeyword_6_1_q;
	...
	protected AbstractElementAlias match_State___LeftCurlyBracketKeyword_8_1_2_RightCurlyBracketKeyword_8_1_8__q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_MethodDeclaration___LeftCurlyBracketKeyword_7_0_RightCurlyBracketKeyword_7_3__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getMethodDeclarationAccess().getLeftCurlyBracketKeyword_7_0()), new TokenAlias(false, false, grammarAccess.getMethodDeclarationAccess().getRightCurlyBracketKeyword_7_3()));
		match_MethodImplementation_LeftParenthesisRightParenthesisKeyword_6_1_q = new TokenAlias(false, true, grammarAccess.getMethodImplementationAccess().getLeftParenthesisRightParenthesisKeyword_6_1());
		...
		match_State___LeftCurlyBracketKeyword_8_1_2_RightCurlyBracketKeyword_8_1_8__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getStateAccess().getLeftCurlyBracketKeyword_8_1_2()), new TokenAlias(false, false, grammarAccess.getStateAccess().getRightCurlyBracketKeyword_8_1_8()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_MethodDeclaration___LeftCurlyBracketKeyword_7_0_RightCurlyBracketKeyword_7_3__q.equals(syntax))
				emit_MethodDeclaration___LeftCurlyBracketKeyword_7_0_RightCurlyBracketKeyword_7_3__q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_MethodImplementation_LeftParenthesisRightParenthesisKeyword_6_1_q.equals(syntax))
				emit_MethodImplementation_LeftParenthesisRightParenthesisKeyword_6_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if (match_State___LeftCurlyBracketKeyword_8_1_2_RightCurlyBracketKeyword_8_1_8__q.equals(syntax))
				emit_State___LeftCurlyBracketKeyword_8_1_2_RightCurlyBracketKeyword_8_1_8__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     name=ExtendedID (ambiguity) 'schedule' schedule+=ScheduleObjectReference
	 *     name=ExtendedID (ambiguity) '{' declarations+=DeclarationWOSemicolon
	 *     name=ExtendedID (ambiguity) '{' statements+=Statement
	 *     name=ExtendedID (ambiguity) ('{' '}')? (rule end)
	 */
	 ...
	 *     schedule+=ScheduleObjectReference (ambiguity) (rule end)
	 */
	protected void emit_MethodDeclaration___LeftCurlyBracketKeyword_7_0_RightCurlyBracketKeyword_7_3__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     name=ExtendedID (ambiguity) '{' statements+=Statement
	 */
	protected void emit_MethodImplementation_LeftParenthesisRightParenthesisKeyword_6_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 */
	protected void emit_State___LeftCurlyBracketKeyword_8_1_2_RightCurlyBracketKeyword_8_1_8__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
