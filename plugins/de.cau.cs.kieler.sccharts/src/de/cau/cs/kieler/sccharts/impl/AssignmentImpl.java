 ...
 *   <li>{@link de.cau.cs.kieler.sccharts.impl.AssignmentImpl#getIndexExpressions <em>Index Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssignmentImpl extends EffectImpl implements Assignment {
    ...
    public EList<Expression> getIndexExpressions() {
        if (indexExpressions == null) {
            indexExpressions = new EObjectContainmentEList<Expression>(Expression.class, this, SCChartsPackage.ASSIGNMENT__INDEX_EXPRESSIONS);
        }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case SCChartsPackage.ASSIGNMENT__INDEX_EXPRESSIONS:
