 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.sccharts.impl.ExitActionImpl#getPreemption <em>Preemption</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExitActionImpl extends LocalActionImpl implements ExitAction {
    /**
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
    ...
    protected EClass eStaticClass() {
        return SCChartsPackage.Literals.EXIT_ACTION;
    }
    ...
    public void setPreemption(PreemptionType newPreemption) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SCChartsPackage.EXIT_ACTION__PREEMPTION, oldPreemption, preemption));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case SCChartsPackage.EXIT_ACTION__PREEMPTION:
