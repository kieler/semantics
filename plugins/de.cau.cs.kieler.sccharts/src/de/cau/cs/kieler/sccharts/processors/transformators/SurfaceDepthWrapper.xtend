...
import de.cau.cs.kieler.sccharts.transformations.SurfaceDepth
 ...
 */
class SurfaceDepthWrapper extends SCChartsProcessor {
    ...
    override process() {
        val wrappedTransformation = injector.getInstance(SurfaceDepth)
