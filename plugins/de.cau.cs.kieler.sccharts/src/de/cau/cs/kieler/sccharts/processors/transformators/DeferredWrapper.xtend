...
import de.cau.cs.kieler.sccharts.transformations.Deferred
 ...
 */
class DeferredWrapper extends SCChartsProcessor {
    ...
    override process() {
        val wrappedTransformation = injector.getInstance(Deferred)
