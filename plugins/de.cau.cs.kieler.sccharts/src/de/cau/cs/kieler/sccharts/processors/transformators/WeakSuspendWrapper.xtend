...
import de.cau.cs.kieler.sccharts.transformations.WeakSuspend
 ...
 */
class WeakSuspendWrapper extends SCChartsProcessor {
    ...
    override process() {
        val wrappedTransformation = injector.getInstance(WeakSuspend)
