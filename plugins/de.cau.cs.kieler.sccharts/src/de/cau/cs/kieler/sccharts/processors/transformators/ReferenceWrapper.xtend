...
import de.cau.cs.kieler.sccharts.transformations.Reference
 ...
 */
class ReferenceWrapper extends SCChartsProcessor {
    ...
    override process() {
        val wrappedTransformation = injector.getInstance(Reference)
