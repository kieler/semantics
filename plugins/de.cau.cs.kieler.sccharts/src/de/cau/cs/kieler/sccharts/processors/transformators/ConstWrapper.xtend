...
import de.cau.cs.kieler.sccharts.transformations.Const
 ...
 */
class ConstWrapper extends SCChartsProcessor {
    ...
    override process() {
        val wrappedTransformation = injector.getInstance(Const)
