...
import de.cau.cs.kieler.sccharts.transformations.During
 ...
 */
class DuringActionWrapper extends SCChartsProcessor {
    ...
    override process() {
        val wrappedTransformation = injector.getInstance(During)
