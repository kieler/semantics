...
class ScenarioGeneration extends SCChartsProcessor {
    ...
    def SCCharts transform(SCCharts sccharts) {
        val b = sccharts.pragmas.filter[pragma | pragma.name.equals("scenarios")]
    ...
    def State transform(State rootState) {
        ...
        val numberStates = allStates.length
        // determine random start and end state
        val start = random.nextInt(numberStates)
        val end = random.nextInt(numberStates)
