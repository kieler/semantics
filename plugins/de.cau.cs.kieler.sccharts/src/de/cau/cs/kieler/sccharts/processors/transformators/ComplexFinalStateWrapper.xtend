...
import de.cau.cs.kieler.sccharts.transformations.ComplexFinalState
 ...
 */
class ComplexFinalStateWrapper extends SCChartsProcessor {
    ...
    override process() {
        val wrappedTransformation = injector.getInstance(ComplexFinalState)
