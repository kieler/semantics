...
class StatebasedLeanCCodeGenerator extends ExogenousProcessor<SCCharts, CodeContainer> {
    ...
    override process() {
        val template = injector.getInstance(StatebasedLeanTemplate) as StatebasedLeanTemplate
    ...
    protected def void writeToCodeContainer(CodeContainer codeContainer, StatebasedLeanTemplate template, String codeFilename, SCCharts scc) {
