...
class SCChartsSystemProvider implements ISystemProvider {
    ...
    override getSystems() {
        #[
            ...
            "system/de.cau.cs.kieler.sccharts.SCTXToJSON.kico",
            "system/de.cau.cs.kieler.sccharts.extended.toJSON.kico",
            "system/de.cau.cs.kieler.sccharts.extended.toJSON.checked.kico"
        ]
    }
