...
class SCChartsSystemProvider implements ISystemProvider {
    ...
    override getSystems() {
        #[
            ...
            "system/de.cau.cs.kieler.sccharts.simulation.netlist.ref.c.kico",
            "system/de.cau.cs.kieler.sccharts.simulation.tts.netlist.c.kico",
            "system/de.cau.cs.kieler.sccharts.simulation.tts.netlist.ref.c.kico",
            "system/de.cau.cs.kieler.sccharts.simulation.netlist.java.kico",
            "system/de.cau.cs.kieler.sccharts.simulation.netlist.ref.java.kico",
            "system/de.cau.cs.kieler.sccharts.simulation.tts.netlist.java.kico",
            "system/de.cau.cs.kieler.sccharts.simulation.tts.netlist.ref.java.kico",
            ...
            "system/de.cau.cs.kieler.sccharts.netlist.simulink.kico",
            "system/de.cau.cs.kieler.sccharts.refcall.kico"
        ]
    }
