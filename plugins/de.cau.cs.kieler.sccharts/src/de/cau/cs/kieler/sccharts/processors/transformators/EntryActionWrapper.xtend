...
import de.cau.cs.kieler.sccharts.transformations.Entry
 ...
 */
class EntryActionWrapper extends SCChartsProcessor {
    ...
    override process() {
        val wrappedTransformation = injector.getInstance(Entry)
