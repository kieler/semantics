 ...
 */
class EnforcerFeature extends Feature {
    
    public static val ENFORCER_FEATURE_ID = "sccharts.enforcer"
    public static val ENFORCER_FEATURE_NAME = "Enforcer"

    //-------------------------------------------------------------------------
    //--                 K I C O      C O N F I G U R A T I O N              --
    //-------------------------------------------------------------------------
    override getId() {
        return ENFORCER_FEATURE_ID
    }

    override getName() {
        return ENFORCER_FEATURE_NAME
    }
