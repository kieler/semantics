...
import de.cau.cs.kieler.krep.editors.rif.RifRuntimeModule;

/**
 * Manual modifications go to {de.cau.cs.kieler.krep.editors.rif.RifUiModule}
 */
public abstract class AbstractRifUiModule extends RifRuntimeModule {
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.HIGHLIGHTING)).to(de.cau.cs.kieler.krep.editors.rif.parser.antlr.internal.InternalRifLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.outline.transformer.ISemanticModelTransformer> bindISemanticModelTransformer() {
		return de.cau.cs.kieler.krep.editors.rif.outline.RifTransformer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.outline.actions.IContentOutlineNodeAdapterFactory> bindIContentOutlineNodeAdapterFactory() {
		return de.cau.cs.kieler.krep.editors.rif.outline.RifOutlineNodeAdapterFactory.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.core.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return de.cau.cs.kieler.krep.editors.rif.contentassist.RifProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return de.cau.cs.kieler.krep.editors.rif.contentassist.antlr.RifParser.class;
	}

	// contributed by de.itemis.xtext.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(de.cau.cs.kieler.krep.editors.rif.contentassist.antlr.internal.InternalRifLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(de.cau.cs.kieler.krep.editors.rif.contentassist.antlr.internal.InternalRifLexer.class));
	}

	// contributed by de.itemis.xtext.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.common.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.CONTENT_ASSIST)).to(de.cau.cs.kieler.krep.editors.rif.contentassist.antlr.internal.InternalRifLexer.class);
	}
