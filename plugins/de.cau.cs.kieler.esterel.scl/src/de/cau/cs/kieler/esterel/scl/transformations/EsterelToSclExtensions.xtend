...
class EsterelToSclExtensions {
    ...
    /**
     * Returns a unused label by appending the labelCount to "l" and incrementing label count. As all labels
    ...
    def createNewUniqueLabel() {
        de.cau.cs.kieler.esterel.scl.transformations.EsterelToSclExtensions.labelSuffix = de.cau.cs.kieler.esterel.scl.transformations.EsterelToSclExtensions.labelSuffix + 1

        "l" + de.cau.cs.kieler.esterel.scl.transformations.EsterelToSclExtensions.labelSuffix
    }
     ...
     */
    def resetLabelCount() {
        de.cau.cs.kieler.esterel.scl.transformations.EsterelToSclExtensions.labelSuffix = 0;
    }
     ...
     */
    def createNewUniqueVariable(String designatedName, ValueType valueType) {
    ...
    */
    ...
    def StatementSequence createStatementSequence() {
        SclFactory::eINSTANCE.createStatementSequence
    }

    def StatementScope createStatementScope() {
