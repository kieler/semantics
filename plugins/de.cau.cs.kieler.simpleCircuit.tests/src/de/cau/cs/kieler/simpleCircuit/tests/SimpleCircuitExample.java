...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>simpleCircuit</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SimpleCircuitExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(SimpleCircuitPackage.eNS_URI, 
			 SimpleCircuitPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.simplecircuit"));
				Circuit root = SimpleCircuitFactory.eINSTANCE.createCircuit();
