...
import de.cau.cs.kieler.sccharts.sim.sclp.SCChartsSimSCLPPlugin
...
class SimulationVisualization {
    ...
    var AUXILIARY_VARIABLE_TAG_STATE = SCChartsSimSCLPPlugin::AUXILIARY_VARIABLE_TAG_STATE
    var AUXILIARY_VARIABLE_TAG_TRANSITION = SCChartsSimSCLPPlugin::AUXILIARY_VARIABLE_TAG_TRANSITION
