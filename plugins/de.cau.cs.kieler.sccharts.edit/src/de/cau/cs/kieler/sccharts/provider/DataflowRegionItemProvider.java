...
public class DataflowRegionItemProvider extends RegionItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addOncePropertyDescriptor(object);
        }
        return itemPropertyDescriptors;
    }

    /**
     * This adds a property descriptor for the Once feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addOncePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_DataflowRegion_once_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_DataflowRegion_once_feature", "_UI_DataflowRegion_type"),
                 SCChartsPackage.Literals.DATAFLOW_REGION__ONCE,
                 true,
                 false,
                 false,
    ...
    public String getText(Object object) {
        String label = ((DataflowRegion)object).getName();
