 ...
 */
package de.cau.cs.kieler.sccharts.sim.s.xtend
...
import de.cau.cs.kieler.sccharts.sim.s.SCChartsSimSPlugin
...
class SCCharts2Simulation {
    ...
    def Region transform2Simulation (Region rootRegion) {
          ...
          var AUXILIARY_VARIABLE_TAG_STATE =  SCChartsSimSPlugin::AUXILIARY_VARIABLE_TAG_STATE
          var AUXILIARY_VARIABLE_TAG_TRANSITION = SCChartsSimSPlugin::AUXILIARY_VARIABLE_TAG_TRANSITION
