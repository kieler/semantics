 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.prom.kibuild.impl.SignedFloatImpl#getSign <em>Sign</em>}</li>
 *   <li>{@link de.cau.cs.kieler.prom.kibuild.impl.SignedFloatImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SignedFloatImpl extends MinimalEObjectImpl.Container implements SignedFloat
{
  ...
  {
    return KibuildPackage.Literals.SIGNED_FLOAT;
  }
  ...
  public void setSign(Sign newSign)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KibuildPackage.SIGNED_FLOAT__SIGN, oldSign, sign));
  }
