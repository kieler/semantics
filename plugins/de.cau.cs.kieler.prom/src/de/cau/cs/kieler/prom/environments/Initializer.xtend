...
class Initializer extends AbstractPreferenceInitializer {
    ...
    public static def getDefaultEnvironments(){
        ...
        env.wrapperCodeSnippetsOrigin = "platform:/plugin/de.cau.cs.kieler.prom/environments/mindstorms_nxj/snippets"
        ...
        env.mainFileOrigin = "platform:/plugin/de.cau.cs.kieler.prom/environments/mindstorms_nxj/Main.ftl"
