 ...
 *   <li>{@link de.cau.cs.kieler.synccharts.dsl.retypingSynccharts.impl.SignalImpl#getHostCombineOperator <em>Host Combine Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SignalImpl extends ValuedObjectImpl implements Signal
{
  ...
  {
    return RetypingSyncchartsPackage.Literals.SIGNAL;
  }
  ...
  public void setIsInput(boolean newIsInput)
  {
    ...
    isInput = newIsInput;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RetypingSyncchartsPackage.SIGNAL__IS_INPUT, oldIsInput, isInput));
  }
  ...
  public void setIsOutput(boolean newIsOutput)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RetypingSyncchartsPackage.SIGNAL__IS_OUTPUT, oldIsOutput, isOutput));
  }
  ...
  public void setCombineOperator(CombineOperator newCombineOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RetypingSyncchartsPackage.SIGNAL__COMBINE_OPERATOR, oldCombineOperator, combineOperator));
  }
  ...
  public void setHostCombineOperator(String newHostCombineOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RetypingSyncchartsPackage.SIGNAL__HOST_COMBINE_OPERATOR, oldHostCombineOperator, hostCombineOperator));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case RetypingSyncchartsPackage.SIGNAL__IS_OUTPUT:
        return isIsOutput();
      case RetypingSyncchartsPackage.SIGNAL__COMBINE_OPERATOR:
        return getCombineOperator();
      case RetypingSyncchartsPackage.SIGNAL__HOST_COMBINE_OPERATOR:
