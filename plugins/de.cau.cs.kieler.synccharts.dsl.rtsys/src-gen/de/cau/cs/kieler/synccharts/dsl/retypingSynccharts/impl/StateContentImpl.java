 ...
 *   <li>{@link de.cau.cs.kieler.synccharts.dsl.retypingSynccharts.impl.StateContentImpl#getSignalsAndVariables <em>Signals And Variables</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts.dsl.retypingSynccharts.impl.StateContentImpl#getInnerStates <em>Inner States</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts.dsl.retypingSynccharts.impl.StateContentImpl#getParallelStates <em>Parallel States</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateContentImpl extends MinimalEObjectImpl.Container implements StateContent
{
  ...
  /**
   * The cached value of the '{@link #getSignalsAndVariables() <em>Signals And Variables</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getSignalsAndVariables()
   * @generated
   * @ordered
   */
  protected EList<ValuedObject> signalsAndVariables;
  ...
  /**
   * The cached value of the '{@link #getParallelStates() <em>Parallel States</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getParallelStates()
   * @generated
   * @ordered
   */
  protected EList<State> parallelStates;
   ...
   * @generated
   */
  public EList<ValuedObject> getSignalsAndVariables()
  {
    if (signalsAndVariables == null)
    {
      signalsAndVariables = new EObjectContainmentEList<ValuedObject>(ValuedObject.class, this, RetypingSyncchartsPackage.STATE_CONTENT__SIGNALS_AND_VARIABLES);
    }
    return signalsAndVariables;
  }
  ...
  public EList<State> getInnerStates()
  {
    if (innerStates == null)
    {
      innerStates = new EObjectContainmentEList<State>(State.class, this, RetypingSyncchartsPackage.STATE_CONTENT__INNER_STATES);
    }
    return innerStates;
  }
   ...
   * @generated
   */
  public EList<State> getParallelStates()
  {
    if (parallelStates == null)
    {
      parallelStates = new EObjectContainmentEList<State>(State.class, this, RetypingSyncchartsPackage.STATE_CONTENT__PARALLEL_STATES);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case RetypingSyncchartsPackage.STATE_CONTENT__SIGNALS_AND_VARIABLES:
        return ((InternalEList<?>)getSignalsAndVariables()).basicRemove(otherEnd, msgs);
      case RetypingSyncchartsPackage.STATE_CONTENT__INNER_STATES:
        return ((InternalEList<?>)getInnerStates()).basicRemove(otherEnd, msgs);
      case RetypingSyncchartsPackage.STATE_CONTENT__PARALLEL_STATES:
        return ((InternalEList<?>)getParallelStates()).basicRemove(otherEnd, msgs);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case RetypingSyncchartsPackage.STATE_CONTENT__SIGNALS_AND_VARIABLES:
        return getSignalsAndVariables();
      case RetypingSyncchartsPackage.STATE_CONTENT__INNER_STATES:
        return getInnerStates();
      case RetypingSyncchartsPackage.STATE_CONTENT__PARALLEL_STATES:
        return getParallelStates();
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case RetypingSyncchartsPackage.STATE_CONTENT__INNER_ACTION:
        ...
        return;
      case RetypingSyncchartsPackage.STATE_CONTENT__SIGNALS_AND_VARIABLES:
        getSignalsAndVariables().clear();
        getSignalsAndVariables().addAll((Collection<? extends ValuedObject>)newValue);
        return;
      case RetypingSyncchartsPackage.STATE_CONTENT__INNER_STATES:
        ...
        return;
      case RetypingSyncchartsPackage.STATE_CONTENT__PARALLEL_STATES:
        getParallelStates().clear();
        getParallelStates().addAll((Collection<? extends State>)newValue);
        return;
    }
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case RetypingSyncchartsPackage.STATE_CONTENT__SIGNALS_AND_VARIABLES:
        return signalsAndVariables != null && !signalsAndVariables.isEmpty();
      case RetypingSyncchartsPackage.STATE_CONTENT__INNER_STATES:
        return innerStates != null && !innerStates.isEmpty();
      case RetypingSyncchartsPackage.STATE_CONTENT__PARALLEL_STATES:
        return parallelStates != null && !parallelStates.isEmpty();
    }
