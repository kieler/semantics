 ...
 *   <li>{@link de.cau.cs.kieler.synccharts.dsl.retypingSynccharts.StateContent#getSignalsAndVariables <em>Signals And Variables</em>}</li>
...
public interface StateContent extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Signals And Variables</b></em>' containment reference list.
   * The list contents are of type {@link de.cau.cs.kieler.synccharts.dsl.retypingSynccharts.ValuedObject}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Signals And Variables</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Signals And Variables</em>' containment reference list.
   * @see de.cau.cs.kieler.synccharts.dsl.retypingSynccharts.RetypingSyncchartsPackage#getStateContent_SignalsAndVariables()
   * @model containment="true"
   * @generated
   */
  EList<ValuedObject> getSignalsAndVariables();
