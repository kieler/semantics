 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.synccharts.dsl.retypingSynccharts.impl.SignalReferenceImpl#getReference <em>Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SignalReferenceImpl extends ExpressionImpl implements SignalReference
{
  ...
  {
    return RetypingSyncchartsPackage.Literals.SIGNAL_REFERENCE;
  }
    ...
    if (reference != null && reference.eIsProxy())
    {
      ...
      if (reference != oldReference)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RetypingSyncchartsPackage.SIGNAL_REFERENCE__REFERENCE, oldReference, reference));
      }
    }
    return reference;
  }
  ...
  public void setReference(Signal newReference)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RetypingSyncchartsPackage.SIGNAL_REFERENCE__REFERENCE, oldReference, reference));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RetypingSyncchartsPackage.SIGNAL_REFERENCE__REFERENCE:
