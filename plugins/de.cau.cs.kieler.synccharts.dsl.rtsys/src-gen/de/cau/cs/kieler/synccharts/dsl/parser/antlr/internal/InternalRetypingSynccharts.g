...
((	
	    ...
	    { 
	        currentNode=createCompositeNode(grammarAccess.getTransitionAccess().getNewSourceStateTransitionStateParserRuleCall_0_0(), currentNode); 
	    }
	    lv_newSourceState_0=ruleTransitionState 
	    {
	        if ($current==null) {
	        ...
	        try {
	       		set($current, "newSourceState", lv_newSourceState_0, "TransitionState", currentNode);
	        } catch (ValueConverterException vce) {
				handleValueConverterException(vce);
	        }
	        currentNode = currentNode.getParent();
...
(((	
	    ...
	    lv_isInputOutput_0='inputoutput' 
    {
...
((	
    ...
    |(	
	    ...
	    lv_hostCombineOperator_10=	RULE_STRING
	{
...
((	
    ...
    |(	
	    ...
	    lv_hostCombineOperator_21=	RULE_STRING
	{
