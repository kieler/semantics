 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.synccharts.impl.FloatValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FloatValueImpl extends ValueImpl implements FloatValue {
    ...
    protected EClass eStaticClass() {
        return SyncchartsPackage.Literals.FLOAT_VALUE;
    }
    ...
    public void setValue(Float newValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SyncchartsPackage.FLOAT_VALUE__VALUE, oldValue, value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case SyncchartsPackage.FLOAT_VALUE__VALUE:
                return getValue();
        }
