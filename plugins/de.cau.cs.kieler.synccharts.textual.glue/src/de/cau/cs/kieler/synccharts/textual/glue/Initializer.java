 ...
 */
package de.cau.cs.kieler.synccharts.textual.glue;
...
import de.cau.cs.kieler.synccharts.textual.glue.listener.KitsSynchronizationListener;
    ...
    public void earlyStartup() {
        Display.getDefault().asyncExec(new Runnable() {
            public void run() {
                ...
                activePage.addPartListener(new KitsSynchronizationListener(
                        activePage));
            }
        });
    }
