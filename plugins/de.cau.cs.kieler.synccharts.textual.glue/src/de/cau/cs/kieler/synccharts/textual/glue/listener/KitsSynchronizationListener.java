...
package de.cau.cs.kieler.synccharts.textual.glue.listener;
 ...
 * @author oba
 */
public class KitsSynchronizationListener implements IPartListener,
     ...
     */
    public KitsSynchronizationListener(final IWorkbenchPage activePage) {
        ...
        if (part instanceof IEditorPart) {
            ...
            try {// second arg is null as we want to layout the complete diagram
                ...
                Status myStatus = new Status(
                        IStatus.WARNING,
                        Activator.PLUGIN_ID,
                        "Auto-layout failed. Please file a bug with the subject \"Auto Layout failed in KitsSynchronizationListener\" ",
                        layoutFailed);
