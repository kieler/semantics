...
public interface KextPackage extends EPackage
{
  ...
  /**
     * Returns the meta object for the containment reference list '{@link de.cau.cs.kieler.core.kexpressions.text.kext.Kext#getEntities <em>Entities</em>}'.
     * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
     * @return the meta object for the containment reference list '<em>Entities</em>'.
     * @see de.cau.cs.kieler.core.kexpressions.text.kext.Kext#getEntities()
     * @see #getKext()
     * @generated
     */
