 ...
 */
class KiVisProposalProvider extends AbstractKiVisProposalProvider {
    @Inject
    ...
    override completeAttributeMapping_Attribute(EObject model, Assignment assignment, ContentAssistContext context, ICompletionProposalAcceptor acceptor) {
        ...
        switch(model) {
            Animation : {
                ...
                val configurationElements = ExtensionLookupUtil.getConfigurationElements("de.cau.cs.kieler.kivis.animationHandler",
                                                                                          requiredConfig)
