 ...
 */
@ViewSynthesisShared
class ExpandGuardRegionsAction extends SynthesisActionHook implements IAction {
    @Inject extension KRenderingExtensions

    public static final String ID = "de.cau.cs.kieler.circuit.klighd.synthesis.hooks.ExpandGuardRegionsAction"
