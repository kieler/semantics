 ...
 * @generated
 */
public class StateExitActionCreateCommand extends EditElementCommand {

    /**
     * @generated
     */
    public StateExitActionCreateCommand(CreateElementRequest req) {
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
        ...
        owner.getExitActions().add(newElement);
