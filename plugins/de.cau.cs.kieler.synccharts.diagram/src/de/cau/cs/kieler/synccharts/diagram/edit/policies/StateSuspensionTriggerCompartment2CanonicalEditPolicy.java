 ...
 * @generated
 */
public class StateSuspensionTriggerCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {

    /**
     * @generated
     */
    protected EStructuralFeature getFeatureToSynchronize() {
        return SyncchartsPackage.eINSTANCE.getScope_SuspensionTrigger();
    }
    ...
    protected List getSemanticChildrenList() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
                .getStateSuspend_7045SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return StateSuspensionTriggerEditPart.VISUAL_ID == SyncchartsVisualIDRegistry.getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
                .getStateSuspend_7045SemanticChildren((View) getHost().getModel());
