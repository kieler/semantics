 ...
 * @generated
 */
public class StateInnerActionLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = SyncchartsParserProvider
                    .getParser(
                            SyncchartsElementTypes.Action_3035,
                            getParserElement(),
                            SyncchartsVisualIDRegistry
                                    .getType(de.cau.cs.kieler.synccharts.diagram.edit.parts.StateInnerActionLabelEditPart.VISUAL_ID));
        }
        return parser;
    }
