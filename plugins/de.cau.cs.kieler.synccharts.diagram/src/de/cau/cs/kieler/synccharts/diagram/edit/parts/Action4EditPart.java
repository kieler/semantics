...
import de.cau.cs.kieler.synccharts.diagram.edit.policies.Action4ItemSemanticEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.part.SyncchartsVisualIDRegistry;

/**
 * @generated
 */
public class Action4EditPart extends ShapeNodeEditPart {
     ...
     * @generated
     */
    public Action4EditPart(View view) {
        super(view);
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Action4ItemSemanticEditPolicy());
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof ActionTriggersAndEffects4EditPart) {
            ((ActionTriggersAndEffects4EditPart) childEditPart).setLabel(getPrimaryShape()
