...
public class TransitionCreateCommand extends EditElementCommand {
    ...
    public boolean canExecute() {
        ...
        return SyncchartsBaseItemSemanticEditPolicy.LinkConstraints.canCreateTransition_4001(
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
        ...
        Transition newElement = SyncchartsFactory.eINSTANCE.createTransition();
        getContainer().getOutgoingTransitions().add(newElement);
        newElement.setSourceState(getSource());
        newElement.setTargetState(getTarget());
        SyncchartsElementTypes.init_Transition_4001(newElement);
