 ...
 * @generated
 */
public class ActionTriggersAndEffects3EditPart extends CompartmentEditPart
     ...
     * @generated
     */
    public ActionTriggersAndEffects3EditPart(View view) {
        super(view);
    }
            ...
            parser = SyncchartsParserProvider
                    .getParser(
                            ...
                            SyncchartsVisualIDRegistry
                                    .getType(de.cau.cs.kieler.synccharts.diagram.edit.parts.ActionTriggersAndEffects3EditPart.VISUAL_ID));
        }
        return parser;
    }
    ...
    protected DirectEditManager getManager() {
        if (manager == null) {
            setManager(new TextDirectEditManager(this, TextDirectEditManager
                    .getTextCellEditorClass(this), SyncchartsEditPartFactory
