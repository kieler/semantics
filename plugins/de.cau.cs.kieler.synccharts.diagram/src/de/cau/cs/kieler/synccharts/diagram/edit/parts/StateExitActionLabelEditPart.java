 ...
 * @generated
 */
public class StateExitActionLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
     ...
     * @generated
     */
    public StateExitActionLabelEditPart(View view) {
        super(view);
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new RegionEditPart.NodeLabelDragPolicy());
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = SyncchartsParserProvider
                    .getParser(
                            SyncchartsElementTypes.Action_3036,
                            getParserElement(),
                            SyncchartsVisualIDRegistry
                                    .getType(de.cau.cs.kieler.synccharts.diagram.edit.parts.StateExitActionLabelEditPart.VISUAL_ID));
        }
        return parser;
    }
