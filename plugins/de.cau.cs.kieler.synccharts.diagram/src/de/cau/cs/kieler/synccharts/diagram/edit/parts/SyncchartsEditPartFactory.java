    ...
    public EditPart createEditPart(EditPart context, Object model) {
        if (model instanceof View) {
            ...
            case StateEntryActionsCompartmentEditPart.VISUAL_ID:
                return new StateEntryActionsCompartmentEditPart(view);

            case StateInnerActionsCompartmentEditPart.VISUAL_ID:
                return new StateInnerActionsCompartmentEditPart(view);

            case StateExitActionsCompartmentEditPart.VISUAL_ID:
                return new StateExitActionsCompartmentEditPart(view);
            ...
            case StateEntryActionsCompartment2EditPart.VISUAL_ID:
                return new StateEntryActionsCompartment2EditPart(view);

            case StateInnerActionsCompartment2EditPart.VISUAL_ID:
                return new StateInnerActionsCompartment2EditPart(view);

            case StateExitActionsCompartment2EditPart.VISUAL_ID:
                return new StateExitActionsCompartment2EditPart(view);
