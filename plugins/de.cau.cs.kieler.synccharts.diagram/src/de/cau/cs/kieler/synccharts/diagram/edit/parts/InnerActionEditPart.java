...
import de.cau.cs.kieler.synccharts.diagram.edit.policies.InnerActionItemSemanticEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.part.SyncchartsVisualIDRegistry;

/**
 * @generated
 */
public class InnerActionEditPart extends ShapeNodeEditPart {
     ...
     * @generated
     */
    public InnerActionEditPart(View view) {
        super(view);
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InnerActionItemSemanticEditPolicy());
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof InnerActionLabelEditPart) {
            ((InnerActionLabelEditPart) childEditPart).setLabel(getPrimaryShape()
