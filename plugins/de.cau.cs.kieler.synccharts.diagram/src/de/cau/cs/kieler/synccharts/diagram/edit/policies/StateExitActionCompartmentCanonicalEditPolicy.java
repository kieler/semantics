 ...
 * @generated
 */
public class StateExitActionCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
                .getStateOnExitAction_7051SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
                .getStateOnExitAction_7051SemanticChildren((View) getHost().getModel());
