...
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateInnerActionsCompartment2CanonicalEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateInnerActionsCompartment2ItemSemanticEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.part.Messages;

/**
 * @generated
 */
public class StateInnerActionsCompartment2EditPart extends
     ...
     * @generated
     */
    public StateInnerActionsCompartment2EditPart(View view) {
        super(view);
    }
    ...
    public String getCompartmentName() {
        return Messages.StateInnerActionsCompartment2EditPart_title;
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
                new StateInnerActionsCompartment2ItemSemanticEditPolicy());
        installEditPolicy(EditPolicyRoles.CREATION_ROLE,
                new CreationEditPolicy());
        installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
                new DragDropEditPolicy());
        installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
                new StateInnerActionsCompartment2CanonicalEditPolicy());
    }
