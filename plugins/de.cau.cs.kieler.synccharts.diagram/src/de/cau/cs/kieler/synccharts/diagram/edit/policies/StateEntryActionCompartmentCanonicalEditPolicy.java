 ...
 * @generated
 */
public class StateEntryActionCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
            .getStateOnEntryAction_7036SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
            .getStateOnEntryAction_7036SemanticChildren((View) getHost().getModel());
