 ...
 * @generated
 */
public class ActionTriggersAndEffectsEditPart extends CompartmentEditPart implements ITextAwareEditPart {
     ...
     * @generated
     */
    public ActionTriggersAndEffectsEditPart(View view) {
        super(view);
    }
            ...
            parser = SyncchartsParserProvider
                    .getParser(
                            ...
                            SyncchartsVisualIDRegistry
                                    .getType(de.cau.cs.kieler.synccharts.diagram.edit.parts.ActionTriggersAndEffectsEditPart.VISUAL_ID));
        }
        return parser;
    }
