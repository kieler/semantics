...
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateEntryActionCompartmentCanonicalEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateEntryActionCompartmentItemSemanticEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.part.Messages;

/**
 * @generated
 */
public class StateEntryActionCompartmentEditPart extends ShapeCompartmentEditPart {
     ...
     * @generated
     */
    public StateEntryActionCompartmentEditPart(View view) {
        super(view);
    }
    ...
    public String getCompartmentName() {
        return Messages.StateEntryActionCompartmentEditPart_title;
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
                new StateEntryActionCompartmentItemSemanticEditPolicy());
        installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());
        installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
        installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
                new StateEntryActionCompartmentCanonicalEditPolicy());
    }
