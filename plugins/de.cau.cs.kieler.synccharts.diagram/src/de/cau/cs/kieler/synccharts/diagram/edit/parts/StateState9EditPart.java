...
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateState9CanonicalEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateState9ItemSemanticEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.part.Messages;

/**
 * @generated
 */
public class StateState9EditPart extends ShapeCompartmentEditPart {
     ...
     * @generated
     */
    public StateState9EditPart(View view) {
        super(view);
    }
    ...
    public String getCompartmentName() {
        return Messages.StateState9EditPart_title;
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StateState9ItemSemanticEditPolicy());
        installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());
        installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
        installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StateState9CanonicalEditPolicy());
    }
