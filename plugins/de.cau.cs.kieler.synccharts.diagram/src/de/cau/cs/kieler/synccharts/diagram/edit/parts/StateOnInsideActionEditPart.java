 ...
 * @generated
 */
public class StateOnInsideActionEditPart extends ShapeCompartmentEditPart {
     ...
     * @generated
     */
    public StateOnInsideActionEditPart(View view) {
        super(view);
    }
    ...
    public String getCompartmentName() {
        return Messages.StateOnInsideActionEditPart_title;
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StateOnInsideActionItemSemanticEditPolicy());
        installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());
        installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
        installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StateOnInsideActionCanonicalEditPolicy());
    }
