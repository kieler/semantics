...
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateState7CanonicalEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateState7ItemSemanticEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.part.Messages;

/**
 * @generated
 */
public class StateState7EditPart extends ShapeCompartmentEditPart {
     ...
     * @generated
     */
    public StateState7EditPart(View view) {
        super(view);
    }
    ...
    public String getCompartmentName() {
        return Messages.StateState7EditPart_title;
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StateState7ItemSemanticEditPolicy());
        installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());
        installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
        installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StateState7CanonicalEditPolicy());
    }
