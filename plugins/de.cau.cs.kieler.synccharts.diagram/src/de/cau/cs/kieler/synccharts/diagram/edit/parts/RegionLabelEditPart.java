 ...
 * @generated
 */
public class RegionLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
     ...
     * @generated
     */
    public RegionLabelEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = SyncchartsParserProvider
                    .getParser(
                            SyncchartsElementTypes.Region_3031,
                            getParserElement(),
                            SyncchartsVisualIDRegistry
                                    .getType(de.cau.cs.kieler.synccharts.diagram.edit.parts.RegionLabelEditPart.VISUAL_ID));
        }
        return parser;
    }
