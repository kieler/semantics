 ...
 * @generated
 */
public class StateInnerActionCreateCommand extends EditElementCommand {

    /**
     * @generated
     */
    public StateInnerActionCreateCommand(CreateElementRequest req) {
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
        ...
        owner.getInnerActions().add(newElement);
