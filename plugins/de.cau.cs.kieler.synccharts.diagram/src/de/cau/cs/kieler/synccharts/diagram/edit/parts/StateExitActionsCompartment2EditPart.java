...
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateExitActionsCompartment2CanonicalEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateExitActionsCompartment2ItemSemanticEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.part.Messages;

/**
 * @generated
 */
public class StateExitActionsCompartment2EditPart extends
     ...
     * @generated
     */
    public StateExitActionsCompartment2EditPart(View view) {
        super(view);
    }
    ...
    public String getCompartmentName() {
        return Messages.StateExitActionsCompartment2EditPart_title;
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
                new StateExitActionsCompartment2ItemSemanticEditPolicy());
        installEditPolicy(EditPolicyRoles.CREATION_ROLE,
                new CreationEditPolicy());
        installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
                new DragDropEditPolicy());
        installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
                new StateExitActionsCompartment2CanonicalEditPolicy());
    }
