...
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateExitActionCompartment2CanonicalEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateExitActionCompartment2ItemSemanticEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.part.Messages;

/**
 * @generated
 */
public class StateExitActionCompartment2EditPart extends ShapeCompartmentEditPart {
     ...
     * @generated
     */
    public StateExitActionCompartment2EditPart(View view) {
        super(view);
    }
    ...
    public String getCompartmentName() {
        return Messages.StateExitActionCompartment2EditPart_title;
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
                new StateExitActionCompartment2ItemSemanticEditPolicy());
        installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());
        installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
        installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
                new StateExitActionCompartment2CanonicalEditPolicy());
    }
