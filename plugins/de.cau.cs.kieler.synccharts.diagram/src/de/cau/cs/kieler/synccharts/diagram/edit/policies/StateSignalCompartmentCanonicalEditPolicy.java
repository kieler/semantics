 ...
 * @generated
 */
public class StateSignalCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
            .getStateCompartment_7035SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
            .getStateCompartment_7035SemanticChildren((View) getHost().getModel());
