 ...
 * @generated
 */
public class StateSignalCompartmentCanonicalEditPolicy extends
        CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors =
                SyncchartsDiagramUpdater
                        .getStateSignal_7035SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return SignalEditPart.VISUAL_ID == SyncchartsVisualIDRegistry
                .getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors =
                SyncchartsDiagramUpdater
                        .getStateSignal_7035SemanticChildren((View) getHost()
                                .getModel());
