 ...
 * @generated
 */
public class SuspensionTriggerLabelEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public SuspensionTriggerLabelEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = SyncchartsParserProvider
                    .getParser(
                            SyncchartsElementTypes.Action_3018,
                            getParserElement(),
                            SyncchartsVisualIDRegistry
                                    .getType(de.cau.cs.kieler.synccharts.diagram.edit.parts.SuspensionTriggerLabelEditPart.VISUAL_ID));
        }
        return parser;
    }
