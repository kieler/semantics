 ...
 * @generated
 */
public class StateSignalCompartment2CanonicalEditPolicy extends
        CanonicalEditPolicy {
    ...
    protected List getSemanticChildrenList() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
                .getStateSignal_7041SemanticChildren(viewObject);
    ...
    protected void refreshSemantic() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
                .getStateSignal_7041SemanticChildren((View) getHost()
                        .getModel());
