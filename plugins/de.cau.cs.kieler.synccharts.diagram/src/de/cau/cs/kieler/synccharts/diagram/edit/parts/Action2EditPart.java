...
import de.cau.cs.kieler.synccharts.diagram.edit.policies.Action2ItemSemanticEditPolicy;
...
public class Action2EditPart extends ShapeNodeEditPart {
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Action2ItemSemanticEditPolicy());
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof ActionTriggersAndEffects2EditPart) {
            ((ActionTriggersAndEffects2EditPart) childEditPart).setLabel(getPrimaryShape()
