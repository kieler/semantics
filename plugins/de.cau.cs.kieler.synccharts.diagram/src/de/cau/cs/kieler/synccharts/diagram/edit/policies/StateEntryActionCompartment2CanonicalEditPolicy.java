 ...
 * @generated
 */
public class StateEntryActionCompartment2CanonicalEditPolicy extends
        CanonicalEditPolicy {
    ...
    private boolean isMyDiagramElement(View view) {
        return StateEntryActionEditPart.VISUAL_ID == SyncchartsVisualIDRegistry
                .getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
                .getStateOnEntryAction_7029SemanticChildren((View) getHost()
                        .getModel());
