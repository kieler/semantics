 ...
 * @generated
 */
public class StateExitActionCompartment2CanonicalEditPolicy extends
        CanonicalEditPolicy {
    ...
    private boolean isMyDiagramElement(View view) {
        return StateExitActionEditPart.VISUAL_ID == SyncchartsVisualIDRegistry
                .getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors =
                SyncchartsDiagramUpdater
                        .getStateOnExitAction_7031SemanticChildren((View) getHost()
                                .getModel());
