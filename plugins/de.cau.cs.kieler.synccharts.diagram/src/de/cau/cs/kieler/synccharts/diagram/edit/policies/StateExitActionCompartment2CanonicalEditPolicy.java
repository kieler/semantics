 ...
 * @generated
 */
public class StateExitActionCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {

    /**
     * @generated
     */
    protected EStructuralFeature getFeatureToSynchronize() {
        return SyncchartsPackage.eINSTANCE.getScope_ExitActions();
    }
    ...
    protected List getSemanticChildrenList() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
            .getStateOnExitAction_7064SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return StateExitActionEditPart.VISUAL_ID == SyncchartsVisualIDRegistry.getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
            .getStateOnExitAction_7064SemanticChildren((View) getHost().getModel());
