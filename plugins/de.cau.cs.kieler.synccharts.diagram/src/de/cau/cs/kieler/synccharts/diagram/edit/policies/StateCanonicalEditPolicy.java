...
public class StateCanonicalEditPolicy extends CanonicalEditPolicy {
    ...
    protected EStructuralFeature getFeatureToSynchronize() {
        return SyncchartsPackage.eINSTANCE.getScope_BodyText();
    }
    ...
    protected List getSemanticChildrenList() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
                .getState_2004SemanticChildren(viewObject);
    ...
    private boolean isMyDiagramElement(View view) {
        return TextualCodeEditPart.VISUAL_ID == SyncchartsVisualIDRegistry.getVisualID(view);
    }
    ...
    protected void refreshSemantic() {
        ...
        List<SyncchartsNodeDescriptor> childDescriptors = SyncchartsDiagramUpdater
                .getState_2004SemanticChildren((View) getHost().getModel());
