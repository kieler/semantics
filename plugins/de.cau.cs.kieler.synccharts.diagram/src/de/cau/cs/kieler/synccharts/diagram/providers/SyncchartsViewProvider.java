...
public class SyncchartsViewProvider extends AbstractProvider implements IViewProvider {
    ...
    protected boolean provides(CreateNodeViewOperation op) {
        ...
        if (op.getSemanticHint() == null) {
            ...
            visualID = SyncchartsVisualIDRegistry.getNodeVisualID(op.getContainerView(), domainElement);
        } else {
    ...
    public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint,
        ...
        switch (visualID) {
        case StateEditPart.VISUAL_ID:
            return createState_2004(domainElement, containerView, index, persisted, preferencesHint);
        case Region2EditPart.VISUAL_ID:
            return createRegion_3031(domainElement, containerView, index, persisted, preferencesHint);
        case State2EditPart.VISUAL_ID:
            return createState_3032(domainElement, containerView, index, persisted, preferencesHint);
        case SignalEditPart.VISUAL_ID:
            return createSignal_3033(domainElement, containerView, index, persisted, preferencesHint);
        case StateEntryActionEditPart.VISUAL_ID:
            return createAction_3034(domainElement, containerView, index, persisted, preferencesHint);
        case StateInnerActionEditPart.VISUAL_ID:
            return createAction_3035(domainElement, containerView, index, persisted, preferencesHint);
        case StateExitActionEditPart.VISUAL_ID:
            return createAction_3036(domainElement, containerView, index, persisted, preferencesHint);
        case StateSuspensionTriggerEditPart.VISUAL_ID:
            return createAction_3037(domainElement, containerView, index, persisted, preferencesHint);
        case TextualCodeEditPart.VISUAL_ID:
            return createTextualCode_3038(domainElement, containerView, index, persisted,
                    preferencesHint);
        }
    ...
    public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint,
        ...
        case TransitionEditPart.VISUAL_ID:
            return createTransition_4004(getSemanticElement(semanticAdapter), containerView, index,
     ...
     * @generated
     */
    public Node createState_2004(EObject domainElement, View containerView, int index,
        ...
        createCompartment(node,
                ...
                true, false, false, false);
        createCompartment(node,
                SyncchartsVisualIDRegistry.getType(StateExitActionCompartment2EditPart.VISUAL_ID), true,
                false, false, false);
        createCompartment(
                node,
                SyncchartsVisualIDRegistry.getType(StateSuspensionTriggerCompartment2EditPart.VISUAL_ID),
                true, false, false, false);
        createCompartment(node,
     ...
     * @generated
     */
    public Node createRegion_3031(EObject domainElement, View containerView, int index,
            boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
     ...
     * @generated
     */
    public Node createState_3032(EObject domainElement, View containerView, int index,
            boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
        ...
        Node label5047 = createLabel(node,
                SyncchartsVisualIDRegistry.getType(StateInterfaceDeclaration2EditPart.VISUAL_ID));
        createCompartment(node,
                SyncchartsVisualIDRegistry.getType(StateSignalCompartmentEditPart.VISUAL_ID), true,
                false, false, false);
        createCompartment(node,
                SyncchartsVisualIDRegistry.getType(StateEntryActionCompartmentEditPart.VISUAL_ID), true,
                false, false, false);
        createCompartment(node,
                SyncchartsVisualIDRegistry.getType(StateInnerActionCompartmentEditPart.VISUAL_ID), true,
                false, false, false);
        createCompartment(node,
     ...
     * @generated
     */
    public Node createSignal_3033(EObject domainElement, View containerView, int index,
            boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
     ...
     * @generated
     */
    public Node createAction_3034(EObject domainElement, View containerView, int index,
            boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
     ...
     * @generated
     */
    public Node createAction_3035(EObject domainElement, View containerView, int index,
            boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
     ...
     * @generated
     */
    public Node createAction_3036(EObject domainElement, View containerView, int index,
            boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
     ...
     * @generated
     */
    public Node createAction_3037(EObject domainElement, View containerView, int index,
            boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
     ...
     * @generated
     */
    public Node createTextualCode_3038(EObject domainElement, View containerView, int index,
            boolean persisted, PreferencesHint preferencesHint) {
     ...
     * @generated
     */
    public Edge createTransition_4004(EObject domainElement, View containerView, int index,
            boolean persisted, PreferencesHint preferencesHint) {
