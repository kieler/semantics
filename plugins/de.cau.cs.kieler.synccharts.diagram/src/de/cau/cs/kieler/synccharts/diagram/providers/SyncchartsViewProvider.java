...
public class SyncchartsViewProvider extends AbstractProvider implements
    ...
    public Node createState_2001(EObject domainElement, View containerView,
        ...
        createCompartment(node, SyncchartsVisualIDRegistry
                ...
                false, false, false);
        createCompartment(node, SyncchartsVisualIDRegistry
                .getType(StateEntryActionsCompartmentEditPart.VISUAL_ID), true,
                false, false, false);
        createCompartment(node, SyncchartsVisualIDRegistry
                .getType(StateInnerActionsCompartmentEditPart.VISUAL_ID), true,
                false, false, false);
        createCompartment(node, SyncchartsVisualIDRegistry
                .getType(StateExitActionsCompartmentEditPart.VISUAL_ID), true,
                false, false, false);
        createCompartment(node, SyncchartsVisualIDRegistry
    ...
    public Node createState_3002(EObject domainElement, View containerView,
        ...
        createCompartment(node, SyncchartsVisualIDRegistry
                ...
                true, false, false, false);
        createCompartment(node, SyncchartsVisualIDRegistry
                .getType(StateExitActionsCompartment2EditPart.VISUAL_ID), true,
                false, false, false);
        createCompartment(node, SyncchartsVisualIDRegistry
