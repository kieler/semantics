...
public class SyncchartsViewProvider extends AbstractProvider implements
    ...
    public Node createNode(IAdaptable semanticAdapter, View containerView,
        ...
        switch (visualID) {
        case StateEditPart.VISUAL_ID:
            return createState_2005(domainElement, containerView, index,
                    persisted, preferencesHint);
        case Region2EditPart.VISUAL_ID:
            return createRegion_3039(domainElement, containerView, index,
                    persisted, preferencesHint);
        case State2EditPart.VISUAL_ID:
            return createState_3040(domainElement, containerView, index,
                    persisted, preferencesHint);
        case SignalEditPart.VISUAL_ID:
            return createSignal_3041(domainElement, containerView, index,
                    persisted, preferencesHint);
        case StateEntryActionEditPart.VISUAL_ID:
            return createAction_3042(domainElement, containerView, index,
                    persisted, preferencesHint);
        case StateInnerActionEditPart.VISUAL_ID:
            return createAction_3043(domainElement, containerView, index,
                    persisted, preferencesHint);
        case StateExitActionEditPart.VISUAL_ID:
            return createAction_3044(domainElement, containerView, index,
                    persisted, preferencesHint);
        case StateSuspensionTriggerEditPart.VISUAL_ID:
            return createAction_3045(domainElement, containerView, index,
                    persisted, preferencesHint);
        case TextualCodeEditPart.VISUAL_ID:
            return createTextualCode_3046(domainElement, containerView, index,
                    persisted, preferencesHint);
        }
    ...
    public Edge createEdge(IAdaptable semanticAdapter, View containerView,
        ...
        case TransitionEditPart.VISUAL_ID:
            return createTransition_4005(getSemanticElement(semanticAdapter),
     ...
     * @generated
     */
    public Node createState_2005(EObject domainElement, View containerView,
     ...
     * @generated
     */
    public Node createRegion_3039(EObject domainElement, View containerView,
            int index, boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
        node.setType(SyncchartsVisualIDRegistry
     ...
     * @generated
     */
    public Node createState_3040(EObject domainElement, View containerView,
            int index, boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
        node.setType(SyncchartsVisualIDRegistry
     ...
     * @generated
     */
    public Node createSignal_3041(EObject domainElement, View containerView,
            int index, boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
        node.setType(SyncchartsVisualIDRegistry
     ...
     * @generated
     */
    public Node createAction_3042(EObject domainElement, View containerView,
            int index, boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
        node.setType(SyncchartsVisualIDRegistry
     ...
     * @generated
     */
    public Node createAction_3043(EObject domainElement, View containerView,
            int index, boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
        node.setType(SyncchartsVisualIDRegistry
     ...
     * @generated
     */
    public Node createAction_3044(EObject domainElement, View containerView,
            int index, boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
        node.setType(SyncchartsVisualIDRegistry
     ...
     * @generated
     */
    public Node createAction_3045(EObject domainElement, View containerView,
            int index, boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
        node.setType(SyncchartsVisualIDRegistry
     ...
     * @generated
     */
    public Node createTextualCode_3046(EObject domainElement,
     ...
     * @generated
     */
    public Edge createTransition_4005(EObject domainElement,
            View containerView, int index, boolean persisted,
            PreferencesHint preferencesHint) {
