...
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateSignalCompartment2EditPolicy;
import de.cau.cs.kieler.synccharts.diagram.edit.policies.StateSignalCompartment2ItemSemanticEditPolicy;
import de.cau.cs.kieler.synccharts.diagram.part.Messages;

/**
 * @generated
 */
public class StateSignalCompartment2EditPart extends ShapeCompartmentEditPart {
     ...
     * @generated
     */
    public StateSignalCompartment2EditPart(View view) {
        super(view);
    }
    ...
    public String getCompartmentName() {
        return Messages.StateSignalCompartment2EditPart_title;
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
                new StateSignalCompartment2ItemSemanticEditPolicy());
        installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());
        installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
        installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StateSignalCompartment2EditPolicy());
    }
