 ...
 */
public class SCChartsCombination extends AbstractCombination {

    /**
     * The preference key for the highlight color.
     */
    public static final String HIGHLIGHT_COLOR = SCChartsCombination.class.getCanonicalName()
            + ".highlightColor";

    /**
     * The preference key for the highlight color.
     */
    public static final String ERROR_HIGHLIGHT_COLOR = SCChartsCombination.class
            .getCanonicalName() + ".errorHighlightColor";

    /**
     * The preference key for the history color.
     */
    public static final String HISTORY_COLOR = SCChartsCombination.class.getCanonicalName()
            + ".historyColor";

    /**
     * The preference key for the color of inactive states.
     */
    public static final String INACTIVE_COLOR = SCChartsCombination.class.getCanonicalName()
            + ".inactiveColor";

    /**
     * The preference key for the background color of inactive states.
     */
    public static final String INACTIVE_BGCOLOR = SCChartsCombination.class.getCanonicalName()
            + ".inactiveBGColor";

    /**
     * The preference key for the highlight background color.
     */
    public static final String HIGHLIGHT_BGCOLOR = SCChartsCombination.class.getCanonicalName()
            + ".highlightBGColor";

    /**
     * The preference key for the history background color.
     */
    public static final String HISTORY_BGCOLOR = SCChartsCombination.class.getCanonicalName()
            + ".historyBGColor";

    /**
     * The preference key for the black & white mode.
     */
    public static final String BW_MODE = SCChartsCombination.class.getCanonicalName() + ".bwMode";

    /**
     * The preference key for the focus & context mode.
     */
    public static final String FC_MODE = SCChartsCombination.class.getCanonicalName() + ".fcMode";
    ...
    /**
     * Creates a SCCharts simulation combination.
     */
    public SCChartsCombination() {
    ...
    public void execute(final ActiveStates activeStates) {
        // papyrus and sccharts share one trigger state
