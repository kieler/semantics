...
import de.cau.cs.kieler.sccharts.diagram.custom.triggerlisteners.VisibilityManagerShowHideEffect;
import de.cau.cs.kieler.sccharts.diagram.edit.parts.TransitionLabelEditPart;
...
public class HideTransitionLabelsCombination extends AbstractCombination {
     ...
     */
    private static final String HIDE_BUTTON_ID = "de.cau.cs.kieler.sccharts.kivi.hideTransitionLabels";

    /**
     * ID of the show button.
     */
    private static final String SHOW_BUTTON_ID = "de.cau.cs.kieler.sccharts.kivi.showTransitionLabels";
    ...
    public void execute(final ButtonState buttonState, final DiagramState diagram) {
        ...
        // Check if the editor is a SCChartsEditor
