...
class SCChartsEnvironmentInitializer implements IEnvironmentsInitializer {
    ...
    private static def EnvironmentData getArduinoDefaultEnvironment(){
        ...
        val buildConfigFile = new FileData("assets/BuildConfig.kibuild", "platform:/plugin/de.cau.cs.kieler.sccharts.prom/environments/arduino/ArduinoBuildConfig.kibuild")
