 ...
 * <!-- end-user-doc -->
 * @see de.cau.cs.kieler.sccharts.legacy.kexpressions.keffects.KEffectsPackage#getAssignOperator()
 * @model
 * @generated
 */
public enum AssignOperator implements Enumerator {
     ...
     * @ordered
     */
    POSTFIXADD(5, "POSTFIXADD", "POSTFIXADD"),
     ...
     * @ordered
     */
    public static final int POSTFIXADD_VALUE = 5;
