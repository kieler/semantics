 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.sccharts.Scope#getId <em>Id</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.sccharts.Scope#getLabel <em>Label</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.sccharts.Scope#getLocalActions <em>Local Actions</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.sccharts.Scope#getReferencedScope <em>Referenced Scope</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.sccharts.Scope#getBindings <em>Bindings</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.sccharts.Scope#getDeclarations <em>Declarations</em>}</li>
 * </ul>
 *
 * @see de.cau.cs.kieler.sccharts.legacy.sccharts.SCChartsPackage#getScope()
 * @model abstract="true"
 * @generated
 */
public interface Scope extends Annotatable {
     ...
     * @see #setId(String)
     * @see de.cau.cs.kieler.sccharts.legacy.sccharts.SCChartsPackage#getScope_Id()
     * @model
     * @generated
     */
    String getId();
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.sccharts.legacy.sccharts.Scope#getId <em>Id</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setLabel(String)
     * @see de.cau.cs.kieler.sccharts.legacy.sccharts.SCChartsPackage#getScope_Label()
     * @model
     * @generated
     */
    String getLabel();
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.sccharts.legacy.sccharts.Scope#getLabel <em>Label</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The list contents are of type {@link de.cau.cs.kieler.sccharts.legacy.sccharts.LocalAction}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.cau.cs.kieler.sccharts.legacy.sccharts.SCChartsPackage#getScope_LocalActions()
     ...
     * @see de.cau.cs.kieler.sccharts.legacy.sccharts.SCChartsPackage#getScope_ReferencedScope()
     * @model
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.sccharts.legacy.sccharts.Scope#getReferencedScope <em>Referenced Scope</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The list contents are of type {@link de.cau.cs.kieler.sccharts.legacy.sccharts.Binding}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.cau.cs.kieler.sccharts.legacy.sccharts.SCChartsPackage#getScope_Bindings()
     * @model containment="true"
     * @generated
     */
     ...
     * @see de.cau.cs.kieler.sccharts.legacy.sccharts.SCChartsPackage#getScope_Declarations()
     * @model containment="true"
     * @generated
     */
