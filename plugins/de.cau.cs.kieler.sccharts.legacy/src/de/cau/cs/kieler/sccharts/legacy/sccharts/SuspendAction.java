 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.sccharts.SuspendAction#isWeak <em>Weak</em>}</li>
 * </ul>
 *
 * @see de.cau.cs.kieler.sccharts.legacy.sccharts.SCChartsPackage#getSuspendAction()
 * @model
 * @generated
 */
public interface SuspendAction extends LocalAction {
     ...
     * @see #setWeak(boolean)
     * @see de.cau.cs.kieler.sccharts.legacy.sccharts.SCChartsPackage#getSuspendAction_Weak()
     * @model
     * @generated
     */
    boolean isWeak();
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.sccharts.legacy.sccharts.SuspendAction#isWeak <em>Weak</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
