 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.kexpressions.impl.DeclarationImpl#getValuedObjects <em>Valued Objects</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.kexpressions.impl.DeclarationImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.kexpressions.impl.DeclarationImpl#isInput <em>Input</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.kexpressions.impl.DeclarationImpl#isOutput <em>Output</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.kexpressions.impl.DeclarationImpl#isStatic <em>Static</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.kexpressions.impl.DeclarationImpl#isSignal <em>Signal</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.kexpressions.impl.DeclarationImpl#isConst <em>Const</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.kexpressions.impl.DeclarationImpl#isExtern <em>Extern</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.kexpressions.impl.DeclarationImpl#isVolatile <em>Volatile</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.kexpressions.impl.DeclarationImpl#getHostType <em>Host Type</em>}</li>
 * </ul>
 *
 * @generated
 */
