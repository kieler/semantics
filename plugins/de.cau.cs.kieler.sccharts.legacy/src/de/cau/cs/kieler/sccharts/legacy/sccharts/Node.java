 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.sccharts.Node#getId <em>Id</em>}</li>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.sccharts.Node#getLabel <em>Label</em>}</li>
 * </ul>
 *
 * @see de.cau.cs.kieler.sccharts.legacy.sccharts.SCChartsPackage#getNode()
 * @model
 * @generated
 */
public interface Node extends Annotatable {
     ...
     * @see #setId(String)
     * @see de.cau.cs.kieler.sccharts.legacy.sccharts.SCChartsPackage#getNode_Id()
     * @model
     * @generated
     */
    String getId();
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.sccharts.legacy.sccharts.Node#getId <em>Id</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setLabel(String)
     * @see de.cau.cs.kieler.sccharts.legacy.sccharts.SCChartsPackage#getNode_Label()
     * @model
     * @generated
     */
    String getLabel();
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.sccharts.legacy.sccharts.Node#getLabel <em>Label</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
