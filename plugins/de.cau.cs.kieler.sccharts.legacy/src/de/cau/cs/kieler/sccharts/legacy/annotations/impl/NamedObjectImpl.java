...
import de.cau.cs.kieler.sccharts.legacy.annotations.NamedObject;
 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.sccharts.legacy.annotations.impl.NamedObjectImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedObjectImpl extends AnnotatableImpl implements NamedObject {
    ...
    protected EClass eStaticClass() {
        return AnnotationsPackage.Literals.NAMED_OBJECT;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AnnotationsPackage.NAMED_OBJECT__NAME, oldName, name));
    }
