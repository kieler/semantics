 ...
 * generated by Xtext
 */
package de.cau.cs.kieler.sccharts.legacy.kexpressions.kext.services;
...
public class KExtGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class KextElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.sccharts.legacy.kexpressions.kext.KExt.Kext");
	...
	public class TestEntityElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.sccharts.legacy.kexpressions.kext.KExt.TestEntity");
	...
	public class AnnotatedExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.sccharts.legacy.kexpressions.kext.KExt.AnnotatedExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.sccharts.legacy.kexpressions.kext.KExt.Declaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cAnnotationsAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cAnnotationsAnnotationParserRuleCall_0_0 = (RuleCall)cAnnotationsAssignment_0.eContents().get(0);
	...
	public class ValuedObjectElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.sccharts.legacy.kexpressions.kext.KExt.ValuedObject");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("de.cau.cs.kieler.sccharts.legacy.kexpressions.kext.KExt".equals(grammar.getName())) {
				return grammar;
			}
