package de.cau.cs.kieler.sccharts.legacy.kexpressions.parser.antlr.internal;
...
public class InternalKExpressionsLexer extends Lexer {
    ...
    public final void mRULE_HOSTCODE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3196:15: ( '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            // InternalKExpressions.g:3196:17: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
            {
            match('\''); 
            // InternalKExpressions.g:3196:22: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
            loop1:
            do {
                int alt1=3;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalKExpressions.g:3196:23: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
            	    ...
            	    break;
            	case 2 :
            	    // InternalKExpressions.g:3196:64: ~ ( ( '\\\\' | '\\'' ) )
            	    {
    ...
    public final void mRULE_COMMENT_ANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3198:25: ( '/**' ( options {greedy=false; } : . )* '*/' )
            // InternalKExpressions.g:3198:27: '/**' ( options {greedy=false; } : . )* '*/'
            {
            match("/**"); 

            // InternalKExpressions.g:3198:33: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalKExpressions.g:3198:61: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3200:17: ( '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/' )
            // InternalKExpressions.g:3200:19: '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 
            ...
            // InternalKExpressions.g:3200:31: ( options {greedy=false; } : . )*
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalKExpressions.g:3200:59: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            // InternalKExpressions.g:3202:22: ( '0' .. '9' )
            // InternalKExpressions.g:3202:24: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3204:10: ( ( RULE_NUMBER )+ )
            // InternalKExpressions.g:3204:12: ( RULE_NUMBER )+
            {
            // InternalKExpressions.g:3204:12: ( RULE_NUMBER )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3206:12: ( ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' ) )
            // InternalKExpressions.g:3206:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            {
            // InternalKExpressions.g:3206:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // InternalKExpressions.g:3206:15: ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )?
                    {
                    // InternalKExpressions.g:3206:15: ( RULE_NUMBER )+
                    int cnt5=0;
                    loop5:
                    do {
                        int alt5=2;
                    ...
                    match('.'); 
                    // InternalKExpressions.g:3206:32: ( RULE_NUMBER )*
                    loop6:
                    do {
                        int alt6=2;
                    ...
                    // InternalKExpressions.g:3206:45: ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )?
                    int alt9=2;
                    ...
                    switch (alt9) {
                        case 1 :
                            // InternalKExpressions.g:3206:46: ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+
                            {
                            ...
                            // InternalKExpressions.g:3206:56: ( '+' | '-' )?
                            int alt7=2;
                            ...
                            // InternalKExpressions.g:3206:67: ( RULE_NUMBER )+
                            int cnt8=0;
                            loop8:
                            do {
                                int alt8=2;
                    ...
                    // InternalKExpressions.g:3206:82: ( 'f' )?
                    int alt10=2;
                    ...
                    break;
                case 2 :
                    // InternalKExpressions.g:3206:87: ( RULE_NUMBER )+ 'f'
                    {
                    // InternalKExpressions.g:3206:87: ( RULE_NUMBER )+
                    int cnt11=0;
                    loop11:
                    do {
                        int alt11=2;
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3208:14: ( ( 'true' | 'false' ) )
            // InternalKExpressions.g:3208:16: ( 'true' | 'false' )
            {
            // InternalKExpressions.g:3208:16: ( 'true' | 'false' )
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalKExpressions.g:3208:17: 'true'
                    {
                    match("true"); 
                    ...
                    break;
                case 2 :
                    // InternalKExpressions.g:3208:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3210:13: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalKExpressions.g:3210:15: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalKExpressions.g:3210:19: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
            loop14:
            do {
                int alt14=3;
                ...
                switch (alt14) {
            	case 1 :
            	    // InternalKExpressions.g:3210:20: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
            	    if ( input.LA(1)=='\"'||input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||input.LA(1)=='t' ) {
            	        input.consume();
            	    ...
            	    break;
            	case 2 :
            	    // InternalKExpressions.g:3210:61: ~ ( ( '\\\\' | '\"' ) )
            	    {
            	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='!')||(input.LA(1)>='#' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
            	        input.consume();
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3212:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalKExpressions.g:3212:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalKExpressions.g:3212:11: ( '^' )?
            int alt15=2;
            ...
            // InternalKExpressions.g:3212:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop16:
            do {
                int alt16=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3214:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalKExpressions.g:3214:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalKExpressions.g:3214:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop17:
            do {
                int alt17=2;
            ...
            // InternalKExpressions.g:3214:40: ( ( '\\r' )? '\\n' )?
            int alt19=2;
            ...
            switch (alt19) {
                case 1 :
                    // InternalKExpressions.g:3214:41: ( '\\r' )? '\\n'
                    {
                    // InternalKExpressions.g:3214:41: ( '\\r' )?
                    int alt18=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3216:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalKExpressions.g:3216:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalKExpressions.g:3216:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt20=0;
            loop20:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3218:16: ( . )
            // InternalKExpressions.g:3218:18: .
            {
            matchAny(); 
    ...
    static class DFA12 extends DFA {
        ...
        public String getDescription() {
            return "3206:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )";
        }
    }
    static final String DFA21_eotS =
        "\1\uffff\1\40\1\42\3\uffff\1\50\1\uffff\1\53\3\uffff\1\60\1\uffff\1\63\1\65\3\uffff\1\36\2\73\1\36\1\76\2\73\2\36\36\uffff\1\73\1\uffff\1\73\3\uffff\1\76\2\73\4\uffff\1\113\1\114\2\73\2\uffff\1\117\1\73\1\uffff\1\117";
    static final String DFA21_eofS =
        "\121\uffff";
    static final String DFA21_minS =
        "\1\0\1\174\1\46\3\uffff\1\52\1\uffff\1\51\3\uffff\1\75\1\uffff\2\75\3\uffff\1\75\1\162\1\141\1\0\1\56\1\162\1\141\1\0\1\101\12\uffff\1\0\23\uffff\1\145\1\uffff\1\154\3\uffff\1\56\1\165\1\154\4\uffff\2\60\1\145\1\163\2\uffff\1\60\1\145\1\uffff\1\60";
    static final String DFA21_maxS =
        "\1\uffff\1\174\1\46\3\uffff\1\57\1\uffff\1\51\3\uffff\1\75\1\uffff\2\75\3\uffff\1\75\1\162\1\141\1\uffff\1\146\1\162\1\141\1\uffff\1\172\12\uffff\1\uffff\23\uffff\1\145\1\uffff\1\154\3\uffff\1\146\1\165\1\154\4\uffff\2\172\1\145\1\163\2\uffff\1\172\1\145\1\uffff\1\172";
    static final String DFA21_acceptS =
        "\3\uffff\1\5\1\6\1\7\1\uffff\1\11\1\uffff\1\13\1\14\1\15\1\uffff\1\17\2\uffff\1\23\1\24\1\25\11\uffff\1\43\1\45\1\46\1\1\1\3\1\2\1\4\1\5\1\6\1\7\1\uffff\1\44\1\10\1\11\1\20\1\12\1\13\1\14\1\15\1\27\1\16\1\17\1\30\1\21\1\31\1\22\1\23\1\24\1\25\1\26\1\uffff\1\43\1\uffff\1\34\1\37\1\40\3\uffff\1\42\1\45\1\35\1\36\4\uffff\1\32\1\33\2\uffff\1\41\1\uffff";
    static final String DFA21_specialS =
        "\1\2\25\uffff\1\1\3\uffff\1\0\13\uffff\1\3\52\uffff}>";
    static final String[] DFA21_transitionS = {
            "\11\36\2\35\2\36\1\35\22\36\1\35\1\17\1\32\1\22\1\36\1\7\1\2\1\26\1\10\1\11\1\5\1\3\1\15\1\4\1\21\1\6\12\27\2\36\1\14\1\23\1\16\1\36\1\20\32\34\1\12\1\36\1\13\1\33\1\34\1\36\5\34\1\31\11\34\1\24\3\34\1\30\1\34\1\25\4\34\1\36\1\1\uff83\36",
            "\1\37",
            "\1\41",
            "",
            "",
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    ...
                    case 3 : 
                        ...
                        else if ( ((LA21_38>='\u0000' && LA21_38<=')')||(LA21_38>='+' && LA21_38<='\uFFFF')) ) {s = 70;}
