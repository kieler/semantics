 ...
 * generated by Xtext
 */
package de.cau.cs.kieler.sccharts.legacy.text.actions.services;
...
public class ActionsGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class TransitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.sccharts.legacy.text.actions.Actions.Transition");
	...
	public class EntryActionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.sccharts.legacy.text.actions.Actions.EntryAction");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DuringActionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.sccharts.legacy.text.actions.Actions.DuringAction");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ExitActionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.sccharts.legacy.text.actions.Actions.ExitAction");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SuspendActionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.sccharts.legacy.text.actions.Actions.SuspendAction");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IterateActionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.sccharts.legacy.text.actions.Actions.IterateAction");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DivOperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.sccharts.legacy.text.actions.Actions.DivOperator");
	...
	public class HistoryTypeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.sccharts.legacy.text.actions.Actions.HistoryType");
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("de.cau.cs.kieler.sccharts.legacy.text.actions.Actions".equals(grammar.getName())) {
				return grammar;
			}
