...
public class ActionsStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjectorAndDoEMFRegistration() {
		de.cau.cs.kieler.sccharts.legacy.kexpressions.kext.KExtStandaloneSetup.doSetup();
	...
	public Injector createInjector() {
		return Guice.createInjector(new de.cau.cs.kieler.sccharts.legacy.text.actions.ActionsRuntimeModule());
	}
