...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.core.kexpressions.keffects.FunctionCallEffect} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionCallEffectItemProvider extends EffectItemProvider {
    /**
	 ...
	 * @generated
	 */
    public FunctionCallEffectItemProvider(AdapterFactory adapterFactory) {
    ...
    /**
	 * This returns FunctionCallEffect.gif.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @generated
	 */
    ...
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FunctionCallEffect"));
	}
    ...
    public String getText(Object object) {
		String label = ((FunctionCallEffect)object).getFunctionName();
		return label == null || label.length() == 0 ?
			getString("_UI_FunctionCallEffect_type") :
			getString("_UI_FunctionCallEffect_type") + " " + label;
	}
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FunctionCallEffect.class)) {
