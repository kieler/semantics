 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.ExecBody#getVars <em>Vars</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.ExecBody#getKexpressions <em>Kexpressions</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getExecBody()
 * @model
 * @generated
 */
public interface ExecBody extends EObject
{
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getExecBody_Vars()
   * @model
   * @generated
   */
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getExecBody_Kexpressions()
