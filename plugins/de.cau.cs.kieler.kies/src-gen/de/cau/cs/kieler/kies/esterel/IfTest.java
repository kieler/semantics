 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.IfTest#getExpr <em>Expr</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.IfTest#getThenPart <em>Then Part</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.IfTest#getElsif <em>Elsif</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.IfTest#getElsePart <em>Else Part</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.IfTest#getOptEnd <em>Opt End</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getIfTest()
 * @model
 * @generated
 */
public interface IfTest extends Statement
{
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getIfTest_Expr()
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.IfTest#getExpr <em>Expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getIfTest_ThenPart()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.IfTest#getThenPart <em>Then Part</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link de.cau.cs.kieler.kies.esterel.ElsIf}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getIfTest_Elsif()
   * @model containment="true"
   * @generated
   */
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getIfTest_ElsePart()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.IfTest#getElsePart <em>Else Part</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getIfTest_OptEnd()
   * @model
   * @generated
   */
  String getOptEnd();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.IfTest#getOptEnd <em>Opt End</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
