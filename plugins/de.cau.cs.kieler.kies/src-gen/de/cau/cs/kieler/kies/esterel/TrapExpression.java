 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.TrapExpression#getTrap <em>Trap</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getTrapExpression()
 * @model
 * @generated
 */
public interface TrapExpression extends Expression
{
   ...
   * @see #setTrap(ISignal)
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getTrapExpression_Trap()
   * @model
   * @generated
   */
  ISignal getTrap();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.TrapExpression#getTrap <em>Trap</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
