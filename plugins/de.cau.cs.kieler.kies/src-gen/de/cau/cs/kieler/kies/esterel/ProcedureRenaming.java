 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.ProcedureRenaming#getNewName <em>New Name</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.ProcedureRenaming#getOldName <em>Old Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getProcedureRenaming()
 * @model
 * @generated
 */
public interface ProcedureRenaming extends EObject
{
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getProcedureRenaming_NewName()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.ProcedureRenaming#getNewName <em>New Name</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getProcedureRenaming_OldName()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.ProcedureRenaming#getOldName <em>Old Name</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
