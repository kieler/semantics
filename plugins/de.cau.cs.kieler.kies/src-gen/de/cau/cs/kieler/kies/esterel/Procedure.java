 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.Procedure#getName <em>Name</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.Procedure#getIdList1 <em>Id List1</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.Procedure#getIdList2 <em>Id List2</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getProcedure()
 * @model
 * @generated
 */
public interface Procedure extends EObject
{
   ...
   * @see #setName(String)
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getProcedure_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.Procedure#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getProcedure_IdList1()
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getProcedure_IdList2()
   * @model containment="true"
   * @generated
   */
