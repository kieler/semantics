 ...
 *   <li>{@link de.cau.cs.kieler.kies.esterel.AbortInstance#getStatement <em>Statement</em>}</li>
...
public interface AbortInstance extends AbortBody, WeakAbortBody
{
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getAbortInstance_Statement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.AbortInstance#getStatement <em>Statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
