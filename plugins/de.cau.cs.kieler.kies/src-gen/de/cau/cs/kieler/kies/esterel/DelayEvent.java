 ...
 *   <li>{@link de.cau.cs.kieler.kies.esterel.DelayEvent#getFB <em>FB</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.DelayEvent#getEB <em>EB</em>}</li>
 * </ul>
 * </p>
 *
...
public interface DelayEvent extends EObject
{
   ...
   * @see #setFB(String)
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getDelayEvent_FB()
   * @model
   * @generated
   */
  String getFB();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.DelayEvent#getFB <em>FB</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setEB(String)
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getDelayEvent_EB()
   * @model
   * @generated
   */
  String getEB();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.DelayEvent#getEB <em>EB</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
