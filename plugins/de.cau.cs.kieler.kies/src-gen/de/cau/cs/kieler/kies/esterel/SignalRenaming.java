 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.SignalRenaming#getNewName <em>New Name</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.SignalRenaming#getOldName <em>Old Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getSignalRenaming()
 * @model
 * @generated
 */
public interface SignalRenaming extends EObject
{
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getSignalRenaming_NewName()
   * @model
   * @generated
   */
  ISignal getNewName();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.SignalRenaming#getNewName <em>New Name</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getSignalRenaming_OldName()
   * @model
   * @generated
   */
  ISignal getOldName();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.SignalRenaming#getOldName <em>Old Name</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
