 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.FunctionCall#getFunc <em>Func</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.FunctionCall#getKexpressions <em>Kexpressions</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getFunctionCall()
 * @model
 * @generated
 */
public interface FunctionCall extends EObject
{
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getFunctionCall_Func()
   * @model
   * @generated
   */
  Function getFunc();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.FunctionCall#getFunc <em>Func</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getFunctionCall_Kexpressions()
