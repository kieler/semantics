 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.EndLoop#getEndOpt <em>End Opt</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getEndLoop()
 * @model
 * @generated
 */
public interface EndLoop extends EObject
{
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getEndLoop_EndOpt()
   * @model
   * @generated
   */
  String getEndOpt();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.EndLoop#getEndOpt <em>End Opt</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
