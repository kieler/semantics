 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaces.impl.VariablesImpl#getVars <em>Vars</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariablesImpl extends MinimalEObjectImpl.Container implements Variables
{
  ...
  {
    return InterfacesPackage.Literals.VARIABLES;
  }
  ...
  public EList<Variable> getVars()
  {
    if (vars == null)
    {
      vars = new EObjectContainmentEList<Variable>(Variable.class, this, InterfacesPackage.VARIABLES__VARS);
    }
    return vars;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case InterfacesPackage.VARIABLES__VARS:
