 ...
 *
 */
package de.cau.cs.kieler.synccharts.text.interfaces.interfaceDecl.impl;
...
import de.cau.cs.kieler.synccharts.text.interfaces.interfaceDecl.InterfaceDeclPackage;
...
import de.cau.cs.kieler.synccharts.text.interfaces.interfaceDecl.Variables;
 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaceDecl.impl.StateExtendImpl#getRegions <em>Regions</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaceDecl.impl.StateExtendImpl#getInOutputSignals <em>In Output Signals</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaceDecl.impl.StateExtendImpl#getOutputSignals <em>Output Signals</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaceDecl.impl.StateExtendImpl#getInputSignals <em>Input Signals</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaceDecl.impl.StateExtendImpl#getSignals <em>Signals</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaceDecl.impl.StateExtendImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateExtendImpl extends MinimalEObjectImpl.Container implements StateExtend
{
   ...
   * @ordered
   */
  protected EList<Variables> variable;
   ...
   * @generated
   */
  public EList<Variables> getVariable()
  {
    if (variable == null)
    {
      variable = new EObjectContainmentEList<Variables>(Variables.class, this, InterfaceDeclPackage.STATE_EXTEND__VARIABLE);
    }
    return variable;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case InterfaceDeclPackage.STATE_EXTEND__VARIABLE:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case InterfaceDeclPackage.STATE_EXTEND__VARIABLE:
        getVariable().clear();
        getVariable().addAll((Collection<? extends Variables>)newValue);
        return;
    }
