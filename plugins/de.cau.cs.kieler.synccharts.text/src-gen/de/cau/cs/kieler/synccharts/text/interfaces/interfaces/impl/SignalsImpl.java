 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaces.impl.SignalsImpl#getSignals <em>Signals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SignalsImpl extends MinimalEObjectImpl.Container implements Signals
{
  ...
  {
    return InterfacesPackage.Literals.SIGNALS;
  }
  ...
  public EList<Signal> getSignals()
  {
    if (signals == null)
    {
      signals = new EObjectContainmentEList<Signal>(Signal.class, this, InterfacesPackage.SIGNALS__SIGNALS);
    }
    return signals;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case InterfacesPackage.SIGNALS__SIGNALS:
