 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaces.impl.InputSignalsImpl#getSignals <em>Signals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InputSignalsImpl extends MinimalEObjectImpl.Container implements InputSignals
{
  ...
  {
    return InterfacesPackage.Literals.INPUT_SIGNALS;
  }
  ...
  public EList<Signal> getSignals()
  {
    if (signals == null)
    {
      signals = new EObjectContainmentEList<Signal>(Signal.class, this, InterfacesPackage.INPUT_SIGNALS__SIGNALS);
    }
    return signals;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case InterfacesPackage.INPUT_SIGNALS__SIGNALS:
