 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaces.impl.StateExtendImpl#getRegions <em>Regions</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaces.impl.StateExtendImpl#getInOutputSignals <em>In Output Signals</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaces.impl.StateExtendImpl#getOutputSignals <em>Output Signals</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaces.impl.StateExtendImpl#getInputSignals <em>Input Signals</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaces.impl.StateExtendImpl#getSignals <em>Signals</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts.text.interfaces.interfaces.impl.StateExtendImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateExtendImpl extends MinimalEObjectImpl.Container implements StateExtend
{
  ...
  {
    return InterfacesPackage.Literals.STATE_EXTEND;
  }
  ...
  public EList<RegionSignalDec> getRegions()
  {
    if (regions == null)
    {
      regions = new EObjectContainmentEList<RegionSignalDec>(RegionSignalDec.class, this, InterfacesPackage.STATE_EXTEND__REGIONS);
    }
    return regions;
  }
  ...
  public EList<InOutputSignals> getInOutputSignals()
  {
    ...
    {
      inOutputSignals = new EObjectContainmentEList<InOutputSignals>(InOutputSignals.class, this, InterfacesPackage.STATE_EXTEND__IN_OUTPUT_SIGNALS);
    }
  ...
  public EList<OutputSignals> getOutputSignals()
  {
    ...
    {
      outputSignals = new EObjectContainmentEList<OutputSignals>(OutputSignals.class, this, InterfacesPackage.STATE_EXTEND__OUTPUT_SIGNALS);
    }
  ...
  public EList<InputSignals> getInputSignals()
  {
    ...
    {
      inputSignals = new EObjectContainmentEList<InputSignals>(InputSignals.class, this, InterfacesPackage.STATE_EXTEND__INPUT_SIGNALS);
    }
    return inputSignals;
  }
  ...
  public EList<Signals> getSignals()
  {
    if (signals == null)
    {
      signals = new EObjectContainmentEList<Signals>(Signals.class, this, InterfacesPackage.STATE_EXTEND__SIGNALS);
    }
    return signals;
  }
  ...
  public EList<Variables> getVariable()
  {
    if (variable == null)
    {
      variable = new EObjectContainmentEList<Variables>(Variables.class, this, InterfacesPackage.STATE_EXTEND__VARIABLE);
    }
    return variable;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case InterfacesPackage.STATE_EXTEND__REGIONS:
        return ((InternalEList<?>)getRegions()).basicRemove(otherEnd, msgs);
      case InterfacesPackage.STATE_EXTEND__IN_OUTPUT_SIGNALS:
        return ((InternalEList<?>)getInOutputSignals()).basicRemove(otherEnd, msgs);
      case InterfacesPackage.STATE_EXTEND__OUTPUT_SIGNALS:
        return ((InternalEList<?>)getOutputSignals()).basicRemove(otherEnd, msgs);
      case InterfacesPackage.STATE_EXTEND__INPUT_SIGNALS:
        return ((InternalEList<?>)getInputSignals()).basicRemove(otherEnd, msgs);
      case InterfacesPackage.STATE_EXTEND__SIGNALS:
        return ((InternalEList<?>)getSignals()).basicRemove(otherEnd, msgs);
      case InterfacesPackage.STATE_EXTEND__VARIABLE:
