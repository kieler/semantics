...
public class InternalKExpressionsLexer extends Lexer {
    ...
    public final void mT__34() throws RecognitionException {
        try {
            int _type = T__34;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:29:7: ( 'pre' )
            // InternalKExpressions.g:29:9: 'pre'
            {
            match("pre"); 
    ...
    public final void mT__40() throws RecognitionException {
        try {
            int _type = T__40;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:35:7: ( 'val' )
            // InternalKExpressions.g:35:9: 'val'
            {
            match("val"); 
    ...
    public final void mRULE_HOSTCODE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:2996:15: ( '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            // InternalKExpressions.g:2996:17: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
            {
            match('\''); 
            // InternalKExpressions.g:2996:22: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
            loop1:
            do {
                int alt1=3;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalKExpressions.g:2996:23: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
            	    ...
            	    break;
            	case 2 :
            	    // InternalKExpressions.g:2996:64: ~ ( ( '\\\\' | '\\'' ) )
            	    {
    ...
    public final void mRULE_COMMENT_ANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:2998:25: ( '/**' ( options {greedy=false; } : . )* '*/' )
            // InternalKExpressions.g:2998:27: '/**' ( options {greedy=false; } : . )* '*/'
            {
            match("/**"); 

            // InternalKExpressions.g:2998:33: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalKExpressions.g:2998:61: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3000:17: ( '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/' )
            // InternalKExpressions.g:3000:19: '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 
            ...
            // InternalKExpressions.g:3000:31: ( options {greedy=false; } : . )*
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalKExpressions.g:3000:59: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            // InternalKExpressions.g:3002:22: ( '0' .. '9' )
            // InternalKExpressions.g:3002:24: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3004:10: ( ( RULE_NUMBER )+ )
            // InternalKExpressions.g:3004:12: ( RULE_NUMBER )+
            {
            // InternalKExpressions.g:3004:12: ( RULE_NUMBER )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3006:12: ( ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' ) )
            // InternalKExpressions.g:3006:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            {
            // InternalKExpressions.g:3006:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // InternalKExpressions.g:3006:15: ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )?
                    {
                    // InternalKExpressions.g:3006:15: ( RULE_NUMBER )+
                    int cnt5=0;
                    loop5:
                    do {
                        int alt5=2;
                    ...
                    match('.'); 
                    // InternalKExpressions.g:3006:32: ( RULE_NUMBER )*
                    loop6:
                    do {
                        int alt6=2;
                    ...
                    // InternalKExpressions.g:3006:45: ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )?
                    int alt9=2;
                    ...
                    switch (alt9) {
                        case 1 :
                            // InternalKExpressions.g:3006:46: ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+
                            {
                            ...
                            // InternalKExpressions.g:3006:56: ( '+' | '-' )?
                            int alt7=2;
                            ...
                            // InternalKExpressions.g:3006:67: ( RULE_NUMBER )+
                            int cnt8=0;
                            loop8:
                            do {
                                int alt8=2;
                    ...
                    // InternalKExpressions.g:3006:82: ( 'f' )?
                    int alt10=2;
                    ...
                    break;
                case 2 :
                    // InternalKExpressions.g:3006:87: ( RULE_NUMBER )+ 'f'
                    {
                    // InternalKExpressions.g:3006:87: ( RULE_NUMBER )+
                    int cnt11=0;
                    loop11:
                    do {
                        int alt11=2;
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3008:14: ( ( 'true' | 'false' ) )
            // InternalKExpressions.g:3008:16: ( 'true' | 'false' )
            {
            // InternalKExpressions.g:3008:16: ( 'true' | 'false' )
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalKExpressions.g:3008:17: 'true'
                    {
                    match("true"); 
                    ...
                    break;
                case 2 :
                    // InternalKExpressions.g:3008:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3010:13: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalKExpressions.g:3010:15: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalKExpressions.g:3010:19: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
            loop14:
            do {
                int alt14=3;
                ...
                switch (alt14) {
            	case 1 :
            	    // InternalKExpressions.g:3010:20: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
            	    if ( input.LA(1)=='\"'||input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||input.LA(1)=='t' ) {
            	        input.consume();
            	    ...
            	    break;
            	case 2 :
            	    // InternalKExpressions.g:3010:61: ~ ( ( '\\\\' | '\"' ) )
            	    {
            	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='!')||(input.LA(1)>='#' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
            	        input.consume();
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3012:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalKExpressions.g:3012:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalKExpressions.g:3012:11: ( '^' )?
            int alt15=2;
            ...
            // InternalKExpressions.g:3012:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop16:
            do {
                int alt16=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3014:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalKExpressions.g:3014:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalKExpressions.g:3014:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop17:
            do {
                int alt17=2;
            ...
            // InternalKExpressions.g:3014:40: ( ( '\\r' )? '\\n' )?
            int alt19=2;
            ...
            switch (alt19) {
                case 1 :
                    // InternalKExpressions.g:3014:41: ( '\\r' )? '\\n'
                    {
                    // InternalKExpressions.g:3014:41: ( '\\r' )?
                    int alt18=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3016:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalKExpressions.g:3016:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalKExpressions.g:3016:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt20=0;
            loop20:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKExpressions.g:3018:16: ( . )
            // InternalKExpressions.g:3018:18: .
            {
            matchAny(); 
    ...
    static final String DFA21_eotS =
        "\1\uffff\1\40\3\uffff\1\45\1\uffff\1\50\1\52\1\54\4\uffff\1\36\1\63\1\65\3\uffff\1\73\1\63\1\36\1\76\2\63\2\36\26\uffff\1\63\11\uffff\1\63\3\uffff\1\76\2\63\2\uffff\1\113\2\uffff\1\114\2\63\2\uffff\1\117\1\63\1\uffff\1\117";
    static final String DFA21_eofS =
        "\121\uffff";
    static final String DFA21_minS =
        "\1\0\1\51\3\uffff\1\75\1\uffff\2\75\1\46\4\uffff\1\75\1\162\1\174\3\uffff\1\52\1\141\1\0\1\56\1\162\1\141\1\0\1\101\26\uffff\1\145\6\uffff\1\0\2\uffff\1\154\3\uffff\1\56\1\165\1\154\2\uffff\1\60\2\uffff\1\60\1\145\1\163\2\uffff\1\60\1\145\1\uffff\1\60";
    static final String DFA21_maxS =
        "\1\uffff\1\51\3\uffff\1\75\1\uffff\2\75\1\46\4\uffff\1\75\1\162\1\174\3\uffff\1\57\1\141\1\uffff\1\146\1\162\1\141\1\uffff\1\172\26\uffff\1\145\6\uffff\1\uffff\2\uffff\1\154\3\uffff\1\146\1\165\1\154\2\uffff\1\172\2\uffff\1\172\1\145\1\163\2\uffff\1\172\1\145\1\uffff\1\172";
    static final String DFA21_acceptS =
        "\2\uffff\1\2\1\3\1\4\1\uffff\1\6\3\uffff\1\13\1\14\1\15\1\16\3\uffff\1\25\1\26\1\27\10\uffff\1\43\1\45\1\46\1\7\1\1\1\2\1\3\1\4\1\20\1\5\1\6\1\21\1\10\1\22\1\11\1\33\1\12\1\13\1\14\1\15\1\16\1\17\1\uffff\1\43\1\32\1\24\1\25\1\26\1\27\1\uffff\1\44\1\30\1\uffff\1\34\1\37\1\40\3\uffff\1\42\1\45\1\uffff\1\35\1\36\3\uffff\1\23\1\31\2\uffff\1\41\1\uffff";
    static final String DFA21_specialS =
        "\1\3\25\uffff\1\1\3\uffff\1\0\36\uffff\1\2\27\uffff}>";
    static final String[] DFA21_transitionS = {
            "\11\36\2\35\2\36\1\35\22\36\1\35\1\10\1\32\1\14\1\36\1\23\1\11\1\26\1\1\1\2\1\22\1\21\1\6\1\15\1\13\1\24\12\27\2\36\1\5\1\16\1\7\1\36\1\12\32\34\1\3\1\36\1\4\1\33\1\34\1\36\5\34\1\31\11\34\1\17\3\34\1\30\1\34\1\25\4\34\1\36\1\20\uff83\36",
            "\1\37",
            "",
            "",
            "",
