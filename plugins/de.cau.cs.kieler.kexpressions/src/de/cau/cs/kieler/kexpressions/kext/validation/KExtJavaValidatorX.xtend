...
class KExtJavaValidatorX extends de.cau.cs.kieler.kexpressions.kext.validation.AbstractKExtJavaValidator {
    ...
    @Check
    public def void checkCheckAnnotation(de.cau.cs.kieler.kexpressions.kext.TestEntity testEntity) {
