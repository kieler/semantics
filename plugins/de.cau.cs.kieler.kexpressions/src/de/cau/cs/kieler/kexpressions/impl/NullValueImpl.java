 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kexpressions.impl.NullValueImpl#getSchedule <em>Schedule</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NullValueImpl extends EObjectImpl implements NullValue {
    ...
    protected EClass eStaticClass() {
        return KExpressionsPackage.Literals.NULL_VALUE;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case KExpressionsPackage.NULL_VALUE__SCHEDULE:
