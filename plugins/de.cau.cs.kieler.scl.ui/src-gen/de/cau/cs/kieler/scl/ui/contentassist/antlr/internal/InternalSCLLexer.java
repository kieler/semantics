...
public class InternalSCLLexer extends Lexer {
    ...
    public final void mRULE_HOSTCODE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSCL.g:22176:15: ( '`' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '`' ) ) )* '`' )
            // InternalSCL.g:22176:17: '`' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '`' ) ) )* '`'
            {
            match('`'); 
            // InternalSCL.g:22176:21: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '`' ) ) )*
            loop1:
            do {
                int alt1=3;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalSCL.g:22176:22: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
    ...
    public final void mRULE_COMMENT_ANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSCL.g:22178:25: ( '/**' ( options {greedy=false; } : . )* '*/' )
            // InternalSCL.g:22178:27: '/**' ( options {greedy=false; } : . )* '*/'
            {
            match("/**"); 

            // InternalSCL.g:22178:33: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSCL.g:22180:17: ( '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/' )
            // InternalSCL.g:22180:19: '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 
            ...
            // InternalSCL.g:22180:31: ( options {greedy=false; } : . )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_SL_COMMENT_ANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSCL.g:22182:28: ( '//*' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalSCL.g:22182:30: '//*' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//*"); 

            // InternalSCL.g:22182:36: (~ ( ( '\\n' | '\\r' ) ) )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSCL.g:22184:17: ( '//' ~ ( '*' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalSCL.g:22184:19: '//' ~ ( '*' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            // InternalSCL.g:22186:22: ( '0' .. '9' )
            // InternalSCL.g:22186:24: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSCL.g:22188:10: ( ( RULE_NUMBER )+ )
            // InternalSCL.g:22188:12: ( RULE_NUMBER )+
            {
            // InternalSCL.g:22188:12: ( RULE_NUMBER )+
            int cnt10=0;
            loop10:
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSCL.g:22190:12: ( ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' ) )
            // InternalSCL.g:22190:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            {
            // InternalSCL.g:22190:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // InternalSCL.g:22190:15: ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )?
                    {
                    // InternalSCL.g:22190:15: ( RULE_NUMBER )+
                    int cnt11=0;
                    loop11:
                    do {
                        int alt11=2;
                    ...
                    match('.'); 
                    // InternalSCL.g:22190:32: ( RULE_NUMBER )*
                    loop12:
                    do {
                        int alt12=2;
                    ...
                    // InternalSCL.g:22190:45: ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )?
                    int alt15=2;
                    ...
                    switch (alt15) {
                        case 1 :
                            // InternalSCL.g:22190:46: ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+
                            {
                            ...
                            // InternalSCL.g:22190:67: ( RULE_NUMBER )+
                            int cnt14=0;
                            loop14:
                            do {
                                int alt14=2;
                    ...
                    break;
                case 2 :
                    // InternalSCL.g:22190:87: ( RULE_NUMBER )+ 'f'
                    {
                    // InternalSCL.g:22190:87: ( RULE_NUMBER )+
                    int cnt17=0;
                    loop17:
                    do {
                        int alt17=2;
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSCL.g:22192:14: ( ( 'true' | 'false' ) )
            // InternalSCL.g:22192:16: ( 'true' | 'false' )
            {
            // InternalSCL.g:22192:16: ( 'true' | 'false' )
            int alt19=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSCL.g:22194:13: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalSCL.g:22194:15: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalSCL.g:22194:19: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
            loop20:
            do {
                int alt20=3;
                ...
                switch (alt20) {
            	case 1 :
            	    // InternalSCL.g:22194:20: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
            	    if ( input.LA(1)=='\"'||input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||input.LA(1)=='t' ) {
            	        input.consume();
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSCL.g:22196:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalSCL.g:22196:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalSCL.g:22196:11: ( '^' )?
            int alt21=2;
            ...
            // InternalSCL.g:22196:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop22:
            do {
                int alt22=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSCL.g:22198:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalSCL.g:22198:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalSCL.g:22198:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt23=0;
            loop23:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSCL.g:22200:16: ( . )
            // InternalSCL.g:22200:18: .
            {
            matchAny(); 
    ...
    static final String DFA24_eotS =
        "\1\uffff\1\65\1\70\1\73\1\75\1\100\1\103\1\105\1\107\1\113\1\65\1\116\1\uffff\1\65\1\122\1\61\1\65\1\130\1\132\7\65\6\uffff\4\65\1\uffff\1\65\2\uffff\1\170\2\uffff\1\65\1\61\1\175\1\61\3\uffff\3\65\27\uffff\1\65\3\uffff\1\65\3\uffff\3\65\4\uffff\3\65\1\u0095\10\65\6\uffff\7\65\1\uffff\1\65\5\uffff\1\65\3\uffff\1\175\2\uffff\1\u00ab\2\65\1\u00af\1\65\4\uffff\1\u00b1\2\65\1\u00b6\1\u00b8\3\65\1\u00bc\1\65\1\uffff\15\65\1\u00cb\5\65\1\u00d1\1\65\1\uffff\1\u00d3\1\65\1\u00d5\1\uffff\1\65\1\uffff\3\65\4\uffff\1\65\1\u00db\1\65\1\uffff\2\65\1\u00df\6\65\1\u00e6\1\u00e7\1\u00e8\1\65\1\u00ea\1\uffff\1\u00eb\2\65\1\u00ee\1\u00ef\1\uffff\1\65\1\uffff\1\u00f1\1\uffff\1\u00f2\1\65\1\u00f5\2\65\1\uffff\1\65\1\u00f9\1\u00fa\1\uffff\1\u00ea\2\65\1\u00fd\2\65\3\uffff\1\65\2\uffff\2\65\2\uffff\1\65\2\uffff\2\65\1\uffff\1\65\1\u0107\1\65\2\uffff\1\u0109\1\u010a\1\uffff\1\65\1\u010c\1\u010d\1\65\1\u010f\1\u0110\2\65\1\u0113\1\uffff\1\65\2\uffff\1\65\2\uffff\1\65\2\uffff\1\u0117\1\65\1\uffff\1\u0119\1\u011a\1\65\1\uffff\1\u011c\2\uffff\1\65\1\uffff\1\u011e\1\uffff";
    ...
    static final String DFA24_acceptS =
