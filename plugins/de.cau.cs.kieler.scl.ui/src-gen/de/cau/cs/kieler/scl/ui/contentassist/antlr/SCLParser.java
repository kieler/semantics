	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getSCLProgramAccess().getAlternatives_4_1(), "rule__SCLProgram__Alternatives_4_1");
					...
					put(grammarAccess.getSCLProgramAccess().getGroup_4(), "rule__SCLProgram__Group_4__0");
					put(grammarAccess.getSCLProgramAccess().getGroup_4_1_0(), "rule__SCLProgram__Group_4_1_0__0");
					...
					put(grammarAccess.getSCLProgramAccess().getDeclarationsAssignment_4_0(), "rule__SCLProgram__DeclarationsAssignment_4_0");
					put(grammarAccess.getSCLProgramAccess().getStatementsAssignment_4_1_0_0(), "rule__SCLProgram__StatementsAssignment_4_1_0_0");
					put(grammarAccess.getSCLProgramAccess().getStatementsAssignment_4_1_1(), "rule__SCLProgram__StatementsAssignment_4_1_1");
					put(grammarAccess.getSCLProgramAccess().getStatementsAssignment_4_2(), "rule__SCLProgram__StatementsAssignment_4_2");
