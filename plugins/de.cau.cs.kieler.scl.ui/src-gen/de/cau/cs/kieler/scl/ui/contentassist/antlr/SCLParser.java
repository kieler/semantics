	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getProgramAccess().getAlternatives_4_0(), "rule__Program__Alternatives_4_0");
					...
					put(grammarAccess.getConditionalAccess().getAlternatives_3_0(), "rule__Conditional__Alternatives_3_0");
					put(grammarAccess.getConditionalAccess().getAlternatives_4_2_0(), "rule__Conditional__Alternatives_4_2_0");
					...
					put(grammarAccess.getConditionalAccess().getGroup_3_0_0(), "rule__Conditional__Group_3_0_0__0");
					put(grammarAccess.getConditionalAccess().getGroup_3_1(), "rule__Conditional__Group_3_1__0");
					put(grammarAccess.getConditionalAccess().getGroup_4(), "rule__Conditional__Group_4__0");
					put(grammarAccess.getConditionalAccess().getGroup_4_2(), "rule__Conditional__Group_4_2__0");
					put(grammarAccess.getConditionalAccess().getGroup_4_2_0_0(), "rule__Conditional__Group_4_2_0_0__0");
					put(grammarAccess.getConditionalAccess().getGroup_4_2_1(), "rule__Conditional__Group_4_2_1__0");
					...
					put(grammarAccess.getProgramAccess().getValuedObjectsAssignment_2(), "rule__Program__ValuedObjectsAssignment_2");
					...
					put(grammarAccess.getConditionalAccess().getValuedObjectsAssignment_2(), "rule__Conditional__ValuedObjectsAssignment_2");
					put(grammarAccess.getConditionalAccess().getStatementsAssignment_3_0_0_0(), "rule__Conditional__StatementsAssignment_3_0_0_0");
					put(grammarAccess.getConditionalAccess().getStatementsAssignment_3_0_1(), "rule__Conditional__StatementsAssignment_3_0_1");
					put(grammarAccess.getConditionalAccess().getStatementsAssignment_3_1_0(), "rule__Conditional__StatementsAssignment_3_1_0");
					put(grammarAccess.getConditionalAccess().getStatementsAssignment_3_1_1(), "rule__Conditional__StatementsAssignment_3_1_1");
					put(grammarAccess.getConditionalAccess().getValuedObjectsAssignment_4_1(), "rule__Conditional__ValuedObjectsAssignment_4_1");
					put(grammarAccess.getConditionalAccess().getElseStatementsAssignment_4_2_0_0_0(), "rule__Conditional__ElseStatementsAssignment_4_2_0_0_0");
					put(grammarAccess.getConditionalAccess().getElseStatementsAssignment_4_2_0_1(), "rule__Conditional__ElseStatementsAssignment_4_2_0_1");
					put(grammarAccess.getConditionalAccess().getElseStatementsAssignment_4_2_1_0(), "rule__Conditional__ElseStatementsAssignment_4_2_1_0");
					put(grammarAccess.getConditionalAccess().getElseStatementsAssignment_4_2_1_1(), "rule__Conditional__ElseStatementsAssignment_4_2_1_1");
