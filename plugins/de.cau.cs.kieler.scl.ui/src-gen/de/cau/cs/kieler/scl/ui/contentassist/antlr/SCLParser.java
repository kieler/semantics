		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getConditionalAccess().getAlternatives_4_1_0(), "rule__Conditional__Alternatives_4_1_0");
					...
					put(grammarAccess.getConditionalAccess().getGroup_4_1_0_0(), "rule__Conditional__Group_4_1_0_0__0");
					put(grammarAccess.getConditionalAccess().getGroup_4_1_1(), "rule__Conditional__Group_4_1_1__0");
					...
					put(grammarAccess.getConditionalAccess().getElseStatementsAssignment_4_1_0_0_0(), "rule__Conditional__ElseStatementsAssignment_4_1_0_0_0");
					put(grammarAccess.getConditionalAccess().getElseStatementsAssignment_4_1_0_1(), "rule__Conditional__ElseStatementsAssignment_4_1_0_1");
					put(grammarAccess.getConditionalAccess().getElseStatementsAssignment_4_1_1_0(), "rule__Conditional__ElseStatementsAssignment_4_1_1_0");
					put(grammarAccess.getConditionalAccess().getElseStatementsAssignment_4_1_1_1(), "rule__Conditional__ElseStatementsAssignment_4_1_1_1");
