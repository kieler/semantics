		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDeclarationAccess().getGroup_5_0_3(), "rule__Declaration__Group_5_0_3__0");
					put(grammarAccess.getDeclarationAccess().getGroup_5_1(), "rule__Declaration__Group_5_1__0");
					put(grammarAccess.getDeclarationAccess().getGroup_5_1_2(), "rule__Declaration__Group_5_1_2__0");
					...
					put(grammarAccess.getDeclarationAccess().getSignalAssignment_4(), "rule__Declaration__SignalAssignment_4");
					put(grammarAccess.getDeclarationAccess().getTypeAssignment_5_0_0(), "rule__Declaration__TypeAssignment_5_0_0");
					put(grammarAccess.getDeclarationAccess().getHostTypeAssignment_5_0_1(), "rule__Declaration__HostTypeAssignment_5_0_1");
					put(grammarAccess.getDeclarationAccess().getValuedObjectsAssignment_5_0_2(), "rule__Declaration__ValuedObjectsAssignment_5_0_2");
					put(grammarAccess.getDeclarationAccess().getValuedObjectsAssignment_5_0_3_1(), "rule__Declaration__ValuedObjectsAssignment_5_0_3_1");
					put(grammarAccess.getDeclarationAccess().getTypeAssignment_5_1_0(), "rule__Declaration__TypeAssignment_5_1_0");
					put(grammarAccess.getDeclarationAccess().getValuedObjectsAssignment_5_1_1(), "rule__Declaration__ValuedObjectsAssignment_5_1_1");
					put(grammarAccess.getDeclarationAccess().getValuedObjectsAssignment_5_1_2_1(), "rule__Declaration__ValuedObjectsAssignment_5_1_2_1");
