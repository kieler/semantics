...
import de.cau.cs.kieler.sccharts.klighd.srtg.synthesis.SRTGStateSynthesis
 ...
 */
@ViewSynthesisShared
class SRTGControlflowRegionSynthesis extends SubSynthesis<SRTGSynthesis, ControlflowRegion, KNode> {
