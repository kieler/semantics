...
import de.cau.cs.kieler.sccharts.klighd.synthesis.hooks.actions.CollapseAllRegionsAction
import de.cau.cs.kieler.sccharts.klighd.synthesis.hooks.actions.ExpandAllRegionsAction
