 ...
 */
@ViewSynthesisShared
class KPortExtensionsReplacement {
    ...
    create it: try {
            ...
            this.class.getDeclaredField("_createCache_internalCreatePort").get(this)
                as Map<List<?>, KPort>
        } catch (Throwable t) {
            emptyMap()
        } getInternalPortMap() {
     ...
     */
    def boolean portExists(Object o1) {
        getInternalPortMap().containsKey(newArrayList(newArrayList(o1)))
    }

    /**
     * A convenient test method to check whether or not a specific port exists in the create extension
     */
    def boolean portExists(Object o1, Object o2) {
        getInternalPortMap().containsKey(newArrayList(newArrayList(o1, o2)))
    }

    /**
     * A convenient test method to check whether or not a specific port exists in the create extension
     */
    def boolean portExists(Object o1, Object o2, Object o3) {
        getInternalPortMap().containsKey(newArrayList(newArrayList(o1, o2, o3)))
    }

    /**
     * A convenient test method to check whether or not a specific port exists in the create extension
     */
    def boolean portExists(Object o1, Object o2, Object o3, Object o4) {
        getInternalPortMap().containsKey(newArrayList(newArrayList(o1, o2, o3, o4)))
    }    
