...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.synccharts.Region} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegionItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Region_id_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Region_id_feature", "_UI_Region_type"),
                 SyncchartsPackage.Literals.REGION__ID,
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SyncchartsPackage.Literals.REGION__VARIABLES);
            childrenFeatures.add(SyncchartsPackage.Literals.REGION__SIGNALS);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (SyncchartsPackage.Literals.REGION__VARIABLES,
                 SyncchartsFactory.eINSTANCE.createVariable()));

        newChildDescriptors.add
            (createChildParameter
                (SyncchartsPackage.Literals.REGION__SIGNALS,
