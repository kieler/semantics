 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.core.kexpressions.Variable#isConst <em>Const</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.core.kexpressions.KExpressionsPackage#getVariable()
 * @model
 * @generated
 */
public interface Variable extends ValuedObject {
     ...
     * @see de.cau.cs.kieler.core.kexpressions.KExpressionsPackage#getVariable_Const()
     * @model required="true"
     * @generated
     */
    boolean isConst();
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.core.kexpressions.Variable#isConst <em>Const</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
