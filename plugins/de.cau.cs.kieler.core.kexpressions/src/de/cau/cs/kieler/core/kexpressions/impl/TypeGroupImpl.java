 ...
 *   <li>{@link de.cau.cs.kieler.core.kexpressions.impl.TypeGroupImpl#isConst <em>Const</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeGroupImpl extends AnnotatableImpl implements TypeGroup {
    ...
    public void setConst(boolean newConst) {
        ...
        const_ = newConst;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KExpressionsPackage.TYPE_GROUP__CONST, oldConst, const_));
    }
