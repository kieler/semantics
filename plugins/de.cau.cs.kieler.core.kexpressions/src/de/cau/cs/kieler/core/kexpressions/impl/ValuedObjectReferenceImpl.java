 ...
 *   <li>{@link de.cau.cs.kieler.core.kexpressions.impl.ValuedObjectReferenceImpl#getIndexExpressions <em>Index Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValuedObjectReferenceImpl extends ExpressionImpl implements ValuedObjectReference {
    ...
    public EList<Expression> getIndexExpressions() {
        if (indexExpressions == null) {
            indexExpressions = new EObjectContainmentEList<Expression>(Expression.class, this, KExpressionsPackage.VALUED_OBJECT_REFERENCE__INDEX_EXPRESSIONS);
        }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case KExpressionsPackage.VALUED_OBJECT_REFERENCE__INDEX_EXPRESSIONS:
