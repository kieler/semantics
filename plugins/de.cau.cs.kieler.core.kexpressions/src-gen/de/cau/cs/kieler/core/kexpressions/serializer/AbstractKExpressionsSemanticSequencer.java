...
public abstract class AbstractKExpressionsSemanticSequencer extends AnnotationsSemanticSequencer {
		...
		if(semanticObject.eClass().getEPackage() == AnnotationsPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case KExpressionsPackage.OPERATOR_EXPRESSION:
				if(context == grammarAccess.getAddExpressionRule() ||
				   ...
				   context == grammarAccess.getSubExpressionAccess().getOperatorExpressionSubExpressionsAction_1_0() ||
				   context == grammarAccess.getValuedExpressionRule()) {
					sequence_AddExpression_DivExpression_Expression_ModExpression_MultExpression_NegExpression_OrAndExpression_SubExpression_ValuedObjectTestExpression(context, (OperatorExpression) semanticObject); 
					return; 
				}
				else if(context == grammarAccess.getCompareOperationAccess().getOperatorExpressionSubExpressionsAction_0_1_0() ||
				   context == grammarAccess.getNotOrValuedExpressionRule()) {
					sequence_AddExpression_DivExpression_ModExpression_MultExpression_NegExpression_NotExpression_NotOrValuedExpression_OrAndExpression_SubExpression_ValuedObjectTestExpression(context, (OperatorExpression) semanticObject); 
					return; 
				}
				else if(context == grammarAccess.getAtomicExpressionRule()) {
					sequence_AtomicExpression_OrAndExpression_ValuedObjectTestExpression(context, (OperatorExpression) semanticObject); 
					return; 
				}
				else if(context == grammarAccess.getCompareOperationRule()) {
				...
				else if(context == grammarAccess.getNotExpressionRule()) {
					sequence_NotExpression_OrAndExpression_ValuedObjectTestExpression(context, (OperatorExpression) semanticObject); 
					return; 
				}
				else if(context == grammarAccess.getBoolExpressionRule() ||
				   context == grammarAccess.getOrAndExpressionRule()) {
					sequence_OrAndExpression(context, (OperatorExpression) semanticObject); 
					return; 
				}
	 ...
	 * Constraint:
	 *     (
	 *         (subExpressions+=CompareOperation ((operator=AndOperator | operator=OrOperator) subExpressions+=CompareOperation)*) | 
	 ...
	 *     )
	 */
	protected void sequence_AddExpression_DivExpression_Expression_ModExpression_MultExpression_NegExpression_OrAndExpression_SubExpression_ValuedObjectTestExpression(EObject context, OperatorExpression semanticObject) {
	 ...
	 *     )
	 */
	protected void sequence_AddExpression_DivExpression_ModExpression_MultExpression_NegExpression_NotExpression_NotOrValuedExpression_OrAndExpression_SubExpression_ValuedObjectTestExpression(EObject context, OperatorExpression semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     )
	 */
	protected void sequence_AtomicExpression_OrAndExpression_ValuedObjectTestExpression(EObject context, OperatorExpression semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     )
	 */
	protected void sequence_NotExpression_OrAndExpression_ValuedObjectTestExpression(EObject context, OperatorExpression semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     (subExpressions+=CompareOperation ((operator=AndOperator | operator=OrOperator) subExpressions+=CompareOperation)*)
	 */
	protected void sequence_OrAndExpression(EObject context, OperatorExpression semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
