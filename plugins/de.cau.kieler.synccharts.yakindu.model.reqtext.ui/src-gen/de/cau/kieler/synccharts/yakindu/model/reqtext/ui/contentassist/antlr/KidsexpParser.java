...
* generated by Xtext
*/
package de.cau.kieler.synccharts.yakindu.model.reqtext.ui.contentassist.antlr;
...
public class KidsexpParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.cau.kieler.synccharts.yakindu.model.reqtext.ui.contentassist.antlr.internal.InternalKidsexpParser createParser() {
		de.cau.kieler.synccharts.yakindu.model.reqtext.ui.contentassist.antlr.internal.InternalKidsexpParser result = new de.cau.kieler.synccharts.yakindu.model.reqtext.ui.contentassist.antlr.internal.InternalKidsexpParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMyTriggerAccess().getGroup(), "rule__MyTrigger__Group__0");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.cau.kieler.synccharts.yakindu.model.reqtext.ui.contentassist.antlr.internal.InternalKidsexpParser typedParser = (de.cau.kieler.synccharts.yakindu.model.reqtext.ui.contentassist.antlr.internal.InternalKidsexpParser) parser;
