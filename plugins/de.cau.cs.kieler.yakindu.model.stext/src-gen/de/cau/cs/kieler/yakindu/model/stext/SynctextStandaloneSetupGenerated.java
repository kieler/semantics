...
public class SynctextStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new de.cau.cs.kieler.yakindu.model.stext.SynctextRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://kieler.cs.cau.de/yakindu/stext/")) {
		EPackage.Registry.INSTANCE.put("http://kieler.cs.cau.de/yakindu/stext/", de.cau.cs.kieler.yakindu.model.stext.synctext.SynctextPackage.eINSTANCE);
	}
