 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.yakindu.model.stext.synctext.impl.VariableDefinitionImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.model.stext.synctext.impl.VariableDefinitionImpl#getOwningType <em>Owning Type</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.model.stext.synctext.impl.VariableDefinitionImpl#isReadonly <em>Readonly</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.model.stext.synctext.impl.VariableDefinitionImpl#isExternal <em>External</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.model.stext.synctext.impl.VariableDefinitionImpl#getInitialValue <em>Initial Value</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.model.stext.synctext.impl.VariableDefinitionImpl#isIsInput <em>Is Input</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.model.stext.synctext.impl.VariableDefinitionImpl#isIsOutput <em>Is Output</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.model.stext.synctext.impl.VariableDefinitionImpl#isIsStatic <em>Is Static</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.model.stext.synctext.impl.VariableDefinitionImpl#getVarCombineOperator <em>Var Combine Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
