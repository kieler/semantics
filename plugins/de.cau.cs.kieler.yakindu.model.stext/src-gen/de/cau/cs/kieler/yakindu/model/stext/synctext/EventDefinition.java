 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.yakindu.model.stext.synctext.EventDefinition#isIsInput <em>Is Input</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.model.stext.synctext.EventDefinition#isIsOutput <em>Is Output</em>}</li>
...
public interface EventDefinition extends SignalDefinition
{
   ...
   * @see de.cau.cs.kieler.yakindu.model.stext.synctext.SynctextPackage#getEventDefinition_IsInput()
   * @model
   * @generated
   */
  boolean isIsInput();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.yakindu.model.stext.synctext.EventDefinition#isIsInput <em>Is Input</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.yakindu.model.stext.synctext.SynctextPackage#getEventDefinition_IsOutput()
   * @model
   * @generated
   */
  boolean isIsOutput();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.yakindu.model.stext.synctext.EventDefinition#isIsOutput <em>Is Output</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
