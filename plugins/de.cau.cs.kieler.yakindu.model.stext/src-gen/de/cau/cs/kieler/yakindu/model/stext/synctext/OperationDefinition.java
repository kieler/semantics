 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.yakindu.model.stext.synctext.OperationDefinition#getFunctionType <em>Function Type</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.model.stext.synctext.OperationDefinition#getParamType <em>Param Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.yakindu.model.stext.synctext.SynctextPackage#getOperationDefinition()
 * @model
 * @generated
 */
public interface OperationDefinition extends org.yakindu.sct.model.stext.stext.OperationDefinition
{
   ...
   * @see de.cau.cs.kieler.yakindu.model.stext.synctext.SynctextPackage#getOperationDefinition_FunctionType()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.yakindu.model.stext.synctext.OperationDefinition#getFunctionType <em>Function Type</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.yakindu.model.stext.synctext.SynctextPackage#getOperationDefinition_ParamType()
   * @model
   * @generated
   */
  Type getParamType();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.yakindu.model.stext.synctext.OperationDefinition#getParamType <em>Param Type</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
