package de.cau.cs.kieler.yakindu.model.stext.serializer;
...
public abstract class AbstractSynctextSemanticSequencer extends STextSemanticSequencer {
		...
		if(semanticObject.eClass().getEPackage() == StextPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case SynctextPackage.ENTRY:
				if(context == grammarAccess.getEntryRule() ||
				   context == grammarAccess.getStateReactionRule()) {
			...
			case SynctextPackage.EVENT_DEFINITION:
				if(context == grammarAccess.getSignalDeclarationRule() ||
				   context == grammarAccess.getSignalDefinitionRule()) {
					sequence_SignalDefinition(context, (de.cau.cs.kieler.yakindu.model.stext.synctext.EventDefinition) semanticObject); 
					return; 
				}
				else break;
			...
			case SynctextPackage.INSIDE:
				if(context == grammarAccess.getInsideRule() ||
				   context == grammarAccess.getStateReactionRule()) {
			...
			case SynctextPackage.SUSPEND_EFFECT:
				if(context == grammarAccess.getSuspendEffectRule()) {
					sequence_SuspendEffect(context, (SuspendEffect) semanticObject); 
					return; 
				}
				else break;
	...
	/**
	 * Constraint:
	 *     (value=FeatureCall | value=PreReferenceExpression | value=FeatureCall | value=EventValueReferenceExpression | value=PreReferenceExpression)
	 */
	protected void sequence_EventValueReferenceExpression_PreReferenceExpression_PrimaryExpression(EObject context, EventValueReferenceExpression semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     {Inside}
	 */
	protected void sequence_Inside(EObject context, Inside semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (stateReaction=StateReaction reactionTrigger=ReactionTrigger?)
	 */
	...
	/**
	 * Constraint:
	 *     ((trigger=LocalReactionTrigger | trigger=ReactionTrigger)? (effect=ReactionEffect | effect=SuspendEffect))
	 */
	protected void sequence_LocalReaction(EObject context, LocalReaction semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (value=FeatureCall | value=EventValueReferenceExpression | value=PreReferenceExpression)
	 */
	protected void sequence_PreReferenceExpression(EObject context, EventValueReferenceExpression semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     value=FeatureCall
	 */
	protected void sequence_PreValueExpression(EObject context, PreValueExpression semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, SynctextPackage.Literals.PRE_VALUE_EXPRESSION__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SynctextPackage.Literals.PRE_VALUE_EXPRESSION__VALUE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getPreValueExpressionAccess().getValueFeatureCallParserRuleCall_3_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_SignalDefinition(EObject context, de.cau.cs.kieler.yakindu.model.stext.synctext.EventDefinition semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     ((declarations+=VariableDeclaration | declarations+=SignalDeclaration | declarations+=OperationDeclaration | declarations+=LocalReaction)*)
	 */
	 ...
	 *     {SuspendEffect}
	 */
	protected void sequence_SuspendEffect(EObject context, SuspendEffect semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
