 ...
 * <ul>
 *   <li>{@link ecore.impl.EEnumLiteralImpl#getValue <em>Value</em>}</li>
 *   <li>{@link ecore.impl.EEnumLiteralImpl#getInstance <em>Instance</em>}</li>
 *   <li>{@link ecore.impl.EEnumLiteralImpl#getLiteral <em>Literal</em>}</li>
 *   <li>{@link ecore.impl.EEnumLiteralImpl#getEEnum <em>EEnum</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EEnumLiteralImpl extends ENamedElementImpl implements EEnumLiteral {
    ...
    public EEnum getEEnum() {
        if (eContainerFeatureID() != EcorePackage.EENUM_LITERAL__EENUM) return null;
