...
public class SendSignalActionImpl extends InvocationActionImpl implements SendSignalAction {
    ...
    public NotificationChain basicSetTarget(InputPin newTarget, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmlPackage.SEND_SIGNAL_ACTION__TARGET, oldTarget, newTarget);
    ...
    public void setTarget(InputPin newTarget) {
        if (newTarget != target) {
            ...
            if (target != null)
                msgs = ((InternalEObject)target).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmlPackage.SEND_SIGNAL_ACTION__TARGET, null, msgs);
            if (newTarget != null)
                msgs = ((InternalEObject)newTarget).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmlPackage.SEND_SIGNAL_ACTION__TARGET, null, msgs);
            msgs = basicSetTarget(newTarget, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.SEND_SIGNAL_ACTION__TARGET, newTarget, newTarget));
    }
    ...
    public Signal getSignal() {
        if (signal != null && signal.eIsProxy()) {
            ...
            if (signal != oldSignal) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlPackage.SEND_SIGNAL_ACTION__SIGNAL, oldSignal, signal));
            }
        }
        return signal;
    }
    ...
    public void setSignal(Signal newSignal) {
        ...
        signal = newSignal;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.SEND_SIGNAL_ACTION__SIGNAL, oldSignal, signal));
    }
