...
public class ModelImpl extends PackageImpl implements Model {
    ...
    public void setViewpoint(String newViewpoint) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.MODEL__VIEWPOINT, oldViewpoint, viewpoint, !oldViewpointESet));
    }
    ...
    public void unsetViewpoint() {
        ...
        viewpointESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, UmlPackage.MODEL__VIEWPOINT, oldViewpoint, VIEWPOINT_EDEFAULT, oldViewpointESet));
    }
