 ...
 * <ul>
 *   <li>{@link uml.impl.ClearStructuralFeatureActionImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClearStructuralFeatureActionImpl extends StructuralFeatureActionImpl implements ClearStructuralFeatureAction {
    ...
    public NotificationChain basicSetResult(OutputPin newResult, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmlPackage.CLEAR_STRUCTURAL_FEATURE_ACTION__RESULT, oldResult, newResult);
    ...
    public void setResult(OutputPin newResult) {
        if (newResult != result) {
            ...
            if (result != null)
                msgs = ((InternalEObject)result).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmlPackage.CLEAR_STRUCTURAL_FEATURE_ACTION__RESULT, null, msgs);
            if (newResult != null)
                msgs = ((InternalEObject)newResult).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmlPackage.CLEAR_STRUCTURAL_FEATURE_ACTION__RESULT, null, msgs);
            msgs = basicSetResult(newResult, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.CLEAR_STRUCTURAL_FEATURE_ACTION__RESULT, newResult, newResult));
    }
