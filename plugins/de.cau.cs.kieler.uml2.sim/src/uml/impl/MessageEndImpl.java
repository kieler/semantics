...
public abstract class MessageEndImpl extends NamedElementImpl implements MessageEnd {
        ...
        if (message != null && message.eIsProxy()) {
            ...
            if (message != oldMessage) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlPackage.MESSAGE_END__MESSAGE, oldMessage, message));
            }
        }
        return message;
    }
    ...
    public void setMessage(Message newMessage) {
        ...
        message = newMessage;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.MESSAGE_END__MESSAGE, oldMessage, message));
    }
