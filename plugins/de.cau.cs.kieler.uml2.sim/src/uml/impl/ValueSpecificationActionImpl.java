 ...
 * <ul>
 *   <li>{@link uml.impl.ValueSpecificationActionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link uml.impl.ValueSpecificationActionImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValueSpecificationActionImpl extends ActionImpl implements ValueSpecificationAction {
    ...
    public NotificationChain basicSetValue(ValueSpecification newValue, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmlPackage.VALUE_SPECIFICATION_ACTION__VALUE, oldValue, newValue);
    ...
    public void setValue(ValueSpecification newValue) {
        if (newValue != value) {
            ...
            if (value != null)
                msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmlPackage.VALUE_SPECIFICATION_ACTION__VALUE, null, msgs);
            if (newValue != null)
                msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmlPackage.VALUE_SPECIFICATION_ACTION__VALUE, null, msgs);
            msgs = basicSetValue(newValue, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.VALUE_SPECIFICATION_ACTION__VALUE, newValue, newValue));
    }
    ...
    public NotificationChain basicSetResult(OutputPin newResult, NotificationChain msgs) {
        ...
        result = newResult;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmlPackage.VALUE_SPECIFICATION_ACTION__RESULT, oldResult, newResult);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setResult(OutputPin newResult) {
        if (newResult != result) {
            NotificationChain msgs = null;
            if (result != null)
                msgs = ((InternalEObject)result).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmlPackage.VALUE_SPECIFICATION_ACTION__RESULT, null, msgs);
            if (newResult != null)
                msgs = ((InternalEObject)newResult).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmlPackage.VALUE_SPECIFICATION_ACTION__RESULT, null, msgs);
            msgs = basicSetResult(newResult, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.VALUE_SPECIFICATION_ACTION__RESULT, newResult, newResult));
    }
