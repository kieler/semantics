...
public class Pre extends Expression {
    ...
    /**
     * @param name unique name of the expression
     * @param e expression which previous value is computed
     */
...
//    }
	...
	if(e instanceof VarAccess){
	   ...
	   return new de.cau.cs.kieler.krep.compiler.ceq.Equation(name, new de.cau.cs.kieler.krep.compiler.ceq.VarAccess(de.cau.cs.kieler.krep.compiler.ceq.Variable.get(v.getName()), true));
	}else{
