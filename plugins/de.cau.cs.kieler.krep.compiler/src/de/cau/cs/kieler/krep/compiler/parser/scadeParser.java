...
public class scadeParser extends Parser {
    ...
    public String getGrammarFileName() { return "scade.g"; }
    ...
    // scade.g:59:1: var_decls returns [LinkedList<String> vars, Type type] : v= var_id ( ',' v= var_id )* ':' t= type_expr ( when_decl )? ( default_decl )? ( last_decl )? ;
    public final scadeParser.var_decls_return var_decls() throws RecognitionException {
        ...
        try {
            // scade.g:60:5: (v= var_id ( ',' v= var_id )* ':' t= type_expr ( when_decl )? ( default_decl )? ( last_decl )? )
            // scade.g:60:7: v= var_id ( ',' v= var_id )* ':' t= type_expr ( when_decl )? ( default_decl )? ( last_decl )?
            {
    ...
    // scade.g:77:1: user_op_decl : 'node' id= ID in= params[Kind.INPUT] 'returns' out= params[Kind.OUTPUT] opt_body[main] ;
    public final void user_op_decl() throws RecognitionException {
        ...
        try {
            // scade.g:78:5: ( 'node' id= ID in= params[Kind.INPUT] 'returns' out= params[Kind.OUTPUT] opt_body[main] )
            // scade.g:78:7: 'node' id= ID in= params[Kind.INPUT] 'returns' out= params[Kind.OUTPUT] opt_body[main]
            {
    ...
    // $ANTLR start "params"
    // scade.g:85:1: params[Kind io] returns [LinkedList<Variable> vars] : '(' (v= var_decls ( ';' v= var_decls )* )? ')' ;
    ...
    // scade.g:95:1: opt_body[Scope scope] : ( ';' | equation[scope] ';' | (s= signal_block )? (l= local_block )? 'let' ( equation[scope] ';' )* 'tel' ( ';' )? );
    public final void opt_body(Scope scope) throws RecognitionException {
        ...
        try {
            // scade.g:95:23: ( ';' | equation[scope] ';' | (s= signal_block )? (l= local_block )? 'let' ( equation[scope] ';' )* 'tel' ( ';' )? )
            int alt15=3;
            switch ( input.LA(1) ) {
            case 23:
                {
            ...
            switch (alt15) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // scade.g:97:6: (s= signal_block )? (l= local_block )? 'let' ( equation[scope] ';' )* 'tel' ( ';' )?
                    {
    ...
    // scade.g:127:1: equation[Scope scope] : (eq= simple_equation | em= emission | a= state_machine 'returns' '..' );
    ...
    public final LinkedList<Equation> emission() throws RecognitionException {
        ...
        try {
            ...
            state._fsp--;
                      ...
                      eqs.add(new Equation(s, (e!=null?e.expr:null)==null?new Const("True",1):(e!=null?e.expr:null)));
    ...
    // scade.g:152:1: emission_body returns [LinkedList<String> ids, Expression expr] : ( '\\'' id= ID ( 'if' e= expr )? | '(' '\\'' id= ID ( ',' '\\'' id= ID ) ')' ( 'if' e= expr )? );
    public final scadeParser.emission_body_return emission_body() throws RecognitionException {
        ...
        try {
            // scade.g:154:5: ( '\\'' id= ID ( 'if' e= expr )? | '(' '\\'' id= ID ( ',' '\\'' id= ID ) ')' ( 'if' e= expr )? )
            int alt28=2;
    ...
    // scade.g:166:1: state_decl[Automaton a] : (init= 'initial' )? ( 'final' )? 'state' id= ID ( 'unless' (t= transition[s] ';' )+ )? data_def[s] ( 'until' (t= transition[s] ';' )* ( 'synchro' ( actions[s] )? fork[s] ';' )? )? ;
    public final void state_decl(Automaton a) throws RecognitionException {
        ...
        try {
            // scade.g:167:5: ( (init= 'initial' )? ( 'final' )? 'state' id= ID ( 'unless' (t= transition[s] ';' )+ )? data_def[s] ( 'until' (t= transition[s] ';' )* ( 'synchro' ( actions[s] )? fork[s] ';' )? )? )
            // scade.g:167:7: (init= 'initial' )? ( 'final' )? 'state' id= ID ( 'unless' (t= transition[s] ';' )+ )? data_def[s] ( 'until' (t= transition[s] ';' )* ( 'synchro' ( actions[s] )? fork[s] ';' )? )?
            {
            ...
            // scade.g:171:9: ( 'until' (t= transition[s] ';' )* ( 'synchro' ( actions[s] )? fork[s] ';' )? )?
            int alt37=2;
            ...
            switch (alt37) {
                case 1 :
                    // scade.g:171:10: 'until' (t= transition[s] ';' )* ( 'synchro' ( actions[s] )? fork[s] ';' )?
                    {
    ...
    // scade.g:175:1: transition[Scope scope] returns [Transition trans] : 'if' trigger= expr t= arrow[scope] ;
    ...
    // $ANTLR start "arrow"
    // scade.g:178:1: arrow[Scope scope] returns [String target] : ( actions[scope] )? s= fork[scope] ;
    ...
    // $ANTLR start "fork"
    // scade.g:181:1: fork[Scope scope] returns [String target] : (t= target | 'if' expr arrow[scope] ( elsif_fork[scope] )* ( else_fork[scope] )? 'end' );
    public final String fork(Scope scope) throws RecognitionException {
        ...
        try {
            // scade.g:182:5: (t= target | 'if' expr arrow[scope] ( elsif_fork[scope] )* ( else_fork[scope] )? 'end' )
            int alt41=2;
            ...
            switch (alt41) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // scade.g:183:7: 'if' expr arrow[scope] ( elsif_fork[scope] )* ( else_fork[scope] )? 'end'
                    {
    ...
    // $ANTLR start "actions"
    // scade.g:195:1: actions[Scope scope] : ( 'do' '{' ( 'emit' )? emission_body ( ';' ( 'emit' )? emission_body )* '}' | 'do' data_def[scope] );
    public final void actions(Scope scope) throws RecognitionException {
        try {
            // scade.g:196:5: ( 'do' '{' ( 'emit' )? emission_body ( ';' ( 'emit' )? emission_body )* '}' | 'do' data_def[scope] )
            int alt46=2;
    ...
    // $ANTLR start "bin_op"
    // scade.g:246:1: bin_op returns [Operator op] : ( '+' | '-' | '*' | '/' | 'mod' | 'div' | '=' | '<>' | '<' | '>' | '<=' | '>=' | 'and' | 'or' | 'xor' );
    public final Operator bin_op() throws RecognitionException {
        Operator op = null;

        try {
            // scade.g:247:5: ( '+' | '-' | '*' | '/' | 'mod' | 'div' | '=' | '<>' | '<' | '>' | '<=' | '>=' | 'and' | 'or' | 'xor' )
            int alt53=15;
            switch ( input.LA(1) ) {
            case 51:
                {
