...
public class Mov extends Instruction {
    ...
    /**
     * @param to target register
     * @param from source register
     */
   ...
   /* @Override
	...
	case BOOL:
	    switch(from.getType()){
	    case BOOL: op = Opcode.CCMOV.getCode(); break;
	    case INT: op = Opcode.BOOL.getCode(); break;
	    case REAL: op = -1; break;
	    }
	    break;
	case INT:
	    switch(from.getType()){
	    case BOOL: op = Opcode.INT.getCode(); break;
	    case INT: op = Opcode.VVMOV.getCode(); break;
	    case REAL: op = -1; break;
	    }
	    break;
	case REAL:
