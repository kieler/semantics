...
//     */
//    /*
//     * public void init(//final String name, final LinkedList<Variable> vars, final
//     * LinkedList<Equation> eqs) { for (Variable v : vars) { if (v != null) {
//     * this.vars.put(v.getName(), v); if(v.isOutput()){ outputs.add(v); }else if (v.isInput()){
//     * inputs.add(v); } } } if (eqs == null) { this.eqs = new LinkedList<Equation>(); } else {
//     * HashMap<String, List<Variable>> deps = new HashMap<String, List<Variable>>(); for(Equation
//     * e:eqs){ deps.put(e.getName(), e.getDeps()); } DepGraph d = new DepGraph(deps); // make sure
//     * that outputs are not reordered ListIterator<Variable> i = outputs.listIterator(); Variable o1
//     * = i.next(); while(i.hasNext()){ Variable o2 = i.next(); d.add(o1.getName(), o2.getName());
//     * o1=o2; }
//     * 
//     * List<String> sort = d.sort(); for(String s:sort){ for(Equation e: eqs ){
//     * if(s.equals(e.getName())){ this.eqs.add(e); } } } } }
//     */
//
//    /*
//     * public void flatten(){ LinkedList<Equation> aux = new LinkedList<Equation>();
//     * LinkedList<Variable vs> for(Equation eq:eqs){ Variable vs = aux.addAll(eq.flatten(vars)); }
//     * eqs.addAll(aux); }
//     */
//
...
//
//    /*
//     * public LinkedList<Variable> getOutputs() { return outputs; }
//     */
//
//    /*
//     * public LinkedList<KrpVariable> getInputs() { return inputs; }
//     */
