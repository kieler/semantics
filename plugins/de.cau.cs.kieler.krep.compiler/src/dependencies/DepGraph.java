...
public class DepGraph {
     ...
     * @param eqs equations of the program
     */
     ...
     * @param s source of the dependency
     * @param t target of the dependency
     */
	...
	for (final Node n : nodes.values()) {
	    res += n.getName() 
	    + "[ color = " +  colors[core.get(n.getName())] 
	    + ",  label=\"" + n.getName() + " (" + n.getPrio() + ")\"];\n";
