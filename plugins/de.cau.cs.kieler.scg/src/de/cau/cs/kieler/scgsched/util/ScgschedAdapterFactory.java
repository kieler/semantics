...
public class ScgschedAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ScgschedSwitch<Adapter> modelSwitch =
        new ScgschedSwitch<Adapter>() {
			...
			@Override
			public Adapter caseAlteration(Alteration object) {
				return createAlterationAdapter();
			}
			@Override
			public Adapter caseAssignmentAddition(AssignmentAddition object) {
				return createAssignmentAdditionAdapter();
			}
			@Override
			public Adapter caseConditionalAddition(ConditionalAddition object) {
				return createConditionalAdditionAdapter();
			}
			@Override
	...
	public Adapter createAnalysisAdapter() {
		return null;
				...
				/**
	 * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.scgsched.Alteration <em>Alteration</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	public Adapter createAlterationAdapter() {
		return null;
				...
				/**
	 * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.scgsched.AssignmentAddition <em>Assignment Addition</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	public Adapter createAssignmentAdditionAdapter() {
		return null;
				...
				/**
	 * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.scgsched.ConditionalAddition <em>Conditional Addition</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
