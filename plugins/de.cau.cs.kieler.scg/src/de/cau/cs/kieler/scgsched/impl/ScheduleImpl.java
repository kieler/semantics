 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.scgsched.impl.ScheduleImpl#getSchedulingBlocks <em>Scheduling Blocks</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScheduleImpl extends MinimalEObjectImpl.Container implements Schedule {
    ...
    protected EClass eStaticClass() {
        return ScgschedPackage.Literals.SCHEDULE;
    }
    ...
    public EList<SchedulingBlock> getSchedulingBlocks() {
        if (schedulingBlocks == null) {
            schedulingBlocks = new EObjectResolvingEList<SchedulingBlock>(SchedulingBlock.class, this, ScgschedPackage.SCHEDULE__SCHEDULING_BLOCKS);
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ScgschedPackage.SCHEDULE__SCHEDULING_BLOCKS:
