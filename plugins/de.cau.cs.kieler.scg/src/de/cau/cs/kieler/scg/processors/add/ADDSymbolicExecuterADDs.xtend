...
class ADDSymbolicExecuterADDs extends EndogenousProcessor<SymbolicExecuterWrapper> implements Traceable {
    ...
    override getId() {
        "de.cau.cs.kieler.scg.processors.add.symbolicExecuter.adds"
    }
    ...
    override process() {
        model.stage = SymbolicExecuterStages.ADDS
