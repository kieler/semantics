...
class ADDSymbolicExecuterED extends EndogenousProcessor<SymbolicExecuterWrapper> implements Traceable {
    ...
    override getId() {
        "de.cau.cs.kieler.scg.processors.add.symbolicExecuter.ed"
    }
    ...
    override process() {
        model.stage = SymbolicExecuterStages.ED
        model.expressionDAG = new ExpressionDAG(model.executer)
