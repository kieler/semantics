...
class ThreadSegmentIDs {
    ...
    HashMap<Node, Integer> threadSegmentIDs
    ...
    HashMap<Node, Integer> nodePrios
    /** The overall number of thread segment IDs */
    int nThreadSegmentIDs
     ...
     */
    def int getNumberOfThreadSegmentIDs() {
     ...
     */
    def HashMap<Node, Integer> calcThreadSegmentIDs(List<Node> nodes, HashMap<Node, Integer> nodePrios) {
