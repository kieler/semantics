...
class NodePriorities {
    ...
    HashMap<LinkedList<Node>, Boolean> visited
    HashMap<LinkedList<Node>, Integer> index
    LinkedList<LinkedList<Node>> sccs
    LinkedList<LinkedList<Node>> schizoSccList
    HashMap<Node, Integer> sccMap
    HashMap<Node, Integer> schizoSccMap
    HashMap<Node, Integer> nodePrio
    HashMap<LinkedList<Node>, Integer> min
    HashMap<LinkedList<Node>, Integer> max
