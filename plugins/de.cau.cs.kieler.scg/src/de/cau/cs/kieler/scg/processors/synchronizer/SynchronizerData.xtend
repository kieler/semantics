...
class SynchronizerData {
	...
	def SynchronizerData addAdditionalAssignment(SchedulingBlock schedulingBlock, 
	...
	def List<Pair<ValuedObject, Expression>> getAdditionalAssignments(SchedulingBlock schedulingBlock) {
		additionalAssignments.get(schedulingBlock)
	}
	
	def List<SchedulingBlock> getAdditionalAssignmentBlocks() {
