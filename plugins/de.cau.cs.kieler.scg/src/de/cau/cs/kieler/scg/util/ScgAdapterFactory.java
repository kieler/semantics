...
public class ScgAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ScgSwitch<Adapter> modelSwitch =
        new ScgSwitch<Adapter>() {
            ...
            @Override
            public Adapter caseThenDependency(ThenDependency object) {
                return createThenDependencyAdapter();
            }
            @Override
            public Adapter caseElseDependency(ElseDependency object) {
                return createElseDependencyAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.scg.ConditionalDependency <em>Conditional Dependency</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.scg.ThenDependency <em>Then Dependency</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.scg.ElseDependency <em>Else Dependency</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
