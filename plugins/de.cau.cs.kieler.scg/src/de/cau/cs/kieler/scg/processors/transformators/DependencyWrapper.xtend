...
import de.cau.cs.kieler.scg.transformations.dependencies.DependencyTransformation
 ...
 */
class DependencyWrapper extends TypeSafeProcessor<SCGraph, SCGraph> {
    ...
    override process() {
        val wrappedTransformation = injector.getInstance(DependencyTransformation)
