...
public class ScgSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case ScgPackage.CONDITIONAL_DEPENDENCY: {
                ...
                if (result == null) result = caseLink(conditionalDependency);
                if (result == null) result = caseAnnotatable(conditionalDependency);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case ScgPackage.THEN_DEPENDENCY: {
                ThenDependency thenDependency = (ThenDependency)theEObject;
                T result = caseThenDependency(thenDependency);
                if (result == null) result = caseConditionalDependency(thenDependency);
                if (result == null) result = caseDependency(thenDependency);
                if (result == null) result = caseLink(thenDependency);
                if (result == null) result = caseAnnotatable(thenDependency);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case ScgPackage.ELSE_DEPENDENCY: {
                ElseDependency elseDependency = (ElseDependency)theEObject;
                T result = caseElseDependency(elseDependency);
                if (result == null) result = caseConditionalDependency(elseDependency);
                if (result == null) result = caseDependency(elseDependency);
                if (result == null) result = caseLink(elseDependency);
                if (result == null) result = caseAnnotatable(elseDependency);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Then Dependency</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Then Dependency</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseThenDependency(ThenDependency object) {
        return null;
    }

    /**
     * Returns the result of interpreting the object as an instance of '<em>Else Dependency</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Else Dependency</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseElseDependency(ElseDependency object) {
        return null;
    }
