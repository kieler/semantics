...
public class DependencyImpl extends LinkImpl implements Dependency {
    ...
    public void setConcurrent(boolean newConcurrent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScgPackage.DEPENDENCY__CONCURRENT, oldConcurrent, concurrent));
	}
    ...
    public void setConfluent(boolean newConfluent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScgPackage.DEPENDENCY__CONFLUENT, oldConfluent, confluent));
	}
