...
public interface ScgPackage extends EPackage {
    ...
    /**
     * The meta object id for the '{@link de.cau.cs.kieler.scg.impl.ConditionalDependencyImpl <em>Conditional Dependency</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.cau.cs.kieler.scg.impl.ConditionalDependencyImpl
     * @see de.cau.cs.kieler.scg.impl.ScgPackageImpl#getConditionalDependency()
     * @generated
     */
    int CONDITIONAL_DEPENDENCY = 13;
     ...
     * @ordered
     */
    int CONDITIONAL_DEPENDENCY__TARGET = DEPENDENCY__TARGET;
     ...
     * @ordered
     */
    int CONDITIONAL_DEPENDENCY_FEATURE_COUNT = DEPENDENCY_FEATURE_COUNT + 0;

    /**
     * The meta object id for the '{@link de.cau.cs.kieler.scg.impl.ThenDependencyImpl <em>Then Dependency</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.cau.cs.kieler.scg.impl.ThenDependencyImpl
     * @see de.cau.cs.kieler.scg.impl.ScgPackageImpl#getThenDependency()
     * @generated
     */
    int THEN_DEPENDENCY = 14;
     ...
     * @ordered
     */
    int THEN_DEPENDENCY__ANNOTATIONS = CONDITIONAL_DEPENDENCY__ANNOTATIONS;
     ...
     * @ordered
     */
    int THEN_DEPENDENCY__TARGET = CONDITIONAL_DEPENDENCY__TARGET;

    /**
     * The number of structural features of the '<em>Then Dependency</em>' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     * @ordered
     */
    int THEN_DEPENDENCY_FEATURE_COUNT = CONDITIONAL_DEPENDENCY_FEATURE_COUNT + 0;

    /**
     * The meta object id for the '{@link de.cau.cs.kieler.scg.impl.ElseDependencyImpl <em>Else Dependency</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.cau.cs.kieler.scg.impl.ElseDependencyImpl
     * @see de.cau.cs.kieler.scg.impl.ScgPackageImpl#getElseDependency()
     * @generated
     */
    int ELSE_DEPENDENCY = 15;
     ...
     * @ordered
     */
    int ELSE_DEPENDENCY__ANNOTATIONS = CONDITIONAL_DEPENDENCY__ANNOTATIONS;
     ...
     * @ordered
     */
    int ELSE_DEPENDENCY__TARGET = CONDITIONAL_DEPENDENCY__TARGET;

    /**
     * The number of structural features of the '<em>Else Dependency</em>' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     * @ordered
     */
    int ELSE_DEPENDENCY_FEATURE_COUNT = CONDITIONAL_DEPENDENCY_FEATURE_COUNT + 0;
     ...
     * @generated
     */
	int ABSOLUTE_WRITE_RELATIVE_WRITE = 20;
    ...
    /**
     * Returns the meta object for class '{@link de.cau.cs.kieler.scg.ConditionalDependency <em>Conditional Dependency</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for class '<em>Conditional Dependency</em>'.
     * @see de.cau.cs.kieler.scg.ConditionalDependency
     * @generated
     */
    EClass getConditionalDependency();

    /**
     * Returns the meta object for class '{@link de.cau.cs.kieler.scg.ThenDependency <em>Then Dependency</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for class '<em>Then Dependency</em>'.
     * @see de.cau.cs.kieler.scg.ThenDependency
     * @generated
     */
    EClass getThenDependency();

    /**
     * Returns the meta object for class '{@link de.cau.cs.kieler.scg.ElseDependency <em>Else Dependency</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for class '<em>Else Dependency</em>'.
     * @see de.cau.cs.kieler.scg.ElseDependency
     * @generated
     */
    EClass getElseDependency();
	...
	/**
     * Returns the meta object for the attribute '{@link de.cau.cs.kieler.scg.Guard#isDead <em>Dead</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the attribute '<em>Dead</em>'.
     * @see de.cau.cs.kieler.scg.Guard#isDead()
     * @see #getGuard()
     * @generated
     */
	...
	interface Literals {
        ...
        /**
         * The meta object literal for the '{@link de.cau.cs.kieler.scg.impl.ConditionalDependencyImpl <em>Conditional Dependency</em>}' class.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @see de.cau.cs.kieler.scg.impl.ConditionalDependencyImpl
         * @see de.cau.cs.kieler.scg.impl.ScgPackageImpl#getConditionalDependency()
        ...
        /**
         * The meta object literal for the '{@link de.cau.cs.kieler.scg.impl.ThenDependencyImpl <em>Then Dependency</em>}' class.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @see de.cau.cs.kieler.scg.impl.ThenDependencyImpl
         * @see de.cau.cs.kieler.scg.impl.ScgPackageImpl#getThenDependency()
         * @generated
         */
        EClass THEN_DEPENDENCY = eINSTANCE.getThenDependency();

        /**
         * The meta object literal for the '{@link de.cau.cs.kieler.scg.impl.ElseDependencyImpl <em>Else Dependency</em>}' class.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @see de.cau.cs.kieler.scg.impl.ElseDependencyImpl
         * @see de.cau.cs.kieler.scg.impl.ScgPackageImpl#getElseDependency()
         * @generated
         */
        EClass ELSE_DEPENDENCY = eINSTANCE.getElseDependency();
