...
public interface ScgPackage extends EPackage {
     ...
     * @ordered
     */
	int CONTROL_DEPENDENCY__ANNOTATIONS = KEffectsPackage.DEPENDENCY__ANNOTATIONS;
     ...
     * @ordered
     */
	int CONTROL_DEPENDENCY_FEATURE_COUNT = KEffectsPackage.DEPENDENCY_FEATURE_COUNT + 0;
