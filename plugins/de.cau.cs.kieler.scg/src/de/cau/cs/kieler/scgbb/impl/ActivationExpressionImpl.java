   ...
   protected EList<BasicBlock> basicBlocks;
	...
	public EList<ActivationExpression> getEmptyExpressions() {
        if (emptyExpressions == null) {
            emptyExpressions = new EObjectContainmentEList<ActivationExpression>(ActivationExpression.class, this, ScgbbPackage.ACTIVATION_EXPRESSION__EMPTY_EXPRESSIONS);
        }
