...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.core.annotations.BooleanAnnotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanAnnotationItemProvider extends AnnotationItemProvider {
    /**
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 AnnotationsPackage.Literals.BOOLEAN_ANNOTATION__VALUE,
                 true,
                 false,
                 false,
    ...
    public String getText(Object object) {
        String label = ((BooleanAnnotation)object).getName();
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(BooleanAnnotation.class)) {
            case AnnotationsPackage.BOOLEAN_ANNOTATION__VALUE:
