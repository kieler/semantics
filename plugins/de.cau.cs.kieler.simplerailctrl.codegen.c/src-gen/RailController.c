...
void* ThreadFunction2(void* port)
{
  int secondcounter = 0;
  int outtransition = 0;
  int state = (int)(HASH("de.cau.cs.kieler.simplerailctrl.impl.SetPointImpl@8a3c71 (initial: true) (point: [POINT_20, POINT_24], direction: BRANCH)"));
  
  if (DEBUGCONTROLLER) printf("Thread 'org.eclipse.internal.xpand2.type.XpandIterator@4876e0' started.\n");
  ...
  while(1) {
      ...
      //all states
      if (state == -1) {}
	  else if (state == ((int)(HASH("de.cau.cs.kieler.simplerailctrl.impl.SetSpeedImpl@1839aa9 (initial: false) (track: [IC_JCT_0, IC_LN_0, IC_LN_1, IC_LN_2, IC_LN_3, IC_LN_4, IC_LN_5, IC_ST_0, IC_ST_3, IC_ST_4], speed: 100, direction: FWD)")))) {
	  		  P(2); // GET THE GLOBALLOCK
              if (DEBUGCONTROLLER) printf("State %d (de.cau.cs.kieler.simplerailctrl.impl.SetSpeedImpl@1839aa9 (initial: false) (track: [IC_JCT_0, IC_LN_0, IC_LN_1, IC_LN_2, IC_LN_3, IC_LN_4, IC_LN_5, IC_ST_0, IC_ST_3, IC_ST_4], speed: 100, direction: FWD)) entered.\n",(int)(HASH("de.cau.cs.kieler.simplerailctrl.impl.SetSpeedImpl@1839aa9 (initial: false) (track: [IC_JCT_0, IC_LN_0, IC_LN_1, IC_LN_2, IC_LN_3, IC_LN_4, IC_LN_5, IC_ST_0, IC_ST_3, IC_ST_4], speed: 100, direction: FWD)")));
		            ...
		            if ((DEBUGCONTROLLER)&&(!(secondcounter%10))) printf("Transition wait (%d seconds).\n",secondcounter/10);
			  		...
			  		if ((getcontact_sync(railway,IC_ST_3,FIRST,1) != 0)) {
	 	                ...
	 	                if (DEBUGCONTROLLER) printf("Event-Transition taken.\n");
			  			state = HASH("de.cau.cs.kieler.simplerailctrl.impl.SetSpeedImpl@10e443f (initial: false) (track: [IC_ST_0, IC_ST_3], speed: 30, direction: FWD)");
			  			break;
			  		}
	  		  		V(2); // RELEASE THE GLOBALLOCK
	  ...
	  else if (state == ((int)(HASH("de.cau.cs.kieler.simplerailctrl.impl.SetPointImpl@8a3c71 (initial: true) (point: [POINT_20, POINT_24], direction: BRANCH)")))) {
	  		  P(2); // GET THE GLOBALLOCK
              if (DEBUGCONTROLLER) printf("State %d (de.cau.cs.kieler.simplerailctrl.impl.SetPointImpl@8a3c71 (initial: true) (point: [POINT_20, POINT_24], direction: BRANCH)) entered.\n",(int)(HASH("de.cau.cs.kieler.simplerailctrl.impl.SetPointImpl@8a3c71 (initial: true) (point: [POINT_20, POINT_24], direction: BRANCH)")));
		            ...
		            if ((DEBUGCONTROLLER)&&(!(secondcounter%10))) printf("Transition wait (%d seconds).\n",secondcounter/10);
			  		...
			  		if (secondcounter/10 >= 2) {
	 	                ...
	 	                if (DEBUGCONTROLLER) printf("Wait-Transition taken.\n");
			  			state = HASH("de.cau.cs.kieler.simplerailctrl.impl.SetSpeedImpl@1839aa9 (initial: false) (track: [IC_JCT_0, IC_LN_0, IC_LN_1, IC_LN_2, IC_LN_3, IC_LN_4, IC_LN_5, IC_ST_0, IC_ST_3, IC_ST_4], speed: 100, direction: FWD)");
			  			break;
			  		}
	  ...
	  else if (state == ((int)(HASH("de.cau.cs.kieler.simplerailctrl.impl.SetSpeedImpl@10e443f (initial: false) (track: [IC_ST_0, IC_ST_3], speed: 30, direction: FWD)")))) {
	  		  P(2); // GET THE GLOBALLOCK
              if (DEBUGCONTROLLER) printf("State %d (de.cau.cs.kieler.simplerailctrl.impl.SetSpeedImpl@10e443f (initial: false) (track: [IC_ST_0, IC_ST_3], speed: 30, direction: FWD)) entered.\n",(int)(HASH("de.cau.cs.kieler.simplerailctrl.impl.SetSpeedImpl@10e443f (initial: false) (track: [IC_ST_0, IC_ST_3], speed: 30, direction: FWD)")));
	          ...
	          while(1) {
		            ...
		            if ((DEBUGCONTROLLER)&&(!(secondcounter%10))) printf("Transition wait (%d seconds).\n",secondcounter/10);
			  		...
			  		if ((getcontact_sync(railway,IC_ST_3,SECOND,1) != 0)) {
			  		    V(2); // RELEASE THE GLOBALLOCK
	 	                if (DEBUGCONTROLLER) printf("Event-Transition taken.\n");
			  			state = HASH("de.cau.cs.kieler.simplerailctrl.impl.SetSpeedImpl@1a287b7 (initial: false) (track: [IC_ST_3], speed: 0, direction: FWD)");
			  			break;
			  		}
	  		  		V(2); // RELEASE THE GLOBALLOCK
	  ...
	  else if (state == ((int)(HASH("de.cau.cs.kieler.simplerailctrl.impl.SetSpeedImpl@1a287b7 (initial: false) (track: [IC_ST_3], speed: 0, direction: FWD)")))) {
	  		  P(2); // GET THE GLOBALLOCK
              if (DEBUGCONTROLLER) printf("State %d (de.cau.cs.kieler.simplerailctrl.impl.SetSpeedImpl@1a287b7 (initial: false) (track: [IC_ST_3], speed: 0, direction: FWD)) entered.\n",(int)(HASH("de.cau.cs.kieler.simplerailctrl.impl.SetSpeedImpl@1a287b7 (initial: false) (track: [IC_ST_3], speed: 0, direction: FWD)")));
