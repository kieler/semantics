...
* generated by Xtext
*/
package de.cau.kieler.scc.model.scctext.ui.contentassist.antlr;
...
public class SCCExpParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.cau.kieler.scc.model.scctext.ui.contentassist.antlr.internal.InternalSCCExpParser createParser() {
		de.cau.kieler.scc.model.scctext.ui.contentassist.antlr.internal.InternalSCCExpParser result = new de.cau.kieler.scc.model.scctext.ui.contentassist.antlr.internal.InternalSCCExpParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getInterfaceScopeAccess().getAlternatives(), "rule__InterfaceScope__Alternatives");
					put(grammarAccess.getSCCVariableDeclarationAccess().getAlternatives(), "rule__SCCVariableDeclaration__Alternatives");
					put(grammarAccess.getActionDeclarationAccess().getAlternatives(), "rule__ActionDeclaration__Alternatives");
					...
					put(grammarAccess.getInterfaceDeclarationAccess().getGroup_3(), "rule__InterfaceDeclaration__Group_3__0");
					...
					put(grammarAccess.getLocalVariableDeclarationAccess().getGroup_6(), "rule__LocalVariableDeclaration__Group_6__0");
					put(grammarAccess.getInOutVariableDeclarationAccess().getGroup(), "rule__InOutVariableDeclaration__Group__0");
					put(grammarAccess.getInOutVariableDeclarationAccess().getGroup_5(), "rule__InOutVariableDeclaration__Group_5__0");
					put(grammarAccess.getInOutVariableDeclarationAccess().getGroup_6(), "rule__InOutVariableDeclaration__Group_6__0");
					put(grammarAccess.getOutputVariableeclarationAccess().getGroup(), "rule__OutputVariableeclaration__Group__0");
					put(grammarAccess.getOutputVariableeclarationAccess().getGroup_5(), "rule__OutputVariableeclaration__Group_5__0");
					put(grammarAccess.getInputVariableDeclarationAccess().getGroup(), "rule__InputVariableDeclaration__Group__0");
					put(grammarAccess.getInputVariableDeclarationAccess().getGroup_5(), "rule__InputVariableDeclaration__Group_5__0");
					put(grammarAccess.getInputVariableDeclarationAccess().getGroup_6(), "rule__InputVariableDeclaration__Group_6__0");
					put(grammarAccess.getExitActionDeclarationAccess().getGroup(), "rule__ExitActionDeclaration__Group__0");
					put(grammarAccess.getExitActionDeclarationAccess().getGroup_3(), "rule__ExitActionDeclaration__Group_3__0");
					put(grammarAccess.getInsideActionDeclarationAccess().getGroup(), "rule__InsideActionDeclaration__Group__0");
					put(grammarAccess.getInsideActionDeclarationAccess().getGroup_3(), "rule__InsideActionDeclaration__Group_3__0");
					put(grammarAccess.getEntryActionDeclarationAccess().getGroup(), "rule__EntryActionDeclaration__Group__0");
					put(grammarAccess.getEntryActionDeclarationAccess().getGroup_3(), "rule__EntryActionDeclaration__Group_3__0");
					put(grammarAccess.getActionVariableDeclarationAccess().getGroup(), "rule__ActionVariableDeclaration__Group__0");
					put(grammarAccess.getSuspendDeclarationAccess().getGroup(), "rule__SuspendDeclaration__Group__0");
					put(grammarAccess.getSuspendDeclarationAccess().getGroup_3(), "rule__SuspendDeclaration__Group_3__0");
					...
					put(grammarAccess.getInterfaceDeclarationAccess().getDeclarationAssignment_2(), "rule__InterfaceDeclaration__DeclarationAssignment_2");
					put(grammarAccess.getInterfaceDeclarationAccess().getDeclarationAssignment_3_1(), "rule__InterfaceDeclaration__DeclarationAssignment_3_1");
					put(grammarAccess.getLocalVariableDeclarationAccess().getNameAssignment_2(), "rule__LocalVariableDeclaration__NameAssignment_2");
					put(grammarAccess.getLocalVariableDeclarationAccess().getTypeAssignment_4(), "rule__LocalVariableDeclaration__TypeAssignment_4");
					put(grammarAccess.getLocalVariableDeclarationAccess().getInitialValueAssignment_5_1(), "rule__LocalVariableDeclaration__InitialValueAssignment_5_1");
					put(grammarAccess.getLocalVariableDeclarationAccess().getOperatorAssignment_6_1(), "rule__LocalVariableDeclaration__OperatorAssignment_6_1");
					put(grammarAccess.getInOutVariableDeclarationAccess().getNameAssignment_2(), "rule__InOutVariableDeclaration__NameAssignment_2");
					put(grammarAccess.getInOutVariableDeclarationAccess().getTypeAssignment_4(), "rule__InOutVariableDeclaration__TypeAssignment_4");
					put(grammarAccess.getInOutVariableDeclarationAccess().getInitialValueAssignment_5_1(), "rule__InOutVariableDeclaration__InitialValueAssignment_5_1");
					put(grammarAccess.getInOutVariableDeclarationAccess().getOperatorAssignment_6_1(), "rule__InOutVariableDeclaration__OperatorAssignment_6_1");
					put(grammarAccess.getOutputVariableeclarationAccess().getNameAssignment_2(), "rule__OutputVariableeclaration__NameAssignment_2");
					put(grammarAccess.getOutputVariableeclarationAccess().getTypeAssignment_4(), "rule__OutputVariableeclaration__TypeAssignment_4");
					put(grammarAccess.getOutputVariableeclarationAccess().getOperatorAssignment_5_1(), "rule__OutputVariableeclaration__OperatorAssignment_5_1");
					put(grammarAccess.getInputVariableDeclarationAccess().getNameAssignment_2(), "rule__InputVariableDeclaration__NameAssignment_2");
					put(grammarAccess.getInputVariableDeclarationAccess().getTypeAssignment_4(), "rule__InputVariableDeclaration__TypeAssignment_4");
					put(grammarAccess.getInputVariableDeclarationAccess().getInitialValueAssignment_5_1(), "rule__InputVariableDeclaration__InitialValueAssignment_5_1");
					put(grammarAccess.getInputVariableDeclarationAccess().getOperatorAssignment_6_1(), "rule__InputVariableDeclaration__OperatorAssignment_6_1");
					put(grammarAccess.getExitActionDeclarationAccess().getExitActionDeclarationAssignment_2(), "rule__ExitActionDeclaration__ExitActionDeclarationAssignment_2");
					put(grammarAccess.getExitActionDeclarationAccess().getExitActionDeclarationAssignment_3_1(), "rule__ExitActionDeclaration__ExitActionDeclarationAssignment_3_1");
					put(grammarAccess.getInsideActionDeclarationAccess().getInsideActionDeclarationAssignment_2(), "rule__InsideActionDeclaration__InsideActionDeclarationAssignment_2");
					put(grammarAccess.getInsideActionDeclarationAccess().getInsideActionDeclarationAssignment_3_1(), "rule__InsideActionDeclaration__InsideActionDeclarationAssignment_3_1");
					put(grammarAccess.getEntryActionDeclarationAccess().getEntryActionDeclarationAssignment_2(), "rule__EntryActionDeclaration__EntryActionDeclarationAssignment_2");
					put(grammarAccess.getEntryActionDeclarationAccess().getEntryActionDeclarationAssignment_3_1(), "rule__EntryActionDeclaration__EntryActionDeclarationAssignment_3_1");
					put(grammarAccess.getActionVariableDeclarationAccess().getNameAssignment_1(), "rule__ActionVariableDeclaration__NameAssignment_1");
					put(grammarAccess.getSuspendDeclarationAccess().getSuspendDeclarationAssignment_2(), "rule__SuspendDeclaration__SuspendDeclarationAssignment_2");
					put(grammarAccess.getSuspendDeclarationAccess().getSuspendDeclarationAssignment_3_1(), "rule__SuspendDeclaration__SuspendDeclarationAssignment_3_1");
					put(grammarAccess.getSuspendVariableDeclarationAccess().getNameAssignment(), "rule__SuspendVariableDeclaration__NameAssignment");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.cau.kieler.scc.model.scctext.ui.contentassist.antlr.internal.InternalSCCExpParser typedParser = (de.cau.kieler.scc.model.scctext.ui.contentassist.antlr.internal.InternalSCCExpParser) parser;
