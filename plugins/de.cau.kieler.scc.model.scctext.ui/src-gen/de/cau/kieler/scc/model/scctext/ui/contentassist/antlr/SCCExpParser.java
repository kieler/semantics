		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEffectAccess().getActionsAlternatives_1_0(), "rule__Effect__ActionsAlternatives_1_0");
					put(grammarAccess.getEffectAccess().getActionsAlternatives_2_1_0(), "rule__Effect__ActionsAlternatives_2_1_0");
					...
					put(grammarAccess.getTriggerAccess().getIsImmediateAssignment_1(), "rule__Trigger__IsImmediateAssignment_1");
					put(grammarAccess.getTriggerAccess().getDelayAssignment_2(), "rule__Trigger__DelayAssignment_2");
					put(grammarAccess.getTriggerAccess().getExpressionAssignment_4(), "rule__Trigger__ExpressionAssignment_4");
					put(grammarAccess.getEffectAccess().getActionsAssignment_1(), "rule__Effect__ActionsAssignment_1");
					put(grammarAccess.getEffectAccess().getActionsAssignment_2_1(), "rule__Effect__ActionsAssignment_2_1");
