...
package de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.scchartstext.services;
...
public class SCChartsExpGrammarAccess extends AbstractGrammarElementFinder {
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.scchartstext.SCChartsExp".equals(grammar.getName())) {
				return grammar;
			}
