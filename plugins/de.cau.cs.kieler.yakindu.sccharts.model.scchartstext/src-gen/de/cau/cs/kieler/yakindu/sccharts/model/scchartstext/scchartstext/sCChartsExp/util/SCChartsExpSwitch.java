/**
 */
package de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.scchartstext.sCChartsExp.util;

import de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.scchartstext.sCChartsExp.*;
 ...
 * <!-- end-user-doc -->
 * @see de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.scchartstext.sCChartsExp.SCChartsExpPackage
 * @generated
 */
public class SCChartsExpSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case SCChartsExpPackage.VARIABLE_DEFINITION:
      {
