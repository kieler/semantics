...
public class SCChartsExpFactoryImpl extends EFactoryImpl implements SCChartsExpFactory
{
  ...
  public static SCChartsExpFactory init()
  {
    try
    {
      SCChartsExpFactory theSCChartsExpFactory = (SCChartsExpFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.cau.de/cs/kieler/yakindu/sccharts/model/scchartstext/scchartstext/SCChartsExp"); 
