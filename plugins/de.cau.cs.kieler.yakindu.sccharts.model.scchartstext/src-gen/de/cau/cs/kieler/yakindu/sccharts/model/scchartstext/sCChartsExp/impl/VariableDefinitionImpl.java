...
import de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.sCChartsExp.CombineOperator;
import de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.sCChartsExp.SCChartsExpPackage;
import de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.sCChartsExp.VarDirection;
import de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.sCChartsExp.VariableDefinition;
 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.sCChartsExp.impl.VariableDefinitionImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.sCChartsExp.impl.VariableDefinitionImpl#isIsStatic <em>Is Static</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.sCChartsExp.impl.VariableDefinitionImpl#getVarInitialValue <em>Var Initial Value</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.sCChartsExp.impl.VariableDefinitionImpl#getVarCombineOperator <em>Var Combine Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableDefinitionImpl extends org.yakindu.sct.model.stext.stext.impl.VariableDefinitionImpl implements VariableDefinition
{
  ...
  public NotificationChain basicSetVarInitialValue(Expression newVarInitialValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SCChartsExpPackage.VARIABLE_DEFINITION__VAR_INITIAL_VALUE, oldVarInitialValue, newVarInitialValue);
  ...
  public void setVarInitialValue(Expression newVarInitialValue)
  {
    if (newVarInitialValue != varInitialValue)
    {
      ...
      if (varInitialValue != null)
        msgs = ((InternalEObject)varInitialValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SCChartsExpPackage.VARIABLE_DEFINITION__VAR_INITIAL_VALUE, null, msgs);
      if (newVarInitialValue != null)
        msgs = ((InternalEObject)newVarInitialValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SCChartsExpPackage.VARIABLE_DEFINITION__VAR_INITIAL_VALUE, null, msgs);
      msgs = basicSetVarInitialValue(newVarInitialValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SCChartsExpPackage.VARIABLE_DEFINITION__VAR_INITIAL_VALUE, newVarInitialValue, newVarInitialValue));
  }
