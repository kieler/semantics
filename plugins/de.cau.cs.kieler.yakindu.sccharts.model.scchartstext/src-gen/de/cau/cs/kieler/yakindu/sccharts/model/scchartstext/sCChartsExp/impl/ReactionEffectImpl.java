...
import de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.sCChartsExp.ReactionEffect;
 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.sCChartsExp.impl.ReactionEffectImpl#getActions <em>Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReactionEffectImpl extends EffectImpl implements ReactionEffect
{
  ...
  {
    return SCChartsExpPackage.Literals.REACTION_EFFECT;
  }
  ...
  public EList<Expression> getActions()
  {
    if (actions == null)
    {
      actions = new EObjectContainmentEList<Expression>(Expression.class, this, SCChartsExpPackage.REACTION_EFFECT__ACTIONS);
    }
    return actions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SCChartsExpPackage.REACTION_EFFECT__ACTIONS:
