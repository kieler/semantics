...
/**
 * Manual modifications go to {de.cau.cs.kieler.kies.ui.EsterelUiModule}
 */
...
public abstract class AbstractEsterelUiModule extends DefaultUiModule {
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.HIGHLIGHTING)).to(de.cau.cs.kieler.kies.parser.antlr.internal.InternalEsterelLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return de.cau.cs.kieler.kies.ui.contentassist.EsterelProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return de.cau.cs.kieler.kies.ui.contentassist.antlr.EsterelParser.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(de.cau.cs.kieler.kies.ui.contentassist.antlr.internal.InternalEsterelLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(de.cau.cs.kieler.kies.ui.contentassist.antlr.internal.InternalEsterelLexer.class));
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.quickfix.IssueResolutionProvider> bindIssueResolutionProvider() {
		return de.cau.cs.kieler.kies.ui.quickfix.EsterelQuickfixProvider.class;
	}
