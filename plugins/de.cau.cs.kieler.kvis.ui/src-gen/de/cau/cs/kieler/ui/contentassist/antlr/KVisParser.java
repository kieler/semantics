		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getIntervalAccess().getGroup_0_1(), "rule__Interval__Group_0_1__0");
					put(grammarAccess.getIntervalAccess().getGroup_2_1(), "rule__Interval__Group_2_1__0");
					...
					put(grammarAccess.getAnimationAccess().getMappingsAssignment_4(), "rule__Animation__MappingsAssignment_4");
					...
					put(grammarAccess.getIntervalAccess().getFromAssignment_0_1_1(), "rule__Interval__FromAssignment_0_1_1");
					put(grammarAccess.getIntervalAccess().getToAssignment_2_0(), "rule__Interval__ToAssignment_2_0");
					put(grammarAccess.getIntervalAccess().getToAssignment_2_1_1(), "rule__Interval__ToAssignment_2_1_1");
