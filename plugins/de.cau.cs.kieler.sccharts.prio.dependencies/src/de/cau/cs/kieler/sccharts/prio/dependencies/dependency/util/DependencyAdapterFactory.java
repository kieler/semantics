 ...
 * $Id$
 */
package de.cau.cs.kieler.sccharts.prio.dependencies.dependency.util;
 ...
 * <!-- end-user-doc -->
 * @see de.cau.cs.kieler.sccharts.prio.dependencies.dependency.DependencyPackage
 * @generated
 */
public class DependencyAdapterFactory extends AdapterFactoryImpl {
	...
	/**
     * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.sccharts.prio.dependencies.dependency.Dependency <em>Dependency</em>}'.
     * <!-- begin-user-doc -->
	...
	/**
     * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.sccharts.prio.dependencies.dependency.ControlflowDependency <em>Controlflow Dependency</em>}'.
     * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
     * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.sccharts.prio.dependencies.dependency.TransitionDependency <em>Transition Dependency</em>}'.
     * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
     * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.sccharts.prio.dependencies.dependency.Dependencies <em>Dependencies</em>}'.
     * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
     * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.sccharts.prio.dependencies.dependency.Node <em>Node</em>}'.
     * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
