...
import de.cau.cs.kieler.synccharts.labelparser.ActionLabelRuntimeModule;

/**
 * Manual modifications go to {de.cau.cs.kieler.synccharts.labelparser.ActionLabelUiModule}
 */
public abstract class AbstractActionLabelUiModule extends ActionLabelRuntimeModule {
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.HIGHLIGHTING)).to(de.cau.cs.kieler.synccharts.labelparser.parser.antlr.internal.InternalActionLabelLexer.class);
	}
	...
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return de.cau.cs.kieler.synccharts.labelparser.labeling.ActionLabelLabelProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.outline.transformer.ISemanticModelTransformer> bindISemanticModelTransformer() {
		return de.cau.cs.kieler.synccharts.labelparser.outline.ActionLabelTransformer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.outline.actions.IContentOutlineNodeAdapterFactory> bindIContentOutlineNodeAdapterFactory() {
		return de.cau.cs.kieler.synccharts.labelparser.outline.ActionLabelOutlineNodeAdapterFactory.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.core.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return de.cau.cs.kieler.synccharts.labelparser.contentassist.ActionLabelProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return de.cau.cs.kieler.synccharts.labelparser.contentassist.antlr.ActionLabelParser.class;
	}

	// contributed by de.itemis.xtext.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(de.cau.cs.kieler.synccharts.labelparser.contentassist.antlr.internal.InternalActionLabelLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(de.cau.cs.kieler.synccharts.labelparser.contentassist.antlr.internal.InternalActionLabelLexer.class));
	}

	// contributed by de.itemis.xtext.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.common.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.CONTENT_ASSIST)).to(de.cau.cs.kieler.synccharts.labelparser.contentassist.antlr.internal.InternalActionLabelLexer.class);
	}
