...
public class TextImpl extends AnimationImpl implements Text {
    ...
    public void setText_value(String newText_value) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.TEXT__TEXT_VALUE,
                    oldText_value, text_value));
    }
    ...
    public void setFont_size(String newFont_size) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.TEXT__FONT_SIZE,
                    oldFont_size, font_size));
    }
    ...
    public void setFont_family(String newFont_family) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.TEXT__FONT_FAMILY,
                    oldFont_family, font_family));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case MappingPackage.TEXT__TEXT_VALUE:
            return TEXT_VALUE_EDEFAULT == null ? text_value != null : !TEXT_VALUE_EDEFAULT
                    .equals(text_value);
        case MappingPackage.TEXT__FONT_SIZE:
            return FONT_SIZE_EDEFAULT == null ? font_size != null : !FONT_SIZE_EDEFAULT
                    .equals(font_size);
        case MappingPackage.TEXT__FONT_FAMILY:
            return FONT_FAMILY_EDEFAULT == null ? font_family != null : !FONT_FAMILY_EDEFAULT
                    .equals(font_family);
        }
    ...
    public void apply(final Object jsonObject, final String svgElementID) {
        ...
        if (jsonValue != null) {
            ...
            String textValue = ((JSONObject) jsonObject).optString(getKey());
            // Now apply the animation
            if (elem != null) {
                try {
                    // We need to read the first child, to get the textcontent of the tag
