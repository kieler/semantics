 ...
 * <ul>
 *   <li>{@link Moml.RelationType#getGroup <em>Group</em>}</li>
 *   <li>{@link Moml.RelationType#getConfigure <em>Configure</em>}</li>
 *   <li>{@link Moml.RelationType#getDoc <em>Doc</em>}</li>
 *   <li>{@link Moml.RelationType#getProperty <em>Property</em>}</li>
 *   <li>{@link Moml.RelationType#getRename <em>Rename</em>}</li>
 *   <li>{@link Moml.RelationType#getVertex <em>Vertex</em>}</li>
 *   <li>{@link Moml.RelationType#getClass_ <em>Class</em>}</li>
 *   <li>{@link Moml.RelationType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see Moml.MomlPackage#getRelationType()
...
public interface RelationType extends EObject {
	 ...
	 * @see Moml.MomlPackage#getRelationType_Group()
	 ...
	 * @see Moml.MomlPackage#getRelationType_Configure()
	 ...
	 * @see Moml.MomlPackage#getRelationType_Doc()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see Moml.MomlPackage#getRelationType_Property()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see Moml.MomlPackage#getRelationType_Rename()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link Moml.VertexType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see Moml.MomlPackage#getRelationType_Vertex()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see #setClass(String)
	 * @see Moml.MomlPackage#getRelationType_Class()
	...
	/**
	 * Sets the value of the '{@link Moml.RelationType#getClass_ <em>Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see Moml.MomlPackage#getRelationType_Name()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link Moml.RelationType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
