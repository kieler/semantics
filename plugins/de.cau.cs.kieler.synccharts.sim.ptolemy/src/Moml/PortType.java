 ...
 * <ul>
 *   <li>{@link Moml.PortType#getGroup <em>Group</em>}</li>
 *   <li>{@link Moml.PortType#getConfigure <em>Configure</em>}</li>
 *   <li>{@link Moml.PortType#getDoc <em>Doc</em>}</li>
 *   <li>{@link Moml.PortType#getProperty <em>Property</em>}</li>
 *   <li>{@link Moml.PortType#getRename <em>Rename</em>}</li>
 *   <li>{@link Moml.PortType#getClass_ <em>Class</em>}</li>
 *   <li>{@link Moml.PortType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see Moml.MomlPackage#getPortType()
...
public interface PortType extends EObject {
	 ...
	 * @see Moml.MomlPackage#getPortType_Group()
	 ...
	 * @see Moml.MomlPackage#getPortType_Configure()
	 ...
	 * @see Moml.MomlPackage#getPortType_Doc()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see Moml.MomlPackage#getPortType_Property()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see Moml.MomlPackage#getPortType_Rename()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see #setClass(String)
	 * @see Moml.MomlPackage#getPortType_Class()
	...
	/**
	 * Sets the value of the '{@link Moml.PortType#getClass_ <em>Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see Moml.MomlPackage#getPortType_Name()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link Moml.PortType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
