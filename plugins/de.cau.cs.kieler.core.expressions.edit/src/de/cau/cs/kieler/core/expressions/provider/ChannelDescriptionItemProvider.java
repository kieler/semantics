...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.core.expressions.ChannelDescription} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChannelDescriptionItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ExpressionsPackage.Literals.CHANNEL_DESCRIPTION__TYPE);
            childrenFeatures.add(ExpressionsPackage.Literals.CHANNEL_DESCRIPTION__EXPRESSION);
        }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ChannelDescription.class)) {
            case ExpressionsPackage.CHANNEL_DESCRIPTION__TYPE:
            case ExpressionsPackage.CHANNEL_DESCRIPTION__EXPRESSION:
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (ExpressionsPackage.Literals.CHANNEL_DESCRIPTION__TYPE,
                 ExpressionsFactory.eINSTANCE.createTypeIdentifier()));

        newChildDescriptors.add
            (createChildParameter
                (ExpressionsPackage.Literals.CHANNEL_DESCRIPTION__EXPRESSION,
