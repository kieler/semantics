...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.core.expressions.VariableDecl} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableDeclItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ExpressionsPackage.Literals.VARIABLE_DECL__VARIABLES);
            childrenFeatures.add(ExpressionsPackage.Literals.VARIABLE_DECL__TYPE);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (ExpressionsPackage.Literals.VARIABLE_DECL__VARIABLES,
                 ExpressionsFactory.eINSTANCE.createIVariable()));

        newChildDescriptors.add
            (createChildParameter
                (ExpressionsPackage.Literals.VARIABLE_DECL__TYPE,
