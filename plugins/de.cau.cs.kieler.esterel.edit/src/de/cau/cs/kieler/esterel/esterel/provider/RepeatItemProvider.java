...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.esterel.esterel.Repeat} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepeatItemProvider extends StatementContainerItemProvider {
    /**
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addPositivePropertyDescriptor(object);
    ...
    /**
     * This adds a property descriptor for the Positive feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addPositivePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Repeat_positive_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Repeat_positive_feature", "_UI_Repeat_type"),
                 EsterelPackage.Literals.REPEAT__POSITIVE,
                 true,
                 false,
                 false,
    ...
    protected void addOptEndPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Repeat_optEnd_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Repeat_optEnd_feature", "_UI_Repeat_type"),
                 EsterelPackage.Literals.REPEAT__OPT_END,
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(EsterelPackage.Literals.REPEAT__EXPRESSION);
        }
    ...
    public String getText(Object object) {
        ...
        return getString("_UI_Repeat_type") + " " + repeat.isPositive();
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (EsterelPackage.Literals.REPEAT__EXPRESSION,
