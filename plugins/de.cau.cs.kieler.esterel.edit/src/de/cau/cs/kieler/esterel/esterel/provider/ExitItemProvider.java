...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.esterel.esterel.Exit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExitItemProvider extends StatementItemProvider {
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Exit_trap_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Exit_trap_feature", "_UI_Exit_type"),
                 EsterelPackage.Literals.EXIT__TRAP,
                 true,
                 false,
                 true,
                 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(EsterelPackage.Literals.EXIT__EXPRESSION);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (EsterelPackage.Literals.EXIT__EXPRESSION,
