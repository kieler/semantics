...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.esterel.esterel.Emit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EmitItemProvider extends StatementItemProvider {
    /**
     ...
     * @generated
     */
    public EmitItemProvider(AdapterFactory adapterFactory) {
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Emit_signal_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Emit_signal_feature", "_UI_Emit_type"),
                 EsterelPackage.Literals.EMIT__SIGNAL,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addTickPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Emit_tick_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Emit_tick_feature", "_UI_Emit_type"),
                 EsterelPackage.Literals.EMIT__TICK,
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(EsterelPackage.Literals.EMIT__EXPR);
        }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/Emit"));
    }
    ...
    public String getText(Object object) {
        String label = ((Emit)object).getTick();
        return label == null || label.length() == 0 ?
            getString("_UI_Emit_type") :
            getString("_UI_Emit_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(Emit.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (EsterelPackage.Literals.EMIT__EXPR,
