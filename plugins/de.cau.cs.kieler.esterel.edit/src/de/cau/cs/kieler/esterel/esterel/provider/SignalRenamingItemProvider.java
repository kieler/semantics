...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.esterel.esterel.SignalRenaming} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SignalRenaming_newName_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_SignalRenaming_newName_feature", "_UI_SignalRenaming_type"),
                 EsterelPackage.Literals.SIGNAL_RENAMING__NEW_NAME,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addOldNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SignalRenaming_oldName_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_SignalRenaming_oldName_feature", "_UI_SignalRenaming_type"),
                 EsterelPackage.Literals.SIGNAL_RENAMING__OLD_NAME,
                 true,
                 false,
                 true,
                 null,
