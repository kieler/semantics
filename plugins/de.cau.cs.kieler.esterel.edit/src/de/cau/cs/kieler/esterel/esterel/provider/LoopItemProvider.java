...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.esterel.esterel.Loop} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoopItemProvider extends StatementItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsterelPackage.Literals.LOOP__BODY);
			childrenFeatures.add(EsterelPackage.Literals.LOOP__END1);
			childrenFeatures.add(EsterelPackage.Literals.LOOP__END);
		}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EsterelPackage.Literals.LOOP__BODY,
				 EsterelFactory.eINSTANCE.createLoopBody()));

		newChildDescriptors.add
			(createChildParameter
				(EsterelPackage.Literals.LOOP__END1,
				 EsterelFactory.eINSTANCE.createEndLoop()));

		newChildDescriptors.add
			(createChildParameter
				(EsterelPackage.Literals.LOOP__END,
