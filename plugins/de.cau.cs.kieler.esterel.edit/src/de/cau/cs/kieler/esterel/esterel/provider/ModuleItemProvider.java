...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.esterel.esterel.Module} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EsterelPackage.Literals.MODULE__NAME,
				 true,
				 false,
				 false,
    ...
    protected void addEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Module_end_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Module_end_feature", "_UI_Module_type"),
				 EsterelPackage.Literals.MODULE__END,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsterelPackage.Literals.MODULE__INTERFACE);
			childrenFeatures.add(EsterelPackage.Literals.MODULE__BODY);
		}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EsterelPackage.Literals.MODULE__INTERFACE,
				 EsterelFactory.eINSTANCE.createModuleInterface()));

		newChildDescriptors.add
			(createChildParameter
				(EsterelPackage.Literals.MODULE__BODY,
