...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.esterel.esterel.LocalVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocalVariableItemProvider extends StatementContainerItemProvider {
    /**
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_LocalVariable_optEnd_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_LocalVariable_optEnd_feature", "_UI_LocalVariable_type"),
                 EsterelPackage.Literals.LOCAL_VARIABLE__OPT_END,
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(EsterelPackage.Literals.LOCAL_VARIABLE__VAR);
        }
    ...
    public String getText(Object object) {
        String label = ((LocalVariable)object).getOptEnd();
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (EsterelPackage.Literals.LOCAL_VARIABLE__VAR,
