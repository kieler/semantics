...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.esterel.esterel.Procedure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcedureItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EsterelPackage.Literals.PROCEDURE__NAME,
				 true,
				 false,
				 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsterelPackage.Literals.PROCEDURE__ID_LIST1);
			childrenFeatures.add(EsterelPackage.Literals.PROCEDURE__ID_LIST2);
		}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EsterelPackage.Literals.PROCEDURE__ID_LIST1,
		...
		newChildDescriptors.add
			(createChildParameter
				(EsterelPackage.Literals.PROCEDURE__ID_LIST2,
				 EsterelFactory.eINSTANCE.createTypeIdentifier()));
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == EsterelPackage.Literals.PROCEDURE__ID_LIST1 ||
			childFeature == EsterelPackage.Literals.PROCEDURE__ID_LIST2;
