...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.esterel.esterel.ExecBody} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExecBodyItemProvider 
	 ...
	 * @generated
	 */
    public ExecBodyItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExecBody_vars_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExecBody_vars_feature", "_UI_ExecBody_type"),
				 EsterelPackage.Literals.EXEC_BODY__VARS,
				 true,
				 false,
				 true,
				 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsterelPackage.Literals.EXEC_BODY__KEXPRESSIONS);
		}
    ...
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExecBody"));
	}
    ...
    public String getText(Object object) {
		return getString("_UI_ExecBody_type");
	}
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ExecBody.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EsterelPackage.Literals.EXEC_BODY__KEXPRESSIONS,
