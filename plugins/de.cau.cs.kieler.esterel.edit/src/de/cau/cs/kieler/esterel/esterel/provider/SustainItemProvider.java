...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.esterel.esterel.Sustain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SustainItemProvider extends StatementItemProvider {
    /**
     ...
     * @generated
     */
    public SustainItemProvider(AdapterFactory adapterFactory) {
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Sustain_signal_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Sustain_signal_feature", "_UI_Sustain_type"),
                 EsterelPackage.Literals.SUSTAIN__SIGNAL,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addTickPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Sustain_tick_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Sustain_tick_feature", "_UI_Sustain_type"),
                 EsterelPackage.Literals.SUSTAIN__TICK,
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(EsterelPackage.Literals.SUSTAIN__EXPRESSION);
        }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/Sustain"));
    }
    ...
    public String getText(Object object) {
        String label = ((Sustain)object).getTick();
        return label == null || label.length() == 0 ?
            getString("_UI_Sustain_type") :
            getString("_UI_Sustain_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(Sustain.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (EsterelPackage.Literals.SUSTAIN__EXPRESSION,
