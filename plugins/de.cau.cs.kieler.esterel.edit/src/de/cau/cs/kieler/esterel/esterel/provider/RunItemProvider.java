...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.esterel.esterel.Run} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RunItemProvider extends StatementItemProvider {
    /**
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(EsterelPackage.Literals.RUN__MODULE);
            childrenFeatures.add(EsterelPackage.Literals.RUN__LIST);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (EsterelPackage.Literals.RUN__MODULE,
                 EsterelFactory.eINSTANCE.createModuleRenaming()));

        newChildDescriptors.add
            (createChildParameter
                (EsterelPackage.Literals.RUN__LIST,
