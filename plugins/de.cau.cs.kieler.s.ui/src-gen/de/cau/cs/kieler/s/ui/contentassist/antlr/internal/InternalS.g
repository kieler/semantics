...
:
(
{ before(grammarAccess.getEmitAccess().getValueExpressionParserRuleCall_3_1_0()); }
	ruleExpression{ after(grammarAccess.getEmitAccess().getValueExpressionParserRuleCall_3_1_0()); }
)
