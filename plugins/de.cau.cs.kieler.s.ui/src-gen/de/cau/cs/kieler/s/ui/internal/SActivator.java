...
public class SActivator extends AbstractUIPlugin {
	...
	private static final Logger logger = Logger.getLogger(SActivator.class);
	...
	public static final String DE_CAU_CS_KIELER_S_S = "de.cau.cs.kieler.s.S";
	...
	protected Module getRuntimeModule(String grammar) {
		if (DE_CAU_CS_KIELER_S_S.equals(grammar)) {
