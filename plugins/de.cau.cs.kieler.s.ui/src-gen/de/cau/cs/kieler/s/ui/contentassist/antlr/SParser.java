		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getInstructionAccess().getGroup_11(), "rule__Instruction__Group_11__0");
					put(grammarAccess.getInstructionAccess().getGroup_11_1(), "rule__Instruction__Group_11_1__0");
					put(grammarAccess.getInstructionAccess().getGroup_11_1_1(), "rule__Instruction__Group_11_1_1__0");
					...
					put(grammarAccess.getInstructionAccess().getAnnotationsAssignment_11_1_0(), "rule__Instruction__AnnotationsAssignment_11_1_0");
					put(grammarAccess.getInstructionAccess().getAnnotationsAssignment_11_1_1_1(), "rule__Instruction__AnnotationsAssignment_11_1_1_1");
