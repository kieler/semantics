		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getThreadAccess().getGroup_3(), "rule__Thread__Group_3__0");
					...
					put(grammarAccess.getThreadAccess().getNameAssignment_0(), "rule__Thread__NameAssignment_0");
					put(grammarAccess.getThreadAccess().getSignalsAssignment_2_1(), "rule__Thread__SignalsAssignment_2_1");
					put(grammarAccess.getThreadAccess().getStatesAssignment_3_0(), "rule__Thread__StatesAssignment_3_0");
