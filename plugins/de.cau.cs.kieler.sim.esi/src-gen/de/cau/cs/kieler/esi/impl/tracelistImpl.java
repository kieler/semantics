...
import de.cau.cs.kieler.esi.tracelist;
 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esi.impl.tracelistImpl#getTraces <em>Traces</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class tracelistImpl extends MinimalEObjectImpl.Container implements tracelist
{
  ...
  {
    return EsiPackage.Literals.TRACELIST;
  }
  ...
  public EList<trace> getTraces()
  {
    if (traces == null)
    {
      traces = new EObjectContainmentEList<trace>(trace.class, this, EsiPackage.TRACELIST__TRACES);
    }
    return traces;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EsiPackage.TRACELIST__TRACES:
