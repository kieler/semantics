...
// $ANTLR src "../de.cau.cs.kieler.sim.esi/src-gen/de/cau/cs/kieler/parser/antlr/internal/InternalEsi.g" 382
RULE_COMMENT : '%' ('A'..'N'|'P'..'Z') ( options {greedy=false;} : . )*'\n';

// $ANTLR src "../de.cau.cs.kieler.sim.esi/src-gen/de/cau/cs/kieler/parser/antlr/internal/InternalEsi.g" 384
RULE_DIGIT : '0'..'9';

// $ANTLR src "../de.cau.cs.kieler.sim.esi/src-gen/de/cau/cs/kieler/parser/antlr/internal/InternalEsi.g" 386
RULE_LETTER : ('a'..'z'|'A'..'Z');
