 ...
 * @generated
 */
public class PseudostateStereotypeEditPart
...
implements ITextAwareEditPart, IBorderItemEditPart {
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry
						.getType(org.eclipse.papyrus.diagram.statemachine.edit.parts.PseudostateStereotypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public PseudostateStereotypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.Pseudostate_4000,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.statemachine.edit.parts.PseudostateStereotypeEditPart.VISUAL_ID));
		}
