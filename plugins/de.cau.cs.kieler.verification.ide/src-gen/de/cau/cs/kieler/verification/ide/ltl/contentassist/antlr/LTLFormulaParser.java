...
public class LTLFormulaParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, LTLFormulaGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getLTLExpressionAccess().getAlternatives(), "rule__LTLExpression__Alternatives");
			builder.put(grammarAccess.getLTLExpressionAccess().getOperatorAlternatives_0_1_0(), "rule__LTLExpression__OperatorAlternatives_0_1_0");
			...
			builder.put(grammarAccess.getLTLExpressionAccess().getGroup_0(), "rule__LTLExpression__Group_0__0");
			builder.put(grammarAccess.getLTLExpressionAccess().getGroup_1(), "rule__LTLExpression__Group_1__0");
			builder.put(grammarAccess.getLTLExpressionAccess().getGroup_1_1(), "rule__LTLExpression__Group_1_1__0");
			builder.put(grammarAccess.getLTLExpressionAccess().getGroup_1_1_1(), "rule__LTLExpression__Group_1_1_1__0");
			builder.put(grammarAccess.getLTLExpressionAccess().getGroup_1_1_2(), "rule__LTLExpression__Group_1_1_2__0");
			...
			builder.put(grammarAccess.getLTLExpressionAccess().getSubExpressionsAssignment_1_1_1_1(), "rule__LTLExpression__SubExpressionsAssignment_1_1_1_1");
			builder.put(grammarAccess.getLTLExpressionAccess().getSubExpressionsAssignment_1_1_2_2(), "rule__LTLExpression__SubExpressionsAssignment_1_1_2_2");
