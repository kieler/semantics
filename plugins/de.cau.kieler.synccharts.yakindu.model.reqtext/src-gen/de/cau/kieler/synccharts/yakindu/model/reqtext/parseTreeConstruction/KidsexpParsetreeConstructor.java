...
* generated by Xtext
*/
package de.cau.kieler.synccharts.yakindu.model.reqtext.parseTreeConstruction;
...
public class KidsexpParsetreeConstructor extends AbstractParseTreeConstructor {
...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 5: return new TransitionSpecification_ReactionAssignment(this, this, 5, inst);
			case 6: return new StatechartSpecification_Group(this, this, 6, inst);
			case 7: return new StateSpecification_Group(this, this, 7, inst);
			case 8: return new TransitionReaction_Group(this, this, 8, inst);
			case 9: return new MyTrigger_Group(this, this, 9, inst);
			case 10: return new ReactionEffect_Group(this, this, 10, inst);
			case 11: return new ScopedElement_StatechartSpecificationParserRuleCall(this, this, 11, inst);
			case 12: return new Scope_Alternatives(this, this, 12, inst);
			case 13: return new StateScope_Group(this, this, 13, inst);
			case 14: return new StatechartScope_Alternatives(this, this, 14, inst);
			case 15: return new NamedInterfaceScope_InterfaceScopeParserRuleCall(this, this, 15, inst);
			case 16: return new InterfaceScope_Group(this, this, 16, inst);
			case 17: return new InternalScope_Group(this, this, 17, inst);
			case 18: return new Declaration_Alternatives(this, this, 18, inst);
			case 19: return new EventDeclarartion_EventDefinitionParserRuleCall(this, this, 19, inst);
			case 20: return new EventFeature_EventDefinitionParserRuleCall(this, this, 20, inst);
			case 21: return new EventDefinition_Group(this, this, 21, inst);
			case 22: return new VariableDeclaration_VariableDefinitionParserRuleCall(this, this, 22, inst);
			case 23: return new VariableFeature_VariableDefinitionParserRuleCall(this, this, 23, inst);
			case 24: return new VariableDefinition_Group(this, this, 24, inst);
			case 25: return new OperationDeclaration_OperationDefinitionParserRuleCall(this, this, 25, inst);
			case 26: return new OperationFeature_OperationDefinitionParserRuleCall(this, this, 26, inst);
			case 27: return new OperationDefinition_Group(this, this, 27, inst);
			case 28: return new Parameter_Group(this, this, 28, inst);
			case 29: return new Entrypoint_Group(this, this, 29, inst);
			case 30: return new Exitpoint_Group(this, this, 30, inst);
			case 31: return new Reaction_Alternatives(this, this, 31, inst);
			case 32: return new LocalReaction_Group(this, this, 32, inst);
			case 33: return new ReactionTrigger_Group(this, this, 33, inst);
...
protected class StatechartSpecification_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new StatechartSpecification_StatechartKeyword_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// "statechart"
protected class StatechartSpecification_StatechartKeyword_1 extends KeywordToken  {
	
	public StatechartSpecification_StatechartKeyword_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getStatechartSpecificationAccess().getStatechartKeyword_1();
	}
...
protected class StateSpecification_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new StateSpecification_StateKeyword_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// "state"
protected class StateSpecification_StateKeyword_1 extends KeywordToken  {
	
	public StateSpecification_StateKeyword_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getStateSpecificationAccess().getStateKeyword_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new StateSpecification_StateSpecificationAction_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class TransitionReaction_TriggerAssignment_1 extends AssignmentToken  {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new MyTrigger_Group(this, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			IEObjectConsumer param = createEObjectConsumer((EObject)value);
			if(param.isInstanceOf(grammarAccess.getMyTriggerRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getTransitionReactionAccess().getTriggerMyTriggerParserRuleCall_1_0(); 
				consumed = obj;
				return param;
			}
		}
...
// {ReactionTrigger} "trigger"
protected class MyTrigger_Group extends GroupToken {
	
	public MyTrigger_Group(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getMyTriggerAccess().getGroup();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new MyTrigger_TriggerKeyword_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getMyTriggerAccess().getReactionTriggerAction_0().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
// {ReactionTrigger}
protected class MyTrigger_ReactionTriggerAction_0 extends ActionToken  {

	public MyTrigger_ReactionTriggerAction_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Action getGrammarElement() {
		return grammarAccess.getMyTriggerAccess().getReactionTriggerAction_0();
	}
...
// "trigger"
protected class MyTrigger_TriggerKeyword_1 extends KeywordToken  {
	
	public MyTrigger_TriggerKeyword_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getMyTriggerAccess().getTriggerKeyword_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new MyTrigger_ReactionTriggerAction_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class ReactionEffect_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ReactionEffect_EffectKeyword_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// "effect"
protected class ReactionEffect_EffectKeyword_1 extends KeywordToken  {
	
	public ReactionEffect_EffectKeyword_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getReactionEffectAccess().getEffectKeyword_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ReactionEffect_ReactionEffectAction_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
