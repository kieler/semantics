 ...
 * <ul>
 *   <li>{@link de.cau.kieler.synccharts.yakindu.model.reqtext.kidsexp.impl.StateRootImpl#getDef <em>Def</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateRootImpl extends DefRootImpl implements StateRoot
{
  ...
  {
    return KidsexpPackage.Literals.STATE_ROOT;
  }
  ...
  public NotificationChain basicSetDef(StateSpecification newDef, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KidsexpPackage.STATE_ROOT__DEF, oldDef, newDef);
  ...
  public void setDef(StateSpecification newDef)
  {
    if (newDef != def)
    {
      ...
      if (def != null)
        msgs = ((InternalEObject)def).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KidsexpPackage.STATE_ROOT__DEF, null, msgs);
      if (newDef != null)
        msgs = ((InternalEObject)newDef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KidsexpPackage.STATE_ROOT__DEF, null, msgs);
      msgs = basicSetDef(newDef, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KidsexpPackage.STATE_ROOT__DEF, newDef, newDef));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case KidsexpPackage.STATE_ROOT__DEF:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == org.yakindu.sct.model.stext.stext.StateRoot.class)
    {
      ...
      {
        case KidsexpPackage.STATE_ROOT__DEF: return StextPackage.STATE_ROOT__DEF;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == org.yakindu.sct.model.stext.stext.StateRoot.class)
    {
      ...
      {
        case StextPackage.STATE_ROOT__DEF: return KidsexpPackage.STATE_ROOT__DEF;
        default: return -1;
      }
    }
