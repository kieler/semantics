package de.cau.kieler.synccharts.yakindu.model.reqtext.validation;
...
public class AbstractKidsexpJavaValidator extends STextJavaValidator {

	@Override
	protected List<EPackage> getEPackages() {
	    List<EPackage> result = new ArrayList<EPackage>();
	    result.add(de.cau.kieler.synccharts.yakindu.model.reqtext.kidsexp.KidsexpPackage.eINSTANCE);
