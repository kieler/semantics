	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getRootStateAccess().getAlternatives_4(), "rule__RootState__Alternatives_4");
					put(grammarAccess.getRootStateAccess().getAlternatives_4_1_1(), "rule__RootState__Alternatives_4_1_1");
					put(grammarAccess.getRootStateAccess().getAlternatives_4_1_2_0(), "rule__RootState__Alternatives_4_1_2_0");
					put(grammarAccess.getStateAccess().getAlternatives_7(), "rule__State__Alternatives_7");
					put(grammarAccess.getStateAccess().getAlternatives_7_1_1(), "rule__State__Alternatives_7_1_1");
					put(grammarAccess.getStateAccess().getAlternatives_7_1_2_0(), "rule__State__Alternatives_7_1_2_0");
					...
					put(grammarAccess.getScopeCallAccess().getAlternatives_2(), "rule__ScopeCall__Alternatives_2");
					...
					put(grammarAccess.getRootStateAccess().getGroup_4_0(), "rule__RootState__Group_4_0__0");
					put(grammarAccess.getRootStateAccess().getGroup_4_1(), "rule__RootState__Group_4_1__0");
					put(grammarAccess.getRootStateAccess().getGroup_4_1_2(), "rule__RootState__Group_4_1_2__0");
					put(grammarAccess.getStateAccess().getGroup(), "rule__State__Group__0");
					put(grammarAccess.getStateAccess().getGroup_7_0(), "rule__State__Group_7_0__0");
					put(grammarAccess.getStateAccess().getGroup_7_1(), "rule__State__Group_7_1__0");
					put(grammarAccess.getStateAccess().getGroup_7_1_2(), "rule__State__Group_7_1_2__0");
					...
					put(grammarAccess.getTransitionAccess().getGroup_6_0_2(), "rule__Transition__Group_6_0_2__0");
					put(grammarAccess.getTransitionAccess().getGroup_6_0_2_2(), "rule__Transition__Group_6_0_2_2__0");
					...
					put(grammarAccess.getScopeCallAccess().getGroup_2_0(), "rule__ScopeCall__Group_2_0__0");
					put(grammarAccess.getScopeCallAccess().getGroup_2_0_2(), "rule__ScopeCall__Group_2_0_2__0");
					...
					put(grammarAccess.getRootStateAccess().getExpressionAssignment_4_0_1(), "rule__RootState__ExpressionAssignment_4_0_1");
					put(grammarAccess.getRootStateAccess().getDeclarationsAssignment_4_1_1_0(), "rule__RootState__DeclarationsAssignment_4_1_1_0");
					put(grammarAccess.getRootStateAccess().getLocalActionsAssignment_4_1_1_1(), "rule__RootState__LocalActionsAssignment_4_1_1_1");
					put(grammarAccess.getRootStateAccess().getRegionsAssignment_4_1_2_0_0(), "rule__RootState__RegionsAssignment_4_1_2_0_0");
					put(grammarAccess.getRootStateAccess().getRegionsAssignment_4_1_2_0_1(), "rule__RootState__RegionsAssignment_4_1_2_0_1");
					put(grammarAccess.getRootStateAccess().getRegionsAssignment_4_1_2_1(), "rule__RootState__RegionsAssignment_4_1_2_1");
					...
					put(grammarAccess.getStateAccess().getExpressionAssignment_7_0_1(), "rule__State__ExpressionAssignment_7_0_1");
					put(grammarAccess.getStateAccess().getDeclarationsAssignment_7_1_1_0(), "rule__State__DeclarationsAssignment_7_1_1_0");
					put(grammarAccess.getStateAccess().getLocalActionsAssignment_7_1_1_1(), "rule__State__LocalActionsAssignment_7_1_1_1");
					put(grammarAccess.getStateAccess().getRegionsAssignment_7_1_2_0_0(), "rule__State__RegionsAssignment_7_1_2_0_0");
					put(grammarAccess.getStateAccess().getRegionsAssignment_7_1_2_0_1(), "rule__State__RegionsAssignment_7_1_2_0_1");
					put(grammarAccess.getStateAccess().getRegionsAssignment_7_1_2_1(), "rule__State__RegionsAssignment_7_1_2_1");
					...
					put(grammarAccess.getTransitionAccess().getDelayAssignment_6_0_1_0(), "rule__Transition__DelayAssignment_6_0_1_0");
					put(grammarAccess.getTransitionAccess().getTriggerAssignment_6_0_1_1(), "rule__Transition__TriggerAssignment_6_0_1_1");
					put(grammarAccess.getTransitionAccess().getEffectsAssignment_6_0_2_1(), "rule__Transition__EffectsAssignment_6_0_2_1");
					put(grammarAccess.getTransitionAccess().getEffectsAssignment_6_0_2_2_1(), "rule__Transition__EffectsAssignment_6_0_2_2_1");
					...
					put(grammarAccess.getSingleDataflowRegionAccess().getEquationsAssignment_2(), "rule__SingleDataflowRegion__EquationsAssignment_2");
					...
					put(grammarAccess.getScopeReferenceAccess().getScopeAssignment(), "rule__ScopeReference__ScopeAssignment");
					put(grammarAccess.getScopeCallAccess().getScopeAssignment_1(), "rule__ScopeCall__ScopeAssignment_1");
					put(grammarAccess.getScopeCallAccess().getParametersAssignment_2_0_1(), "rule__ScopeCall__ParametersAssignment_2_0_1");
					put(grammarAccess.getScopeCallAccess().getParametersAssignment_2_0_2_1(), "rule__ScopeCall__ParametersAssignment_2_0_2_1");
