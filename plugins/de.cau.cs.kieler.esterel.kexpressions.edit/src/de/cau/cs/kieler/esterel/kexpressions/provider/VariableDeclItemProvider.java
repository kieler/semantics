/**
 */
package de.cau.cs.kieler.esterel.kexpressions.provider;
...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.esterel.kexpressions.VariableDecl} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableDeclItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(KExpressionsPackage.Literals.VARIABLE_DECL__VARIABLES);
            childrenFeatures.add(KExpressionsPackage.Literals.VARIABLE_DECL__TYPE);
        }
    ...
    public String getText(Object object) {
        return getString("_UI_VariableDecl_type");
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (KExpressionsPackage.Literals.VARIABLE_DECL__VARIABLES,
                 KExpressionsFactory.eINSTANCE.createIVariable()));

        newChildDescriptors.add
            (createChildParameter
                (KExpressionsPackage.Literals.VARIABLE_DECL__TYPE,
