 ...
 * 
 * FIXME: This is a direct copy of de.cau.cs.kieler.core.model.util.ModelingUtil in order
 *        to avoid the dependency of kieler.core.ui to kieler.core.model (which would always
 *        pull in all the modeling stuff like Xtend/Xpand). This should be handled in some 
 *        other way, e.g. the ErrorHandler should be extensible by other plugins or something
 *        like that.
 * 
 * @author haf
 * 
