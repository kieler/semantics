...
import sj.examples.GRCbal3;
import junit.framework.TestCase;

/**
 * JUnit test cases to test the right behavior of the example GRCbal3. The test case is also used to
 * test if SJ is working correct for this program.
 * 
 * @author mhei
 * 
 */
public class GRCbal3Test extends TestCase {
    ...
    public void testCaseOne() {
        ...
        // second tick not necessary because the program terminates after the first
        // tick
        /*
