 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.xkev.mapping.impl.MovePathImpl#getPath <em>Path</em>}</li>
 *   <li>{@link de.cau.cs.kieler.xkev.mapping.impl.MovePathImpl#getAnchor_point <em>Anchor point</em>}</li>
 *   <li>{@link de.cau.cs.kieler.xkev.mapping.impl.MovePathImpl#getAuto_orientation <em>Auto orientation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MovePathImpl extends AnimationImpl implements MovePath {
    ...
    /* (non-Javadoc)
     * @see de.cau.cs.kieler.xkev.mapping.Animation#apply(de.cau.cs.kieler.sim.kiem.json.JSONObject, java.lang.String)
     */
