...
import de.cau.cs.kieler.xkev.actions.OpenImageWizardAction;
//import de.cau.cs.kieler.xkev.animation.AnimationManager;
...
public class EnvironmentView extends ViewPart {
	...
	private void makeActions() {
		...
		refreshAction.setImageDescriptor(Activator.getDefault().getImageDescriptor("icons/view/refresh.gif"));
