...
public class AbortErrorDialog extends ErrorDialog implements SelectionListener {
    ...
    public AbortErrorDialog(Shell parentShell, String dialogTitle, String message, IStatus status,
            int displayMask, boolean abortable) {
    ...
    public static void openError(String message, IStatus status, boolean abortable) {
        ...
        AbortErrorDialog dialog = new AbortErrorDialog(null, "Error", message, status, displayMask,
                abortable);
        dialog.open();
    }
