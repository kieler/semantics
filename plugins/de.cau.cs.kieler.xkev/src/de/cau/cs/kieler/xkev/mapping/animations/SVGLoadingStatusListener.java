...
/**
 * This class implements the SVGDocumentLoaderListener. It returns the loadingStatus
 * of the SVGDocument.
 * 
 * return values for the getLoadingStatus() method are:
 * -1 : not initilized!
 *  0 : loading completed
 *  1 : document loading cancelled
 *  2 : document loading failed
 *  3 : document loading started 
 * 
