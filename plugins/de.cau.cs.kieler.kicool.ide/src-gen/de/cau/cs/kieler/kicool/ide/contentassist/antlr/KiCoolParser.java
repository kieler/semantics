		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProcessorAccess().getGroup_1(), "rule__Processor__Group_1__0");
					...
					put(grammarAccess.getSystemAccess().getIdAssignment_3(), "rule__System__IdAssignment_3");
					put(grammarAccess.getSystemAccess().getVersionAssignment_5(), "rule__System__VersionAssignment_5");
					put(grammarAccess.getSystemAccess().getLabelAssignment_7(), "rule__System__LabelAssignment_7");
					put(grammarAccess.getSystemAccess().getInputClassAssignment_8_1(), "rule__System__InputClassAssignment_8_1");
					put(grammarAccess.getSystemAccess().getStartsetsAssignment_9_1(), "rule__System__StartsetsAssignment_9_1");
					...
					put(grammarAccess.getProcessorAccess().getPresetsAssignment_0_2(), "rule__Processor__PresetsAssignment_0_2");
					put(grammarAccess.getProcessorAccess().getPreprocessesAssignment_1_2(), "rule__Processor__PreprocessesAssignment_1_2");
					put(grammarAccess.getProcessorAccess().getIdAssignment_2(), "rule__Processor__IdAssignment_2");
