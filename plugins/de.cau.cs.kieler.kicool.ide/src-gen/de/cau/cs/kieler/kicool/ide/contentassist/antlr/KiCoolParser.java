		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSystemAccess().getPublicAssignment_0(), "rule__System__PublicAssignment_0");
					put(grammarAccess.getSystemAccess().getDeveloperAssignment_1(), "rule__System__DeveloperAssignment_1");
					put(grammarAccess.getSystemAccess().getSimulationAssignment_2(), "rule__System__SimulationAssignment_2");
					put(grammarAccess.getSystemAccess().getIdAssignment_4(), "rule__System__IdAssignment_4");
					put(grammarAccess.getSystemAccess().getLabelAssignment_6(), "rule__System__LabelAssignment_6");
					put(grammarAccess.getSystemAccess().getConfigAssignment_7_1(), "rule__System__ConfigAssignment_7_1");
