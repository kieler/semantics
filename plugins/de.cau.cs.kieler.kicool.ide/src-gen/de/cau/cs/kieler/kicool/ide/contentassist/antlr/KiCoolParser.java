...
public class KiCoolParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KiCoolGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getImpliesExpressionAccess().getAlternatives(), "rule__ImpliesExpression__Alternatives");
			...
			builder.put(grammarAccess.getImpliesExpressionAccess().getGroup_0(), "rule__ImpliesExpression__Group_0__0");
