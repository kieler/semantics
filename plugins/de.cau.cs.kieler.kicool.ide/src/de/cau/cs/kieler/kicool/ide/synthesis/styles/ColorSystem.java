 ...
 */
package de.cau.cs.kieler.kicool.ide.synthesis.styles;

import static de.cau.cs.kieler.kicool.ide.synthesis.styles.ColorStore.*;
...
public enum ColorSystem implements IColorSystem {
    ...
    LOG(LOG_FOREGROUND, LOG_BACKGROUND, LOG_BACKGROUND_TARGET),
    ...
    HALT(HALT_FOREGROUND, HALT_BACKGROUND, HALT_BACKGROUND_TARGET),
    ...
    ENVIRONMENT_MODEL(ENVIRONMENT_MODEL_FOREGROUND, ENVIRONMENT_MODEL_BACKGROUND, ENVIRONMENT_MODEL_BACKGROUND_TARGET);
