...
public class ScadeSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        ScadeProgram scadeProgram = (ScadeProgram)theEObject;
        T result = caseScadeProgram(scadeProgram);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ScadePackage.SCADE_EQUATION:
      {
        ScadeEquation scadeEquation = (ScadeEquation)theEObject;
        T result = caseScadeEquation(scadeEquation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   * @generated
   */
  public T caseScadeProgram(ScadeProgram object)
  {
    return null;
  }
