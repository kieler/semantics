...
public class LustreGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ProductExpressionElements extends AbstractParserRuleElementFinder {
		...
		//IntDivExpression ({OperatorExpression.subExpressions+=current} operator=MultOperator subExpressions+=IntDivExpression
		//('*' subExpressions+=IntDivExpression)* | {OperatorExpression.subExpressions+=current} operator=DivOperator
		//subExpressions+=IntDivExpression ('/' subExpressions+=IntDivExpression)* | {OperatorExpression.subExpressions+=current}
		//operator=ModOperator subExpressions+=IntDivExpression ('mod' subExpressions+=IntDivExpression)*)*
		public Group getGroup() { return cGroup; }
