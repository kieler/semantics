 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.lustre.lustre.OperatorExpression#getSubExpressions <em>Sub Expressions</em>}</li>
 *   <li>{@link de.cau.cs.kieler.lustre.lustre.OperatorExpression#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @see de.cau.cs.kieler.lustre.lustre.LustrePackage#getOperatorExpression()
 * @model
 * @generated
 */
public interface OperatorExpression extends Expression
{
   ...
   * @see de.cau.cs.kieler.lustre.lustre.LustrePackage#getOperatorExpression_SubExpressions()
   ...
   * @see de.cau.cs.kieler.lustre.lustre.LustrePackage#getOperatorExpression_Operator()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.lustre.lustre.OperatorExpression#getOperator <em>Operator</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
