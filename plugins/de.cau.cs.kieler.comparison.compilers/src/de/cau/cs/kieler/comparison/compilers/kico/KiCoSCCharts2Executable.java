 ...
 *
 */
public class KiCoSCCharts2Executable implements ICompiler {
    ...
    @Override
    public String getID() {
        return "KiCo - SCCharts to Executable";
    }
    ...
    public Language getTrgLanguage() {
        return Language.ExecutableCode;
    }
    ...
    public Collection<String> getFeasibleProperties() {
        ...
        ret.add(LanguageProperties.REACTIVE);
        return ret;
    }
}
