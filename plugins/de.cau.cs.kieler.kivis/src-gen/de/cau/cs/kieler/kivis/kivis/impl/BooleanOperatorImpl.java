 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kivis.kivis.impl.BooleanOperatorImpl#getAND <em>AND</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanOperatorImpl extends MinimalEObjectImpl.Container implements BooleanOperator
{
  ...
  {
    return KivisPackage.Literals.BOOLEAN_OPERATOR;
  }
  ...
  public void setAND(String newAND)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KivisPackage.BOOLEAN_OPERATOR__AND, oldAND, and));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KivisPackage.BOOLEAN_OPERATOR__AND:
        return getAND();
    }
