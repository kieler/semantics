 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kivis.kivis.impl.EventImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kivis.kivis.impl.EventImpl#getElement <em>Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventImpl extends MinimalEObjectImpl.Container implements Event
{
  ...
  {
    return KivisPackage.Literals.EVENT;
  }
  ...
  public void setEvent(DOMEvent newEvent)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KivisPackage.EVENT__EVENT, oldEvent, event));
  }
  ...
  public void setElement(String newElement)
  {
    ...
    element = newElement;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KivisPackage.EVENT__ELEMENT, oldElement, element));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KivisPackage.EVENT__EVENT:
        return getEvent();
      case KivisPackage.EVENT__ELEMENT:
        return getElement();
    }
