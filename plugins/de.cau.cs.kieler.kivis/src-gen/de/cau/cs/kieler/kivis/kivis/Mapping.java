 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kivis.kivis.Mapping#getVariableDomain <em>Variable Domain</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kivis.kivis.Mapping#getAttributeDomain <em>Attribute Domain</em>}</li>
 * </ul>
 *
 * @see de.cau.cs.kieler.kivis.kivis.KivisPackage#getMapping()
 * @model
 * @generated
 */
public interface Mapping extends EObject
{
   ...
   * @see de.cau.cs.kieler.kivis.kivis.KivisPackage#getMapping_VariableDomain()
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kivis.kivis.Mapping#getVariableDomain <em>Variable Domain</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.kivis.kivis.KivisPackage#getMapping_AttributeDomain()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kivis.kivis.Mapping#getAttributeDomain <em>Attribute Domain</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
