 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.synccharts01.Signal#getValue <em>Value</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts01.Signal#getParentState <em>Parent State</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts01.Signal#isIsInput <em>Is Input</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts01.Signal#isIsOutput <em>Is Output</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts01.Signal#getCombineOperator <em>Combine Operator</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts01.Signal#getHostCombineOperator <em>Host Combine Operator</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts01.Signal#getParentRegion <em>Parent Region</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.synccharts01.SyncchartsPackage#getSignal()
 * @model
 * @generated
 */
public interface Signal extends ValuedObject {
	 ...
	 * @see de.cau.cs.kieler.synccharts01.SyncchartsPackage#getSignal_Value()
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.synccharts01.Signal#getValue <em>Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.cau.cs.kieler.synccharts01.State#getSignals <em>Signals</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.cau.cs.kieler.synccharts01.SyncchartsPackage#getSignal_ParentState()
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.synccharts01.Signal#getParentState <em>Parent State</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.synccharts01.SyncchartsPackage#getSignal_IsInput()
	 * @model required="true"
	 * @generated
	 */
	boolean isIsInput();
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.synccharts01.Signal#isIsInput <em>Is Input</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.synccharts01.SyncchartsPackage#getSignal_IsOutput()
	 * @model required="true"
	 * @generated
	 */
	boolean isIsOutput();
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.synccharts01.Signal#isIsOutput <em>Is Output</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link de.cau.cs.kieler.synccharts01.CombineOperator}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.cau.cs.kieler.synccharts01.SyncchartsPackage#getSignal_CombineOperator()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.synccharts01.Signal#getCombineOperator <em>Combine Operator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.cau.cs.kieler.synccharts01.SyncchartsPackage#getSignal_HostCombineOperator()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.synccharts01.Signal#getHostCombineOperator <em>Host Combine Operator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.cau.cs.kieler.synccharts01.Region#getSignals <em>Signals</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.cau.cs.kieler.synccharts01.SyncchartsPackage#getSignal_ParentRegion()
	...
	/**
	 * Sets the value of the '{@link de.cau.cs.kieler.synccharts01.Signal#getParentRegion <em>Parent Region</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
