...
import de.cau.cs.kieler.synccharts01.Effect;
import de.cau.cs.kieler.synccharts01.Expression;
 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.synccharts01.impl.ActionImpl#getEffects <em>Effects</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts01.impl.ActionImpl#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts01.impl.ActionImpl#getTriggersAndEffects <em>Triggers And Effects</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts01.impl.ActionImpl#getParentStateEntryAction <em>Parent State Entry Action</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts01.impl.ActionImpl#getParentStateInnerAction <em>Parent State Inner Action</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts01.impl.ActionImpl#getParentStateExitAction <em>Parent State Exit Action</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts01.impl.ActionImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts01.impl.ActionImpl#isIsImmediate <em>Is Immediate</em>}</li>
 *   <li>{@link de.cau.cs.kieler.synccharts01.impl.ActionImpl#getParentStateSuspension <em>Parent State Suspension</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
