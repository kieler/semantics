 ...
 *   <li>{@link de.cau.cs.kieler.synccharts.impl.SignalImpl#getParentScope <em>Parent Scope</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SignalImpl extends ValuedObjectImpl implements Signal {
	...
	public Scope getParentScope() {
		if (parentScope != null && parentScope.eIsProxy()) {
			...
			if (parentScope != oldParentScope) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SyncchartsPackage.SIGNAL__PARENT_SCOPE, oldParentScope, parentScope));
			}
		}
		return parentScope;
	}
	...
	public void setParentScope(Scope newParentScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyncchartsPackage.SIGNAL__PARENT_SCOPE, oldParentScope, parentScope));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SyncchartsPackage.SIGNAL__PARENT_SCOPE:
