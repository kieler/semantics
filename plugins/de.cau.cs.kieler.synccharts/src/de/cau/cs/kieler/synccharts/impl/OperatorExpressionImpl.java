 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.synccharts.impl.OperatorExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperatorExpressionImpl extends ComplexExpressionImpl implements OperatorExpression {
	...
	protected EClass eStaticClass() {
		return SyncchartsPackage.Literals.OPERATOR_EXPRESSION;
	}
	...
	public void setOperator(OperatorType newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyncchartsPackage.OPERATOR_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SyncchartsPackage.OPERATOR_EXPRESSION__OPERATOR:
				return getOperator();
		}
