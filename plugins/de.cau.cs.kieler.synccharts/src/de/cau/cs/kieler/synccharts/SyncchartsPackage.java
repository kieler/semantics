...
public interface SyncchartsPackage extends EPackage {
	...
	/**
     * Returns the meta object for the reference '{@link de.cau.cs.kieler.synccharts.State#getBodyReference <em>Body Reference</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the reference '<em>Body Reference</em>'.
     * @see de.cau.cs.kieler.synccharts.State#getBodyReference()
     * @see #getState()
     * @generated
     */
    ...
    /**
     * Returns the meta object for the containment reference '{@link de.cau.cs.kieler.synccharts.State#getBodyContents <em>Body Contents</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the containment reference '<em>Body Contents</em>'.
     * @see de.cau.cs.kieler.synccharts.State#getBodyContents()
     * @see #getState()
     * @generated
     */
