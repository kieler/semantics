...
public abstract class ScopeImpl extends EObjectImpl implements Scope {
	...
	public EList<Variable> getVariables() {
		if (variables == null) {
			variables = new EObjectContainmentWithInverseEList<Variable>(Variable.class, this, SyncchartsPackage.SCOPE__VARIABLES, SyncchartsPackage.VARIABLE__PARENT_SCOPE);
		}
		return variables;
	}
