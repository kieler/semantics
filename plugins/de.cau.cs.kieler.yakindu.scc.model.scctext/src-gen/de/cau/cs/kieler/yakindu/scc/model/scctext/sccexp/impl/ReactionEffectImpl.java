 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.yakindu.scc.model.scctext.sccexp.impl.ReactionEffectImpl#getActions <em>Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReactionEffectImpl extends EffectImpl implements ReactionEffect
{
  ...
  {
    return SccexpPackage.Literals.REACTION_EFFECT;
  }
  ...
  public EList<Expression> getActions()
  {
    if (actions == null)
    {
      actions = new EObjectContainmentEList<Expression>(Expression.class, this, SccexpPackage.REACTION_EFFECT__ACTIONS);
    }
    return actions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SccexpPackage.REACTION_EFFECT__ACTIONS:
