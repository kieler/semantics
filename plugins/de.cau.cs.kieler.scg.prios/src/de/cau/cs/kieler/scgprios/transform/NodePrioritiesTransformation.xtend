...
import de.cau.cs.kieler.scgprios.transform.NodePrioritiesTransformation
...
import de.cau.cs.kieler.scgprios.calculation.SCGtoSCGwithNodePrios
...
class NodePrioritiesTransformation extends Transformation{
    ...
    public def SCGraph transformSCGDEPToSCGNODEPRIO(SCGraph graph) {
        var nodePrios = new SCGtoSCGwithNodePrios
        nodePrios.calcPrios(graph)
        graph
    }
