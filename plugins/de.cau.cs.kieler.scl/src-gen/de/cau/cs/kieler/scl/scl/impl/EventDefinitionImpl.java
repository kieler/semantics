 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.scl.scl.impl.EventDefinitionImpl#isInput <em>Input</em>}</li>
 *   <li>{@link de.cau.cs.kieler.scl.scl.impl.EventDefinitionImpl#isOutput <em>Output</em>}</li>
 *   <li>{@link de.cau.cs.kieler.scl.scl.impl.EventDefinitionImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.cau.cs.kieler.scl.scl.impl.EventDefinitionImpl#getVarInitialValue <em>Var Initial Value</em>}</li>
 *   <li>{@link de.cau.cs.kieler.scl.scl.impl.EventDefinitionImpl#getVarCombineOperator <em>Var Combine Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventDefinitionImpl extends SignalDefinitionImpl implements EventDefinition
{
  ...
  {
    return SclPackage.Literals.EVENT_DEFINITION;
  }
  ...
  public void setInput(boolean newInput)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.EVENT_DEFINITION__INPUT, oldInput, input));
  }
  ...
  public void setOutput(boolean newOutput)
  {
    ...
    output = newOutput;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.EVENT_DEFINITION__OUTPUT, oldOutput, output));
  }
  ...
  public Type getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SclPackage.EVENT_DEFINITION__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(Type newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.EVENT_DEFINITION__TYPE, oldType, type));
  }
  ...
  public NotificationChain basicSetVarInitialValue(Expression newVarInitialValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SclPackage.EVENT_DEFINITION__VAR_INITIAL_VALUE, oldVarInitialValue, newVarInitialValue);
  ...
  public void setVarInitialValue(Expression newVarInitialValue)
  {
    if (newVarInitialValue != varInitialValue)
    {
      ...
      if (varInitialValue != null)
        msgs = ((InternalEObject)varInitialValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SclPackage.EVENT_DEFINITION__VAR_INITIAL_VALUE, null, msgs);
      if (newVarInitialValue != null)
        msgs = ((InternalEObject)newVarInitialValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SclPackage.EVENT_DEFINITION__VAR_INITIAL_VALUE, null, msgs);
      msgs = basicSetVarInitialValue(newVarInitialValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.EVENT_DEFINITION__VAR_INITIAL_VALUE, newVarInitialValue, newVarInitialValue));
  }
  ...
  public void setVarCombineOperator(CombineOperator newVarCombineOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SclPackage.EVENT_DEFINITION__VAR_COMBINE_OPERATOR, oldVarCombineOperator, varCombineOperator));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SclPackage.EVENT_DEFINITION__VAR_INITIAL_VALUE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SclPackage.EVENT_DEFINITION__INPUT:
        return isInput();
      case SclPackage.EVENT_DEFINITION__OUTPUT:
        return isOutput();
      case SclPackage.EVENT_DEFINITION__TYPE:
        if (resolve) return getType();
        return basicGetType();
      case SclPackage.EVENT_DEFINITION__VAR_INITIAL_VALUE:
        return getVarInitialValue();
      case SclPackage.EVENT_DEFINITION__VAR_COMBINE_OPERATOR:
