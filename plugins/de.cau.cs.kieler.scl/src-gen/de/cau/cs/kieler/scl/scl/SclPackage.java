...
/**
  ...
  /**
     ...
     * @ordered
     */
    int CONDITIONAL__ANNOTATIONS = INSTRUCTION_FEATURE_COUNT + 0;
...
/**
   ...
   * <!-- end-user-doc -->
     ...
     * @ordered
     */
  int CONDITIONAL__EXPRESSION = INSTRUCTION_FEATURE_COUNT + 2;
   ...
   * <!-- end-user-doc -->
     ...
     * @ordered
     */
  int CONDITIONAL__DECLARATIONS = INSTRUCTION_FEATURE_COUNT + 3;
   ...
   * <!-- end-user-doc -->
     ...
     * @ordered
     */
  int CONDITIONAL__ELSE_STATEMENTS = INSTRUCTION_FEATURE_COUNT + 4;
   ...
   * <!-- end-user-doc -->
     ...
     * @ordered
     */
  int CONDITIONAL_FEATURE_COUNT = INSTRUCTION_FEATURE_COUNT + 5;
...
/**
  ...
  /**
     ...
     * @ordered
     */
    int STATEMENT_SCOPE__ANNOTATIONS = INSTRUCTION_FEATURE_COUNT + 0;
...
/**
   ...
   * <!-- end-user-doc -->
     ...
     * @ordered
     */
  int STATEMENT_SCOPE__DECLARATIONS = INSTRUCTION_FEATURE_COUNT + 2;
   ...
   * <!-- end-user-doc -->
     ...
     * @ordered
     */
  int STATEMENT_SCOPE_FEATURE_COUNT = INSTRUCTION_FEATURE_COUNT + 3;
