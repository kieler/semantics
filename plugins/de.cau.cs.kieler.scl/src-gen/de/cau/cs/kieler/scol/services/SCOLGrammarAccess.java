 ...
 * generated by Xtext
 */
package de.cau.cs.kieler.scol.services;
...
@Singleton
public class SCOLGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class SCOLProgramElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.scol.SCOL.SCOLProgram");
	...
	private final SCOLProgramElements pSCOLProgram;
	...
	@Inject
	public SCOLGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pSCOLProgram = new SCOLProgramElements();
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("de.cau.cs.kieler.scol.SCOL".equals(grammar.getName())) {
				return grammar;
			}
	...
	//    modules+=Module*
	//;
	public SCOLProgramElements getSCOLProgramAccess() {
		return pSCOLProgram;
	}
	
	public ParserRule getSCOLProgramRule() {
		return getSCOLProgramAccess().getRule();
	}
