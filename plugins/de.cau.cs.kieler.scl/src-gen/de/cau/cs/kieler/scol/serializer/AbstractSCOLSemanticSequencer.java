...
public abstract class AbstractSCOLSemanticSequencer extends SCLSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		else if (epackage == ScolPackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
			case ScolPackage.SCOL_PROGRAM:
				sequence_SCOLProgram(context, (SCOLProgram) semanticObject); 
				return; 
			}
	...
	/**
	 * Contexts:
	 *     SCOLProgram returns SCOLProgram
	 *
	 * Constraint:
	 *     ((pragmas+=Pragma+ modules+=Module+) | modules+=Module+)?
	 */
	protected void sequence_SCOLProgram(ISerializationContext context, SCOLProgram semanticObject) {
