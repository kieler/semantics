...
public class EsiExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {
	...
	public Object create() throws CoreException {
		de.cau.cs.kieler.sim.esi.internal.EsiActivator instance = de.cau.cs.kieler.sim.esi.internal.EsiActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = de.cau.cs.kieler.sim.esi.internal.EsiActivator.getInstance().getInjector("de.cau.cs.kieler.sim.esi.Esi");
