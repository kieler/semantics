	...
	public void start(BundleContext context) throws Exception {
		...
		try {
			...
			injectors.put("de.cau.cs.kieler.sim.esi.Esi", Guice.createInjector(
				Modules.override(Modules.override(getRuntimeModule("de.cau.cs.kieler.sim.esi.Esi")).with(getUiModule("de.cau.cs.kieler.sim.esi.Esi"))).with(getSharedStateModule())
			));
