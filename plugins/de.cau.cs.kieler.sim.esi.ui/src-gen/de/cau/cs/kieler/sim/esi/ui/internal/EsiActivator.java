...
public class EsiActivator extends AbstractUIPlugin {
	...
	private static final Logger logger = Logger.getLogger(EsiActivator.class);
	...
	public static final String DE_CAU_CS_KIELER_SIM_ESI_ESI = "de.cau.cs.kieler.sim.esi.Esi";
	...
	protected Module getRuntimeModule(String grammar) {
		if (DE_CAU_CS_KIELER_SIM_ESI_ESI.equals(grammar)) {
