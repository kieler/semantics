...
public class EsiParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.cau.cs.kieler.contentassist.antlr.internal.InternalEsiLexer createLexer(CharStream stream) {
		return new de.cau.cs.kieler.contentassist.antlr.internal.InternalEsiLexer(stream);
	}
	
	@Override
	protected de.cau.cs.kieler.contentassist.antlr.internal.InternalEsiParser createParser() {
		de.cau.cs.kieler.contentassist.antlr.internal.InternalEsiParser result = new de.cau.cs.kieler.contentassist.antlr.internal.InternalEsiParser(null);
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.cau.cs.kieler.contentassist.antlr.internal.InternalEsiParser typedParser = (de.cau.cs.kieler.contentassist.antlr.internal.InternalEsiParser) parser;
