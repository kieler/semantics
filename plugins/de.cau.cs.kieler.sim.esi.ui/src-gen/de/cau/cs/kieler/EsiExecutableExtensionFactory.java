...
public class EsiExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {
	...
	public Object create() throws CoreException {
		de.cau.cs.kieler.internal.EsiActivator instance = de.cau.cs.kieler.internal.EsiActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = de.cau.cs.kieler.internal.EsiActivator.getInstance().getInjector("de.cau.cs.kieler.Esi");
