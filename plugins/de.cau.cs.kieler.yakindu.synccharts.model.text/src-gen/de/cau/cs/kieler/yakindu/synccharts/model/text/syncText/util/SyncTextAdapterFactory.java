/**
 */
package de.cau.cs.kieler.yakindu.synccharts.model.text.syncText.util;
...
public class SyncTextAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected SyncTextSwitch<Adapter> modelSwitch =
    new SyncTextSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseSCChartsExp_SignalDefinition(de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.scchartstext.sCChartsExp.SignalDefinition object)
      {
      ...
      @Override
      public Adapter caseSCChartsExp_VariableDefinition(de.cau.cs.kieler.yakindu.sccharts.model.scchartstext.scchartstext.sCChartsExp.VariableDefinition object)
      {
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.yakindu.synccharts.model.text.syncText.SignalDefinition <em>Signal Definition</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.yakindu.synccharts.model.text.syncText.VariableDefinition <em>Variable Definition</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.yakindu.synccharts.model.text.syncText.EventDefinition <em>Event Definition</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
