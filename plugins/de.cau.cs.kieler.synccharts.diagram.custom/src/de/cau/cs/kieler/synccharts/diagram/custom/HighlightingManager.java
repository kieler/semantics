...
public final class HighlightingManager {
    ...
    private final HashMap<IWorkbenchPart, HashMap<EditPart, ShapeHighlightEffect>> map;

    /**
     * True if the manager should only be able to receive events through the alternate methods.
     */
    ...
    /**
     * Highlight an edit part with the given colors. This will override any highlighting effect
     * currently in place on the particular edit part.
     * 
     ...
     */
    public static void lockedHighlight(final IWorkbenchPart editor, final EditPart editPart,
            final Color foreground, final Color background) {
        HashMap<EditPart, ShapeHighlightEffect> parts = instance.map.get(editor);
        if (parts == null) {
     ...
     * @param background the background color
     */
    public static void highlight(final IWorkbenchPart editor, final EditPart editPart,
            final Color foreground, final Color background) {
     ...
     * @param editPart the edit part
     */
    public static void lockedReset(final IWorkbenchPart editor, final EditPart editPart) {
        HashMap<EditPart, ShapeHighlightEffect> parts = instance.map.get(editor);
     ...
     * @param editPart the edit part
     */
    public static void reset(final IWorkbenchPart editor, final EditPart editPart) {
        if (!instance.isLocked) {
     ...
     * @return the effect
     */
    private static ShapeHighlightEffect highlightPart(final EditPart part, final Color foreground,
