 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.krep.editors.klp.klp.impl.LabelImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.cau.cs.kieler.krep.editors.klp.klp.impl.LabelImpl#getAddr <em>Addr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LabelImpl extends MinimalEObjectImpl.Container implements Label {
	...
	protected EClass eStaticClass() {
		return KlpPackage.Literals.LABEL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KlpPackage.LABEL__NAME, oldName, name));
	}
	...
	public void setAddr(int newAddr) {
		...
		addr = newAddr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KlpPackage.LABEL__ADDR, oldAddr, addr));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KlpPackage.LABEL__NAME:
				return getName();
			case KlpPackage.LABEL__ADDR:
				return getAddr();
		}
