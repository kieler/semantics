...
public abstract class AbstractLTLFormulaSyntacticSequencer extends AbstractSyntacticSequencer {

	protected LTLFormulaGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (LTLFormulaGrammarAccess) access;
	 ...
	 * This ambiguous syntax occurs at:
	 *     (rule start) '(' (ambiguity) operator=BitwiseNotOperator
	 *     (rule start) '(' (ambiguity) operator=FinalOperator
	 *     (rule start) '(' (ambiguity) operator=GlobalOperator
	 *     (rule start) '(' (ambiguity) operator=NextOperator
	 *     (rule start) '(' (ambiguity) operator=NotOperator
	 *     (rule start) '(' (ambiguity) {OperatorExpression.subExpressions+=}
	 *     (rule start) (ambiguity) operator=BitwiseNotOperator
	 *     (rule start) (ambiguity) operator=FinalOperator
