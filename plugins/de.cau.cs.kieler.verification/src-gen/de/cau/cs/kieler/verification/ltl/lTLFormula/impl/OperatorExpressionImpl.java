 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.verification.ltl.lTLFormula.impl.OperatorExpressionImpl#getSchedule <em>Schedule</em>}</li>
 *   <li>{@link de.cau.cs.kieler.verification.ltl.lTLFormula.impl.OperatorExpressionImpl#getSubExpressions <em>Sub Expressions</em>}</li>
 *   <li>{@link de.cau.cs.kieler.verification.ltl.lTLFormula.impl.OperatorExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperatorExpressionImpl extends MinimalEObjectImpl.Container implements OperatorExpression
{
  ...
  {
    return LTLFormulaPackage.Literals.OPERATOR_EXPRESSION;
  }
  ...
  public EList<ScheduleObjectReference> getSchedule()
  {
    if (schedule == null)
    {
      schedule = new EObjectContainmentEList<ScheduleObjectReference>(ScheduleObjectReference.class, this, LTLFormulaPackage.OPERATOR_EXPRESSION__SCHEDULE);
    }
    return schedule;
  }
  ...
  public EList<Expression> getSubExpressions()
  {
    ...
    {
      subExpressions = new EObjectContainmentEList<Expression>(Expression.class, this, LTLFormulaPackage.OPERATOR_EXPRESSION__SUB_EXPRESSIONS);
    }
  ...
  public void setOperator(LTLOperatorType newOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LTLFormulaPackage.OPERATOR_EXPRESSION__OPERATOR, oldOperator, operator));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LTLFormulaPackage.OPERATOR_EXPRESSION__SCHEDULE:
        return ((InternalEList<?>)getSchedule()).basicRemove(otherEnd, msgs);
      case LTLFormulaPackage.OPERATOR_EXPRESSION__SUB_EXPRESSIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case LTLFormulaPackage.OPERATOR_EXPRESSION__OPERATOR:
        return getOperator();
    }
