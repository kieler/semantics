...
public class InternalKiCoolLexer extends Lexer {
    ...
    public final void mT__34() throws RecognitionException {
        try {
            int _type = T__34;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:29:7: ( 'silent' )
            // InternalKiCool.g:29:9: 'silent'
            {
            match("silent"); 
    ...
    public final void mT__35() throws RecognitionException {
        try {
            int _type = T__35;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:30:7: ( 'key' )
            // InternalKiCool.g:30:9: 'key'
            {
            match("key"); 
    ...
    public final void mRULE_COMMENT_ANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:6016:25: ( '/**' ( options {greedy=false; } : . )* '*/' )
            // InternalKiCool.g:6016:27: '/**' ( options {greedy=false; } : . )* '*/'
            {
            match("/**"); 

            // InternalKiCool.g:6016:33: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:6018:17: ( '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/' )
            // InternalKiCool.g:6018:19: '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 
            ...
            // InternalKiCool.g:6018:31: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_SL_COMMENT_ANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:6020:28: ( '//*' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalKiCool.g:6020:30: '//*' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//*"); 

            // InternalKiCool.g:6020:36: (~ ( ( '\\n' | '\\r' ) ) )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:6022:17: ( '//' ~ ( '*' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalKiCool.g:6022:19: '//' ~ ( '*' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            // InternalKiCool.g:6024:22: ( '0' .. '9' )
            // InternalKiCool.g:6024:24: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:6026:10: ( ( RULE_NUMBER )+ )
            // InternalKiCool.g:6026:12: ( RULE_NUMBER )+
            {
            // InternalKiCool.g:6026:12: ( RULE_NUMBER )+
            int cnt9=0;
            loop9:
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:6028:12: ( ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' ) )
            // InternalKiCool.g:6028:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            {
            // InternalKiCool.g:6028:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // InternalKiCool.g:6028:15: ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )?
                    {
                    // InternalKiCool.g:6028:15: ( RULE_NUMBER )+
                    int cnt10=0;
                    loop10:
                    do {
                        int alt10=2;
                    ...
                    match('.'); 
                    // InternalKiCool.g:6028:32: ( RULE_NUMBER )*
                    loop11:
                    do {
                        int alt11=2;
                    ...
                    // InternalKiCool.g:6028:45: ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )?
                    int alt14=2;
                    ...
                    switch (alt14) {
                        case 1 :
                            // InternalKiCool.g:6028:46: ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+
                            {
                            ...
                            // InternalKiCool.g:6028:67: ( RULE_NUMBER )+
                            int cnt13=0;
                            loop13:
                            do {
                                int alt13=2;
                    ...
                    break;
                case 2 :
                    // InternalKiCool.g:6028:87: ( RULE_NUMBER )+ 'f'
                    {
                    // InternalKiCool.g:6028:87: ( RULE_NUMBER )+
                    int cnt16=0;
                    loop16:
                    do {
                        int alt16=2;
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:6030:14: ( ( 'true' | 'false' ) )
            // InternalKiCool.g:6030:16: ( 'true' | 'false' )
            {
            // InternalKiCool.g:6030:16: ( 'true' | 'false' )
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalKiCool.g:6030:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:6032:13: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalKiCool.g:6032:15: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalKiCool.g:6032:19: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
            loop19:
            do {
                int alt19=3;
                ...
                switch (alt19) {
            	case 1 :
            	    // InternalKiCool.g:6032:20: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:6034:9: ( ( '^' )? ( ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' ) | '_' '0' .. '9' | '__' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalKiCool.g:6034:11: ( '^' )? ( ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' ) | '_' '0' .. '9' | '__' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalKiCool.g:6034:11: ( '^' )?
            int alt20=2;
            ...
            // InternalKiCool.g:6034:16: ( ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' ) | '_' '0' .. '9' | '__' )
            int alt24=3;
            ...
            switch (alt24) {
                case 1 :
                    // InternalKiCool.g:6034:17: ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' )
                    {
                    // InternalKiCool.g:6034:17: ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' )
                    int alt23=2;
                    switch ( input.LA(1) ) {
                    ...
                    switch (alt23) {
                        case 1 :
                            // InternalKiCool.g:6034:18: ( '_' )? 'a' .. 'z'
                            {
                            // InternalKiCool.g:6034:18: ( '_' )?
                            int alt21=2;
                            ...
                            break;
                        case 2 :
                            // InternalKiCool.g:6034:32: ( '_' )? 'A' .. 'Z'
                            {
                            // InternalKiCool.g:6034:32: ( '_' )?
                            int alt22=2;
                    ...
                    break;
                case 2 :
                    // InternalKiCool.g:6034:47: '_' '0' .. '9'
                    {
                    match('_'); 
                    matchRange('0','9'); 
            ...
            // InternalKiCool.g:6034:66: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop25:
            do {
                int alt25=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:6036:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalKiCool.g:6036:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalKiCool.g:6036:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt26=0;
            loop26:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:6038:16: ( . )
            // InternalKiCool.g:6038:18: .
            {
            matchAny(); 
    ...
    static class DFA17 extends DFA {
        ...
        public String getDescription() {
            return "6028:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )";
        }
    }
    static final String DFA27_eotS =
        "\3\uffff\5\40\2\uffff\1\40\4\uffff\1\40\1\32\1\60\2\40\3\32\6\uffff\3\40\1\uffff\4\40\2\uffff\2\40\4\uffff\1\40\4\uffff\1\60\2\40\2\uffff\1\40\1\112\6\40\1\121\2\40\1\124\4\uffff\3\40\1\uffff\6\40\1\uffff\1\40\1\137\1\uffff\1\140\4\40\1\145\1\146\1\40\1\150\1\40\2\uffff\1\140\1\152\1\153\1\40\2\uffff\1\40\1\uffff\1\40\2\uffff\1\157\1\40\1\161\1\uffff\1\40\1\uffff\3\40\1\166\1\uffff";
    static final String DFA27_eofS =
        "\167\uffff";
    static final String DFA27_minS =
        "\1\0\2\uffff\2\145\1\141\1\156\1\154\2\uffff\1\157\4\uffff\1\145\1\52\1\56\1\162\1\141\1\0\1\101\1\60\6\uffff\1\163\1\164\1\154\1\uffff\1\162\1\142\1\160\1\151\2\uffff\1\145\1\163\4\uffff\1\171\2\0\2\uffff\1\56\1\165\1\154\2\uffff\1\164\1\60\1\145\1\163\1\145\1\165\1\145\1\141\1\60\1\143\1\164\1\60\4\uffff\1\145\1\163\1\145\1\uffff\1\156\1\151\1\154\1\164\1\162\1\163\1\uffff\1\145\1\60\1\uffff\1\60\1\145\1\155\1\164\1\157\2\60\1\155\1\60\1\163\2\uffff\3\60\1\156\2\uffff\1\145\1\uffff\1\163\2\uffff\1\60\1\144\1\60\1\uffff\1\151\1\uffff\1\141\1\164\1\145\1\60\1\uffff";
    static final String DFA27_maxS =
        "\1\uffff\2\uffff\1\171\1\145\1\141\1\156\1\154\2\uffff\1\162\4\uffff\1\145\1\57\1\146\1\162\1\141\1\uffff\2\172\6\uffff\1\163\1\164\1\154\1\uffff\1\162\1\142\1\164\1\151\2\uffff\1\157\1\163\4\uffff\1\171\2\uffff\2\uffff\1\146\1\165\1\154\2\uffff\1\164\1\172\1\145\1\163\1\145\1\165\1\145\1\141\1\172\1\143\1\164\1\172\4\uffff\1\145\1\163\1\145\1\uffff\1\156\1\151\1\154\1\164\1\162\1\163\1\uffff\1\145\1\172\1\uffff\1\172\1\145\1\155\1\164\1\157\2\172\1\155\1\172\1\163\2\uffff\3\172\1\156\2\uffff\1\145\1\uffff\1\163\2\uffff\1\172\1\144\1\172\1\uffff\1\151\1\uffff\1\141\1\164\1\145\1\172\1\uffff";
    static final String DFA27_acceptS =
        "\1\uffff\1\1\1\2\5\uffff\1\12\1\13\1\uffff\1\17\1\20\1\21\1\22\10\uffff\2\35\1\36\1\37\1\1\1\2\3\uffff\1\35\4\uffff\1\12\1\13\2\uffff\1\17\1\20\1\21\1\22\3\uffff\1\31\1\32\3\uffff\1\34\1\36\14\uffff\1\25\1\26\1\27\1\30\3\uffff\1\7\6\uffff\1\14\2\uffff\1\24\12\uffff\1\16\1\33\4\uffff\1\5\1\6\1\uffff\1\11\1\uffff\1\3\1\23\3\uffff\1\4\1\uffff\1\15\4\uffff\1\10";
