...
public class InternalKiCoolLexer extends Lexer {
    ...
    public final void mT__25() throws RecognitionException {
        try {
            int _type = T__25;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:21:7: ( 'set' )
            // InternalKiCool.g:21:9: 'set'
            {
            match("set"); 
    ...
    public final void mRULE_COMMENT_ANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:5567:25: ( '/**' ( options {greedy=false; } : . )* '*/' )
            // InternalKiCool.g:5567:27: '/**' ( options {greedy=false; } : . )* '*/'
            {
            match("/**"); 

            // InternalKiCool.g:5567:33: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:5569:17: ( '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/' )
            // InternalKiCool.g:5569:19: '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 
            ...
            // InternalKiCool.g:5569:31: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            // InternalKiCool.g:5571:22: ( '0' .. '9' )
            // InternalKiCool.g:5571:24: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:5573:10: ( ( RULE_NUMBER )+ )
            // InternalKiCool.g:5573:12: ( RULE_NUMBER )+
            {
            // InternalKiCool.g:5573:12: ( RULE_NUMBER )+
            int cnt3=0;
            loop3:
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:5575:12: ( ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' ) )
            // InternalKiCool.g:5575:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            {
            // InternalKiCool.g:5575:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalKiCool.g:5575:15: ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )?
                    {
                    // InternalKiCool.g:5575:15: ( RULE_NUMBER )+
                    int cnt4=0;
                    loop4:
                    do {
                        int alt4=2;
                    ...
                    match('.'); 
                    // InternalKiCool.g:5575:32: ( RULE_NUMBER )*
                    loop5:
                    do {
                        int alt5=2;
                    ...
                    // InternalKiCool.g:5575:45: ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )?
                    int alt8=2;
                    ...
                    switch (alt8) {
                        case 1 :
                            // InternalKiCool.g:5575:46: ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+
                            {
                            ...
                            // InternalKiCool.g:5575:67: ( RULE_NUMBER )+
                            int cnt7=0;
                            loop7:
                            do {
                                int alt7=2;
                    ...
                    break;
                case 2 :
                    // InternalKiCool.g:5575:87: ( RULE_NUMBER )+ 'f'
                    {
                    // InternalKiCool.g:5575:87: ( RULE_NUMBER )+
                    int cnt10=0;
                    loop10:
                    do {
                        int alt10=2;
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:5577:14: ( ( 'true' | 'false' ) )
            // InternalKiCool.g:5577:16: ( 'true' | 'false' )
            {
            // InternalKiCool.g:5577:16: ( 'true' | 'false' )
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalKiCool.g:5577:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:5579:13: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalKiCool.g:5579:15: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalKiCool.g:5579:19: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
            loop13:
            do {
                int alt13=3;
                ...
                switch (alt13) {
            	case 1 :
            	    // InternalKiCool.g:5579:20: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:5581:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalKiCool.g:5581:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalKiCool.g:5581:11: ( '^' )?
            int alt14=2;
            ...
            // InternalKiCool.g:5581:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop15:
            do {
                int alt15=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:5583:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalKiCool.g:5583:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalKiCool.g:5583:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop16:
            do {
                int alt16=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:5585:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalKiCool.g:5585:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalKiCool.g:5585:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt19=0;
            loop19:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKiCool.g:5587:16: ( . )
            // InternalKiCool.g:5587:18: .
            {
            matchAny(); 
    ...
    static class DFA11 extends DFA {
        ...
        public String getDescription() {
            return "5575:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )";
        }
    }
    static final String DFA20_eotS =
        "\2\uffff\5\34\2\uffff\1\34\5\uffff\1\34\1\30\1\55\2\34\2\30\4\uffff\2\34\1\uffff\4\34\2\uffff\2\34\5\uffff\1\34\4\uffff\1\55\2\34\2\uffff\1\34\1\103\5\34\1\111\1\34\1\113\2\uffff\3\34\1\uffff\5\34\1\uffff\1\124\1\uffff\1\125\3\34\1\131\1\132\1\34\1\134\2\uffff\1\125\1\135\1\34\2\uffff\1\34\2\uffff\1\140\1\34\1\uffff\4\34\1\146\1\uffff";
    static final String DFA20_eofS =
        "\147\uffff";
    static final String DFA20_minS =
        "\1\0\1\uffff\2\145\1\141\1\156\1\154\2\uffff\1\157\5\uffff\1\145\1\52\1\56\1\162\1\141\1\0\1\101\4\uffff\1\163\1\164\1\uffff\1\162\1\142\1\160\1\151\2\uffff\1\145\1\163\5\uffff\1\171\1\0\3\uffff\1\56\1\165\1\154\2\uffff\1\164\1\60\1\163\1\145\1\165\1\145\1\141\1\60\1\164\1\60\2\uffff\1\145\1\163\1\145\1\uffff\1\151\1\154\1\164\1\162\1\163\1\uffff\1\60\1\uffff\1\60\1\145\1\155\1\157\2\60\1\155\1\60\2\uffff\2\60\1\156\2\uffff\1\145\2\uffff\1\60\1\144\1\uffff\1\151\1\141\1\164\1\145\1\60\1\uffff";
    static final String DFA20_maxS =
        "\1\uffff\1\uffff\1\171\1\145\1\141\1\156\1\154\2\uffff\1\162\5\uffff\1\145\1\57\1\146\1\162\1\141\1\uffff\1\172\4\uffff\1\163\1\164\1\uffff\1\162\1\142\1\164\1\151\2\uffff\1\145\1\163\5\uffff\1\171\1\uffff\3\uffff\1\146\1\165\1\154\2\uffff\1\164\1\172\1\163\1\145\1\165\1\145\1\141\1\172\1\164\1\172\2\uffff\1\145\1\163\1\145\1\uffff\1\151\1\154\1\164\1\162\1\163\1\uffff\1\172\1\uffff\1\172\1\145\1\155\1\157\2\172\1\155\1\172\2\uffff\2\172\1\156\2\uffff\1\145\2\uffff\1\172\1\144\1\uffff\1\151\1\141\1\164\1\145\1\172\1\uffff";
    static final String DFA20_acceptS =
        "\1\uffff\1\1\5\uffff\1\10\1\11\1\uffff\1\15\1\16\1\17\1\20\1\21\7\uffff\1\31\1\33\1\34\1\1\2\uffff\1\31\4\uffff\1\10\1\11\2\uffff\1\15\1\16\1\17\1\20\1\21\2\uffff\1\32\1\25\1\26\3\uffff\1\30\1\33\12\uffff\1\23\1\24\3\uffff\1\13\5\uffff\1\12\1\uffff\1\22\10\uffff\1\14\1\27\3\uffff\1\4\1\5\1\uffff\1\7\1\2\2\uffff\1\3\5\uffff\1\6";
    static final String DFA20_specialS =
        "\1\0\23\uffff\1\1\26\uffff\1\2\73\uffff}>";
    static final String[] DFA20_transitionS = {
            "\11\30\2\27\2\30\1\27\22\30\1\27\1\30\1\24\1\14\10\30\1\15\1\16\1\1\1\20\12\21\6\30\1\13\32\26\1\7\1\30\1\10\1\25\1\26\1\30\1\6\4\26\1\23\2\26\1\5\1\26\1\17\1\4\3\26\1\11\2\26\1\2\1\22\1\26\1\3\4\26\1\30\1\12\uff83\30",
            "",
            "\1\33\23\uffff\1\32",
            "\1\35",
            "\1\36",
