		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProcessorAccess().getIdAssignment_0(), "rule__Processor__IdAssignment_0");
					put(grammarAccess.getProcessorAccess().getMetricAssignment_1_1(), "rule__Processor__MetricAssignment_1_1");
