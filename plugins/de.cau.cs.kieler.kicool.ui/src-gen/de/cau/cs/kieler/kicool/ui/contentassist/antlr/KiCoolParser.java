		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSystemAccess().getIdAssignment_2(), "rule__System__IdAssignment_2");
					put(grammarAccess.getSystemAccess().getVersionAssignment_4(), "rule__System__VersionAssignment_4");
					put(grammarAccess.getSystemAccess().getLabelAssignment_6(), "rule__System__LabelAssignment_6");
					put(grammarAccess.getSystemAccess().getInputClassAssignment_7_1(), "rule__System__InputClassAssignment_7_1");
					put(grammarAccess.getSystemAccess().getStartsetsAssignment_8_1(), "rule__System__StartsetsAssignment_8_1");
					put(grammarAccess.getSystemAccess().getIntermediatesAssignment_9(), "rule__System__IntermediatesAssignment_9");
					put(grammarAccess.getSystemAccess().getProcessorsAssignment_10(), "rule__System__ProcessorsAssignment_10");
