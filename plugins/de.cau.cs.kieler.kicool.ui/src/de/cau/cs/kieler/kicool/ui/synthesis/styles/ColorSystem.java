...
public enum ColorSystem implements IColorSystem {
    ...
    ON(OK_FOREGROUND, OK_FOREGROUND, OK_FOREGROUND),
    OFF(ERROR_FOREGROUND, ERROR_FOREGROUND, ERROR_FOREGROUND),
    HALT(HALT_FOREGROUND, HALT_FOREGROUND, HALT_FOREGROUND),
