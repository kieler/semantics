                ...
                if (result != null) {
                    if (result.getKey().equals(AbstractResult.STATUS)) {
                        ...
                        if (value.equals(ResultStatus
                            ...
                            return KiemAutoUIPlugin.getCreatedImage();
                        } else if (value.equals(ResultStatus
                                .labelOf(ResultStatus.RUNNING))) {
                            return KiemAutoUIPlugin.getRunningImage();
                        } else if (value.equals(ResultStatus
                                .labelOf(ResultStatus.ABORTED))) {
                            return KiemAutoUIPlugin.getWarningImage();
                        } else if (value.equals(ResultStatus
                                .labelOf(ResultStatus.ERROR))) {
                            return KiemAutoUIPlugin.getFalseImage();
                        } else {
                            return KiemAutoUIPlugin.getTrueImage();
                        }
                    }
