 ...
 * <ol>
 * <li>preparing Esterel code for a possibly visualized simulation execution run
 * </li>
 * <li>generating C code with the Esterelv5_100</li>
 * <li>compiling the C code to an executable</li>
 * <li>starting and running the executable stepwise generating inputs and
 * examinating outputs.</li>
 * </ol>
 * <br>
 * 
 * 
...
public class DataComponent extends EsterelSimulatorDataComponent {
	 ...
	 * {@inheritDoc}
	 */
	protected java.net.URI compileEsterelToC(final URI strlFile,
			final File outFile, final EsterelSimulationProgressMonitor monitor)
			throws IOException, URISyntaxException {

		/*
		 * Handling the header file for the simulation Header must have the same
		 * name as the source esterel file with extension .h
		 */
		...
		System.out.println("Compile 1" + strlFile.toString() + " , "
				+ outFile.toString());
