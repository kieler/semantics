...
public class PartTrigger extends AbstractTrigger implements IPartListener /*, IPartListener2*/ {
    ...
    /** The default property containing the editorInput path if the active is an editor. */
    public static final IProperty<IPath> EDITOR_INPUT_PATH = new Property<IPath>(EDITOR_INPUT_PATH_ID);
...
//        IWorkbenchPart part = partRef.getPart(false);
    ...
    public static enum EventType {
         ...
         * This might occur if a view is maximized, which often leads
         * to strange behavior if PlatformUI....getActiveEditor is used. */
        ACTIVE_EDITOR_HIDDEN,

        /**
         * The active editor is visible again and is kept on.
         * This might occur if a view maximized view is re-normalized,
         * which led to PlatformUI....getActiveEditor returns null in the past.
         */
    ...
    public static class PartState extends AbstractTriggerState implements IPropertyHolder {
         ...
         * 
         * @param theCurrentActivePart the currently active workbench part.
         * @param theCurrentActiveEditorPart the currently active editor part.
         * @param theEventType indicates the kind of the occurred event. 
         */
