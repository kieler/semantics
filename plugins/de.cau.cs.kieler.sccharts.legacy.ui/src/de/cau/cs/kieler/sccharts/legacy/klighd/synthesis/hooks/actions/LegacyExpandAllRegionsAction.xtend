 ...
 */
class LegacyExpandAllRegionsAction implements IAction {
    
    public static val ID = "de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.hooks.actions.LegacyExpandAllRegionsAction"
