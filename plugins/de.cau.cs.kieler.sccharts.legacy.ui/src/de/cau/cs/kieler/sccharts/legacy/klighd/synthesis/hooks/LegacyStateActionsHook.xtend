 ...
 */
@ViewSynthesisShared
class LegacyStateActionsHook extends SynthesisActionHook {
    ...
    /** Action ID */
    public static final String ID = "de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.hooks.LegacyStateActionsHook"
    /** The related synthesis option */
    public static final SynthesisOption SHOW_STATE_ACTIONS = SynthesisOption.createCheckOption("State actions", true).
    	setCategory(GeneralSynthesisOptions::APPEARANCE).setUpdateAction(LegacyStateActionsHook.ID); // Register this action as updater
    ...
    private static final IProperty<Integer> INDEX = new Property<Integer>(
        "de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.hooks.actions.index", 0)
