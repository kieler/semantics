...
import de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.StateSynthesis
import de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.styles.ColorStore
import de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.styles.StateStyles

import static de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.styles.ColorStore.Color.*
 ...
 */
@ViewSynthesisShared
class LegacyBlackWhiteModeHook extends SynthesisHook {
