 ...
 */
@ViewSynthesisShared
class LegacyDeclarationsHook extends SynthesisActionHook {
    ...
    /** Action ID */
    public static final String ID = "de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.hooks.LegacyDeclarationsHook";
    /** The related synthesis option */
    public static final SynthesisOption SHOW_DECLARATIONS = SynthesisOption.createCheckOption("Declarations", true).
        setCategory(GeneralSynthesisOptions::APPEARANCE).setUpdateAction(LegacyDeclarationsHook.ID); // Add this action as updater
    /** Property to save position of the container */
    private static final IProperty<Integer> INDEX = new Property<Integer>(
        "de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.hooks.declarations.index", 0);
