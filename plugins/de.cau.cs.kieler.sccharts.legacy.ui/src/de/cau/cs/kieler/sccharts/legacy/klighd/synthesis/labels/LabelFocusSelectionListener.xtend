...
import de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.hooks.LegacyLabelShorteningHook
...
class LabelFocusSelectionListener implements ISelectionChangedListener {
    ...
    private final static IProperty<Set<WeakReference<KLabel>>> FOCUSED_LABELS = new Property<Set<WeakReference<KLabel>>>(
        "de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.labels.focus", emptySet)
    ...
    override selectionChanged(SelectionChangedEvent event) {
        ...
        val labelShortening = viewContext.getOptionValue(LegacyLabelShorteningHook.SHORTEN_LABEL_STRATEGY)
