 ...
 */
@ViewSynthesisShared
class LegacyLayoutHook extends SynthesisActionHook {
    
    /** Action ID */
    public static final String ID = "de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.hooks.LegacyLayoutHook";
    ...
    public static final SynthesisOption LAYOUT_DIRECTION = SynthesisOption.createChoiceOption("Direction", #["HV", "VH", "Down", "Right"], "HV").
        setCategory(GeneralSynthesisOptions::LAYOUT).setUpdateAction(LegacyLayoutHook.ID); // Register this action as updater
    ...
    private static final IProperty<Boolean> BLOCK_ALTERNATIN_LAYOUT = new Property<Boolean>(
        "de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.hooks.layout.override", false)
    ...
    private static final IProperty<Boolean> DEFAULT_DIRECTION = new Property<Boolean>(
        "de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.hooks.layout.direction.default", false)
    ...
    private static final IProperty<Integer> HV_DEPTH = new Property<Integer>(
        "de.cau.cs.kieler.sccharts.legacy.klighd.synthesis.hooks.layout.hv.depth", null)
