 ...
 */
class LegacySynthesisAnnotationHook extends SynthesisHook {
    ...
    override start(Scope source, KNode node) {
        ...
        source.annotations.filter[name === SYNTHESIS_OPTIONS_ANNOTATION].forEach[processSynthesisOptionAnnotation];
    }
