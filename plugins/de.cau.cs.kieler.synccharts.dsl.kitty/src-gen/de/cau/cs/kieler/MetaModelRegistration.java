...
public class MetaModelRegistration {
    ...
    static {
		...
		public static void register() {
			String nsURI = "http://de.cau.cs.kieler.synccharts.dsl.kitty";
			if (EPackage.Registry.INSTANCE.get(nsURI) == null) {
   				try {
					EPackage pack = (EPackage) loadRootObject("de/cau/cs/kieler/kitty" + ".ecore");
	...
	public static EPackage getEPackage() {
		return EPackage.Registry.INSTANCE.getEPackage("http://de.cau.cs.kieler.synccharts.dsl.kitty");
	}
