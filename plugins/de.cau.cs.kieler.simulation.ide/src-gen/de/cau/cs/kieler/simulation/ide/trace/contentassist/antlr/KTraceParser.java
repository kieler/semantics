 ...
 * generated by Xtext
 */
package de.cau.cs.kieler.simulation.ide.trace.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import de.cau.cs.kieler.simulation.ide.trace.contentassist.antlr.internal.InternalKTraceParser;
...
public class KTraceParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(KTraceGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KTraceGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getTraceFileAccess().getAlternatives(), "rule__TraceFile__Alternatives");
			...
			builder.put(grammarAccess.getEsoTickAccess().getGroup_2_1_1(), "rule__EsoTick__Group_2_1_1__0");
			builder.put(grammarAccess.getEsoTickAccess().getGroup_4(), "rule__EsoTick__Group_4__0");
			builder.put(grammarAccess.getEsoTickAccess().getGroup_4_1_1(), "rule__EsoTick__Group_4_1_1__0");
			builder.put(grammarAccess.getKVPairAccess().getGroup(), "rule__KVPair__Group__0");
			builder.put(grammarAccess.getKTracesAccess().getGroup(), "rule__KTraces__Group__0");
			builder.put(grammarAccess.getKTracesAccess().getGroup_1(), "rule__KTraces__Group_1__0");
			builder.put(grammarAccess.getKTracesAccess().getGroup_3(), "rule__KTraces__Group_3__0");
			builder.put(grammarAccess.getKTracesAccess().getGroup_4(), "rule__KTraces__Group_4__0");
			builder.put(grammarAccess.getKTraceAccess().getGroup(), "rule__KTrace__Group__0");
			builder.put(grammarAccess.getKTickAccess().getGroup(), "rule__KTick__Group__0");
			builder.put(grammarAccess.getKTickAccess().getGroup_1(), "rule__KTick__Group_1__0");
			builder.put(grammarAccess.getKTickAccess().getGroup_3(), "rule__KTick__Group_3__0");
			builder.put(grammarAccess.getKTickAccess().getGroup_5(), "rule__KTick__Group_5__0");
			...
			builder.put(grammarAccess.getEsoTracesAccess().getTracesAssignment(), "rule__EsoTraces__TracesAssignment");
			builder.put(grammarAccess.getEsoTraceAccess().getTicksAssignment_3(), "rule__EsoTrace__TicksAssignment_3");
			builder.put(grammarAccess.getEsoTickAccess().getInputsAssignment_1(), "rule__EsoTick__InputsAssignment_1");
			builder.put(grammarAccess.getEsoTickAccess().getOutputsAssignment_2_2(), "rule__EsoTick__OutputsAssignment_2_2");
			builder.put(grammarAccess.getEsoTickAccess().getAnnotationsAssignment_3(), "rule__EsoTick__AnnotationsAssignment_3");
			builder.put(grammarAccess.getEsoTickAccess().getAnnotationsAssignment_4_2(), "rule__EsoTick__AnnotationsAssignment_4_2");
			builder.put(grammarAccess.getKVPairAccess().getNameAssignment_1(), "rule__KVPair__NameAssignment_1");
			builder.put(grammarAccess.getKVPairAccess().getValuesAssignment_3(), "rule__KVPair__ValuesAssignment_3");
			builder.put(grammarAccess.getKTracesAccess().getPragmasAssignment_0(), "rule__KTraces__PragmasAssignment_0");
			builder.put(grammarAccess.getKTracesAccess().getTracesAssignment_2(), "rule__KTraces__TracesAssignment_2");
			builder.put(grammarAccess.getKTracesAccess().getTracesAssignment_3_2(), "rule__KTraces__TracesAssignment_3_2");
			builder.put(grammarAccess.getKTraceAccess().getPragmasAssignment_0(), "rule__KTrace__PragmasAssignment_0");
			builder.put(grammarAccess.getKTraceAccess().getTicksAssignment_1(), "rule__KTrace__TicksAssignment_1");
			builder.put(grammarAccess.getKTickAccess().getNameAssignment_1_0(), "rule__KTick__NameAssignment_1_0");
			builder.put(grammarAccess.getKTickAccess().getInputsAssignment_2(), "rule__KTick__InputsAssignment_2");
			builder.put(grammarAccess.getKTickAccess().getOutputsAssignment_3_1(), "rule__KTick__OutputsAssignment_3_1");
			builder.put(grammarAccess.getKTickAccess().getGotoAssignment_5_1(), "rule__KTick__GotoAssignment_5_1");
	...
	@Override
	protected InternalKTraceParser createParser() {
		InternalKTraceParser result = new InternalKTraceParser(null);
