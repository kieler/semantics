 ...
 */
public class SCLPExecution extends AbstractExecution {
    ...
    /** The path to scl. */
    private static final String SCLP_PATH = "sclp";
     ...
     */
    public SCLPExecution(final String outputPath, final boolean cycleCountOrTime) {
    ...
    public String buildCompileCommandLine(final List<String> filePaths) {
        ...
        System.out.println("start buildCompileCommandLine");
