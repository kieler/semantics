 ...
 * CellEditor by overriding {@link #provideCellEditor(Composite)}. It may also provide its own icon
 * Image by overriding the {@link #provideIcon()} method.
 * 
...
public abstract class KiemPropertyType implements IKiemPropertyType {
    ...
    private static final Image PROPERTY_DEFAULT = AbstractUIPlugin.imageDescriptorFromPlugin(
            "de.cau.cs.kieler.sim.kiem", "icons/propertyIcon.png").createImage();
    ...
    /**
     * Provides a cell editor of this KiemPropertyType. This method may be overridden by
     * implementing classes. By default it provides a TextCellEditor.
     * 
     * @param parent
    ...
    /**
     * Provide an icon Image for this KiemPropertyType. This method may be overridden by
     * implementing classes. By default it provides a plain property icon.
     * 
    ...
    /**
     * Sets the default cell editor. This method is called by the EditingSupport and should be left
     * untouched. Please use the method {@link #provideCellEditor(Composite)} to provide a different
     * than the default CellEditor.
     * 
     * @param parent
     *            the parent SWT composite that holds the Cell Editor
     */
    public final void setCellEditor(final Composite parent) {
    ...
    /**
     * Gets the CellEditor that is used for this KiemPropertyType. This method is called by the
     * EditingSupport and should be left untouched. Please use the method
     * {@link #provideCellEditor(Composite)} to provide a different than the default CellEditor.
     * 
    ...
    /**
     * Gets the icon Image of this KiemPropertyType. This method is called by the LabelProvide and
     * should be left untouched. Please use the method {@link #provideIcon()} to provide a different
