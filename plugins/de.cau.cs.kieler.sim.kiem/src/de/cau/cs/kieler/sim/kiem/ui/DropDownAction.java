...
/**
 * The Class DropDownAction. This is a helper class that simplifies the creation of drop down
 * actions, by adding simple Actions. A DropDownAction always has a default Action which it refers
...
public class DropDownAction extends Action implements IMenuCreator {
    ...
    /**
     * Instantiates a new drop down action. This always has a default Action that is the first
     * action in the drop down menu. The DropDownAction inherits the icon, action, text, enableness
     * and the visibility from this default Action.
     * 
     * @param defaultActionParam
     *            the default Action
     */
    public DropDownAction(final Action defaultActionParam) {
        this.defaultAction = defaultActionParam;
        ...
        IPropertyChangeListener pcl = new PropertyChangeListener();
     ...
     *            the citem
     */
    protected void addContributionItemToMenu(final Menu parent, final IContributionItem citem) {
     ...
     *            the IContributionItem to add
     */
    public void add(final IContributionItem contributionItem) {
    ...
    public Menu getMenu(final Control parent) {
        ...
        for (int c = 0; c < this.itemList.size(); c++) {
            ...
            if (item instanceof Action) {
                ...
                addContributionItemToMenu(fMenu, (IContributionItem) itemList.get(c));
            }
    ...
    /**
     * The listener interface for receiving propertyChange events. The class that is interested in
     * processing a propertyChange event implements this interface, and the object created with that
     * class is registered with a component using the component's
     * <code>addPropertyChangeListener</code> method. When the propertyChange event occurs, that
    ...
    class PropertyChangeListener implements IPropertyChangeListener {
        public void propertyChange(final org.eclipse.jface.util.PropertyChangeEvent event) {
            ...
            setDisabledImageDescriptor(defaultAction.getDisabledImageDescriptor());
