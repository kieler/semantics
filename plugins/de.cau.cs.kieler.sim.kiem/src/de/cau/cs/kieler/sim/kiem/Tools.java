...
import de.cau.cs.kieler.sim.kiem.ui.AbortErrorDialog;
...
// create a SchemaFactory capable of understanding WXS schemas
	...
	private static IStatusLineManager getStatusLineManager(){
			...
			for (int i = 0; i < views.length; i++) {
				...
				if(view.getViewSite().getId().equals(KiemView.ID)){
...
class DiagramRunnable implements Runnable{
	...
	public void run() {
		...
		Status s = new Status(IStatus.ERROR, KiemPlugin.PLUGIN_ID, exc.getMessage(),alibiException);
