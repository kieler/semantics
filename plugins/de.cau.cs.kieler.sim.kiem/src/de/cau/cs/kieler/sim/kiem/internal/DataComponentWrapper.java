 ...
 * {@link de.cau.cs.kieler.sim.kiem.internal.AbstractDataComponent} class. It should enrich the
...
public class DataComponentWrapper implements Serializable {
     ...
     *            the contained DataComponent
     */
    public DataComponentWrapper(final AbstractDataComponent componentParam) {
        super();
    ...
    /**
     * Sets the properties for the DataComponent and this DataComponentWrapper instance. These are just
     ...
     * 
     * @see de.cau.cs.kieler.sim.kiem.internal.AbstractDataComponent#isProducer()
     */
     ...
     * 
     * @see de.cau.cs.kieler.sim.kiem.internal.AbstractDataComponent#isObserver()
     */
     ...
     * @return the name
     * 
     * @see de.cau.cs.kieler.sim.kiem.internal.AbstractDataComponent#getName()
     */
     ...
     * 
     * @see de.cau.cs.kieler.sim.kiem.internal.AbstractDataComponent#provideFilterKeys()
     */
     ...
     * 
     * @see de.cau.cs.kieler.sim.kiem.internal.AbstractDataComponent#getProperties()
     */
     ...
     * 
     * @see de.cau.cs.kieler.sim.kiem.internal.AbstractDataComponent#isHistoryStep()
     */
     ...
     * 
     * @see de.cau.cs.kieler.sim.kiem.internal.AbstractDataComponent#setHistoryStep(boolean)
     */
     ...
     * 
     * @see de.cau.cs.kieler.sim.kiem.internal.AbstractDataComponent#isMaster()
     */
     ...
     * 
     * @see de.cau.cs.kieler.sim.kiem.internal.AbstractDataComponent#isMacroStepDone()
     */
     ...
     * 
     * @see de.cau.cs.kieler.sim.kiem.internal.AbstractDataComponent#checkProperties(KiemProperty[])
     */
     ...
     * 
     * @see de.cau.cs.kieler.sim.kiem.internal.AbstractDataComponent#isMasterImplementingGUI()
     */
