 ...
 * 
 */
public class KiemPropertyTypeBool extends KiemPropertyType implements
		IKiemPropertyType {
	 ...
	 * 
	 * @see
	 * de.cau.cs.kieler.sim.kiem.data.KiemPropertyType#provideCellEditor(org
	...
	/**
	 * This method bridges boolean values (encoded as Strings in property) to
	 * int of the combobox cell editor. If the first item is selected, the saved
