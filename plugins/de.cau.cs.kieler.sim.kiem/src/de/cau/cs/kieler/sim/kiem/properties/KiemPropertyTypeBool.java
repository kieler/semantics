...
public class KiemPropertyTypeBool extends KiemPropertyType implements IKiemPropertyType {
     ...
     * (non-Javadoc)
     * 
     * @see de.cau.cs.kieler.sim.kiem.data.KiemPropertyType#provideCellEditor(org
    ...
    /**
     * This method bridges boolean values (encoded as Strings in property) to int of the combobox
     * cell editor. If the String is equal to "true" it returns 1. This tells the cell editor to
     * display the first item (true) in the combobox. Otherwise the second item (false) is
     * displayed.
     * 
     * {@inheritDoc}
     */
    ...
    /**
     * This method bridges boolean values (encoded as Strings in property) to int of the combobox
     * cell editor. If the first item is selected, the saved value is "true", otherwise it is
     * "false".
     * 
     * {@inheritDoc}
     */
