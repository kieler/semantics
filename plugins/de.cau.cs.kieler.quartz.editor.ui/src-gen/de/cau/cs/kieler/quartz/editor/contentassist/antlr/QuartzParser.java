		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAtomicStmtAccess().getAlternatives_9_2_1(), "rule__AtomicStmt__Alternatives_9_2_1");
					...
					put(grammarAccess.getAtomicStmtAccess().getGroup_9_2(), "rule__AtomicStmt__Group_9_2__0");
					...
					put(grammarAccess.getAtomicStmtAccess().getT23Assignment_7_2(), "rule__AtomicStmt__T23Assignment_7_2");
					put(grammarAccess.getAtomicStmtAccess().getT06Assignment_8_3(), "rule__AtomicStmt__T06Assignment_8_3");
					put(grammarAccess.getAtomicStmtAccess().getTAssignment_9_3(), "rule__AtomicStmt__TAssignment_9_3");
					put(grammarAccess.getAtomicStmtAccess().getT13Assignment_10_2(), "rule__AtomicStmt__T13Assignment_10_2");
					put(grammarAccess.getAtomicStmtAccess().getT14Assignment_10_4(), "rule__AtomicStmt__T14Assignment_10_4");
					put(grammarAccess.getAtomicStmtAccess().getExprAssignment_11_4(), "rule__AtomicStmt__ExprAssignment_11_4");
					put(grammarAccess.getAtomicStmtAccess().getT24Assignment_11_6(), "rule__AtomicStmt__T24Assignment_11_6");
					put(grammarAccess.getAtomicStmtAccess().getT07Assignment_13_2(), "rule__AtomicStmt__T07Assignment_13_2");
