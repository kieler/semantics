...
* generated by Xtext
*/
package de.cau.cs.kieler.yakindu.model.stext.ui.contentassist.antlr;
...
public class SynctextParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.cau.cs.kieler.yakindu.model.stext.ui.contentassist.antlr.internal.InternalSynctextParser createParser() {
		de.cau.cs.kieler.yakindu.model.stext.ui.contentassist.antlr.internal.InternalSynctextParser result = new de.cau.cs.kieler.yakindu.model.stext.ui.contentassist.antlr.internal.InternalSynctextParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getReactionTriggerAccess().getAlternatives_4(), "rule__ReactionTrigger__Alternatives_4");
					...
					put(grammarAccess.getReactionTriggerAccess().getGroup_4_1(), "rule__ReactionTrigger__Group_4_1__0");
					...
					put(grammarAccess.getReactionTriggerAccess().getDelayAssignment_3(), "rule__ReactionTrigger__DelayAssignment_3");
					put(grammarAccess.getReactionTriggerAccess().getTriggerAssignment_4_0(), "rule__ReactionTrigger__TriggerAssignment_4_0");
					put(grammarAccess.getReactionTriggerAccess().getGuardExpressionAssignment_4_1_1(), "rule__ReactionTrigger__GuardExpressionAssignment_4_1_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.cau.cs.kieler.yakindu.model.stext.ui.contentassist.antlr.internal.InternalSynctextParser typedParser = (de.cau.cs.kieler.yakindu.model.stext.ui.contentassist.antlr.internal.InternalSynctextParser) parser;
