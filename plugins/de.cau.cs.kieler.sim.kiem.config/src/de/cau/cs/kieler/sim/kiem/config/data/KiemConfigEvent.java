...
/**
 * Slightly modified version of the original KiemEvent.
 * <p>
...
public class KiemConfigEvent {
     ...
     */
    public static final int FILE_LOADED = 4096;

    /**
     * The Constant SAVE event is triggered when the user saves a scheduling.
     * The info in this case is the location of the file as an IPath object.
     */
    public static final int FILE_SAVED = 8192;

    /**
     * The Constant LOCATION CHANGED event is triggered when the user renames,
     * deletes or moves an execution file through the eclipse refactoring
     * mechanism.
     */
    public static final int FILE_LOCATION_CHANGED = 16384;

    /**
     * This Constant event is triggered when anything is loaded from the Eclipse
     * Preference Store and the preference pages or some other part has to
     * refresh their information.
     */
    public static final int PREFERENCES_LOADED = 32768;

    /**
     * This Constant event is triggered when anything is saved to the Eclipse
     * Preference Store.
     */
    public static final int PREFERENCES_SAVED = 65536;
     ...
     */
    public KiemConfigEvent(final int[] eventCodesParam, final Object infoParam) {
     ...
     *            the event codes param
     */
    public KiemConfigEvent(final int[] eventCodesParam) {
        this.event = eventCodesParam.clone();
        this.info = null;
    }
     ...
     */
    public KiemConfigEvent(final int eventCodeParam, final Object infoParam) {
     ...
     *            the event code param
     */
    public KiemConfigEvent(final int eventCodeParam) {
        this.event = new int[1];
        this.event[0] = eventCodeParam;
        this.info = null;
    }
