...
public class InternalKEffectsLexer extends Lexer {
    ...
    public final void mRULE_HOSTCODE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKEffects.g:10188:15: ( '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            // InternalKEffects.g:10188:17: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
            {
            match('\''); 
            // InternalKEffects.g:10188:22: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
            loop1:
            do {
                int alt1=3;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalKEffects.g:10188:23: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
    ...
    public final void mRULE_COMMENT_ANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKEffects.g:10190:25: ( '/**' ( options {greedy=false; } : . )* '*/' )
            // InternalKEffects.g:10190:27: '/**' ( options {greedy=false; } : . )* '*/'
            {
            match("/**"); 

            // InternalKEffects.g:10190:33: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKEffects.g:10192:17: ( '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/' )
            // InternalKEffects.g:10192:19: '/*' ~ ( '*' ) ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 
            ...
            // InternalKEffects.g:10192:31: ( options {greedy=false; } : . )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            // InternalKEffects.g:10194:22: ( '0' .. '9' )
            // InternalKEffects.g:10194:24: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKEffects.g:10196:10: ( ( RULE_NUMBER )+ )
            // InternalKEffects.g:10196:12: ( RULE_NUMBER )+
            {
            // InternalKEffects.g:10196:12: ( RULE_NUMBER )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKEffects.g:10198:12: ( ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' ) )
            // InternalKEffects.g:10198:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            {
            // InternalKEffects.g:10198:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // InternalKEffects.g:10198:15: ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )?
                    {
                    // InternalKEffects.g:10198:15: ( RULE_NUMBER )+
                    int cnt5=0;
                    loop5:
                    do {
                        int alt5=2;
                    ...
                    match('.'); 
                    // InternalKEffects.g:10198:32: ( RULE_NUMBER )*
                    loop6:
                    do {
                        int alt6=2;
                    ...
                    // InternalKEffects.g:10198:45: ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )?
                    int alt9=2;
                    ...
                    switch (alt9) {
                        case 1 :
                            // InternalKEffects.g:10198:46: ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+
                            {
                            ...
                            // InternalKEffects.g:10198:67: ( RULE_NUMBER )+
                            int cnt8=0;
                            loop8:
                            do {
                                int alt8=2;
                    ...
                    break;
                case 2 :
                    // InternalKEffects.g:10198:87: ( RULE_NUMBER )+ 'f'
                    {
                    // InternalKEffects.g:10198:87: ( RULE_NUMBER )+
                    int cnt11=0;
                    loop11:
                    do {
                        int alt11=2;
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKEffects.g:10200:14: ( ( 'true' | 'false' ) )
            // InternalKEffects.g:10200:16: ( 'true' | 'false' )
            {
            // InternalKEffects.g:10200:16: ( 'true' | 'false' )
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalKEffects.g:10200:17: 'true'
                    {
                    match("true"); 
                    ...
                    break;
                case 2 :
                    // InternalKEffects.g:10200:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKEffects.g:10202:13: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalKEffects.g:10202:15: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalKEffects.g:10202:19: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
            loop14:
            do {
                int alt14=3;
                ...
                switch (alt14) {
            	case 1 :
            	    // InternalKEffects.g:10202:20: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
            	    if ( input.LA(1)=='\"'||input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||input.LA(1)=='t' ) {
            	        input.consume();
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKEffects.g:10204:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalKEffects.g:10204:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalKEffects.g:10204:11: ( '^' )?
            int alt15=2;
            ...
            // InternalKEffects.g:10204:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop16:
            do {
                int alt16=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKEffects.g:10206:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalKEffects.g:10206:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalKEffects.g:10206:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop17:
            do {
                int alt17=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKEffects.g:10208:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalKEffects.g:10208:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalKEffects.g:10208:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt20=0;
            loop20:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalKEffects.g:10210:16: ( . )
            // InternalKEffects.g:10210:18: .
            {
            matchAny(); 
    ...
    public void mTokens() throws RecognitionException {
        ...
        switch (alt21) {
            ...
            case 34 :
                ...
                break;
            case 35 :
                // InternalKEffects.g:1:214: RULE_HOSTCODE
                {
                mRULE_HOSTCODE(); 
                ...
                break;
            case 36 :
                // InternalKEffects.g:1:228: RULE_COMMENT_ANNOTATION
                {
                ...
                break;
            case 37 :
                // InternalKEffects.g:1:252: RULE_ML_COMMENT
                {
                mRULE_ML_COMMENT(); 
                ...
                break;
            case 38 :
                // InternalKEffects.g:1:268: RULE_INT
                {
                mRULE_INT(); 
                ...
                break;
            case 39 :
                // InternalKEffects.g:1:277: RULE_FLOAT
                {
                mRULE_FLOAT(); 
                ...
                break;
            case 40 :
                // InternalKEffects.g:1:288: RULE_BOOLEAN
                {
                mRULE_BOOLEAN(); 
                ...
                break;
            case 41 :
                // InternalKEffects.g:1:301: RULE_STRING
                {
                mRULE_STRING(); 
                ...
                break;
            case 42 :
                // InternalKEffects.g:1:313: RULE_ID
                {
                mRULE_ID(); 
                ...
                break;
            case 43 :
                // InternalKEffects.g:1:321: RULE_SL_COMMENT
                {
                mRULE_SL_COMMENT(); 
                ...
                break;
            case 44 :
                // InternalKEffects.g:1:337: RULE_WS
                {
                mRULE_WS(); 
                ...
                break;
            case 45 :
                // InternalKEffects.g:1:345: RULE_ANY_OTHER
                {
                mRULE_ANY_OTHER(); 
    ...
    static class DFA12 extends DFA {
        ...
        public String getDescription() {
            return "10198:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )";
        }
    }
    static final String DFA21_eotS =
        "\1\uffff\1\40\1\42\1\44\1\46\1\51\1\54\1\56\1\uffff\1\63\1\40\1\66\1\70\1\72\1\74\7\uffff\1\36\1\105\2\40\2\36\3\uffff\1\40\24\uffff\1\40\22\uffff\1\105\2\40\2\uffff\1\122\2\uffff\1\123\2\40\2\uffff\1\126\1\40\1\uffff\1\126";
    static final String DFA21_eofS =
        "\130\uffff";
    static final String DFA21_minS =
        "\1\0\1\162\1\174\1\46\1\75\1\53\1\55\1\75\1\uffff\1\52\1\141\1\51\3\75\7\uffff\1\0\1\56\1\162\1\141\1\0\1\101\3\uffff\1\145\21\uffff\1\0\2\uffff\1\154\22\uffff\1\56\1\165\1\154\2\uffff\1\60\2\uffff\1\60\1\145\1\163\2\uffff\1\60\1\145\1\uffff\1\60";
    static final String DFA21_maxS =
        "\1\uffff\1\162\1\174\1\46\4\75\1\uffff\1\75\1\141\1\51\3\75\7\uffff\1\uffff\1\146\1\162\1\141\1\uffff\1\172\3\uffff\1\145\21\uffff\1\uffff\2\uffff\1\154\22\uffff\1\146\1\165\1\154\2\uffff\1\172\2\uffff\1\172\1\145\1\163\2\uffff\1\172\1\145\1\uffff\1\172";
    static final String DFA21_acceptS =
        "\10\uffff\1\10\6\uffff\1\34\1\35\1\36\1\37\1\40\1\41\1\42\6\uffff\1\52\1\54\1\55\1\uffff\1\52\1\13\1\2\1\14\1\3\1\32\1\4\1\17\1\23\1\5\1\20\1\24\1\6\1\21\1\7\1\10\1\22\1\uffff\1\53\1\11\1\uffff\1\15\1\33\1\25\1\16\1\27\1\26\1\31\1\30\1\34\1\35\1\36\1\37\1\40\1\41\1\42\1\43\1\46\1\47\3\uffff\1\51\1\54\1\uffff\1\44\1\45\3\uffff\1\1\1\12\2\uffff\1\50\1\uffff";
