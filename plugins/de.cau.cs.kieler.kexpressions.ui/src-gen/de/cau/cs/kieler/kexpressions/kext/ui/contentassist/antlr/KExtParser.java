		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getScheduleDeclarationAccess().getGroup_5(), "rule__ScheduleDeclaration__Group_5__0");
					put(grammarAccess.getScheduleDeclarationWOSemicolonAccess().getGroup(), "rule__ScheduleDeclarationWOSemicolon__Group__0");
					put(grammarAccess.getScheduleDeclarationWOSemicolonAccess().getGroup_5(), "rule__ScheduleDeclarationWOSemicolon__Group_5__0");
					...
					put(grammarAccess.getScheduleDeclarationAccess().getPrioritiesAssignment_3(), "rule__ScheduleDeclaration__PrioritiesAssignment_3");
					put(grammarAccess.getScheduleDeclarationAccess().getValuedObjectsAssignment_4(), "rule__ScheduleDeclaration__ValuedObjectsAssignment_4");
					put(grammarAccess.getScheduleDeclarationAccess().getValuedObjectsAssignment_5_1(), "rule__ScheduleDeclaration__ValuedObjectsAssignment_5_1");
					...
					put(grammarAccess.getScheduleDeclarationWOSemicolonAccess().getPrioritiesAssignment_3(), "rule__ScheduleDeclarationWOSemicolon__PrioritiesAssignment_3");
					put(grammarAccess.getScheduleDeclarationWOSemicolonAccess().getValuedObjectsAssignment_4(), "rule__ScheduleDeclarationWOSemicolon__ValuedObjectsAssignment_4");
					put(grammarAccess.getScheduleDeclarationWOSemicolonAccess().getValuedObjectsAssignment_5_1(), "rule__ScheduleDeclarationWOSemicolon__ValuedObjectsAssignment_5_1");
