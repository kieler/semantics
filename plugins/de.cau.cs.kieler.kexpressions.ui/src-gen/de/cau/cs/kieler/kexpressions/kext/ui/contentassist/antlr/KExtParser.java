 ...
 * generated by Xtext
 */
package de.cau.cs.kieler.kexpressions.kext.ui.contentassist.antlr;
...
public class KExtParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.cau.cs.kieler.kexpressions.kext.ui.contentassist.antlr.internal.InternalKExtParser createParser() {
		de.cau.cs.kieler.kexpressions.kext.ui.contentassist.antlr.internal.InternalKExtParser result = new de.cau.cs.kieler.kexpressions.kext.ui.contentassist.antlr.internal.InternalKExtParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVariableDeclarationAccess().getExternAssignment_5(), "rule__VariableDeclaration__ExternAssignment_5");
					...
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getExternAssignment_5(), "rule__VariableDeclarationWOSemicolon__ExternAssignment_5");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.cau.cs.kieler.kexpressions.kext.ui.contentassist.antlr.internal.InternalKExtParser typedParser = (de.cau.cs.kieler.kexpressions.kext.ui.contentassist.antlr.internal.InternalKExtParser) parser;
