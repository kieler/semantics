 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.editor.quartz.quartz.InOutName#getNames <em>Names</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.editor.quartz.quartz.QuartzPackage#getInOutName()
 * @model
 * @generated
 */
public interface InOutName extends InOutNameList
{
   ...
   * @see de.cau.cs.kieler.editor.quartz.quartz.QuartzPackage#getInOutName_Names()
