 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.editor.quartz.quartz.ImportList#getImp <em>Imp</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.editor.quartz.quartz.QuartzPackage#getImportList()
 * @model
 * @generated
 */
public interface ImportList extends EObject
{
   ...
   * @see de.cau.cs.kieler.editor.quartz.quartz.QuartzPackage#getImportList_Imp()
