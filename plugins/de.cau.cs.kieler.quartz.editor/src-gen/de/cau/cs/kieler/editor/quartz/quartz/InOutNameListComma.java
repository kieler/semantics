 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.editor.quartz.quartz.InOutNameListComma#getNames <em>Names</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.editor.quartz.quartz.QuartzPackage#getInOutNameListComma()
 * @model
 * @generated
 */
public interface InOutNameListComma extends EObject
{
   ...
   * The list contents are of type {@link de.cau.cs.kieler.editor.quartz.quartz.InOutName}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.cau.cs.kieler.editor.quartz.quartz.QuartzPackage#getInOutNameListComma_Names()
