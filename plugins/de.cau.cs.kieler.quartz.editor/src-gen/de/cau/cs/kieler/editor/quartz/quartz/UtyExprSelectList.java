 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.editor.quartz.quartz.UtyExprSelectList#getTk <em>Tk</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.editor.quartz.quartz.QuartzPackage#getUtyExprSelectList()
 * @model
 * @generated
 */
public interface UtyExprSelectList extends EObject
{
   ...
   * @see #setTk(UtyExpr)
   * @see de.cau.cs.kieler.editor.quartz.quartz.QuartzPackage#getUtyExprSelectList_Tk()
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.editor.quartz.quartz.UtyExprSelectList#getTk <em>Tk</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
