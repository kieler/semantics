 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.editor.quartz.quartz.QType#getTa <em>Ta</em>}</li>
 *   <li>{@link de.cau.cs.kieler.editor.quartz.quartz.QType#getTb <em>Tb</em>}</li>
 *   <li>{@link de.cau.cs.kieler.editor.quartz.quartz.QType#getTc <em>Tc</em>}</li>
 *   <li>{@link de.cau.cs.kieler.editor.quartz.quartz.QType#getDims <em>Dims</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.editor.quartz.quartz.QuartzPackage#getQType()
 * @model
 * @generated
 */
public interface QType extends EObject
{
   ...
   * @see #setTa(UtyExpr)
   * @see de.cau.cs.kieler.editor.quartz.quartz.QuartzPackage#getQType_Ta()
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.editor.quartz.quartz.QType#getTa <em>Ta</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setTb(UtyExpr)
   * @see de.cau.cs.kieler.editor.quartz.quartz.QuartzPackage#getQType_Tb()
   * @model containment="true"
   * @generated
   */
  UtyExpr getTb();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.editor.quartz.quartz.QType#getTb <em>Tb</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setTc(UtyExpr)
   * @see de.cau.cs.kieler.editor.quartz.quartz.QuartzPackage#getQType_Tc()
   * @model containment="true"
   * @generated
   */
  UtyExpr getTc();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.editor.quartz.quartz.QType#getTc <em>Tc</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setDims(DimList)
   * @see de.cau.cs.kieler.editor.quartz.quartz.QuartzPackage#getQType_Dims()
   * @model containment="true"
   * @generated
   */
  DimList getDims();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.editor.quartz.quartz.QType#getDims <em>Dims</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
