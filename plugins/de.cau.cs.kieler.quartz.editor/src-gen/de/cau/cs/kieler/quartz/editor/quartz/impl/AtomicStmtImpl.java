 ...
 *   <li>{@link de.cau.cs.kieler.quartz.editor.quartz.impl.AtomicStmtImpl#getT16 <em>T16</em>}</li>
...
public class AtomicStmtImpl extends MinimalEObjectImpl.Container implements AtomicStmt
{
  ...
  public NotificationChain basicSetT16(AtomicStmt newT16, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QuartzPackage.ATOMIC_STMT__T16, oldT16, newT16);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setT16(AtomicStmt newT16)
  {
    if (newT16 != t16)
    {
      NotificationChain msgs = null;
      if (t16 != null)
        msgs = ((InternalEObject)t16).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QuartzPackage.ATOMIC_STMT__T16, null, msgs);
      if (newT16 != null)
        msgs = ((InternalEObject)newT16).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QuartzPackage.ATOMIC_STMT__T16, null, msgs);
      msgs = basicSetT16(newT16, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, QuartzPackage.ATOMIC_STMT__T16, newT16, newT16));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case QuartzPackage.ATOMIC_STMT__T16:
