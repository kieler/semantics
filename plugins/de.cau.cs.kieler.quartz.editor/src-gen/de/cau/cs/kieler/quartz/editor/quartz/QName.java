 ...
 *   <li>{@link de.cau.cs.kieler.quartz.editor.quartz.QName#getStmt <em>Stmt</em>}</li>
 *   <li>{@link de.cau.cs.kieler.quartz.editor.quartz.QName#getTs <em>Ts</em>}</li>
 *   <li>{@link de.cau.cs.kieler.quartz.editor.quartz.QName#getT08 <em>T08</em>}</li>
 ...
 * @generated
 */
public interface QName extends InOutName, UtyExpr, Generic
{
  /**
   ...
   * @see #setStmt(Stmt)
   * @see de.cau.cs.kieler.quartz.editor.quartz.QuartzPackage#getQName_Stmt()
   * @model containment="true"
   * @generated
   */
  Stmt getStmt();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.quartz.editor.quartz.QName#getStmt <em>Stmt</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setTs(dUtyExprs)
   * @see de.cau.cs.kieler.quartz.editor.quartz.QuartzPackage#getQName_Ts()
   * @model containment="true"
   * @generated
   */
  dUtyExprs getTs();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.quartz.editor.quartz.QName#getTs <em>Ts</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setTs(dUtyExprs value);

  /**
   * Returns the value of the '<em><b>T08</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>T08</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>T08</em>' containment reference.
   * @see #setT08(Stmt)
   * @see de.cau.cs.kieler.quartz.editor.quartz.QuartzPackage#getQName_T08()
   * @model containment="true"
   * @generated
   */
  Stmt getT08();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.quartz.editor.quartz.QName#getT08 <em>T08</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>T08</em>' containment reference.
   * @see #getT08()
   * @generated
   */
  void setT08(Stmt value);
