 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.quartz.editor.quartz.SeqStmt#getS <em>S</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.quartz.editor.quartz.QuartzPackage#getSeqStmt()
 * @model
 * @generated
 */
public interface SeqStmt extends EObject
{
   ...
   * The list contents are of type {@link de.cau.cs.kieler.quartz.editor.quartz.AtomicStmt}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.cau.cs.kieler.quartz.editor.quartz.QuartzPackage#getSeqStmt_S()
