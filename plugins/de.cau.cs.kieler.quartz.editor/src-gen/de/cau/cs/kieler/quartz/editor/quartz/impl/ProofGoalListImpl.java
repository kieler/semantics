 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.quartz.editor.quartz.impl.ProofGoalListImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.cau.cs.kieler.quartz.editor.quartz.impl.ProofGoalListImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link de.cau.cs.kieler.quartz.editor.quartz.impl.ProofGoalListImpl#getGoals <em>Goals</em>}</li>
 *   <li>{@link de.cau.cs.kieler.quartz.editor.quartz.impl.ProofGoalListImpl#getVer <em>Ver</em>}</li>
 *   <li>{@link de.cau.cs.kieler.quartz.editor.quartz.impl.ProofGoalListImpl#getCtrl <em>Ctrl</em>}</li>
 *   <li>{@link de.cau.cs.kieler.quartz.editor.quartz.impl.ProofGoalListImpl#getAss <em>Ass</em>}</li>
 *   <li>{@link de.cau.cs.kieler.quartz.editor.quartz.impl.ProofGoalListImpl#getCtr <em>Ctr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
