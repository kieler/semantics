 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.quartz.editor.quartz.LocStmt#getLocals <em>Locals</em>}</li>
 *   <li>{@link de.cau.cs.kieler.quartz.editor.quartz.LocStmt#getStmt <em>Stmt</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.quartz.editor.quartz.QuartzPackage#getLocStmt()
 * @model
 * @generated
 */
public interface LocStmt extends AtomicStmt
{
   ...
   * The list contents are of type {@link de.cau.cs.kieler.quartz.editor.quartz.InterfaceList}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.cau.cs.kieler.quartz.editor.quartz.QuartzPackage#getLocStmt_Locals()
