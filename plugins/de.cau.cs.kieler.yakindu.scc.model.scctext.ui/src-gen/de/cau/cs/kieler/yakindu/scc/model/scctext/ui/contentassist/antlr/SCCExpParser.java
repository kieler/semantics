		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLocalReactionTriggerAccess().getAlternatives_1(), "rule__LocalReactionTrigger__Alternatives_1");
					put(grammarAccess.getLocalReactionSpecAccess().getAlternatives(), "rule__LocalReactionSpec__Alternatives");
					put(grammarAccess.getStateActionAccess().getAlternatives(), "rule__StateAction__Alternatives");
					...
					put(grammarAccess.getLocalReactionTriggerAccess().getGroup_1_0(), "rule__LocalReactionTrigger__Group_1_0__0");
					put(grammarAccess.getLocalReactionTriggerAccess().getGroup_1_0_1(), "rule__LocalReactionTrigger__Group_1_0_1__0");
					put(grammarAccess.getLocalReactionTriggerAccess().getGroup_1_0_2(), "rule__LocalReactionTrigger__Group_1_0_2__0");
					put(grammarAccess.getLocalReactionTriggerAccess().getGroup_1_1(), "rule__LocalReactionTrigger__Group_1_1__0");
					put(grammarAccess.getLocalReactionEffectAccess().getGroup(), "rule__LocalReactionEffect__Group__0");
					put(grammarAccess.getLocalReactionEffectAccess().getGroup_2(), "rule__LocalReactionEffect__Group_2__0");
					...
					put(grammarAccess.getReactionTriggerAccess().getGroup_3_0(), "rule__ReactionTrigger__Group_3_0__0");
					put(grammarAccess.getReactionTriggerAccess().getGroup_3_0_1(), "rule__ReactionTrigger__Group_3_0_1__0");
					put(grammarAccess.getReactionTriggerAccess().getGroup_3_0_2(), "rule__ReactionTrigger__Group_3_0_2__0");
					...
					put(grammarAccess.getPreValueExpressionreturnsAccess().getGroup(), "rule__PreValueExpressionreturns__Group__0");
					...
					put(grammarAccess.getSignalDefinitionAccess().getNameAssignment_2(), "rule__SignalDefinition__NameAssignment_2");
					...
					put(grammarAccess.getLocalReactionTriggerAccess().getTriggersAssignment_1_0_0(), "rule__LocalReactionTrigger__TriggersAssignment_1_0_0");
					put(grammarAccess.getLocalReactionTriggerAccess().getTriggersAssignment_1_0_1_1(), "rule__LocalReactionTrigger__TriggersAssignment_1_0_1_1");
					put(grammarAccess.getLocalReactionTriggerAccess().getGuardExpressionAssignment_1_0_2_1(), "rule__LocalReactionTrigger__GuardExpressionAssignment_1_0_2_1");
					put(grammarAccess.getLocalReactionTriggerAccess().getGuardExpressionAssignment_1_1_1(), "rule__LocalReactionTrigger__GuardExpressionAssignment_1_1_1");
					put(grammarAccess.getLocalReactionEffectAccess().getActionsAssignment_1(), "rule__LocalReactionEffect__ActionsAssignment_1");
					put(grammarAccess.getLocalReactionEffectAccess().getActionsAssignment_2_1(), "rule__LocalReactionEffect__ActionsAssignment_2_1");
					...
					put(grammarAccess.getReactionTriggerAccess().getTriggersAssignment_3_0_0(), "rule__ReactionTrigger__TriggersAssignment_3_0_0");
					put(grammarAccess.getReactionTriggerAccess().getTriggersAssignment_3_0_1_1(), "rule__ReactionTrigger__TriggersAssignment_3_0_1_1");
					put(grammarAccess.getReactionTriggerAccess().getGuardExpressionAssignment_3_0_2_1(), "rule__ReactionTrigger__GuardExpressionAssignment_3_0_2_1");
					...
					put(grammarAccess.getPreValueExpressionreturnsAccess().getValueAssignment_3(), "rule__PreValueExpressionreturns__ValueAssignment_3");
