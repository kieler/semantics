 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.EveryDo#getDelay <em>Delay</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.EveryDo#getOptEnd <em>Opt End</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getEveryDo()
 * @model
 * @generated
 */
public interface EveryDo extends StatementContainer, Statement
{
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getEveryDo_Delay()
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.EveryDo#getDelay <em>Delay</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getEveryDo_OptEnd()
   * @model
   * @generated
   */
  String getOptEnd();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.EveryDo#getOptEnd <em>Opt End</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
