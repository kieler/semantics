 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.ConstantExpression#getConstant <em>Constant</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kies.esterel.ConstantExpression#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getConstantExpression()
 * @model
 * @generated
 */
public interface ConstantExpression extends Expression
{
   ...
   * @see de.cau.cs.kieler.kies.esterel.EsterelPackage#getConstantExpression_Constant()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kies.esterel.ConstantExpression#getConstant <em>Constant</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
