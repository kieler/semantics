/**
 */
package de.cau.cs.kieler.esterel.scest.util;

import de.cau.cs.kieler.annotations.Annotatable;

import de.cau.cs.kieler.esterel.EsterelProgram;

import de.cau.cs.kieler.esterel.scest.*;
 ...
 * <!-- end-user-doc -->
 * @see de.cau.cs.kieler.esterel.scest.ScestPackage
 * @generated
 */
public class ScestSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case ScestPackage.SC_EST_PROGRAM:
      {
        ...
        if (result == null) result = caseEsterelProgram(scEstProgram);
      ...
      case ScestPackage.SC_EST_MODULE:
      {
        ...
        if (result == null) result = caseEsterel_Module(scEstModule);
        if (result == null) result = caseModule(scEstModule);
        if (result == null) result = caseScope(scEstModule);
        if (result == null) result = caseDeclarationScope(scEstModule);
   ...
   * @generated
   */
  public T caseEsterel_Module(de.cau.cs.kieler.esterel.Module object)
  {
    return null;
  }
