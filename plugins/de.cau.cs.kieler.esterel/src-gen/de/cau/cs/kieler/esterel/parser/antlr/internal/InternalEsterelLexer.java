...
public class InternalEsterelLexer extends Lexer {
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEsterel.g:22948:17: ( '%' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalEsterel.g:22948:19: '%' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match('%'); 
            // InternalEsterel.g:22948:23: (~ ( ( '\\n' | '\\r' ) ) )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEsterel.g:22950:17: ( '%' '{' ( options {greedy=false; } : . )* '}' '%' )
            // InternalEsterel.g:22950:19: '%' '{' ( options {greedy=false; } : . )* '}' '%'
            {
            match('%'); 
            match('{'); 
            // InternalEsterel.g:22950:27: ( options {greedy=false; } : . )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEsterel.g:22952:13: ( '\"' (~ ( '\"' ) | '\"' '\"' )* '\"' )
            // InternalEsterel.g:22952:15: '\"' (~ ( '\"' ) | '\"' '\"' )* '\"'
            {
            match('\"'); 
            // InternalEsterel.g:22952:19: (~ ( '\"' ) | '\"' '\"' )*
            loop5:
            do {
                int alt5=3;
    ...
    public final void mRULE_HOSTCODE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEsterel.g:22954:15: ( '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            // InternalEsterel.g:22954:17: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
            {
            match('\''); 
            // InternalEsterel.g:22954:22: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
            loop6:
            do {
                int alt6=3;
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalEsterel.g:22954:23: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
    ...
    public final void mRULE_COMMENT_ANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEsterel.g:22956:25: ( '/**' ( options {greedy=false; } : . )* '*/' )
            // InternalEsterel.g:22956:27: '/**' ( options {greedy=false; } : . )* '*/'
            {
            match("/**"); 

            // InternalEsterel.g:22956:33: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_SL_COMMENT_ANNOTATION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEsterel.g:22958:28: ( '//*' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalEsterel.g:22958:30: '//*' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//*"); 

            // InternalEsterel.g:22958:36: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            // InternalEsterel.g:22960:22: ( '0' .. '9' )
            // InternalEsterel.g:22960:24: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEsterel.g:22962:10: ( ( RULE_NUMBER )+ )
            // InternalEsterel.g:22962:12: ( RULE_NUMBER )+
            {
            // InternalEsterel.g:22962:12: ( RULE_NUMBER )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEsterel.g:22964:12: ( ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' ) )
            // InternalEsterel.g:22964:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            {
            // InternalEsterel.g:22964:14: ( ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )? | ( RULE_NUMBER )+ 'f' )
            int alt19=2;
            ...
            switch (alt19) {
                case 1 :
                    // InternalEsterel.g:22964:15: ( RULE_NUMBER )+ '.' ( RULE_NUMBER )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )? ( 'f' )?
                    {
                    // InternalEsterel.g:22964:15: ( RULE_NUMBER )+
                    int cnt12=0;
                    loop12:
                    do {
                        int alt12=2;
                    ...
                    match('.'); 
                    // InternalEsterel.g:22964:32: ( RULE_NUMBER )*
                    loop13:
                    do {
                        int alt13=2;
                    ...
                    // InternalEsterel.g:22964:45: ( ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+ )?
                    int alt16=2;
                    ...
                    switch (alt16) {
                        case 1 :
                            // InternalEsterel.g:22964:46: ( 'e' | 'E' ) ( '+' | '-' )? ( RULE_NUMBER )+
                            {
                            ...
                            // InternalEsterel.g:22964:67: ( RULE_NUMBER )+
                            int cnt15=0;
                            loop15:
                            do {
                                int alt15=2;
                    ...
                    break;
                case 2 :
                    // InternalEsterel.g:22964:87: ( RULE_NUMBER )+ 'f'
                    {
                    // InternalEsterel.g:22964:87: ( RULE_NUMBER )+
                    int cnt18=0;
                    loop18:
                    do {
                        int alt18=2;
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEsterel.g:22966:14: ( ( 'true' | 'false' ) )
            // InternalEsterel.g:22966:16: ( 'true' | 'false' )
            {
            // InternalEsterel.g:22966:16: ( 'true' | 'false' )
            int alt20=2;
            ...
            switch (alt20) {
                case 1 :
                    // InternalEsterel.g:22966:17: 'true'
                    {
                    match("true"); 
                    ...
                    break;
                case 2 :
                    // InternalEsterel.g:22966:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEsterel.g:22968:9: ( ( '^' )? ( ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' ) | '_' '0' .. '9' | '__' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalEsterel.g:22968:11: ( '^' )? ( ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' ) | '_' '0' .. '9' | '__' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalEsterel.g:22968:11: ( '^' )?
            int alt21=2;
            ...
            // InternalEsterel.g:22968:16: ( ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' ) | '_' '0' .. '9' | '__' )
            int alt25=3;
            ...
            switch (alt25) {
                case 1 :
                    // InternalEsterel.g:22968:17: ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' )
                    {
                    // InternalEsterel.g:22968:17: ( ( '_' )? 'a' .. 'z' | ( '_' )? 'A' .. 'Z' )
                    int alt24=2;
                    switch ( input.LA(1) ) {
                    ...
                    switch (alt24) {
                        case 1 :
                            // InternalEsterel.g:22968:18: ( '_' )? 'a' .. 'z'
                            {
                            // InternalEsterel.g:22968:18: ( '_' )?
                            int alt22=2;
                            ...
                            break;
                        case 2 :
                            // InternalEsterel.g:22968:32: ( '_' )? 'A' .. 'Z'
                            {
                            // InternalEsterel.g:22968:32: ( '_' )?
                            int alt23=2;
                    ...
                    break;
                case 2 :
                    // InternalEsterel.g:22968:47: '_' '0' .. '9'
                    {
                    match('_'); 
                    matchRange('0','9'); 
            ...
            // InternalEsterel.g:22968:66: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop26:
            do {
                int alt26=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEsterel.g:22970:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalEsterel.g:22970:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalEsterel.g:22970:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt27=0;
            loop27:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEsterel.g:22972:16: ( . )
            // InternalEsterel.g:22972:18: .
            {
            matchAny(); 
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    case 0 : 
                        ...
                        else if ( (LA28_44=='{') ) {s = 166;}

                        else if ( ((LA28_44>='\u0000' && LA28_44<='<')||(LA28_44>='>' && LA28_44<='z')||(LA28_44>='|' && LA28_44<='\uFFFF')) ) {s = 168;}
                    ...
                    case 6 : 
                        ...
                        else if ( (LA28_375=='}') ) {s = 274;}

                        else if ( ((LA28_375>='\u0000' && LA28_375<='\t')||(LA28_375>='\u000B' && LA28_375<='\f')||(LA28_375>='\u000E' && LA28_375<='|')||(LA28_375>='~' && LA28_375<='\uFFFF')) ) {s = 275;}
                    ...
                    case 10 : 
                        ...
                        else if ( (LA28_166=='}') ) {s = 274;}

                        else if ( ((LA28_166>='\u0000' && LA28_166<='\t')||(LA28_166>='\u000B' && LA28_166<='\f')||(LA28_166>='\u000E' && LA28_166<='|')||(LA28_166>='~' && LA28_166<='\uFFFF')) ) {s = 275;}
