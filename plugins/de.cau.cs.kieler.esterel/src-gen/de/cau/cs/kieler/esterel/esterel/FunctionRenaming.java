...
public interface FunctionRenaming extends EObject
{
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getFunctionRenaming_NewFunc()
   * @model
   * @generated
   */
  String getNewFunc();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.FunctionRenaming#getNewFunc <em>New Func</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
