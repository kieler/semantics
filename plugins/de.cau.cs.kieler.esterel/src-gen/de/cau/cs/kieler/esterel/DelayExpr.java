 ...
 *   <li>{@link de.cau.cs.kieler.esterel.DelayExpr#isIsImmediate <em>Is Immediate</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.DelayExpr#getSignalExpr <em>Signal Expr</em>}</li>
 * </ul>
 *
...
public interface DelayExpr extends EObject
{
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getDelayExpr_IsImmediate()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.DelayExpr#isIsImmediate <em>Is Immediate</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getDelayExpr_SignalExpr()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.DelayExpr#getSignalExpr <em>Signal Expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
