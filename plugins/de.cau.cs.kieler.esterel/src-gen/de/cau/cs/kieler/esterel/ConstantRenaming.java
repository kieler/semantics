 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.ConstantRenaming#getValue <em>Value</em>}</li>
...
public interface ConstantRenaming extends EObject
{
   ...
   * @see #setValue(String)
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getConstantRenaming_Value()
   * @model
   * @generated
   */
  String getValue();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.ConstantRenaming#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.ConstantRenaming#getNewName <em>New Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
