...
public interface PresentEvent extends EObject
{
   ...
   * @see #setFB(String)
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getPresentEvent_FB()
   * @model
   * @generated
   */
  String getFB();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.PresentEvent#getFB <em>FB</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setEB(String)
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getPresentEvent_EB()
   * @model
   * @generated
   */
  String getEB();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.PresentEvent#getEB <em>EB</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
