 ...
 *   <li>{@link de.cau.cs.kieler.esterel.Present#getThenAnnotations <em>Then Annotations</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.Present#getThenStatements <em>Then Statements</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.Present#getCases <em>Cases</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.Present#getElseAnnotations <em>Else Annotations</em>}</li>
...
public interface Present extends Statement
{
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getPresent_ThenAnnotations()
   * @model containment="true"
   * @generated
   */
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getPresent_ThenStatements()
   * @model containment="true"
   * @generated
   */
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getPresent_ElseAnnotations()
   * @model containment="true"
   * @generated
   */
