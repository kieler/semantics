...
public interface ConstantWithValue extends EObject
{
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getConstantWithValue_Constant()
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.ConstantWithValue#getConstant <em>Constant</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setValue(String)
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getConstantWithValue_Value()
   * @model
   * @generated
   */
  String getValue();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.ConstantWithValue#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
