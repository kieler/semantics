 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.Constant#getName <em>Name</em>}</li>
...
public interface Constant extends EObject
{
   ...
   * @see #setName(String)
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getConstant_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.Constant#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
