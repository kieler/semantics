 ...
 *   <li>{@link de.cau.cs.kieler.esterel.ModuleRenaming#isRenamed <em>Renamed</em>}</li>
...
public interface ModuleRenaming extends EObject
{
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getModuleRenaming_Renamed()
   * @model
   * @generated
   */
  boolean isRenamed();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.ModuleRenaming#isRenamed <em>Renamed</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
