...
public interface TypeRenaming extends EObject
{
   ...
   * @see #setNewName(Type)
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getTypeRenaming_NewName()
   * @model
   * @generated
   */
  Type getNewName();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.TypeRenaming#getNewName <em>New Name</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getTypeRenaming_NewType()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.TypeRenaming#getNewType <em>New Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setOldName(Type)
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getTypeRenaming_OldName()
   * @model
   * @generated
   */
  Type getOldName();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.TypeRenaming#getOldName <em>Old Name</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
