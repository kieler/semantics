 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.Renaming#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.Renaming#getRenamings <em>Renamings</em>}</li>
 * </ul>
 *
 * @see de.cau.cs.kieler.esterel.EsterelPackage#getRenaming()
 * @model
 * @generated
 */
public interface Renaming extends EObject
{
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getRenaming_Annotations()
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getRenaming_Renamings()
   * @model containment="true"
   * @generated
   */
