 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.FunctionExpression#getFuncion <em>Funcion</em>}</li>
...
public interface FunctionExpression extends Expression
{
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getFunctionExpression_Funcion()
   * @model
   * @generated
   */
  Function getFuncion();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.FunctionExpression#getFuncion <em>Funcion</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
