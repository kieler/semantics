 ...
 *   <li>{@link de.cau.cs.kieler.esterel.Exec#getVars <em>Vars</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.Exec#getKexpressions <em>Kexpressions</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.Exec#getRetSignal <em>Ret Signal</em>}</li>
...
public interface Exec extends StatementContainer, Statement
{
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getExec_Vars()
   * @model
   * @generated
   */
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getExec_Kexpressions()
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getExec_RetSignal()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.Exec#getRetSignal <em>Ret Signal</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
