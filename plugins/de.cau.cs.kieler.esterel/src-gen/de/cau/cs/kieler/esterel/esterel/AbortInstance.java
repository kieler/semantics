 ...
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.AbortInstance#getStatement <em>Statement</em>}</li>
...
public interface AbortInstance extends AbortBody, WeakAbortBody
{
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getAbortInstance_Delay()
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.AbortInstance#getDelay <em>Delay</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getAbortInstance_Statement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.AbortInstance#getStatement <em>Statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getAbortInstance_OptEnd()
   * @model
   * @generated
   */
  String getOptEnd();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.AbortInstance#getOptEnd <em>Opt End</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
