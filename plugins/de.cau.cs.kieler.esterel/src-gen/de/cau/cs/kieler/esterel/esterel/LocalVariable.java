 ...
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.LocalVariable#getStatement <em>Statement</em>}</li>
...
public interface LocalVariable extends Statement
{
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getLocalVariable_Statement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.LocalVariable#getStatement <em>Statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
