 ...
 *   <li>{@link de.cau.cs.kieler.esterel.IfTest#getThenAnnotations <em>Then Annotations</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.IfTest#getThenStatements <em>Then Statements</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.IfTest#getElseif <em>Elseif</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.IfTest#getElseAnnotations <em>Else Annotations</em>}</li>
...
public interface IfTest extends Statement
{
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getIfTest_ThenAnnotations()
   * @model containment="true"
   * @generated
   */
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getIfTest_ThenStatements()
   * @model containment="true"
   * @generated
   */
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getIfTest_ElseAnnotations()
   * @model containment="true"
   * @generated
   */
