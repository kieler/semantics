 ...
 *   <li>{@link de.cau.cs.kieler.esterel.Run#getList <em>List</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Run extends Statement
{
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getRun_List()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.Run#getList <em>List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
