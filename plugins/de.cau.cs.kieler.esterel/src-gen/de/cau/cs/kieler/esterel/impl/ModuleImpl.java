 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.ModuleImpl#getIntSignalDecls <em>Int Signal Decls</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.ModuleImpl#getIntTypeDecls <em>Int Type Decls</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.ModuleImpl#getIntSensorDecls <em>Int Sensor Decls</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.ModuleImpl#getIntConstantDecls <em>Int Constant Decls</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.ModuleImpl#getIntRelationDecls <em>Int Relation Decls</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.ModuleImpl#getIntTaskDecls <em>Int Task Decls</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.ModuleImpl#getIntFunctionDecls <em>Int Function Decls</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.ModuleImpl#getIntProcedureDecls <em>Int Procedure Decls</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModuleImpl extends de.cau.cs.kieler.scl.impl.ModuleImpl implements Module
{
  /**
