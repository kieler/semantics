...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abort Instance</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.impl.AbortInstanceImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.impl.AbortInstanceImpl#getStatement <em>Statement</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.impl.AbortInstanceImpl#getOptEnd <em>Opt End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AbortInstanceImpl extends AbortBodyImpl implements AbortInstance
{
  ...
  {
    return EsterelPackage.Literals.ABORT_INSTANCE;
  }
  ...
  public NotificationChain basicSetDelay(DelayExpr newDelay, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EsterelPackage.ABORT_INSTANCE__DELAY, oldDelay, newDelay);
  ...
  public void setDelay(DelayExpr newDelay)
  {
    if (newDelay != delay)
    {
      ...
      if (delay != null)
        msgs = ((InternalEObject)delay).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EsterelPackage.ABORT_INSTANCE__DELAY, null, msgs);
      if (newDelay != null)
        msgs = ((InternalEObject)newDelay).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EsterelPackage.ABORT_INSTANCE__DELAY, null, msgs);
      msgs = basicSetDelay(newDelay, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EsterelPackage.ABORT_INSTANCE__DELAY, newDelay, newDelay));
  }
  ...
  public void setOptEnd(String newOptEnd)
  {
    ...
    optEnd = newOptEnd;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EsterelPackage.ABORT_INSTANCE__OPT_END, oldOptEnd, optEnd));
  }
