 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.TrapDeclList#getTrapDecl <em>Trap Decl</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.esterel.EsterelPackage#getTrapDeclList()
 * @model
 * @generated
 */
public interface TrapDeclList extends EObject
{
   ...
   * The list contents are of type {@link de.cau.cs.kieler.esterel.TrapDecl}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getTrapDeclList_TrapDecl()
