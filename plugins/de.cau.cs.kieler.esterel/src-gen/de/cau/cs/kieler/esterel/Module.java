 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.Module#getName <em>Name</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.Module#getModInt <em>Mod Int</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.Module#getModBody <em>Mod Body</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Module extends EObject
{
   ...
   * @see #setName(String)
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getModule_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.Module#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getModule_ModInt()
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.Module#getModInt <em>Mod Int</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getModule_ModBody()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.Module#getModBody <em>Mod Body</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
