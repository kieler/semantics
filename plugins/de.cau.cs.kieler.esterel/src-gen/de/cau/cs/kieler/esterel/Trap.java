 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.Trap#getTrapDeclList <em>Trap Decl List</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.Trap#getStatement <em>Statement</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.Trap#getTrapHandlerList <em>Trap Handler List</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Trap extends Statement
{
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getTrap_TrapDeclList()
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.Trap#getTrapDeclList <em>Trap Decl List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getTrap_Statement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.Trap#getStatement <em>Statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getTrap_TrapHandlerList()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.Trap#getTrapHandlerList <em>Trap Handler List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
