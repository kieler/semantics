 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.ElsIf#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.ElsIf#getExpression <em>Expression</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.ElsIf#getThenStatements <em>Then Statements</em>}</li>
 * </ul>
 *
...
public interface ElsIf extends EObject
{
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getElsIf_Annotations()
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getElsIf_ThenStatements()
   * @model containment="true"
   * @generated
   */
