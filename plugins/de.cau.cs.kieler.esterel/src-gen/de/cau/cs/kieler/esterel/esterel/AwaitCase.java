 ...
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.AwaitCase#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
...
public interface AwaitCase extends AwaitBody
{
   ...
   * @see #setEnd(String)
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getAwaitCase_End()
   * @model
   * @generated
   */
  String getEnd();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.AwaitCase#getEnd <em>End</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
