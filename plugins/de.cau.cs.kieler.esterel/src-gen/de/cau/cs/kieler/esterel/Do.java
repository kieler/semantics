 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.Do#getEndingAnnotations <em>Ending Annotations</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.Do#getExpression <em>Expression</em>}</li>
...
public interface Do extends StatementContainer, Statement
{
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getDo_EndingAnnotations()
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getDo_Expression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.Do#getExpression <em>Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
