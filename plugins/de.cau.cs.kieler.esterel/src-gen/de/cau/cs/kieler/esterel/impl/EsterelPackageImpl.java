...
import de.cau.cs.kieler.esterel.RelationType;
...
public class EsterelPackageImpl extends EPackageImpl implements EsterelPackage
{
  ...
  public void initializePackageContents()
  {
    ...
    moduleEClass.getESuperTypes().add(theSCLPackage.getModule());
    ...
    initEReference(getEsterelProgram_Modules(), this.getModule(), null, "modules", null, 0, -1, EsterelProgram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getOneTypeConstantDecls_Constants(), this.getConstant(), null, "constants", null, 0, -1, OneTypeConstantDecls.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
