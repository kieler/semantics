 ...
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ExecCase#getStatement <em>Statement</em>}</li>
 * </ul>
 * </p>
 *
...
public interface ExecCase extends EObject
{
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getExecCase_Statement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.ExecCase#getStatement <em>Statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
