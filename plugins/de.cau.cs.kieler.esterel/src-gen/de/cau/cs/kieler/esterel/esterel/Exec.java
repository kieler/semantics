 ...
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.Exec#getStatement <em>Statement</em>}</li>
...
public interface Exec extends Statement
{
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getExec_Statement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.Exec#getStatement <em>Statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
