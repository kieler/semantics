...
public class TypeIdentifierImpl extends MinimalEObjectImpl.Container implements TypeIdentifier
{
  ...
  public void setTypeID(String newTypeID)
  {
    ...
    typeID = newTypeID;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EsterelPackage.TYPE_IDENTIFIER__TYPE_ID, oldTypeID, typeID));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EsterelPackage.TYPE_IDENTIFIER__TYPE:
        return getType();
      case EsterelPackage.TYPE_IDENTIFIER__TYPE_ID:
        return getTypeID();
