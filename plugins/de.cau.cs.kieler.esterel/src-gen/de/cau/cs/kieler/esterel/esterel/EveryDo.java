 ...
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.EveryDo#getStatement <em>Statement</em>}</li>
 * </ul>
 * </p>
 *
...
public interface EveryDo extends Statement
{
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getEveryDo_Statement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.EveryDo#getStatement <em>Statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
