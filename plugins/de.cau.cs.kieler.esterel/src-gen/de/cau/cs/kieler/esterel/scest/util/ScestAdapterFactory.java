...
public class ScestAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected ScestSwitch<Adapter> modelSwitch =
    new ScestSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseEsterel_Module(de.cau.cs.kieler.esterel.Module object)
      {
        return createEsterel_ModuleAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.esterel.scest.SCEstProgram <em>SC Est Program</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.esterel.scest.SCEstModule <em>SC Est Module</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.esterel.scest.UnEmit <em>Un Emit</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.esterel.scest.Set <em>Set</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createEsterel_ModuleAdapter()
  {
    return null;
  }
