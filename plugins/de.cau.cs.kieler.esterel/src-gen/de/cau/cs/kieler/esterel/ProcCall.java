 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.ProcCall#getProc <em>Proc</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.ProcCall#getVarList <em>Var List</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.ProcCall#getKexpressions <em>Kexpressions</em>}</li>
 * </ul>
 *
 * @see de.cau.cs.kieler.esterel.EsterelPackage#getProcCall()
 * @model
 * @generated
 */
public interface ProcCall extends Statement
{
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getProcCall_Proc()
   * @model
   * @generated
   */
  Procedure getProc();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.ProcCall#getProc <em>Proc</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getProcCall_VarList()
   * @model
   * @generated
   */
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getProcCall_Kexpressions()
