 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntSignalDecl <em>Int Signal Decl</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntTypeDecl <em>Int Type Decl</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntSensorDecl <em>Int Sensor Decl</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntConstantDecl <em>Int Constant Decl</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntRelationDecl <em>Int Relation Decl</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntFunctionDecl <em>Int Function Decl</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntProcedureDecl <em>Int Procedure Decl</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getModuleInterface()
 * @model
 * @generated
 */
public interface ModuleInterface extends EObject
{
   ...
   * The list contents are of type {@link de.cau.cs.kieler.esterel.esterel.SignalDecl}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getModuleInterface_IntSignalDecl()
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getModuleInterface_IntTypeDecl()
   * @model containment="true"
   * @generated
   */
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getModuleInterface_IntSensorDecl()
   * @model containment="true"
   * @generated
   */
   ...
   * The list contents are of type {@link de.cau.cs.kieler.esterel.esterel.ConstantDecl}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getModuleInterface_IntConstantDecl()
   * @model containment="true"
   * @generated
   */
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getModuleInterface_IntRelationDecl()
   * @model containment="true"
   * @generated
   */
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getModuleInterface_IntFunctionDecl()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Int Procedure Decl</b></em>' containment reference list.
   * The list contents are of type {@link de.cau.cs.kieler.esterel.esterel.ProcedureDecl}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Int Procedure Decl</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Int Procedure Decl</em>' containment reference list.
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getModuleInterface_IntProcedureDecl()
   * @model containment="true"
   * @generated
   */
