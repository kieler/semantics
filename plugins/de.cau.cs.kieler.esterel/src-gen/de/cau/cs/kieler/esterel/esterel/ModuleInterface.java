 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntSignalDecls <em>Int Signal Decls</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntTypeDecls <em>Int Type Decls</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntSensorDecls <em>Int Sensor Decls</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntConstantDecls <em>Int Constant Decls</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntRelationDecls <em>Int Relation Decls</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntTaskDecls <em>Int Task Decls</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntFunctionDecls <em>Int Function Decls</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.ModuleInterface#getIntProcedureDecls <em>Int Procedure Decls</em>}</li>
 * </ul>
 * </p>
 *
