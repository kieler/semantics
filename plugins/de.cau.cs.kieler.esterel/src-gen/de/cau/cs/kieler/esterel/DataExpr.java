 ...
 *   <li>{@link de.cau.cs.kieler.esterel.DataExpr#getRight <em>Right</em>}</li>
...
public interface DataExpr extends EObject
{
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getDataExpr_Right()
   * @model containment="true"
   * @generated
   */
  DataExpr getRight();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.DataExpr#getRight <em>Right</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
