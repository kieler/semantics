 ...
 *   <li>{@link de.cau.cs.kieler.esterel.esterel.impl.ChannelTypeImpl#getOp <em>Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChannelTypeImpl extends MinimalEObjectImpl.Container implements ChannelType
{
  ...
  public void setOp(String newOp)
  {
    ...
    op = newOp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EsterelPackage.CHANNEL_TYPE__OP, oldOp, op));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case EsterelPackage.CHANNEL_TYPE__FUNC:
        ...
        return basicGetFunc();
      case EsterelPackage.CHANNEL_TYPE__OP:
        return getOp();
    }
