...
public interface LocalSignalDecl extends Statement
{
   ...
   * @see de.cau.cs.kieler.esterel.esterel.EsterelPackage#getLocalSignalDecl_Statement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.esterel.LocalSignalDecl#getStatement <em>Statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
