 ...
 *   <li>{@link de.cau.cs.kieler.esterel.ExecCase#getVars <em>Vars</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.ExecCase#getKexpressions <em>Kexpressions</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.ExecCase#getRetSignal <em>Ret Signal</em>}</li>
 * </ul>
 *
...
public interface ExecCase extends StatementContainer
{
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getExecCase_Vars()
   * @model
   * @generated
   */
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getExecCase_Kexpressions()
   ...
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getExecCase_RetSignal()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.ExecCase#getRetSignal <em>Ret Signal</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
