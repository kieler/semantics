 ...
 *   <li>{@link de.cau.cs.kieler.esterel.impl.PresentImpl#getThenAnnotations <em>Then Annotations</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.PresentImpl#getThenStatements <em>Then Statements</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.PresentImpl#getCases <em>Cases</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.PresentImpl#getElseAnnotations <em>Else Annotations</em>}</li>
