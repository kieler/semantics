 ...
 *   <li>{@link de.cau.cs.kieler.esterel.Emit#getTick <em>Tick</em>}</li>
...
public interface Emit extends Statement
{
   ...
   * @see #setTick(String)
   * @see de.cau.cs.kieler.esterel.EsterelPackage#getEmit_Tick()
   * @model
   * @generated
   */
  String getTick();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.esterel.Emit#getTick <em>Tick</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
