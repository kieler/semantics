 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.ElsIfImpl#getStatements <em>Statements</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.ElsIfImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElsIfImpl extends StatementImpl implements ElsIf {
    /**
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case EsterelPackage.ELS_IF__STATEMENTS:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == StatementContainer.class) {
            switch (derivedFeatureID) {
                case EsterelPackage.ELS_IF__STATEMENTS: return SCLPackage.STATEMENT_CONTAINER__STATEMENTS;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == StatementContainer.class) {
            switch (baseFeatureID) {
                case SCLPackage.STATEMENT_CONTAINER__STATEMENTS: return EsterelPackage.ELS_IF__STATEMENTS;
                default: return -1;
            }
        }
