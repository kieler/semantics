 ...
 *
 */
class NothingTransformation extends EsterelProcessor {
    
    // -------------------------------------------------------------------------
    // --                 K I C O      C O N F I G U R A T I O N              --
    // -------------------------------------------------------------------------
    override getId() {
        return SCEstTransformation::NOTHING_ID
    }

    override getName() {
        return SCEstTransformation::NOTHING_NAME
    }

//    override getExpandsFeatureId() {
//        return SCEstFeature::NOTHING_ID
//    }
//        
...
//    }
    ...
    def Statement transformStatement(Statement statement) {
        if (statement instanceof Nothing) {
            return createLabel(createNewUniqueLabel)
        }
