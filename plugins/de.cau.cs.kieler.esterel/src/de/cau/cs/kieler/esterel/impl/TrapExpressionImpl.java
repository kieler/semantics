 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.TrapExpressionImpl#getSchedule <em>Schedule</em>}</li>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.TrapExpressionImpl#getTrap <em>Trap</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TrapExpressionImpl extends MinimalEObjectImpl.Container implements TrapExpression {
    ...
    public Signal getTrap() {
        if (trap != null && trap.eIsProxy()) {
            ...
            trap = (Signal)eResolveProxy(oldTrap);
            if (trap != oldTrap) {
