 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.OutputDeclarationImpl#getValuedObjects <em>Valued Objects</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputDeclarationImpl extends AnnotatableImpl implements OutputDeclaration {
    /**
    ...
    protected EClass eStaticClass() {
        return EsterelPackage.Literals.OUTPUT_DECLARATION;
    }
    ...
    public EList<ValuedObject> getValuedObjects() {
        if (valuedObjects == null) {
            valuedObjects = new EObjectContainmentEList<ValuedObject>(ValuedObject.class, this, EsterelPackage.OUTPUT_DECLARATION__VALUED_OBJECTS);
        }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case EsterelPackage.OUTPUT_DECLARATION__VALUED_OBJECTS:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == Declaration.class) {
            switch (derivedFeatureID) {
                case EsterelPackage.OUTPUT_DECLARATION__VALUED_OBJECTS: return KExpressionsPackage.DECLARATION__VALUED_OBJECTS;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == Declaration.class) {
            switch (baseFeatureID) {
                case KExpressionsPackage.DECLARATION__VALUED_OBJECTS: return EsterelPackage.OUTPUT_DECLARATION__VALUED_OBJECTS;
                default: return -1;
            }
        }
