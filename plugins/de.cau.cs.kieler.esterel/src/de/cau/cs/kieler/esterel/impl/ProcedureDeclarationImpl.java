 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.ProcedureDeclarationImpl#getProcedures <em>Procedures</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcedureDeclarationImpl extends AnnotatableImpl implements ProcedureDeclaration {
    ...
    protected EClass eStaticClass() {
        return EsterelPackage.Literals.PROCEDURE_DECLARATION;
    }
    ...
    public EList<Procedure> getProcedures() {
        if (procedures == null) {
            procedures = new EObjectContainmentEList<Procedure>(Procedure.class, this, EsterelPackage.PROCEDURE_DECLARATION__PROCEDURES);
        }
        return procedures;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case EsterelPackage.PROCEDURE_DECLARATION__PROCEDURES:
