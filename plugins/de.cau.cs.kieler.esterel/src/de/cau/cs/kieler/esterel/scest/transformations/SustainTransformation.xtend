 ...
 *
 */
class SustainTransformation extends AbstractExpansionTransformation implements Traceable{
    
    // -------------------------------------------------------------------------
    // --                 K I C O      C O N F I G U R A T I O N              --
    // -------------------------------------------------------------------------
    override getId() {
        return SCEstTransformation::SUSTAIN_ID
    }

    override getName() {
        return SCEstTransformation::SUSTAIN_NAME
    }

    override getExpandsFeatureId() {
        return SCEstFeature::SUSTAIN_ID
    }
        
    override getProducesFeatureIds() {
        return Sets.newHashSet(SCEstTransformation::EMIT_ID)
    }
    ...
    def Statement transformStatement(Statement statement) {
        if (statement instanceof Sustain) {
            var sustain = statement as Sustain
