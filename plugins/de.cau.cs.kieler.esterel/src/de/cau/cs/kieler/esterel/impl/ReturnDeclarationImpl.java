 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.esterel.impl.ReturnDeclarationImpl#getValuedObjects <em>Valued Objects</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReturnDeclarationImpl extends AnnotatableImpl implements ReturnDeclaration {
    /**
    ...
    protected EClass eStaticClass() {
        return EsterelPackage.Literals.RETURN_DECLARATION;
    }
    ...
    public EList<ValuedObject> getValuedObjects() {
        if (valuedObjects == null) {
            valuedObjects = new EObjectContainmentEList<ValuedObject>(ValuedObject.class, this, EsterelPackage.RETURN_DECLARATION__VALUED_OBJECTS);
        }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case EsterelPackage.RETURN_DECLARATION__VALUED_OBJECTS:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == Declaration.class) {
            switch (derivedFeatureID) {
                case EsterelPackage.RETURN_DECLARATION__VALUED_OBJECTS: return KExpressionsPackage.DECLARATION__VALUED_OBJECTS;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == Declaration.class) {
            switch (baseFeatureID) {
                case KExpressionsPackage.DECLARATION__VALUED_OBJECTS: return EsterelPackage.RETURN_DECLARATION__VALUED_OBJECTS;
                default: return -1;
            }
        }
