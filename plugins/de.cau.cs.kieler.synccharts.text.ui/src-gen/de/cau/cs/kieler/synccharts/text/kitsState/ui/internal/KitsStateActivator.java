...
public class KitsStateActivator extends AbstractUIPlugin {
	...
	public static final String DE_CAU_CS_KIELER_SYNCCHARTS_TEXT_KITSSTATE_KITSSTATE = "de.cau.cs.kieler.synccharts.text.kitsState.KitsState";
	
	private static final Logger logger = Logger.getLogger(KitsStateActivator.class);
	...
	protected Module getRuntimeModule(String grammar) {
		if (DE_CAU_CS_KIELER_SYNCCHARTS_TEXT_KITSSTATE_KITSSTATE.equals(grammar)) {
