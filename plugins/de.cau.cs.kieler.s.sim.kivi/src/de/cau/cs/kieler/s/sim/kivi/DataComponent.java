...
public class DataComponent extends JSONObjectSimulationDataComponent {
    ...
    /**
     * Gets the encoded emf id to compare objects to the ones produced by the S simulation in
     * S2Simulation.xtend.
     * 
     * @param eObject
     *            the e object
        ...
        for (EObject statement : oldActiveErrorStatements) {
            ...
            if (!newActiveErrorStatements.contains(statement)) {
                try {
                    ...
                    throw new KiemExecutionException(
                            "No active S editor for statement visualization.", false, false, true,
                            e);
                }
            }
        }
    ...
    private XtextEditor getSEditor() throws KiemInitializationException {
        ...
        if ((editorPart != null) && (editorPart instanceof XtextEditor)) {
            ...
            if (xtextEditor.getDocument() instanceof XtextDocument
                    && xtextEditor.getLanguageName().equals(SSimKiviPlugin.S_LANGUAGE)) {
        ...
        throw new KiemInitializationException(
                "No opened S editor found for simulation visualization.", true, null);
    }
