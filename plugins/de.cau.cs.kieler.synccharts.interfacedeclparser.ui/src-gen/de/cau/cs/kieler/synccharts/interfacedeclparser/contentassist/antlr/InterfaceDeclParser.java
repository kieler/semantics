		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRegionSignalDecAccess().getAlternatives_3_1(), "rule__RegionSignalDec__Alternatives_3_1");
					...
					put(grammarAccess.getRegionSignalDecAccess().getGroup_3(), "rule__RegionSignalDec__Group_3__0");
					put(grammarAccess.getRegionSignalDecAccess().getGroup_3_1_0(), "rule__RegionSignalDec__Group_3_1_0__0");
					...
					put(grammarAccess.getRegionSignalDecAccess().getSignalsAssignment_2_0_1(), "rule__RegionSignalDec__SignalsAssignment_2_0_1");
					put(grammarAccess.getRegionSignalDecAccess().getVarsAssignment_2_1(), "rule__RegionSignalDec__VarsAssignment_2_1");
					put(grammarAccess.getRegionSignalDecAccess().getSignalsAssignment_3_1_0_1(), "rule__RegionSignalDec__SignalsAssignment_3_1_0_1");
					put(grammarAccess.getRegionSignalDecAccess().getVarsAssignment_3_1_1(), "rule__RegionSignalDec__VarsAssignment_3_1_1");
					...
					put(grammarAccess.getVariableAccess().getHostTypeAssignment_4_1(), "rule__Variable__HostTypeAssignment_4_1");
				}
			};
		}
