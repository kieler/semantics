...
import de.cau.cs.kieler.synccharts.interfacedeclparser.InterfaceDeclRuntimeModule;

/**
 * Manual modifications go to {de.cau.cs.kieler.synccharts.interfacedeclparser.InterfaceDeclUiModule}
 */
public abstract class AbstractInterfaceDeclUiModule extends InterfaceDeclRuntimeModule {
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.HIGHLIGHTING)).to(de.cau.cs.kieler.synccharts.interfacedeclparser.parser.antlr.internal.InternalInterfaceDeclLexer.class);
	}
	...
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return de.cau.cs.kieler.synccharts.interfacedeclparser.labeling.InterfaceDeclLabelProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.outline.transformer.ISemanticModelTransformer> bindISemanticModelTransformer() {
		return de.cau.cs.kieler.synccharts.interfacedeclparser.outline.InterfaceDeclTransformer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.outline.actions.IContentOutlineNodeAdapterFactory> bindIContentOutlineNodeAdapterFactory() {
		return de.cau.cs.kieler.synccharts.interfacedeclparser.outline.InterfaceDeclOutlineNodeAdapterFactory.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.core.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return de.cau.cs.kieler.synccharts.interfacedeclparser.contentassist.InterfaceDeclProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return de.cau.cs.kieler.synccharts.interfacedeclparser.contentassist.antlr.InterfaceDeclParser.class;
	}

	// contributed by de.itemis.xtext.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(de.cau.cs.kieler.synccharts.interfacedeclparser.contentassist.antlr.internal.InternalInterfaceDeclLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(de.cau.cs.kieler.synccharts.interfacedeclparser.contentassist.antlr.internal.InternalInterfaceDeclLexer.class));
	}

	// contributed by de.itemis.xtext.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.common.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.CONTENT_ASSIST)).to(de.cau.cs.kieler.synccharts.interfacedeclparser.contentassist.antlr.internal.InternalInterfaceDeclLexer.class);
	}
