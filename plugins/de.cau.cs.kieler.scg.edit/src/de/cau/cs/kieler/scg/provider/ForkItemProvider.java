 ...
 * @generated
 */
public class ForkItemProvider extends NodeItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    /**
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Fork_join_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Fork_join_feature", "_UI_Fork_type"),
                 ScgPackage.Literals.FORK__JOIN,
                 true,
                 false,
                 true,
                 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ScgPackage.Literals.FORK__NEXT);
        }
    ...
    public String getText(Object object) {
        Fork fork = (Fork)object;
        return getString("_UI_Fork_type") + " " + fork.isIsInitial();
    }
