...
public class ConditionalAdditionItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addBeforeBlockPropertyDescriptor(object);
            addUntilBlockPropertyDescriptor(object);
        }
        return itemPropertyDescriptors;
    }

	/**
     * This adds a property descriptor for the Before Block feature.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	protected void addBeforeBlockPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ConditionalAddition_beforeBlock_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ConditionalAddition_beforeBlock_feature", "_UI_ConditionalAddition_type"),
                 ScgschedPackage.Literals.CONDITIONAL_ADDITION__BEFORE_BLOCK,
                 true,
                 false,
                 true,
                 null,
	...
	/**
     * This adds a property descriptor for the Until Block feature.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	protected void addUntilBlockPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ConditionalAddition_untilBlock_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ConditionalAddition_untilBlock_feature", "_UI_ConditionalAddition_type"),
                 ScgschedPackage.Literals.CONDITIONAL_ADDITION__UNTIL_BLOCK,
                 true,
                 false,
                 true,
                 null,
