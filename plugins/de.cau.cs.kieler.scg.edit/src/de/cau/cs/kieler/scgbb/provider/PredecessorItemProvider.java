...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.scgbb.Predecessor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PredecessorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ScgbbPackage.Literals.PREDECESSOR__BASIC_BLOCK,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addBlockTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Predecessor_blockType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Predecessor_blockType_feature", "_UI_Predecessor_type"),
				 ScgbbPackage.Literals.PREDECESSOR__BLOCK_TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ScgbbPackage.Literals.PREDECESSOR__CONDITIONAL,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		BlockType labelValue = ((Predecessor)object).getBlockType();
