 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.circuit.impl.NodeImpl#getPorts <em>Ports</em>}</li>
...
public class NodeImpl extends MinimalEObjectImpl.Container implements Node {
	...
	public EList<Port> getPorts() {
		if (ports == null) {
			ports = new EObjectContainmentWithInverseEList<Port>(Port.class, this, CircuitPackage.NODE__PORTS, CircuitPackage.PORT__NODE);
		}
		return ports;
	}
