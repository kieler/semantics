 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.circuit.impl.PortImpl#getAnnotations <em>Annotations</em>}</li>
...
public class PortImpl extends LinkableImpl implements Port {
	...
	public EList<Annotation> getAnnotations() {
		if (annotations == null) {
			annotations = new EObjectContainmentEList<Annotation>(Annotation.class, this, CircuitPackage.PORT__ANNOTATIONS);
		}
		return annotations;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Annotatable.class) {
			switch (derivedFeatureID) {
				case CircuitPackage.PORT__ANNOTATIONS: return AnnotationsPackage.ANNOTATABLE__ANNOTATIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Annotatable.class) {
			switch (baseFeatureID) {
				case AnnotationsPackage.ANNOTATABLE__ANNOTATIONS: return CircuitPackage.PORT__ANNOTATIONS;
				default: return -1;
			}
		}
		if (baseClass == NamedObject.class) {
