 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.yakindu.sccharts.sim.scg.scg.Parallel#getFirstInstruction <em>First Instruction</em>}</li>
 *   <li>{@link de.cau.cs.kieler.yakindu.sccharts.sim.scg.scg.Parallel#getSecondInstruction <em>Second Instruction</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.yakindu.sccharts.sim.scg.scg.ScgPackage#getParallel()
 * @model
 * @generated
 */
public interface Parallel extends Instruction, de.cau.cs.kieler.yakindu.sccharts.sim.scl.scl.Parallel
{
  /**
   ...
   * @see de.cau.cs.kieler.yakindu.sccharts.sim.scg.scg.ScgPackage#getParallel_FirstInstruction()
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.yakindu.sccharts.sim.scg.scg.Parallel#getFirstInstruction <em>First Instruction</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.yakindu.sccharts.sim.scg.scg.ScgPackage#getParallel_SecondInstruction()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.yakindu.sccharts.sim.scg.scg.Parallel#getSecondInstruction <em>Second Instruction</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
