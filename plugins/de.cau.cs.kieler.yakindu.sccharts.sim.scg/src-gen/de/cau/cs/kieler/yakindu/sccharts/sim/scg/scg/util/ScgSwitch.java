...
public class ScgSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case ScgPackage.PROGRAM:
      {
        ...
        if (result == null) result = caseScl_Program(program);
      ...
      case ScgPackage.ANNOTATION:
      {
        ...
        if (result == null) result = caseScl_Annotation(annotation);
   ...
   * @generated
   */
  public T caseScl_Program(de.cau.cs.kieler.yakindu.sccharts.sim.scl.scl.Program object)
  {
    return null;
  }
   ...
   * @generated
   */
  public T caseScl_Annotation(de.cau.cs.kieler.yakindu.sccharts.sim.scl.scl.Annotation object)
  {
    return null;
  }
