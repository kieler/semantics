...
public class GotoImpl extends InstructionImpl implements Goto
{
  ...
  {
    return ScgPackage.Literals.GOTO;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScgPackage.GOTO__NAME, oldName, name));
  }
  ...
  {
    if (baseClass == de.cau.cs.kieler.yakindu.sccharts.sim.scl.scl.Goto.class)
    {
      switch (derivedFeatureID)
      {
        case ScgPackage.GOTO__NAME: return SclPackage.GOTO__NAME;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == de.cau.cs.kieler.yakindu.sccharts.sim.scl.scl.Goto.class)
    {
      ...
      {
        case SclPackage.GOTO__NAME: return ScgPackage.GOTO__NAME;
        default: return -1;
      }
    }
