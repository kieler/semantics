...
@Singleton
public class Kits_textonlyGrammarAccess implements IGrammarAccess {
	...
	public class StateElements implements IParserRuleAccess {
		...
		//+=Action|"suspension" suspensionTrigger=Action|signals+=Signal)+ 
		//    	 	    
		//  		 	    
		//  		         
		//  		 	     // kein effect, kein delay, kein immediate
	...
	@Inject
	public Kits_textonlyGrammarAccess(GrammarProvider grammarProvider,
