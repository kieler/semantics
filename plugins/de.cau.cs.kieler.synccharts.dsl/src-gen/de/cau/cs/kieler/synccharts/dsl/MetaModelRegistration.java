...
public class MetaModelRegistration {
    ...
    static {
		...
		public static void register() {
			String nsURI = "de.cau.cs.kieler.synccharts.dsl";
			if (EPackage.Registry.INSTANCE.get(nsURI) == null) {
   				try {
					EPackage pack = (EPackage) loadRootObject("de/cau/cs/kieler/synccharts/dsl/scdsl" + ".ecore");
	...
	public static EPackage getEPackage() {
		return EPackage.Registry.INSTANCE.getEPackage("de.cau.cs.kieler.synccharts.dsl");
	}
	...
	private static String getLanguagePath() {
	   return "de/cau/cs/kieler/synccharts/dsl/scdsl";
	}
