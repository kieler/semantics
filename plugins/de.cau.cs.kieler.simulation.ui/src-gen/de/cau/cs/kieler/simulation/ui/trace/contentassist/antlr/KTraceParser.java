 ...
 * generated by Xtext
 */
package de.cau.cs.kieler.simulation.ui.trace.contentassist.antlr;
...
public class KTraceParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.cau.cs.kieler.simulation.ui.trace.contentassist.antlr.internal.InternalKTraceParser createParser() {
		de.cau.cs.kieler.simulation.ui.trace.contentassist.antlr.internal.InternalKTraceParser result = new de.cau.cs.kieler.simulation.ui.trace.contentassist.antlr.internal.InternalKTraceParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getTraceFileAccess().getAlternatives(), "rule__TraceFile__Alternatives");
					put(grammarAccess.getEsoTickAccess().getAlternatives_2_1(), "rule__EsoTick__Alternatives_2_1");
					put(grammarAccess.getEsoTickAccess().getAlternatives_4_1(), "rule__EsoTick__Alternatives_4_1");
					...
					put(grammarAccess.getEsoTraceAccess().getGroup(), "rule__EsoTrace__Group__0");
					put(grammarAccess.getEsoTickAccess().getGroup(), "rule__EsoTick__Group__0");
					put(grammarAccess.getEsoTickAccess().getGroup_2(), "rule__EsoTick__Group_2__0");
					put(grammarAccess.getEsoTickAccess().getGroup_2_1_1(), "rule__EsoTick__Group_2_1_1__0");
					put(grammarAccess.getEsoTickAccess().getGroup_4(), "rule__EsoTick__Group_4__0");
					put(grammarAccess.getEsoTickAccess().getGroup_4_1_1(), "rule__EsoTick__Group_4_1_1__0");
					put(grammarAccess.getKVPairAccess().getGroup(), "rule__KVPair__Group__0");
					put(grammarAccess.getKTracesAccess().getGroup(), "rule__KTraces__Group__0");
					put(grammarAccess.getKTracesAccess().getGroup_1(), "rule__KTraces__Group_1__0");
					put(grammarAccess.getKTracesAccess().getGroup_3(), "rule__KTraces__Group_3__0");
					...
					put(grammarAccess.getEsoTickAccess().getOutputsAssignment_2_2(), "rule__EsoTick__OutputsAssignment_2_2");
					put(grammarAccess.getEsoTickAccess().getAnnotationsAssignment_3(), "rule__EsoTick__AnnotationsAssignment_3");
					put(grammarAccess.getEsoTickAccess().getAnnotationsAssignment_4_2(), "rule__EsoTick__AnnotationsAssignment_4_2");
					put(grammarAccess.getKVPairAccess().getNameAssignment_1(), "rule__KVPair__NameAssignment_1");
					put(grammarAccess.getKVPairAccess().getValuesAssignment_3(), "rule__KVPair__ValuesAssignment_3");
					put(grammarAccess.getKTracesAccess().getPragmasAssignment_0(), "rule__KTraces__PragmasAssignment_0");
					put(grammarAccess.getKTracesAccess().getTracesAssignment_2(), "rule__KTraces__TracesAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.cau.cs.kieler.simulation.ui.trace.contentassist.antlr.internal.InternalKTraceParser typedParser = (de.cau.cs.kieler.simulation.ui.trace.contentassist.antlr.internal.InternalKTraceParser) parser;
			typedParser.entryRuleTraceFile();
