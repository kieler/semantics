...
:
	(
		{ before(grammarAccess.getEsoTickAccess().getInputsEmissionParserRuleCall_1_0()); }
		ruleEmission
		{ after(grammarAccess.getEsoTickAccess().getInputsEmissionParserRuleCall_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getEsoTickAccess().getOutputsEmissionParserRuleCall_2_2_0()); }
		ruleEmission
		{ after(grammarAccess.getEsoTickAccess().getOutputsEmissionParserRuleCall_2_2_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
