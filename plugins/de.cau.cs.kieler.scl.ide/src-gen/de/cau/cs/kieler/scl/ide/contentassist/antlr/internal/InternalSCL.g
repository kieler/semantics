...
:
	(
		...
		ruleParameter
		{ after(grammarAccess.getModuleCallAccess().getParametersParameterParserRuleCall_3_0_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleParameter
		{ after(grammarAccess.getModuleCallAccess().getParametersParameterParserRuleCall_3_0_2_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
