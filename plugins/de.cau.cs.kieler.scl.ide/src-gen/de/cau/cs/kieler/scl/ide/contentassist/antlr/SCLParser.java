...
public class SCLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SCLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getModuleCallParameterAccess().getGroup_0(), "rule__ModuleCallParameter__Group_0__0");
			builder.put(grammarAccess.getModuleCallParameterAccess().getGroup_2(), "rule__ModuleCallParameter__Group_2__0");
			builder.put(grammarAccess.getModuleCallParameterAccess().getGroup_2_2(), "rule__ModuleCallParameter__Group_2_2__0");
			...
			builder.put(grammarAccess.getModuleCallParameterAccess().getPureOutputAssignment_0_0(), "rule__ModuleCallParameter__PureOutputAssignment_0_0");
			builder.put(grammarAccess.getModuleCallParameterAccess().getCallByReferenceAssignment_0_1(), "rule__ModuleCallParameter__CallByReferenceAssignment_0_1");
			builder.put(grammarAccess.getModuleCallParameterAccess().getExpressionAssignment_1(), "rule__ModuleCallParameter__ExpressionAssignment_1");
			builder.put(grammarAccess.getModuleCallParameterAccess().getExplicitBindingAssignment_2_1(), "rule__ModuleCallParameter__ExplicitBindingAssignment_2_1");
			builder.put(grammarAccess.getModuleCallParameterAccess().getExplicitBindingIndicesAssignment_2_2_1(), "rule__ModuleCallParameter__ExplicitBindingIndicesAssignment_2_2_1");
