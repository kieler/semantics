		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getConditionalAccess().getAlternatives_7(), "rule__Conditional__Alternatives_7");
					put(grammarAccess.getLegacyConditionalAccess().getAlternatives_5(), "rule__LegacyConditional__Alternatives_5");
					put(grammarAccess.getThreadAccess().getAlternatives_1(), "rule__Thread__Alternatives_1");
					put(grammarAccess.getModuleCallAccess().getAlternatives_3(), "rule__ModuleCall__Alternatives_3");
					...
					put(grammarAccess.getVariableDeclarationAccess().getAlternatives_6(), "rule__VariableDeclaration__Alternatives_6");
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getAlternatives_6(), "rule__VariableDeclarationWOSemicolon__Alternatives_6");
					...
					put(grammarAccess.getPriorityProtocolAccess().getAlternatives(), "rule__PriorityProtocol__Alternatives");
					...
					put(grammarAccess.getLegacyConditionalAccess().getGroup_5_0(), "rule__LegacyConditional__Group_5_0__0");
					put(grammarAccess.getLegacyElseScopeAccess().getGroup(), "rule__LegacyElseScope__Group__0");
					...
					put(grammarAccess.getModuleCallAccess().getGroup(), "rule__ModuleCall__Group__0");
					put(grammarAccess.getModuleCallAccess().getGroup_3_0(), "rule__ModuleCall__Group_3_0__0");
					put(grammarAccess.getModuleCallAccess().getGroup_3_0_2(), "rule__ModuleCall__Group_3_0_2__0");
					...
					put(grammarAccess.getVariableDeclarationAccess().getGroup_6_0(), "rule__VariableDeclaration__Group_6_0__0");
					put(grammarAccess.getVariableDeclarationAccess().getGroup_6_2(), "rule__VariableDeclaration__Group_6_2__0");
					put(grammarAccess.getVariableDeclarationAccess().getGroup_8(), "rule__VariableDeclaration__Group_8__0");
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getGroup(), "rule__VariableDeclarationWOSemicolon__Group__0");
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getGroup_6_0(), "rule__VariableDeclarationWOSemicolon__Group_6_0__0");
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getGroup_6_2(), "rule__VariableDeclarationWOSemicolon__Group_6_2__0");
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getGroup_8(), "rule__VariableDeclarationWOSemicolon__Group_8__0");
					...
					put(grammarAccess.getReferenceDeclarationAccess().getGroup_1_1_2(), "rule__ReferenceDeclaration__Group_1_1_2__0");
					...
					put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGroup_1_1_2(), "rule__ReferenceDeclarationWOSemicolon__Group_1_1_2__0");
					put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getGroup_3(), "rule__ReferenceDeclarationWOSemicolon__Group_3__0");
					put(grammarAccess.getExternStringAccess().getGroup(), "rule__ExternString__Group__0");
					put(grammarAccess.getScheduleDeclarationAccess().getGroup(), "rule__ScheduleDeclaration__Group__0");
					put(grammarAccess.getScheduleDeclarationAccess().getGroup_3(), "rule__ScheduleDeclaration__Group_3__0");
					put(grammarAccess.getScheduleDeclarationAccess().getGroup_4(), "rule__ScheduleDeclaration__Group_4__0");
					put(grammarAccess.getScheduleDeclarationAccess().getGroup_4_2(), "rule__ScheduleDeclaration__Group_4_2__0");
					...
					put(grammarAccess.getScheduleDeclarationWOSemicolonAccess().getGroup_3(), "rule__ScheduleDeclarationWOSemicolon__Group_3__0");
					put(grammarAccess.getScheduleDeclarationWOSemicolonAccess().getGroup_4(), "rule__ScheduleDeclarationWOSemicolon__Group_4__0");
					put(grammarAccess.getScheduleDeclarationWOSemicolonAccess().getGroup_4_2(), "rule__ScheduleDeclarationWOSemicolon__Group_4_2__0");
					...
					put(grammarAccess.getModuleAccess().getStatementsAssignment_5(), "rule__Module__StatementsAssignment_5");
					put(grammarAccess.getPauseAccess().getAnnotationsAssignment_1(), "rule__Pause__AnnotationsAssignment_1");
					put(grammarAccess.getPauseAccess().getSemicolonAssignment_3(), "rule__Pause__SemicolonAssignment_3");
					...
					put(grammarAccess.getConditionalAccess().getStatementsAssignment_5(), "rule__Conditional__StatementsAssignment_5");
					put(grammarAccess.getConditionalAccess().getElseAssignment_7_0(), "rule__Conditional__ElseAssignment_7_0");
					put(grammarAccess.getConditionalAccess().getSemicolonAssignment_7_1(), "rule__Conditional__SemicolonAssignment_7_1");
					...
					put(grammarAccess.getElseScopeAccess().getStatementsAssignment_5(), "rule__ElseScope__StatementsAssignment_5");
					put(grammarAccess.getElseScopeAccess().getSemicolonAssignment_7(), "rule__ElseScope__SemicolonAssignment_7");
					put(grammarAccess.getLegacyConditionalAccess().getAnnotationsAssignment_0(), "rule__LegacyConditional__AnnotationsAssignment_0");
					put(grammarAccess.getLegacyConditionalAccess().getExpressionAssignment_2(), "rule__LegacyConditional__ExpressionAssignment_2");
					put(grammarAccess.getLegacyConditionalAccess().getStatementsAssignment_4(), "rule__LegacyConditional__StatementsAssignment_4");
					put(grammarAccess.getLegacyConditionalAccess().getSemicolonAssignment_5_0_1(), "rule__LegacyConditional__SemicolonAssignment_5_0_1");
					put(grammarAccess.getLegacyConditionalAccess().getElseAssignment_5_1(), "rule__LegacyConditional__ElseAssignment_5_1");
					put(grammarAccess.getLegacyElseScopeAccess().getAnnotationsAssignment_1(), "rule__LegacyElseScope__AnnotationsAssignment_1");
					put(grammarAccess.getLegacyElseScopeAccess().getStatementsAssignment_3(), "rule__LegacyElseScope__StatementsAssignment_3");
					put(grammarAccess.getLegacyElseScopeAccess().getSemicolonAssignment_5(), "rule__LegacyElseScope__SemicolonAssignment_5");
					...
					put(grammarAccess.getThreadAccess().getStatementsAssignment_1_0_3(), "rule__Thread__StatementsAssignment_1_0_3");
					put(grammarAccess.getThreadAccess().getStatementsAssignment_1_1(), "rule__Thread__StatementsAssignment_1_1");
					...
					put(grammarAccess.getParallelAccess().getSemicolonAssignment_3(), "rule__Parallel__SemicolonAssignment_3");
					...
					put(grammarAccess.getScopeStatementAccess().getStatementsAssignment_4(), "rule__ScopeStatement__StatementsAssignment_4");
					put(grammarAccess.getModuleCallAccess().getAnnotationsAssignment_0(), "rule__ModuleCall__AnnotationsAssignment_0");
					put(grammarAccess.getModuleCallAccess().getModuleAssignment_2(), "rule__ModuleCall__ModuleAssignment_2");
					put(grammarAccess.getModuleCallAccess().getParametersAssignment_3_0_1(), "rule__ModuleCall__ParametersAssignment_3_0_1");
					put(grammarAccess.getModuleCallAccess().getParametersAssignment_3_0_2_1(), "rule__ModuleCall__ParametersAssignment_3_0_2_1");
					put(grammarAccess.getModuleCallAccess().getSemicolonAssignment_4(), "rule__ModuleCall__SemicolonAssignment_4");
					...
					put(grammarAccess.getVariableDeclarationAccess().getGlobalAssignment_4(), "rule__VariableDeclaration__GlobalAssignment_4");
					put(grammarAccess.getVariableDeclarationAccess().getStaticAssignment_5(), "rule__VariableDeclaration__StaticAssignment_5");
					put(grammarAccess.getVariableDeclarationAccess().getSignalAssignment_6_0_0(), "rule__VariableDeclaration__SignalAssignment_6_0_0");
					put(grammarAccess.getVariableDeclarationAccess().getTypeAssignment_6_0_1(), "rule__VariableDeclaration__TypeAssignment_6_0_1");
					put(grammarAccess.getVariableDeclarationAccess().getSignalAssignment_6_1(), "rule__VariableDeclaration__SignalAssignment_6_1");
					put(grammarAccess.getVariableDeclarationAccess().getTypeAssignment_6_2_0(), "rule__VariableDeclaration__TypeAssignment_6_2_0");
					put(grammarAccess.getVariableDeclarationAccess().getHostTypeAssignment_6_2_1(), "rule__VariableDeclaration__HostTypeAssignment_6_2_1");
					put(grammarAccess.getVariableDeclarationAccess().getValuedObjectsAssignment_7(), "rule__VariableDeclaration__ValuedObjectsAssignment_7");
					put(grammarAccess.getVariableDeclarationAccess().getValuedObjectsAssignment_8_1(), "rule__VariableDeclaration__ValuedObjectsAssignment_8_1");
					put(grammarAccess.getVariableDeclarationAccess().getAnnotationsAssignment_10(), "rule__VariableDeclaration__AnnotationsAssignment_10");
					...
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getGlobalAssignment_4(), "rule__VariableDeclarationWOSemicolon__GlobalAssignment_4");
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getStaticAssignment_5(), "rule__VariableDeclarationWOSemicolon__StaticAssignment_5");
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getSignalAssignment_6_0_0(), "rule__VariableDeclarationWOSemicolon__SignalAssignment_6_0_0");
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getTypeAssignment_6_0_1(), "rule__VariableDeclarationWOSemicolon__TypeAssignment_6_0_1");
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getSignalAssignment_6_1(), "rule__VariableDeclarationWOSemicolon__SignalAssignment_6_1");
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getTypeAssignment_6_2_0(), "rule__VariableDeclarationWOSemicolon__TypeAssignment_6_2_0");
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getHostTypeAssignment_6_2_1(), "rule__VariableDeclarationWOSemicolon__HostTypeAssignment_6_2_1");
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getValuedObjectsAssignment_7(), "rule__VariableDeclarationWOSemicolon__ValuedObjectsAssignment_7");
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getValuedObjectsAssignment_8_1(), "rule__VariableDeclarationWOSemicolon__ValuedObjectsAssignment_8_1");
					put(grammarAccess.getVariableDeclarationWOSemicolonAccess().getAnnotationsAssignment_9(), "rule__VariableDeclarationWOSemicolon__AnnotationsAssignment_9");
					...
					put(grammarAccess.getReferenceDeclarationAccess().getExternAssignment_1_1_2_1(), "rule__ReferenceDeclaration__ExternAssignment_1_1_2_1");
					...
					put(grammarAccess.getReferenceDeclarationWOSemicolonAccess().getExternAssignment_1_1_2_1(), "rule__ReferenceDeclarationWOSemicolon__ExternAssignment_1_1_2_1");
					...
					put(grammarAccess.getExternStringAccess().getAnnotationsAssignment_0(), "rule__ExternString__AnnotationsAssignment_0");
					put(grammarAccess.getExternStringAccess().getCodeAssignment_1(), "rule__ExternString__CodeAssignment_1");
					...
					put(grammarAccess.getScheduleDeclarationAccess().getGlobalAssignment_3_1(), "rule__ScheduleDeclaration__GlobalAssignment_3_1");
					put(grammarAccess.getScheduleDeclarationAccess().getPrioritiesAssignment_4_1(), "rule__ScheduleDeclaration__PrioritiesAssignment_4_1");
					put(grammarAccess.getScheduleDeclarationAccess().getPrioritiesAssignment_4_2_1(), "rule__ScheduleDeclaration__PrioritiesAssignment_4_2_1");
					...
					put(grammarAccess.getScheduleDeclarationWOSemicolonAccess().getGlobalAssignment_3_1(), "rule__ScheduleDeclarationWOSemicolon__GlobalAssignment_3_1");
					put(grammarAccess.getScheduleDeclarationWOSemicolonAccess().getPrioritiesAssignment_4_1(), "rule__ScheduleDeclarationWOSemicolon__PrioritiesAssignment_4_1");
					put(grammarAccess.getScheduleDeclarationWOSemicolonAccess().getPrioritiesAssignment_4_2_1(), "rule__ScheduleDeclarationWOSemicolon__PrioritiesAssignment_4_2_1");
					...
					put(grammarAccess.getPostfixEffectAccess().getReferenceAssignment_1(), "rule__PostfixEffect__ReferenceAssignment_1");
					put(grammarAccess.getPostfixEffectAccess().getOperatorAssignment_2(), "rule__PostfixEffect__OperatorAssignment_2");
					put(grammarAccess.getPostfixEffectAccess().getScheduleAssignment_3_1(), "rule__PostfixEffect__ScheduleAssignment_3_1");
