 ...
 * generated by Xtext
 */
package de.cau.cs.kieler.ide.scol.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import de.cau.cs.kieler.ide.scol.contentassist.antlr.internal.InternalSCOLParser;
import de.cau.cs.kieler.scol.services.SCOLGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class SCOLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(SCOLGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SCOLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSCOLProgramAccess().getGroup(), "rule__SCOLProgram__Group__0");
			...
			builder.put(grammarAccess.getSCOLProgramAccess().getPragmasAssignment_0(), "rule__SCOLProgram__PragmasAssignment_0");
			builder.put(grammarAccess.getSCOLProgramAccess().getModulesAssignment_1(), "rule__SCOLProgram__ModulesAssignment_1");
	...
	@Override
	protected InternalSCOLParser createParser() {
		InternalSCOLParser result = new InternalSCOLParser(null);
