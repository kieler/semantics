...
:
(
{ before(grammarAccess.getTransitionAccess().getTriggerBoolExpressionParserRuleCall_4_0()); }
	ruleBoolExpression{ after(grammarAccess.getTransitionAccess().getTriggerBoolExpressionParserRuleCall_4_0()); }
)
