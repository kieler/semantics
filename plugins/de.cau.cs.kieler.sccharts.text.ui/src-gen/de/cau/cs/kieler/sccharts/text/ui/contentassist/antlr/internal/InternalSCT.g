...
:
(
{ before(grammarAccess.getSCChartsAccess().getAnnotationsPragmaAnnotationParserRuleCall_0_0()); }
	rulePragmaAnnotation{ after(grammarAccess.getSCChartsAccess().getAnnotationsPragmaAnnotationParserRuleCall_0_0()); }
)
