		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEntryActionAccess().getGroup_4(), "rule__EntryAction__Group_4__0");
					put(grammarAccess.getEntryActionAccess().getGroup_4_2(), "rule__EntryAction__Group_4_2__0");
					put(grammarAccess.getDuringActionAccess().getGroup(), "rule__DuringAction__Group__0");
					put(grammarAccess.getDuringActionAccess().getGroup_5(), "rule__DuringAction__Group_5__0");
					put(grammarAccess.getDuringActionAccess().getGroup_5_2(), "rule__DuringAction__Group_5_2__0");
					put(grammarAccess.getExitActionAccess().getGroup(), "rule__ExitAction__Group__0");
					put(grammarAccess.getExitActionAccess().getGroup_4(), "rule__ExitAction__Group_4__0");
					put(grammarAccess.getExitActionAccess().getGroup_4_2(), "rule__ExitAction__Group_4_2__0");
					...
					put(grammarAccess.getValuedObjectAccess().getTypeAssignment_7_1_1(), "rule__ValuedObject__TypeAssignment_7_1_1");
					put(grammarAccess.getValuedObjectAccess().getCombineOperatorAssignment_7_1_3(), "rule__ValuedObject__CombineOperatorAssignment_7_1_3");
					...
					put(grammarAccess.getEntryActionAccess().getTriggerAssignment_3(), "rule__EntryAction__TriggerAssignment_3");
					put(grammarAccess.getEntryActionAccess().getEffectsAssignment_4_1(), "rule__EntryAction__EffectsAssignment_4_1");
					put(grammarAccess.getEntryActionAccess().getEffectsAssignment_4_2_1(), "rule__EntryAction__EffectsAssignment_4_2_1");
					put(grammarAccess.getDuringActionAccess().getIsImmediateAssignment_1(), "rule__DuringAction__IsImmediateAssignment_1");
					put(grammarAccess.getDuringActionAccess().getTriggerAssignment_4(), "rule__DuringAction__TriggerAssignment_4");
					put(grammarAccess.getDuringActionAccess().getEffectsAssignment_5_1(), "rule__DuringAction__EffectsAssignment_5_1");
					put(grammarAccess.getDuringActionAccess().getEffectsAssignment_5_2_1(), "rule__DuringAction__EffectsAssignment_5_2_1");
					put(grammarAccess.getExitActionAccess().getTriggerAssignment_3(), "rule__ExitAction__TriggerAssignment_3");
					put(grammarAccess.getExitActionAccess().getEffectsAssignment_4_1(), "rule__ExitAction__EffectsAssignment_4_1");
					put(grammarAccess.getExitActionAccess().getEffectsAssignment_4_2_1(), "rule__ExitAction__EffectsAssignment_4_2_1");
