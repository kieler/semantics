		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRootRegionAccess().getDeclarationsAssignment_2_5(), "rule__RootRegion__DeclarationsAssignment_2_5");
					...
					put(grammarAccess.getSCChartAccess().getDeclarationsAssignment_5_1_1_0_0(), "rule__SCChart__DeclarationsAssignment_5_1_1_0_0");
