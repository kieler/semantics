		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getInputNodeAccess().getExpressionAssignment_4(), "rule__InputNode__ExpressionAssignment_4");
					...
					put(grammarAccess.getOutputNodeAccess().getValuedObjectAssignment_3(), "rule__OutputNode__ValuedObjectAssignment_3");
					...
					put(grammarAccess.getReferencedNodeAccess().getReferencedScopeAssignment_3(), "rule__ReferencedNode__ReferencedScopeAssignment_3");
