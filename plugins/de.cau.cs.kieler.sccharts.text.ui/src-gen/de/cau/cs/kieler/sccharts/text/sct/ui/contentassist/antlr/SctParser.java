	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getSingleDataflowRegionAccess().getAlternatives_2(), "rule__SingleDataflowRegion__Alternatives_2");
					put(grammarAccess.getDataflowRegionAccess().getAlternatives_8(), "rule__DataflowRegion__Alternatives_8");
					...
					put(grammarAccess.getStateAccess().getAlternatives_6_1_2(), "rule__State__Alternatives_6_1_2");
					...
					put(grammarAccess.getSingleControlflowRegionAccess().getGroup_1(), "rule__SingleControlflowRegion__Group_1__0");
					put(grammarAccess.getSingleControlflowRegionAccess().getGroup_1_4(), "rule__SingleControlflowRegion__Group_1_4__0");
					put(grammarAccess.getSingleDataflowRegionAccess().getGroup(), "rule__SingleDataflowRegion__Group__0");
					put(grammarAccess.getSingleDataflowRegionAccess().getGroup_1(), "rule__SingleDataflowRegion__Group_1__0");
					put(grammarAccess.getSingleDataflowRegionAccess().getGroup_1_4(), "rule__SingleDataflowRegion__Group_1_4__0");
					...
					put(grammarAccess.getControlflowRegionAccess().getGroup_5(), "rule__ControlflowRegion__Group_5__0");
					...
					put(grammarAccess.getSingleControlflowRegionAccess().getAnnotationsAssignment_1_0(), "rule__SingleControlflowRegion__AnnotationsAssignment_1_0");
					put(grammarAccess.getSingleControlflowRegionAccess().getIdAssignment_1_2(), "rule__SingleControlflowRegion__IdAssignment_1_2");
					put(grammarAccess.getSingleControlflowRegionAccess().getLabelAssignment_1_3(), "rule__SingleControlflowRegion__LabelAssignment_1_3");
					put(grammarAccess.getSingleControlflowRegionAccess().getForAssignment_1_4_1(), "rule__SingleControlflowRegion__ForAssignment_1_4_1");
					put(grammarAccess.getSingleControlflowRegionAccess().getDeclarationsAssignment_1_6(), "rule__SingleControlflowRegion__DeclarationsAssignment_1_6");
					put(grammarAccess.getSingleControlflowRegionAccess().getStatesAssignment_2(), "rule__SingleControlflowRegion__StatesAssignment_2");
					put(grammarAccess.getSingleDataflowRegionAccess().getAnnotationsAssignment_1_0(), "rule__SingleDataflowRegion__AnnotationsAssignment_1_0");
					put(grammarAccess.getSingleDataflowRegionAccess().getIdAssignment_1_2(), "rule__SingleDataflowRegion__IdAssignment_1_2");
					put(grammarAccess.getSingleDataflowRegionAccess().getLabelAssignment_1_3(), "rule__SingleDataflowRegion__LabelAssignment_1_3");
					put(grammarAccess.getSingleDataflowRegionAccess().getForAssignment_1_4_1(), "rule__SingleDataflowRegion__ForAssignment_1_4_1");
					put(grammarAccess.getSingleDataflowRegionAccess().getDeclarationsAssignment_1_6(), "rule__SingleDataflowRegion__DeclarationsAssignment_1_6");
					put(grammarAccess.getSingleDataflowRegionAccess().getEquationsAssignment_2_0(), "rule__SingleDataflowRegion__EquationsAssignment_2_0");
					put(grammarAccess.getSingleDataflowRegionAccess().getNodesAssignment_2_1(), "rule__SingleDataflowRegion__NodesAssignment_2_1");
					...
					put(grammarAccess.getControlflowRegionAccess().getForAssignment_5_1(), "rule__ControlflowRegion__ForAssignment_5_1");
					put(grammarAccess.getControlflowRegionAccess().getDeclarationsAssignment_7(), "rule__ControlflowRegion__DeclarationsAssignment_7");
					put(grammarAccess.getControlflowRegionAccess().getStatesAssignment_8(), "rule__ControlflowRegion__StatesAssignment_8");
					...
					put(grammarAccess.getDataflowRegionAccess().getForAssignment_5_1(), "rule__DataflowRegion__ForAssignment_5_1");
					put(grammarAccess.getDataflowRegionAccess().getDeclarationsAssignment_7(), "rule__DataflowRegion__DeclarationsAssignment_7");
					put(grammarAccess.getDataflowRegionAccess().getEquationsAssignment_8_0(), "rule__DataflowRegion__EquationsAssignment_8_0");
					put(grammarAccess.getDataflowRegionAccess().getNodesAssignment_8_1(), "rule__DataflowRegion__NodesAssignment_8_1");
					...
					put(grammarAccess.getStateAccess().getRegionsAssignment_6_1_3(), "rule__State__RegionsAssignment_6_1_3");
