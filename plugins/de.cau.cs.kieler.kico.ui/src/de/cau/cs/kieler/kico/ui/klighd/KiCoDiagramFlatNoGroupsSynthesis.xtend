 ...
 */
class KiCoDiagramFlatNoGroupsSynthesis extends AbstractDiagramSynthesis<List<FeatureDummy>> {
...
//    // -------------------------------------------------------------------------
    ...
    def void connectToNonGroup(FeatureDummy source, FeatureDummy dest, boolean dashed) {
         if (dest.isGroup) {
