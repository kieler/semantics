 ...
 */
class KiCoDiagramFlatNoGroupsSynthesis extends AbstractDiagramSynthesis<List<TransformationDummy>> {
...
//    // -------------------------------------------------------------------------
                ...
                if (transformationDummy.isGroup) {
                    ...
                    for (dest : transformationDummy.dependencies) {
                        ...
                        if (transSource != null && transDest != null) {
                            transSource.connectToNonGroup(transDest, false)
                        }
                    }
                }
            ];
    ...
    def void connectToNonGroup(TransformationDummy source, TransformationDummy dest, boolean dashed) {
         if (dest.isGroup) {
                 for (groupDest : dest.dependencies) {
                         var transGroupDest = groupDest
                         connectToNonGroup(source, transGroupDest, dashed)
                  }
         } else {
             if (source != null && dest != null) {
                 source.translateTransition(dest, false)
             }
         }
    }
