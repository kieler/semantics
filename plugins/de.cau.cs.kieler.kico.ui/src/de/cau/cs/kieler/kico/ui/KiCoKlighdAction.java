...
/**
 * This is the base abstract class for a KiCo KLighD action for selecting, unselecting transformations
 * in the internal KLighD View. It provides access methods to color the shapes and text.
 * 
 * @author cmot
...
public abstract class KiCoKlighdAction {
    ...
    private static HashMap<TransformationDummy, KRoundedRectangle> transformationDummy2KRoundedRectangle = new HashMap<TransformationDummy, KRoundedRectangle>();
    private static HashMap<TransformationDummy, KText> transformationDummy2KText = new HashMap<TransformationDummy, KText>();
...
//    }
    ...
    KText getKText(final TransformationDummy transformationDummy, final ActionContext context) {
        if (!transformationDummy2KText.containsKey(transformationDummy)) {
            KText kText = context.getViewContext().getTargetElement(transformationDummy, KText.class);
     ...
     */
    void setLabelColor(final TransformationDummy transformationDummy, final ActionContext context, KColor foregroundColor, KColor backgroundColor) {
