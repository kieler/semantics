...
public interface SyncchartsPackage extends EPackage {
     ...
     * @ordered
     */
    int ACTION__ANNOTATIONS = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE__ANNOTATIONS;
     ...
     * @ordered
     */
    int ACTION__EFFECTS = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int ACTION__TRIGGER = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int ACTION__DELAY = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
    int ACTION__IS_IMMEDIATE = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 3;
     ...
     * @ordered
     */
    int ACTION__LABEL = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 4;
     ...
     * @ordered
     */
    int ACTION_FEATURE_COUNT = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 5;
     ...
     * @ordered
     */
    int SCOPE__ANNOTATIONS = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE__ANNOTATIONS;
     ...
     * @ordered
     */
    int SCOPE__ID = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int SCOPE__LABEL = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int SCOPE__SIGNALS = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
    int SCOPE__VARIABLES = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 3;
     ...
     * @ordered
     */
    int SCOPE__SUSPENSION_TRIGGER = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 4;
     ...
     * @ordered
     */
    int SCOPE__EXIT_ACTIONS = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 5;
     ...
     * @ordered
     */
    int SCOPE__INNER_ACTIONS = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 6;
     ...
     * @ordered
     */
    int SCOPE__ENTRY_ACTIONS = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 7;
     ...
     * @ordered
     */
    int SCOPE__BODY_REFERENCE = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 8;
     ...
     * @ordered
     */
    int SCOPE__BODY_CONTENTS = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 9;
     ...
     * @ordered
     */
    int SCOPE__BODY_TEXT = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 10;
     ...
     * @ordered
     */
    int SCOPE__RENAMINGS = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 11;
     ...
     * @ordered
     */
    int SCOPE__INTERFACE_DECLARATION = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 12;
     ...
     * @ordered
     */
    int SCOPE_FEATURE_COUNT = de.cau.cs.kieler.annotations.AnnotationsPackage.ANNOTATABLE_FEATURE_COUNT + 13;
