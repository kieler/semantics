#!/bin/bash
#copy the main file
CONTROLLER_TARGET=RailwayControllerC/SampleController.c
...
cat $CONTROLLER_TARGET \
	...
	| (while read -r FILENAME; do
		...
		echo "Tick File: $FILE"
		cp -u $FILE RailwayControllerC/
	done)

make SampleController.bin && ./Executables/SampleController + $(sed -n -e "/^[*IOK]/p" railway.cnf | tr "*\n\r" "- ") "" "" "" "" "" "" "" "" "" "" ""
