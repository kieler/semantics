...
void mergeSingleDataArrays_simulation(
  ...
  trackExtDataArray_simulation *trackExtDataArrayMerged /* simulation::mergeSingleDataArrays::trackExtDataArrayMerged */)
{
  ...
  for (i = 0; i < 48; i++)
    {
      mergeSingleData_simulation(
        &(*contactArray1)[i],
        (*positionArrayHead1)[i],
        (*positionArrayTail1)[i],
        (*errorArrayBlocks1)[i],
        (*errorArrayPoints1)[i],
        &(*contactArray2)[i],
        (*positionArrayHead2)[i],
        (*positionArrayTail2)[i],
        (*errorArrayBlocks2)[i],
        (*errorArrayPoints2)[i],
        &(*trackExtDataArray1)[i],
        &(*trackExtDataArray2)[i],
        &(*contactsArrayMerged)[i],
        &(*positionArrayHeadMerged)[i],
        &(*positionArrayTailMerged)[i],
        &(*errorArrayBlocksMerged)[i],
        &(*errorArrayPointsMerged)[i],
        &(*trackExtDataArrayMerged)[i]);
    }
}

/* $**************  KCG Version 6.0.0b (build i19) **************
** mergeSingleDataArrays_simulation.c
** Generation date: 2009-02-24T01:42:12
*************************************************************$ */
