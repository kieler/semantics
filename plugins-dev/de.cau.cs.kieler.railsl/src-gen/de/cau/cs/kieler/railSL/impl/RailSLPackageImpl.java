...
import de.cau.cs.kieler.railSL.WaitStatement;
...
public class RailSLPackageImpl extends EPackageImpl implements RailSLPackage
{
   ...
   * @see de.cau.cs.kieler.railSL.RailSLPackage#eNS_URI
   * @see #init()
   * @generated
   */
