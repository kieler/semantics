...
public interface RailSLPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the containment reference list '{@link de.cau.cs.kieler.railsl.railSL.Program#getBlocks <em>Blocks</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Blocks</em>'.
   * @see de.cau.cs.kieler.railsl.railSL.Program#getBlocks()
   * @see #getProgram()
   * @generated
   */
