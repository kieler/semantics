...
<#if varType == "string">
<@cJSON_value_method />((${var} != NULL) ? ${var} : "")<#t>
<#else>
...
<#if varType == "bool" || varType == "pure" || varType == "int" || varType == "unsigned">
${item}->valueint;
...
<#if varType == "int" || varType == "float" || varType == "double" || varType == "unsigned">
