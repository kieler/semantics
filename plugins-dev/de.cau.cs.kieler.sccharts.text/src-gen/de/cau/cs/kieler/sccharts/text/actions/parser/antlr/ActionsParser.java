...
public class ActionsParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected de.cau.cs.kieler.sccharts.text.actions.parser.antlr.internal.InternalActionsParser createParser(XtextTokenStream stream) {
		return new de.cau.cs.kieler.sccharts.text.actions.parser.antlr.internal.InternalActionsParser(stream, getGrammarAccess());
	}
